...
namespace ReversePrism.DataModels
{
    ...
    public partial class GashaHistoryDetailCellView : DataModel
    {
        ...
        public static GashaHistoryDetailCellView? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new GashaHistoryDetailCellView() { Pointer= p0 };
