...
namespace ReversePrism.DataModels
{
    ...
    public partial class MonoPInvokeCallbackAttribute : DataModel
    {
        ...
        public static MonoPInvokeCallbackAttribute? FromPointer(IntPtr p0)
        {
            ...
            value.Type                                      = GetObject<Type>(new IntPtr(p + 0x010), ReversePrism.DataModels.Type.FromPointer); // 024669413F38 0x10 Type                        ( 000186692850 ModelClassType Type Type Type Pointer )
