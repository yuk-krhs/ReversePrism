...
namespace ReversePrism.DataModels
{
    ...
    // 028 CompletionCallbackData                   ModelEnumType CompletionCallbackData CompletionCallbackData CompletionCallbackData Int32
    public partial class BatchContextSafeHandle : DataModel
    {
        ...
        public static BatchContextSafeHandle? FromPointer(IntPtr p0)
        {
            ...
            value.CompletionCallbackData                    = (CompletionCallbackData)GetInt32(new IntPtr(p + 0x028)); // 0x28 CompletionCallbackData      ( ModelEnumType CompletionCallbackData CompletionCallbackData CompletionCallbackData Int32 )
