...
namespace ReversePrism.DataModels
{
    ...
    public partial class Number
    {
        ...
        public static Number? FromPointer(IntPtr p0)
        {
            ...
            value.S_rgval64Power10By16                      = GetUInt64List(new IntPtr(p + 0x010)); // 0270D6E19608 0x10 S_rgval64Power10By16        ( 000185B84A20 ModelPrimitiveListType ulong[] ulong[] List<ulong> Pointer )
            value.S_rgexp64Power10By16                      = GetInt16List(new IntPtr(p + 0x018)); // 0270D6E19628 0x18 S_rgexp64Power10By16        ( 000185B8D910 ModelPrimitiveListType short[] short[] List<short> Pointer )
