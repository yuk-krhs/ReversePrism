...
namespace ReversePrism.DataModels
{
    ...
    public partial class Datatype_short : DataModel
    {
        ...
        public static Datatype_short? FromPointer(IntPtr p0)
        {
            ...
            value.Numeric10FacetsChecker                    = GetObject<FacetsChecker>(new IntPtr(p + 0x010), ReversePrism.DataModels.FacetsChecker.FromPointer); // 02466758BA28 0x10 Numeric10FacetsChecker      ( 00018654FD90 ModelClassType FacetsChecker FacetsChecker FacetsChecker Pointer )
