...
namespace ReversePrism.DataModels
{
    ...
    public partial class XmlSchemaObjectTable
    {
        ...
        public static XmlSchemaObjectTable? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new XmlSchemaObjectTable();

            value.Entries                                   = GetEnumList<XmlSchemaObjectEntry>(new IntPtr(p + 0x018)); // 0270D74F84D0 0x18 Entries                     ( 000185D318A8 ModelEnumListType List`1<XmlSchemaObjectEntry> List`1<XmlSchemaObjectEntry> List<XmlSchemaObjectEntry> Pointer )
