...
namespace ReversePrism.DataModels
{
    ...
    public partial class SchemaInfo
    {
        ...
        public static SchemaInfo? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SchemaInfo();

            value.DocTypeName                               = GetObject<XmlQualifiedName>(new IntPtr(p + 0x030), ReversePrism.DataModels.XmlQualifiedName.FromPointer); // 0270D744D880 0x30 DocTypeName                 ( 0001866BC7E0 ModelClassType XmlQualifiedName XmlQualifiedName XmlQualifiedName Pointer )
            value.InternalDtdSubset                         = GetString(new IntPtr(p + 0x038)); // 0270D744D8A0 0x38 InternalDtdSubset           ( 000186671910 ModelPrimitiveType string string string String )
            value.HasNonCDataAttributes                     = GetBool(new IntPtr(p + 0x040)); // 0270D744D8C0 0x40 HasNonCDataAttributes       ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.HasDefaultAttributes                      = GetBool(new IntPtr(p + 0x041)); // 0270D744D8E0 0x41 HasDefaultAttributes        ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.ErrorCount                                = GetInt32(new IntPtr(p + 0x058)); // 0270D744D940 0x58 ErrorCount                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SchemaType                                = (SchemaType)GetInt32(new IntPtr(p + 0x05C)); // 0270D744D960 0x5C SchemaType                  ( 0001866EB700 ModelEnumType SchemaType SchemaType SchemaType Int32 )
