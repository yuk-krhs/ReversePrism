...
namespace ReversePrism.DataModels
{
    ...
    public partial class AllElementsContentValidator : DataModel
    {
        ...
        public static AllElementsContentValidator? FromPointer(IntPtr p0)
        {
            ...
            value.Elements                                  = GetObject<Hashtable>(new IntPtr(p + 0x018), ReversePrism.DataModels.Hashtable.FromPointer); // 02466755F610 0x18 Elements                    ( 0001865DE360 ModelClassType Hashtable Hashtable Hashtable Pointer )
            value.IsRequired                                = GetObject<BitSet>(new IntPtr(p + 0x028), ReversePrism.DataModels.BitSet.FromPointer); // 02466755F650 0x28 IsRequired                  ( 000186593A90 ModelClassType BitSet BitSet BitSet Pointer )
            value.CountRequired                             = GetInt32(new IntPtr(p + 0x030)); // 02466755F670 0x30 CountRequired               ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
