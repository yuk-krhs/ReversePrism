...
namespace ReversePrism.DataModels
{
    ...
    // 028 ItemPrefab                               ModelClassType ExchangeGoodsSetItem ExchangeGoodsSetItem ExchangeGoodsSetItem Pointer
    ...
    public partial class ExchangeHistoryDetailItemContainerView : DataModel
    {
        ...
        public static ExchangeHistoryDetailItemContainerView? FromPointer(IntPtr p0)
        {
            ...
            value.ItemPrefab                                = GetObject<ExchangeGoodsSetItem>(new IntPtr(p + 0x028), ReversePrism.DataModels.ExchangeGoodsSetItem.FromPointer); // 0x28 ItemPrefab                  ( ModelClassType ExchangeGoodsSetItem ExchangeGoodsSetItem ExchangeGoodsSetItem Pointer )
