...
namespace ReversePrism.DataModels
{
    ...
    public partial class WarningHeaderValue
    {
        ...
        public static WarningHeaderValue? FromPointer(IntPtr p0)
        {
            ...
            value.Agent                                     = GetString(new IntPtr(p + 0x010)); // 0270DB8C0CC0 0x10 Agent                       ( 000186671910 ModelPrimitiveType string string string String )
            value.Code                                      = GetInt32(new IntPtr(p + 0x018)); // 0270DB8C0CE0 0x18 Code                        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Text                                      = GetString(new IntPtr(p + 0x038)); // 0270DB8C0D20 0x38 Text                        ( 000186671910 ModelPrimitiveType string string string String )
