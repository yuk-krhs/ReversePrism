...
namespace ReversePrism.DataModels
{
    ...
    public partial class JsonSerializerProxy
    {
        ...
        public static JsonSerializerProxy? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new JsonSerializerProxy();

            value.SerializerReader                          = GetObject<JsonSerializerInternalReader>(new IntPtr(p + 0x0E0), ReversePrism.DataModels.JsonSerializerInternalReader.FromPointer); // 0270066B8420 0xE0 SerializerReader            ( 00018675F670 ModelClassType JsonSerializerInternalReader JsonSerializerInternalReader JsonSerializerInternalReader Pointer )
            value.SerializerWriter                          = GetObject<JsonSerializerInternalWriter>(new IntPtr(p + 0x0E8), ReversePrism.DataModels.JsonSerializerInternalWriter.FromPointer); // 0270066B8440 0xE8 SerializerWriter            ( 00018675FB00 ModelClassType JsonSerializerInternalWriter JsonSerializerInternalWriter JsonSerializerInternalWriter Pointer )
            value.Serializer                                = GetObject<JsonSerializer>(new IntPtr(p + 0x0F0), ReversePrism.DataModels.JsonSerializer.FromPointer); // 0270066B8460 0xF0 Serializer                  ( 00018675EEB0 ModelClassType JsonSerializer JsonSerializer JsonSerializer Pointer )
