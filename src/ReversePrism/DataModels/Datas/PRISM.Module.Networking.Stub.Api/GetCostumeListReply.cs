...
namespace ReversePrism.DataModels
{
    ...
    // 018 CostumeSetList                           ModelClassListType RepeatedField`1<CostumeSetStatus> RepeatedField`1<CostumeSetStatus> List<CostumeSetStatus> Pointer
    ...
    public partial class GetCostumeListReply : DataModel
    {
        ...
        public static GetCostumeListReply? FromPointer(IntPtr p0)
        {
            ...
            value.CostumeSetList                            = GetObjectList<CostumeSetStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.CostumeSetStatus.FromPointer); // 0x18 CostumeSetList              ( ModelClassListType RepeatedField`1<CostumeSetStatus> RepeatedField`1<CostumeSetStatus> List<CostumeSetStatus> Pointer )
