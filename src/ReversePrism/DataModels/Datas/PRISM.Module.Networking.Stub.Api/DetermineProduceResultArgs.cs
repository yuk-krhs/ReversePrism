...
namespace ReversePrism.DataModels
{
    ...
    public partial class DetermineProduceResultArgs : DataModel
    {
        ...
        public static DetermineProduceResultArgs? FromPointer(IntPtr p0)
        {
            ...
            value.MstFavoriteMarkId                         = GetInt32(new IntPtr(p + 0x018)); // 02466250B5A0 0x18 MstFavoriteMarkId           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.AttachingPotentialLiveSkillList           = GetObjectList<AttachingPotentialLiveSkillStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.AttachingPotentialLiveSkillStatus.FromPointer); // 02466250B600 0x20 AttachingPotentialLiveSkillList ( 000185CCEDB8 ModelClassListType RepeatedField`1<AttachingPotentialLiveSkillStatus> RepeatedField`1<AttachingPotentialLiveSkillStatus> List<AttachingPotentialLiveSkillStatus> Pointer )
