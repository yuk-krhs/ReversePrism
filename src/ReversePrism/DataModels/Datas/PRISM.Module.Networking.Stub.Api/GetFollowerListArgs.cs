...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<GetFollowerListArgs> IL2CPP_TYPE_GENERICINST
    ...
    // 020 SortOrderType                            ModelEnumType SortOrderType SortOrderType SortOrderType Int32
    public partial class GetFollowerListArgs : DataModel
    {
        public string                                   Cursor                                  { get; set; }
        public SortOrderType                            SortOrderType                           { get; set; }

        public static GetFollowerListArgs? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;
            ...
            value.SortOrderType                             = (SortOrderType)GetInt32(new IntPtr(p + 0x020)); // 0x20 SortOrderType               ( ModelEnumType SortOrderType SortOrderType SortOrderType Int32 )
