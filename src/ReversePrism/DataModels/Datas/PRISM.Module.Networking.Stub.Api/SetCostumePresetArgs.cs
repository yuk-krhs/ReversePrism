...
namespace ReversePrism.DataModels
{
    ...
    public partial class SetCostumePresetArgs : DataModel
    {
        ...
        public static SetCostumePresetArgs? FromPointer(IntPtr p0)
        {
            ...
            value.CostumePresetId                           = GetString(new IntPtr(p + 0x018)); // 0245A40502F8 0x18 CostumePresetId             ( 000186671910 ModelPrimitiveType string string string String )
            value.MstCostumeId                              = GetInt32(new IntPtr(p + 0x020)); // 0245A4050338 0x20 MstCostumeId                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstHairstyleId                            = GetInt32(new IntPtr(p + 0x024)); // 0245A4050378 0x24 MstHairstyleId              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstAccessoryIdList                        = GetInt32List(new IntPtr(p + 0x028)); // 0245A40503D8 0x28 MstAccessoryIdList          ( 000185CE1CE8 ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
            value.PresetType                                = (CostumePresetType)GetInt32(new IntPtr(p + 0x030)); // 0245A4050418 0x30 PresetType                  ( 000186630A70 ModelEnumType CostumePresetType CostumePresetType CostumePresetType Int32 )
