...
namespace ReversePrism.DataModels
{
    ...
    // 018 WeekScheduleList                         ModelClassListType RepeatedField`1<WeekScheduleStatus> RepeatedField`1<WeekScheduleStatus> List<WeekScheduleStatus> Pointer
    ...
    public partial class GetProduceTopReply : DataModel
    {
        ...
        public static GetProduceTopReply? FromPointer(IntPtr p0)
        {
            ...
            value.WeekScheduleList                          = GetObjectList<WeekScheduleStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.WeekScheduleStatus.FromPointer); // 0x18 WeekScheduleList            ( ModelClassListType RepeatedField`1<WeekScheduleStatus> RepeatedField`1<WeekScheduleStatus> List<WeekScheduleStatus> Pointer )
