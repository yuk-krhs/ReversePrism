...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<FinishSchedulePublicRelationsReply> IL2CPP_TYPE_GENERICINST
    ...
    public partial class FinishSchedulePublicRelationsReply : DataModel
    {
        public ProduceBaseInfoStatus?                   ProduceBaseInfo                         { get; set; }
        public ScheduleDetailType                       ScheduleDetailType                      { get; set; }
        public List<ProduceCardStatus>?                 ProduceCardList                         { get; set; }

        public static FinishSchedulePublicRelationsReply? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new FinishSchedulePublicRelationsReply() { Pointer= p0 };
