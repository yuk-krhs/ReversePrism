...
namespace ReversePrism.DataModels
{
    ...
    // 018 MyRankingList                            ModelClassListType RepeatedField`1<RankedUserStatus> RepeatedField`1<RankedUserStatus> List<RankedUserStatus> Pointer
    public partial class GetSelfRankingReply : DataModel
    {
        ...
        public static GetSelfRankingReply? FromPointer(IntPtr p0)
        {
            ...
            value.MyRankingList                             = GetObjectList<RankedUserStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.RankedUserStatus.FromPointer); // 0x18 MyRankingList               ( ModelClassListType RepeatedField`1<RankedUserStatus> RepeatedField`1<RankedUserStatus> List<RankedUserStatus> Pointer )
