...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetSelfRankingReply
    {
        ...
        public static GetSelfRankingReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetSelfRankingReply();

            value.MyRankingList                             = GetObjectList<RankedUserStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.RankedUserStatus.FromPointer); // 0270D1017610 0x18 MyRankingList               ( 000185CEE9F8 ModelClassListType RepeatedField`1<RankedUserStatus> RepeatedField`1<RankedUserStatus> List<RankedUserStatus> Pointer )
