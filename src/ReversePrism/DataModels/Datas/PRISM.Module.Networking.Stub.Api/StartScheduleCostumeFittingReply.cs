...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<StartScheduleCostumeFittingReply> IL2CPP_TYPE_GENERICINST
    ...
    // 034 DeletableProduceCardAmount               ModelPrimitiveType int int int Int32
    ...
    public partial class StartScheduleCostumeFittingReply : DataModel
    {
        ...
        public static StartScheduleCostumeFittingReply? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new StartScheduleCostumeFittingReply() { Pointer= p0 };
            ...
            value.DeletableProduceCardAmount                = GetInt32(new IntPtr(p + 0x034)); // 0x34 DeletableProduceCardAmount  ( ModelPrimitiveType int int int Int32 )
