...
namespace ReversePrism.DataModels
{
    ...
    public partial class SetMvUnitArgs
    {
        ...
        public static SetMvUnitArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SetMvUnitArgs();

            value.UnitNumber                                = GetInt32(new IntPtr(p + 0x018)); // 0270D21F2CC0 0x18 UnitNumber                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SlotList                                  = GetObjectList<MvUnitSlotStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.MvUnitSlotStatus.FromPointer); // 0270D21F2D20 0x20 SlotList                    ( 000185CE7A48 ModelClassListType RepeatedField`1<MvUnitSlotStatus> RepeatedField`1<MvUnitSlotStatus> List<MvUnitSlotStatus> Pointer )
