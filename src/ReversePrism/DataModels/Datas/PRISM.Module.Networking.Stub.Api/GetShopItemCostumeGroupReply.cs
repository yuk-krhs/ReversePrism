...
namespace ReversePrism.DataModels
{
    ...
    // 018 CostumeGroup                             ModelClassType ShopItemCostumeGroupStatus ShopItemCostumeGroupStatus ShopItemCostumeGroupStatus Pointer
    ...
    public partial class GetShopItemCostumeGroupReply : DataModel
    {
        ...
        public static GetShopItemCostumeGroupReply? FromPointer(IntPtr p0)
        {
            ...
            value.CostumeGroup                              = GetObject<ShopItemCostumeGroupStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ShopItemCostumeGroupStatus.FromPointer); // 0x18 CostumeGroup                ( ModelClassType ShopItemCostumeGroupStatus ShopItemCostumeGroupStatus ShopItemCostumeGroupStatus Pointer )
