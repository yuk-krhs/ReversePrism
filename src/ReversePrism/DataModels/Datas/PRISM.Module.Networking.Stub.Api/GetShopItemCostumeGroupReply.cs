...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetShopItemCostumeGroupReply
    {
        ...
        public static GetShopItemCostumeGroupReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetShopItemCostumeGroupReply();

            value.CostumeGroup                              = GetObject<ShopItemCostumeGroupStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ShopItemCostumeGroupStatus.FromPointer); // 0270D27DC2F8 0x18 CostumeGroup                ( 00018675E4A0 ModelClassType ShopItemCostumeGroupStatus ShopItemCostumeGroupStatus ShopItemCostumeGroupStatus Pointer )
            value.TotalBillingAmount                        = GetInt32(new IntPtr(p + 0x020)); // 0270D27DC338 0x20 TotalBillingAmount          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
