...
namespace ReversePrism.DataModels
{
    ...
    // 018 Exchange                                 ModelClassType GashaExchangeStatus GashaExchangeStatus GashaExchangeStatus Pointer
    ...
    // 028 RewardProductList                        ModelClassListType RepeatedField`1<GashaRewardProductStatus> RepeatedField`1<GashaRewardProductStatus> List<GashaRewardProductStatus> Pointer
    public partial class PurchaseGashaExchangeReply : DataModel
    {
        ...
        public static PurchaseGashaExchangeReply? FromPointer(IntPtr p0)
        {
            ...
            value.Exchange                                  = GetObject<GashaExchangeStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.GashaExchangeStatus.FromPointer); // 0x18 Exchange                    ( ModelClassType GashaExchangeStatus GashaExchangeStatus GashaExchangeStatus Pointer )
            ...
            value.RewardProductList                         = GetObjectList<GashaRewardProductStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.GashaRewardProductStatus.FromPointer); // 0x28 RewardProductList           ( ModelClassListType RepeatedField`1<GashaRewardProductStatus> RepeatedField`1<GashaRewardProductStatus> List<GashaRewardProductStatus> Pointer )
