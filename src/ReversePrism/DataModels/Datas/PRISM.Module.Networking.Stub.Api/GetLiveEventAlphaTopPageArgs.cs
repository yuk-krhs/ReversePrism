...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetLiveEventAlphaTopPageArgs
    {
        ...
        public static GetLiveEventAlphaTopPageArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetLiveEventAlphaTopPageArgs();

            value.MstEventId                                = GetInt32(new IntPtr(p + 0x018)); // 0270D21A8240 0x18 MstEventId                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
