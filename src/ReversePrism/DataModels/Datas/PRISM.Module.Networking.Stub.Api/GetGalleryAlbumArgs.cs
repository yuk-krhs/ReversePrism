...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetGalleryAlbumArgs
    {
        ...
        public static GetGalleryAlbumArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetGalleryAlbumArgs();

            value.MstCharacterInfoId                        = GetInt32(new IntPtr(p + 0x018)); // 0270042031F0 0x18 MstCharacterInfoId          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
