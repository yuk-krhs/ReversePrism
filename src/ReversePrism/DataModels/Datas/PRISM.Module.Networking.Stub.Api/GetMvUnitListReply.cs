...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetMvUnitListReply
    {
        ...
        public static GetMvUnitListReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetMvUnitListReply();

            value.UnitList                                  = GetObjectList<MvUnitStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.MvUnitStatus.FromPointer); // 0270D21D8D28 0x18 UnitList                    ( 000185CE7C98 ModelClassListType RepeatedField`1<MvUnitStatus> RepeatedField`1<MvUnitStatus> List<MvUnitStatus> Pointer )
