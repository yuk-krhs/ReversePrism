...
namespace ReversePrism.DataModels
{
    ...
    // 030 ProduceCardList                          ModelClassListType RepeatedField`1<ProduceCardStatus> RepeatedField`1<ProduceCardStatus> List<ProduceCardStatus> Pointer
    ...
    // 048 ScheduleDetailType                       ModelEnumType ScheduleDetailType ScheduleDetailType ScheduleDetailType Int32
    ...
    // 058 IsSupportBonus                           ModelPrimitiveType bool bool bool Bool
    // 000 ScheduleLevelFieldNumber                 int IL2CPP_TYPE_I4
    // 05C ScheduleLevel                            ModelPrimitiveType int int int Int32
    // 000 VitalityVariationFieldNumber             int IL2CPP_TYPE_I4
    // 060 VitalityVariation                        ModelClassType VitalityVariationStatus VitalityVariationStatus VitalityVariationStatus Pointer
    ...
    // 068 ExertSupportEffectList                   ModelClassListType RepeatedField`1<ExertSupportEffectStatus> RepeatedField`1<ExertSupportEffectStatus> List<ExertSupportEffectStatus> Pointer
    public partial class StartScheduleWorkingReply : DataModel
    {
        ...
        public static StartScheduleWorkingReply? FromPointer(IntPtr p0)
        {
            ...
            value.ProduceCardList                           = GetObjectList<ProduceCardStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.ProduceCardStatus.FromPointer); // 0x30 ProduceCardList             ( ModelClassListType RepeatedField`1<ProduceCardStatus> RepeatedField`1<ProduceCardStatus> List<ProduceCardStatus> Pointer )
            ...
            value.ScheduleDetailType                        = (ScheduleDetailType)GetInt32(new IntPtr(p + 0x048)); // 0x48 ScheduleDetailType          ( ModelEnumType ScheduleDetailType ScheduleDetailType ScheduleDetailType Int32 )
            ...
            value.IsSupportBonus                            = GetBool(new IntPtr(p + 0x058)); // 0x58 IsSupportBonus              ( ModelPrimitiveType bool bool bool Bool )
            value.ScheduleLevel                             = GetInt32(new IntPtr(p + 0x05C)); // 0x5C ScheduleLevel               ( ModelPrimitiveType int int int Int32 )
            value.VitalityVariation                         = GetObject<VitalityVariationStatus>(new IntPtr(p + 0x060), ReversePrism.DataModels.VitalityVariationStatus.FromPointer); // 0x60 VitalityVariation           ( ModelClassType VitalityVariationStatus VitalityVariationStatus VitalityVariationStatus Pointer )
            value.ExertSupportEffectList                    = GetObjectList<ExertSupportEffectStatus>(new IntPtr(p + 0x068), ReversePrism.DataModels.ExertSupportEffectStatus.FromPointer); // 0x68 ExertSupportEffectList      ( ModelClassListType RepeatedField`1<ExertSupportEffectStatus> RepeatedField`1<ExertSupportEffectStatus> List<ExertSupportEffectStatus> Pointer )
