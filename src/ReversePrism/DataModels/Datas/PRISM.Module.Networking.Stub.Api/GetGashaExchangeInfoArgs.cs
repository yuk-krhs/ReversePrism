...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetGashaExchangeInfoArgs
    {
        ...
        public static GetGashaExchangeInfoArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetGashaExchangeInfoArgs();

            value.GashaExchangeId                           = GetString(new IntPtr(p + 0x018)); // 0270D1A108F8 0x18 GashaExchangeId             ( 000186671910 ModelPrimitiveType string string string String )
