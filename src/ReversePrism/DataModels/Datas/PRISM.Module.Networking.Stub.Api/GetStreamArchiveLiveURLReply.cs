...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetStreamArchiveLiveURLReply
    {
        ...
        public static GetStreamArchiveLiveURLReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetStreamArchiveLiveURLReply();

            value.MstStreamProgramId                        = GetInt32(new IntPtr(p + 0x018)); // 0270D2ABE548 0x18 MstStreamProgramId          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.StreamUrl                                 = GetString(new IntPtr(p + 0x020)); // 0270D2ABE588 0x20 StreamUrl                   ( 000186671910 ModelPrimitiveType string string string String )
            value.YoutubeUrl                                = GetString(new IntPtr(p + 0x028)); // 0270D2ABE5C8 0x28 YoutubeUrl                  ( 000186671910 ModelPrimitiveType string string string String )
