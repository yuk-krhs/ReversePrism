...
namespace ReversePrism.DataModels
{
    ...
    public partial class SelectProduceStrategyReply
    {
        ...
        public static SelectProduceStrategyReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SelectProduceStrategyReply();

            value.ProduceBaseInfo                           = GetObject<ProduceBaseInfoStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ProduceBaseInfoStatus.FromPointer); // 0270D259D280 0x18 ProduceBaseInfo             ( 0001865332D0 ModelClassType ProduceBaseInfoStatus ProduceBaseInfoStatus ProduceBaseInfoStatus Pointer )
            value.ProduceStrategy                           = GetObject<ProduceStrategyStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProduceStrategyStatus.FromPointer); // 0270D259D2C0 0x20 ProduceStrategy             ( 000186584640 ModelClassType ProduceStrategyStatus ProduceStrategyStatus ProduceStrategyStatus Pointer )
            value.ProduceCardList                           = GetObjectList<ProduceCardStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ProduceCardStatus.FromPointer); // 0270D259D320 0x28 ProduceCardList             ( 000185CEB1C8 ModelClassListType RepeatedField`1<ProduceCardStatus> RepeatedField`1<ProduceCardStatus> List<ProduceCardStatus> Pointer )
            value.PotentialSupportSkill                     = GetObject<GettablePotentialSupportSkillStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.GettablePotentialSupportSkillStatus.FromPointer); // 0270D259D360 0x30 PotentialSupportSkill       ( 000186678D40 ModelClassType GettablePotentialSupportSkillStatus GettablePotentialSupportSkillStatus GettablePotentialSupportSkillStatus Pointer )
