...
namespace ReversePrism.DataModels
{
    ...
    // 020 ProduceStrategy                          ModelClassType ProduceStrategyStatus ProduceStrategyStatus ProduceStrategyStatus Pointer
    ...
    // 030 PotentialSupportSkill                    ModelClassType GettablePotentialSupportSkillStatus GettablePotentialSupportSkillStatus GettablePotentialSupportSkillStatus Pointer
    public partial class SelectProduceStrategyReply : DataModel
    {
        ...
        public static SelectProduceStrategyReply? FromPointer(IntPtr p0)
        {
            ...
            value.ProduceStrategy                           = GetObject<ProduceStrategyStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProduceStrategyStatus.FromPointer); // 0x20 ProduceStrategy             ( ModelClassType ProduceStrategyStatus ProduceStrategyStatus ProduceStrategyStatus Pointer )
            ...
            value.PotentialSupportSkill                     = GetObject<GettablePotentialSupportSkillStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.GettablePotentialSupportSkillStatus.FromPointer); // 0x30 PotentialSupportSkill       ( ModelClassType GettablePotentialSupportSkillStatus GettablePotentialSupportSkillStatus GettablePotentialSupportSkillStatus Pointer )
