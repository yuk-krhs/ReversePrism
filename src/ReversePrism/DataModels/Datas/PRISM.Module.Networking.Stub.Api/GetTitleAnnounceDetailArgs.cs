...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetTitleAnnounceDetailArgs
    {
        ...
        public static GetTitleAnnounceDetailArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetTitleAnnounceDetailArgs();

            value.Platform                                  = GetString(new IntPtr(p + 0x018)); // 0270D2B5E5C8 0x18 Platform                    ( 000186671910 ModelPrimitiveType string string string String )
            value.ArticleId                                 = GetString(new IntPtr(p + 0x020)); // 0270D2B5E608 0x20 ArticleId                   ( 000186671910 ModelPrimitiveType string string string String )
