...
namespace ReversePrism.DataModels
{
    ...
    public partial class FinishPvpMatchArgs
    {
        ...
        public static FinishPvpMatchArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new FinishPvpMatchArgs();

            value.InGameResult                              = GetObject<PvpInGameResultStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.PvpInGameResultStatus.FromPointer); // 0270D2738078 0x18 InGameResult                ( 0001865E7180 ModelClassType PvpInGameResultStatus PvpInGameResultStatus PvpInGameResultStatus Pointer )
