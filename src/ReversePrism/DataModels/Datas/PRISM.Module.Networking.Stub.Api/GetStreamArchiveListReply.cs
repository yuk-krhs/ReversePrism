...
namespace ReversePrism.DataModels
{
    ...
    // 018 ProgramList                              ModelClassListType RepeatedField`1<ArchiveStreamProgramStatus> RepeatedField`1<ArchiveStreamProgramStatus> List<ArchiveStreamProgramStatus> Pointer
    public partial class GetStreamArchiveListReply : DataModel
    {
        ...
        public static GetStreamArchiveListReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetStreamArchiveListReply() { Pointer= p0 };

            value.ProgramList                               = GetObjectList<ArchiveStreamProgramStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ArchiveStreamProgramStatus.FromPointer); // 0x18 ProgramList                 ( ModelClassListType RepeatedField`1<ArchiveStreamProgramStatus> RepeatedField`1<ArchiveStreamProgramStatus> List<ArchiveStreamProgramStatus> Pointer )
