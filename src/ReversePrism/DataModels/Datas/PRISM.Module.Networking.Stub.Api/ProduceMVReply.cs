...
namespace ReversePrism.DataModels
{
    ...
    // 020 CsidList                                 ModelPrimitiveListType RepeatedField`1<string> RepeatedField`1<string> List<string> Pointer
    // 000 IsArEffectFieldNumber                    int IL2CPP_TYPE_I4
    // 028 IsArEffect                               ModelPrimitiveType bool bool bool Bool
    // 000 FesUnitRankFieldNumber                   int IL2CPP_TYPE_I4
    // 02C FesUnitRank                              ModelEnumType ProduceParameterRank ProduceParameterRank ProduceParameterRank Int32
    public partial class ProduceMVReply : DataModel
    {
        ...
        public static ProduceMVReply? FromPointer(IntPtr p0)
        {
            ...
            value.CsidList                                  = GetStringList(new IntPtr(p + 0x020)); // 0x20 CsidList                    ( ModelPrimitiveListType RepeatedField`1<string> RepeatedField`1<string> List<string> Pointer )
            value.IsArEffect                                = GetBool(new IntPtr(p + 0x028)); // 0x28 IsArEffect                  ( ModelPrimitiveType bool bool bool Bool )
            value.FesUnitRank                               = (ProduceParameterRank)GetInt32(new IntPtr(p + 0x02C)); // 0x2C FesUnitRank                 ( ModelEnumType ProduceParameterRank ProduceParameterRank ProduceParameterRank Int32 )
