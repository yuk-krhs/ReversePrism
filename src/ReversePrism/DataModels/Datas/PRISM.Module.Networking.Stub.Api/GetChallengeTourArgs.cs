...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetChallengeTourArgs
    {
        ...
        public static GetChallengeTourArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetChallengeTourArgs();

            value.ChallengeTourId                           = GetInt32(new IntPtr(p + 0x018)); // 0270D0B43D50 0x18 ChallengeTourId             ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
