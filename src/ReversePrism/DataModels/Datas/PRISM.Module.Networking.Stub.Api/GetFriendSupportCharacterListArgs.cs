...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetFriendSupportCharacterListArgs
    {
        ...
        public static GetFriendSupportCharacterListArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetFriendSupportCharacterListArgs();

            value.MstUnitId                                 = GetInt32(new IntPtr(p + 0x018)); // 0270D25622A8 0x18 MstUnitId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstSupportCharacterIdList                 = GetInt32List(new IntPtr(p + 0x020)); // 0270D2562308 0x20 MstSupportCharacterIdList   ( 000185CE1CE8 ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
