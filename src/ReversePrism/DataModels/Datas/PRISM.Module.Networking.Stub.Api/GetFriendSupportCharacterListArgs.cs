...
namespace ReversePrism.DataModels
{
    ...
    // 020 MstSupportCharacterIdList                ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer
    public partial class GetFriendSupportCharacterListArgs : DataModel
    {
        ...
        public static GetFriendSupportCharacterListArgs? FromPointer(IntPtr p0)
        {
            ...
            value.MstSupportCharacterIdList                 = GetInt32List(new IntPtr(p + 0x020)); // 0x20 MstSupportCharacterIdList   ( ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
