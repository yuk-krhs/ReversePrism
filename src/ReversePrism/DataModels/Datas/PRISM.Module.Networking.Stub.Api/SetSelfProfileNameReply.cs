...
namespace ReversePrism.DataModels
{
    ...
    public partial class SetSelfProfileNameReply
    {
        ...
        public static SetSelfProfileNameReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SetSelfProfileNameReply();

            value.Profile                                   = GetObject<UserProfileStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.UserProfileStatus.FromPointer); // 0270D270EF08 0x18 Profile                     ( 000186750350 ModelClassType UserProfileStatus UserProfileStatus UserProfileStatus Pointer )
