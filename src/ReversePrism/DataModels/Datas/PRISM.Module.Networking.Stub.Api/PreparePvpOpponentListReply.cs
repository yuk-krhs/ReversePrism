...
namespace ReversePrism.DataModels
{
    ...
    // 020 OpponentList                             ModelClassListType RepeatedField`1<PvpOpponentStatus> RepeatedField`1<PvpOpponentStatus> List<PvpOpponentStatus> Pointer
    public partial class PreparePvpOpponentListReply : DataModel
    {
        ...
        public static PreparePvpOpponentListReply? FromPointer(IntPtr p0)
        {
            ...
            value.OpponentList                              = GetObjectList<PvpOpponentStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.PvpOpponentStatus.FromPointer); // 0x20 OpponentList                ( ModelClassListType RepeatedField`1<PvpOpponentStatus> RepeatedField`1<PvpOpponentStatus> List<PvpOpponentStatus> Pointer )
