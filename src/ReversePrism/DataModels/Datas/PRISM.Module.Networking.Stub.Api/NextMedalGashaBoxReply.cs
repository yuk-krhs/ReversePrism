...
namespace ReversePrism.DataModels
{
    ...
    public partial class NextMedalGashaBoxReply : DataModel
    {
        ...
        public static NextMedalGashaBoxReply? FromPointer(IntPtr p0)
        {
            ...
            value.MedalGashaStatus                          = GetObject<MedalGashaStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.MedalGashaStatus.FromPointer); // 024662203730 0x18 MedalGashaStatus            ( 0001865EEDD0 ModelClassType MedalGashaStatus MedalGashaStatus MedalGashaStatus Pointer )
            value.BoxList                                   = GetObjectList<MedalGashaBoxStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.MedalGashaBoxStatus.FromPointer); // 024662203790 0x20 BoxList                     ( 000185CE5988 ModelClassListType RepeatedField`1<MedalGashaBoxStatus> RepeatedField`1<MedalGashaBoxStatus> List<MedalGashaBoxStatus> Pointer )
