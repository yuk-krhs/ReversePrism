...
namespace ReversePrism.DataModels
{
    ...
    // 018 LastPass                                 ModelClassType LoginBonusPassStatus LoginBonusPassStatus LoginBonusPassStatus Pointer
    public partial class ExecuteLoginBonusPassReply : DataModel
    {
        ...
        public static ExecuteLoginBonusPassReply? FromPointer(IntPtr p0)
        {
            ...
            value.LastPass                                  = GetObject<LoginBonusPassStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.LoginBonusPassStatus.FromPointer); // 0x18 LastPass                    ( ModelClassType LoginBonusPassStatus LoginBonusPassStatus LoginBonusPassStatus Pointer )
