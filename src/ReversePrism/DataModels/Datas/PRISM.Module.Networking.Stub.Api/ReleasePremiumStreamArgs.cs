...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<ReleasePremiumStreamArgs> IL2CPP_TYPE_GENERICINST
    ...
    public partial class ReleasePremiumStreamArgs : DataModel
    {
        public int                                      MstStreamProgramId                      { get; set; }

        public static ReleasePremiumStreamArgs? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new ReleasePremiumStreamArgs() { Pointer= p0 };
