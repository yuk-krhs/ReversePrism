...
namespace ReversePrism.DataModels
{
    ...
    // 01C SceneType                                ModelEnumType IdolBaseCostumeTargetSceneType IdolBaseCostumeTargetSceneType IdolBaseCostumeTargetSceneType Int32
    ...
    public partial class SetIdolBaseCostumeArgs : DataModel
    {
        ...
        public static SetIdolBaseCostumeArgs? FromPointer(IntPtr p0)
        {
            ...
            value.SceneType                                 = (IdolBaseCostumeTargetSceneType)GetInt32(new IntPtr(p + 0x01C)); // 0x1C SceneType                   ( ModelEnumType IdolBaseCostumeTargetSceneType IdolBaseCostumeTargetSceneType IdolBaseCostumeTargetSceneType Int32 )
