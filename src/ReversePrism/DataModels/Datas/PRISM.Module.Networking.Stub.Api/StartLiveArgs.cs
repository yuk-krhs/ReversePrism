...
namespace ReversePrism.DataModels
{
    ...
    // 028 UnitNumber                               ModelPrimitiveType int int int Int32
    ...
    // 030 SupportIdolList                          ModelClassListType RepeatedField`1<LiveSupportIdolStatus> RepeatedField`1<LiveSupportIdolStatus> List<LiveSupportIdolStatus> Pointer
    // 000 DeviceTokenFieldNumber                   int IL2CPP_TYPE_I4
    // 038 DeviceToken                              ModelPrimitiveType string string string String
    public partial class StartLiveArgs : DataModel
    {
        ...
        public static StartLiveArgs? FromPointer(IntPtr p0)
        {
            ...
            value.UnitNumber                                = GetInt32(new IntPtr(p + 0x028)); // 0x28 UnitNumber                  ( ModelPrimitiveType int int int Int32 )
            value.SupportIdolList                           = GetObjectList<LiveSupportIdolStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.LiveSupportIdolStatus.FromPointer); // 0x30 SupportIdolList             ( ModelClassListType RepeatedField`1<LiveSupportIdolStatus> RepeatedField`1<LiveSupportIdolStatus> List<LiveSupportIdolStatus> Pointer )
            value.DeviceToken                               = GetString(new IntPtr(p + 0x038)); // 0x38 DeviceToken                 ( ModelPrimitiveType string string string String )
