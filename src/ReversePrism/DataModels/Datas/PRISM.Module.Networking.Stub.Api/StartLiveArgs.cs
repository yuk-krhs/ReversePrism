...
namespace ReversePrism.DataModels
{
    ...
    public partial class StartLiveArgs : DataModel
    {
        ...
        public static StartLiveArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new StartLiveArgs() { Pointer= p0 };

            value.MstSongId                                 = GetInt32(new IntPtr(p + 0x018)); // 0246621A96A0 0x18 MstSongId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.DifficultyLevel                           = (SongDifficultyLevel)GetInt32(new IntPtr(p + 0x01C)); // 0246621A96E0 0x1C DifficultyLevel             ( 000186529820 ModelEnumType SongDifficultyLevel SongDifficultyLevel SongDifficultyLevel Int32 )
            value.StartType                                 = (LiveStartType)GetInt32(new IntPtr(p + 0x020)); // 0246621A9720 0x20 StartType                   ( 000186582F90 ModelEnumType LiveStartType LiveStartType LiveStartType Int32 )
            value.LiveBoost                                 = GetInt32(new IntPtr(p + 0x024)); // 0246621A9760 0x24 LiveBoost                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.UnitNumber                                = GetInt32(new IntPtr(p + 0x028)); // 0246621A97A0 0x28 UnitNumber                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SupportIdolList                           = GetObjectList<LiveSupportIdolStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.LiveSupportIdolStatus.FromPointer); // 0246621A9800 0x30 SupportIdolList             ( 000185CE3E48 ModelClassListType RepeatedField`1<LiveSupportIdolStatus> RepeatedField`1<LiveSupportIdolStatus> List<LiveSupportIdolStatus> Pointer )
            value.DeviceToken                               = GetString(new IntPtr(p + 0x038)); // 0246621A9840 0x38 DeviceToken                 ( 000186671910 ModelPrimitiveType string string string String )
