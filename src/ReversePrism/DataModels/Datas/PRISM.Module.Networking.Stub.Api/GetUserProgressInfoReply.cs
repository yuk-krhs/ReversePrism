...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetUserProgressInfoReply
    {
        ...
        public static GetUserProgressInfoReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetUserProgressInfoReply();

            value.TotalHighScoreRating                      = GetObject<TotalHighScoreRatingStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.TotalHighScoreRatingStatus.FromPointer); // 0270D270A648 0x18 TotalHighScoreRating        ( 00018668CAE0 ModelClassType TotalHighScoreRatingStatus TotalHighScoreRatingStatus TotalHighScoreRatingStatus Pointer )
            value.TotalTechnicalRating                      = GetObject<TotalTechnicalRatingStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.TotalTechnicalRatingStatus.FromPointer); // 0270D270A688 0x20 TotalTechnicalRating        ( 00018668D290 ModelClassType TotalTechnicalRatingStatus TotalTechnicalRatingStatus TotalTechnicalRatingStatus Pointer )
            value.LiveFinishList                            = GetObjectList<UserProfileLiveStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.UserProfileLiveStatus.FromPointer); // 0270D270A6E8 0x28 LiveFinishList              ( 000185CF7058 ModelClassListType RepeatedField`1<UserProfileLiveStatus> RepeatedField`1<UserProfileLiveStatus> List<UserProfileLiveStatus> Pointer )
            value.LiveFullComboList                         = GetObjectList<UserProfileLiveStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.UserProfileLiveStatus.FromPointer); // 0270D270A748 0x30 LiveFullComboList           ( 000185CF7058 ModelClassListType RepeatedField`1<UserProfileLiveStatus> RepeatedField`1<UserProfileLiveStatus> List<UserProfileLiveStatus> Pointer )
            value.LiveAllGreatList                          = GetObjectList<UserProfileLiveStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.UserProfileLiveStatus.FromPointer); // 0270D270A7A8 0x38 LiveAllGreatList            ( 000185CF7058 ModelClassListType RepeatedField`1<UserProfileLiveStatus> RepeatedField`1<UserProfileLiveStatus> List<UserProfileLiveStatus> Pointer )
            value.LiveAllPerfectList                        = GetObjectList<UserProfileLiveStatus>(new IntPtr(p + 0x040), ReversePrism.DataModels.UserProfileLiveStatus.FromPointer); // 0270D270A808 0x40 LiveAllPerfectList          ( 000185CF7058 ModelClassListType RepeatedField`1<UserProfileLiveStatus> RepeatedField`1<UserProfileLiveStatus> List<UserProfileLiveStatus> Pointer )
            value.BestProduceParameterRank                  = (ProduceParameterRank)GetInt32(new IntPtr(p + 0x048)); // 0270D270A848 0x48 BestProduceParameterRank    ( 000186562070 ModelEnumType ProduceParameterRank ProduceParameterRank ProduceParameterRank Int32 )
            value.ProduceScenarioFinishList                 = GetObjectList<UserProfileProduceStatus>(new IntPtr(p + 0x050), ReversePrism.DataModels.UserProfileProduceStatus.FromPointer); // 0270D270A8A8 0x50 ProduceScenarioFinishList   ( 000185CF74D8 ModelClassListType RepeatedField`1<UserProfileProduceStatus> RepeatedField`1<UserProfileProduceStatus> List<UserProfileProduceStatus> Pointer )
            value.ParameterRankDetailList                   = GetObjectList<UserProfileFesUnitRankStatus>(new IntPtr(p + 0x058), ReversePrism.DataModels.UserProfileFesUnitRankStatus.FromPointer); // 0270D270A908 0x58 ParameterRankDetailList     ( 000185CF6E18 ModelClassListType RepeatedField`1<UserProfileFesUnitRankStatus> RepeatedField`1<UserProfileFesUnitRankStatus> List<UserProfileFesUnitRankStatus> Pointer )
