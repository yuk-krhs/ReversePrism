...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetProducerEventInfoArgs
    {
        ...
        public static GetProducerEventInfoArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetProducerEventInfoArgs();

            value.EventType                                 = (ProfileEventType)GetInt32(new IntPtr(p + 0x018)); // 0270D26F87C8 0x18 EventType                   ( 0001865B3340 ModelEnumType ProfileEventType ProfileEventType ProfileEventType Int32 )
            value.MstEventId                                = GetInt32(new IntPtr(p + 0x01C)); // 0270D26F8808 0x1C MstEventId                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
