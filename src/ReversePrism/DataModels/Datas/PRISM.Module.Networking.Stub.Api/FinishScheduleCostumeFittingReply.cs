...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<FinishScheduleCostumeFittingReply> IL2CPP_TYPE_GENERICINST
    ...
    public partial class FinishScheduleCostumeFittingReply : DataModel
    {
        ...
        public static FinishScheduleCostumeFittingReply? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new FinishScheduleCostumeFittingReply() { Pointer= p0 };
