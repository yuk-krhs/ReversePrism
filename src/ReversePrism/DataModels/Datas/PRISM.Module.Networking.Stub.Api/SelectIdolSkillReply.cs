...
namespace ReversePrism.DataModels
{
    ...
    public partial class SelectIdolSkillReply : DataModel
    {
        ...
        public static SelectIdolSkillReply? FromPointer(IntPtr p0)
        {
            ...
            value.ProduceIdol                               = GetObject<ProduceIdolStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ProduceIdolStatus.FromPointer); // 0246625414B8 0x18 ProduceIdol                 ( 000186550070 ModelClassType ProduceIdolStatus ProduceIdolStatus ProduceIdolStatus Pointer )
