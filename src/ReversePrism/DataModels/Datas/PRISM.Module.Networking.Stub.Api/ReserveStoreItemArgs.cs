...
namespace ReversePrism.DataModels
{
    ...
    public partial class ReserveStoreItemArgs
    {
        ...
        public static ReserveStoreItemArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ReserveStoreItemArgs();

            value.MstStoreItemId                            = GetInt32(new IntPtr(p + 0x018)); // 0270D0B45310 0x18 MstStoreItemId              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
