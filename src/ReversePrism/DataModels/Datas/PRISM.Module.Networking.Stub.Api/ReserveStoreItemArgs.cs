...
namespace ReversePrism.DataModels
{
    ...
    // 018 MstStoreItemId                           ModelPrimitiveType int int int Int32
    public partial class ReserveStoreItemArgs : DataModel
    {
        ...
        public static ReserveStoreItemArgs? FromPointer(IntPtr p0)
        {
            ...
            value.MstStoreItemId                            = GetInt32(new IntPtr(p + 0x018)); // 0x18 MstStoreItemId              ( ModelPrimitiveType int int int Int32 )
