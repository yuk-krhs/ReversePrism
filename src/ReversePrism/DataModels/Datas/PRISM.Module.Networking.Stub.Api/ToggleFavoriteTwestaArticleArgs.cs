...
namespace ReversePrism.DataModels
{
    ...
    public partial class ToggleFavoriteTwestaArticleArgs
    {
        ...
        public static ToggleFavoriteTwestaArticleArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ToggleFavoriteTwestaArticleArgs();

            value.FavoriteDate                              = GetDateTime(new IntPtr(p + 0x010)); // 0270D22FC8C0 0x10 FavoriteDate                ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.MstTwestaArticleId                        = GetInt32(new IntPtr(p + 0x028)); // 0270D22FC940 0x28 MstTwestaArticleId          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value._FavoriteDate                             = GetObject<Timestamp>(new IntPtr(p + 0x030), ReversePrism.DataModels.Timestamp.FromPointer); // 0270D22FC980 0x30 _FavoriteDate               ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
