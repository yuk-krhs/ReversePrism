...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<SetLiveEventAllSongBreakTimeReply> IL2CPP_TYPE_GENERICINST
    ...
    public partial class SetLiveEventAllSongBreakTimeReply : DataModel
    {
        public EventBreakTimeStatus?                    BreakTime                               { get; set; }

        public static SetLiveEventAllSongBreakTimeReply? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new SetLiveEventAllSongBreakTimeReply() { Pointer= p0 };
