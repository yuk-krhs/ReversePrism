...
namespace ReversePrism.DataModels
{
    ...
    public partial class IssueInviteCodeArgs : DataModel
    {
        ...
        public static IssueInviteCodeArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new IssueInviteCodeArgs() { Pointer= p0 };

            value.MstFriendInvitationId                     = GetInt32(new IntPtr(p + 0x018)); // 0246614E4598 0x18 MstFriendInvitationId       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
