...
namespace ReversePrism.DataModels
{
    ...
    // 028 DeletedProduceCardList                   ModelClassListType RepeatedField`1<ProduceCardStatus> RepeatedField`1<ProduceCardStatus> List<ProduceCardStatus> Pointer
    public partial class FinishScheduleAdviceReply : DataModel
    {
        ...
        public static FinishScheduleAdviceReply? FromPointer(IntPtr p0)
        {
            ...
            value.DeletedProduceCardList                    = GetObjectList<ProduceCardStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ProduceCardStatus.FromPointer); // 0x28 DeletedProduceCardList      ( ModelClassListType RepeatedField`1<ProduceCardStatus> RepeatedField`1<ProduceCardStatus> List<ProduceCardStatus> Pointer )
