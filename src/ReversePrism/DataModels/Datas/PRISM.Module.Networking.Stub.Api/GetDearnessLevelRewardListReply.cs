...
namespace ReversePrism.DataModels
{
    ...
    // 020 DearnessLevelRewardList                  ModelClassListType RepeatedField`1<DearnessLevelRewardStatus> RepeatedField`1<DearnessLevelRewardStatus> List<DearnessLevelRewardStatus> Pointer
    public partial class GetDearnessLevelRewardListReply : DataModel
    {
        ...
        public static GetDearnessLevelRewardListReply? FromPointer(IntPtr p0)
        {
            ...
            value.DearnessLevelRewardList                   = GetObjectList<DearnessLevelRewardStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.DearnessLevelRewardStatus.FromPointer); // 0x20 DearnessLevelRewardList     ( ModelClassListType RepeatedField`1<DearnessLevelRewardStatus> RepeatedField`1<DearnessLevelRewardStatus> List<DearnessLevelRewardStatus> Pointer )
