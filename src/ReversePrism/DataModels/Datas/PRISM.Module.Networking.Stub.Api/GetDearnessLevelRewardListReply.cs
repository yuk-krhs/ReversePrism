...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetDearnessLevelRewardListReply
    {
        ...
        public static GetDearnessLevelRewardListReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetDearnessLevelRewardListReply();

            value.MstIdolId                                 = GetInt32(new IntPtr(p + 0x018)); // 0270D20F6038 0x18 MstIdolId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.DearnessLevelRewardList                   = GetObjectList<DearnessLevelRewardStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.DearnessLevelRewardStatus.FromPointer); // 0270D20F6098 0x20 DearnessLevelRewardList     ( 000185CD32C8 ModelClassListType RepeatedField`1<DearnessLevelRewardStatus> RepeatedField`1<DearnessLevelRewardStatus> List<DearnessLevelRewardStatus> Pointer )
