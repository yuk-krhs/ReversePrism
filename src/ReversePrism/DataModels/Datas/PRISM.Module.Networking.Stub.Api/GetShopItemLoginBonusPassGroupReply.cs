...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetShopItemLoginBonusPassGroupReply : DataModel
    {
        ...
        public static GetShopItemLoginBonusPassGroupReply? FromPointer(IntPtr p0)
        {
            ...
            value.LoginBonusPassGroup                       = GetObject<ShopItemLoginBonusPassGroupStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ShopItemLoginBonusPassGroupStatus.FromPointer); // 024662745850 0x18 LoginBonusPassGroup         ( 00018675F9A0 ModelClassType ShopItemLoginBonusPassGroupStatus ShopItemLoginBonusPassGroupStatus ShopItemLoginBonusPassGroupStatus Pointer )
            value.TotalBillingAmount                        = GetInt32(new IntPtr(p + 0x020)); // 024662745890 0x20 TotalBillingAmount          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
