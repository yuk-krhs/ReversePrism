...
namespace ReversePrism.DataModels
{
    ...
    // 018 MstSpecialMissionStepId                  ModelPrimitiveType int int int Int32
    ...
    // 020 MstMissionIdList                         ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer
    public partial class ReceiveSpecialMissionRewardArgs : DataModel
    {
        ...
        public static ReceiveSpecialMissionRewardArgs? FromPointer(IntPtr p0)
        {
            ...
            value.MstSpecialMissionStepId                   = GetInt32(new IntPtr(p + 0x018)); // 0x18 MstSpecialMissionStepId     ( ModelPrimitiveType int int int Int32 )
            value.MstMissionIdList                          = GetInt32List(new IntPtr(p + 0x020)); // 0x20 MstMissionIdList            ( ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
