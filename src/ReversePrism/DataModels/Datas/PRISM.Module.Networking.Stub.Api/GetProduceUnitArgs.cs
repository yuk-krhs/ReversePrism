...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetProduceUnitArgs
    {
        ...
        public static GetProduceUnitArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetProduceUnitArgs();

            value.MstUnitId                                 = GetInt32(new IntPtr(p + 0x018)); // 0270D25857B0 0x18 MstUnitId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
