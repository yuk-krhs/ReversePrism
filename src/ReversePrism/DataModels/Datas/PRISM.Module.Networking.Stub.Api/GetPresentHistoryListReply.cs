...
namespace ReversePrism.DataModels
{
    ...
    // 018 PresentHistory                           ModelClassListType RepeatedField`1<PresentHistoryStatus> RepeatedField`1<PresentHistoryStatus> List<PresentHistoryStatus> Pointer
    ...
    public partial class GetPresentHistoryListReply : DataModel
    {
        ...
        public static GetPresentHistoryListReply? FromPointer(IntPtr p0)
        {
            ...
            value.PresentHistory                            = GetObjectList<PresentHistoryStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.PresentHistoryStatus.FromPointer); // 0x18 PresentHistory              ( ModelClassListType RepeatedField`1<PresentHistoryStatus> RepeatedField`1<PresentHistoryStatus> List<PresentHistoryStatus> Pointer )
