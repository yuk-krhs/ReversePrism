...
namespace ReversePrism.DataModels
{
    ...
    public partial class ToggleStoryFavoriteArgs : DataModel
    {
        ...
        public static ToggleStoryFavoriteArgs? FromPointer(IntPtr p0)
        {
            ...
            value.StoryId                                   = GetObject<StoryIDStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.StoryIDStatus.FromPointer); // 0246629B6838 0x18 StoryId                     ( 0001865979C0 ModelClassType StoryIDStatus StoryIDStatus StoryIDStatus Pointer )
