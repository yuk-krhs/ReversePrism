...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<ExecuteConnectProviderAndTokenArgs> IL2CPP_TYPE_GENERICINST
    ...
    public partial class ExecuteConnectProviderAndTokenArgs
    {
        ...
        public static ExecuteConnectProviderAndTokenArgs? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;
