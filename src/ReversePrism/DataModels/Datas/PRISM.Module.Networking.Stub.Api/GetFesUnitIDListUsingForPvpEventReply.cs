...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetFesUnitIDListUsingForPvpEventReply : DataModel
    {
        ...
        public static GetFesUnitIDListUsingForPvpEventReply? FromPointer(IntPtr p0)
        {
            ...
            value.FesUnitIdList                             = GetStringList(new IntPtr(p + 0x018)); // 0246612A42B8 0x18 FesUnitIdList               ( 000185CF3478 ModelPrimitiveListType RepeatedField`1<string> RepeatedField`1<string> List<string> Pointer )
