...
namespace ReversePrism.DataModels
{
    ...
    // 028 PlatformUserId                           ModelPrimitiveType string string string String
    ...
    // 038 AdId                                     ModelPrimitiveType string string string String
    // 000 ViewerIdFieldNumber                      int IL2CPP_TYPE_I4
    // 040 ViewerId                                 ModelPrimitiveType long long long Int64
    // 000 ViewerIdSignatureFieldNumber             int IL2CPP_TYPE_I4
    // 048 ViewerIdSignature                        ModelPrimitiveType string string string String
    public partial class RegisterArgs : DataModel
    {
        ...
        public static RegisterArgs? FromPointer(IntPtr p0)
        {
            ...
            value.PlatformUserId                            = GetString(new IntPtr(p + 0x028)); // 0x28 PlatformUserId              ( ModelPrimitiveType string string string String )
            value.DeviceName                                = GetString(new IntPtr(p + 0x030)); // 0x30 DeviceName                  ( ModelPrimitiveType string string string String )
            value.AdId                                      = GetString(new IntPtr(p + 0x038)); // 0x38 AdId                        ( ModelPrimitiveType string string string String )
            value.ViewerId                                  = GetInt64(new IntPtr(p + 0x040)); // 0x40 ViewerId                    ( ModelPrimitiveType long long long Int64 )
            value.ViewerIdSignature                         = GetString(new IntPtr(p + 0x048)); // 0x48 ViewerIdSignature           ( ModelPrimitiveType string string string String )
