...
namespace ReversePrism.DataModels
{
    ...
    public partial class SetHomeSettingReply
    {
        public HomeSettingFavoriteIdolStatus?           FavoriteIdolSetting                     { get; set; }

        public static SetHomeSettingReply? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new SetHomeSettingReply();

            value.FavoriteIdolSetting                       = GetObject<HomeSettingFavoriteIdolStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.HomeSettingFavoriteIdolStatus.FromPointer); // 0270D2059E00 0x18 FavoriteIdolSetting         ( 0001866CC290 ModelClassType HomeSettingFavoriteIdolStatus HomeSettingFavoriteIdolStatus HomeSettingFavoriteIdolStatus Pointer )
