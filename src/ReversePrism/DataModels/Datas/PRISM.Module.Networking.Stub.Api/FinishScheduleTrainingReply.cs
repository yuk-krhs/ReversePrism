...
namespace ReversePrism.DataModels
{
    ...
    public partial class FinishScheduleTrainingReply : DataModel
    {
        ...
        public static FinishScheduleTrainingReply? FromPointer(IntPtr p0)
        {
            ...
            value.ProduceBaseInfo                           = GetObject<ProduceBaseInfoStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ProduceBaseInfoStatus.FromPointer); // 0246625288A0 0x18 ProduceBaseInfo             ( 0001865332D0 ModelClassType ProduceBaseInfoStatus ProduceBaseInfoStatus ProduceBaseInfoStatus Pointer )
            value.ScheduleVariation                         = GetObject<ScheduleVariationStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ScheduleVariationStatus.FromPointer); // 0246625288E0 0x20 ScheduleVariation           ( 0001866E49B0 ModelClassType ScheduleVariationStatus ScheduleVariationStatus ScheduleVariationStatus Pointer )
            value.ScheduleDetailType                        = (ScheduleDetailType)GetInt32(new IntPtr(p + 0x028)); // 024662528920 0x28 ScheduleDetailType          ( 0001866D43F0 ModelEnumType ScheduleDetailType ScheduleDetailType ScheduleDetailType Int32 )
