...
namespace ReversePrism.DataModels
{
    ...
    // 028 RewardProductList                        ModelClassListType RepeatedField`1<RewardProductStatus> RepeatedField`1<RewardProductStatus> List<RewardProductStatus> Pointer
    public partial class ExchangeShinyPartyTokenReply : DataModel
    {
        ...
        public static ExchangeShinyPartyTokenReply? FromPointer(IntPtr p0)
        {
            ...
            value.RewardProductList                         = GetObjectList<RewardProductStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.RewardProductStatus.FromPointer); // 0x28 RewardProductList           ( ModelClassListType RepeatedField`1<RewardProductStatus> RepeatedField`1<RewardProductStatus> List<RewardProductStatus> Pointer )
