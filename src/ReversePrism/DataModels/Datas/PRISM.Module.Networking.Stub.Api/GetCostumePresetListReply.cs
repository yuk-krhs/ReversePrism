...
namespace ReversePrism.DataModels
{
    ...
    // 018 CostumePresetList                        ModelClassListType RepeatedField`1<CostumePresetStatus> RepeatedField`1<CostumePresetStatus> List<CostumePresetStatus> Pointer
    public partial class GetCostumePresetListReply : DataModel
    {
        ...
        public static GetCostumePresetListReply? FromPointer(IntPtr p0)
        {
            ...
            value.CostumePresetList                         = GetObjectList<CostumePresetStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.CostumePresetStatus.FromPointer); // 0x18 CostumePresetList           ( ModelClassListType RepeatedField`1<CostumePresetStatus> RepeatedField`1<CostumePresetStatus> List<CostumePresetStatus> Pointer )
