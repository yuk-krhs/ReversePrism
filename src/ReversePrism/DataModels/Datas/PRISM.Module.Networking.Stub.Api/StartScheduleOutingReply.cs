...
namespace ReversePrism.DataModels
{
    ...
    // 058 ExertSupportEffectList                   ModelClassListType RepeatedField`1<ExertSupportEffectStatus> RepeatedField`1<ExertSupportEffectStatus> List<ExertSupportEffectStatus> Pointer
    public partial class StartScheduleOutingReply : DataModel
    {
        ...
        public static StartScheduleOutingReply? FromPointer(IntPtr p0)
        {
            ...
            value.ExertSupportEffectList                    = GetObjectList<ExertSupportEffectStatus>(new IntPtr(p + 0x058), ReversePrism.DataModels.ExertSupportEffectStatus.FromPointer); // 0x58 ExertSupportEffectList      ( ModelClassListType RepeatedField`1<ExertSupportEffectStatus> RepeatedField`1<ExertSupportEffectStatus> List<ExertSupportEffectStatus> Pointer )
