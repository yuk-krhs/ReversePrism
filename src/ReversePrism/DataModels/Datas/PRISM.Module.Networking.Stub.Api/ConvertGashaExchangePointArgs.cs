...
namespace ReversePrism.DataModels
{
    ...
    public partial class ConvertGashaExchangePointArgs : DataModel
    {
        ...
        public static ConvertGashaExchangePointArgs? FromPointer(IntPtr p0)
        {
            ...
            value.GashaExchangeIdList                       = GetStringList(new IntPtr(p + 0x018)); // 0246619914C8 0x18 GashaExchangeIdList         ( 000185CF3478 ModelPrimitiveListType RepeatedField`1<string> RepeatedField`1<string> List<string> Pointer )
