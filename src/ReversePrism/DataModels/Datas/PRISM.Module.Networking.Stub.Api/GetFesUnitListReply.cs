...
namespace ReversePrism.DataModels
{
    ...
    // 018 FesUnitList                              ModelClassListType RepeatedField`1<FesUnitStatus> RepeatedField`1<FesUnitStatus> List<FesUnitStatus> Pointer
    public partial class GetFesUnitListReply : DataModel
    {
        ...
        public static GetFesUnitListReply? FromPointer(IntPtr p0)
        {
            ...
            value.FesUnitList                               = GetObjectList<FesUnitStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.FesUnitStatus.FromPointer); // 0x18 FesUnitList                 ( ModelClassListType RepeatedField`1<FesUnitStatus> RepeatedField`1<FesUnitStatus> List<FesUnitStatus> Pointer )
