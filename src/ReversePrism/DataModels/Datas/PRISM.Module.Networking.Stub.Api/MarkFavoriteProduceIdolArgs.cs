...
namespace ReversePrism.DataModels
{
    ...
    public partial class MarkFavoriteProduceIdolArgs
    {
        ...
        public static MarkFavoriteProduceIdolArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new MarkFavoriteProduceIdolArgs();

            value.MstProduceIdolId                          = GetInt32(new IntPtr(p + 0x018)); // 0270D25FC0D8 0x18 MstProduceIdolId            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstFavoriteMarkId                         = GetInt32(new IntPtr(p + 0x01C)); // 0270D25FC118 0x1C MstFavoriteMarkId           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
