...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetGalleryVoiceListArgs
    {
        ...
        public static GetGalleryVoiceListArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetGalleryVoiceListArgs();

            value.MstCharacterInfoId                        = GetInt32(new IntPtr(p + 0x018)); // 027004207248 0x18 MstCharacterInfoId          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
