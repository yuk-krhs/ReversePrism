...
namespace ReversePrism.DataModels
{
    ...
    public partial class StartChallengeTourStageArgs
    {
        ...
        public static StartChallengeTourStageArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new StartChallengeTourStageArgs();

            value.StageId                                   = GetInt32(new IntPtr(p + 0x018)); // 0270D0B54170 0x18 StageId                     ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
