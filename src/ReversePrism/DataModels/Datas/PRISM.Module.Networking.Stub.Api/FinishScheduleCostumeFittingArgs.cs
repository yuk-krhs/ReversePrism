...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<FinishScheduleCostumeFittingArgs> IL2CPP_TYPE_GENERICINST
    ...
    public partial class FinishScheduleCostumeFittingArgs : DataModel
    {
        public List<string>?                            SelectProduceCardIdList                 { get; set; }
        public List<string>?                            DeleteProduceCardIdList                 { get; set; }

        public static FinishScheduleCostumeFittingArgs? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new FinishScheduleCostumeFittingArgs() { Pointer= p0 };
