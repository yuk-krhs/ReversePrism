...
namespace ReversePrism.DataModels
{
    ...
    // 018 IsLiveEnable                             ModelPrimitiveType bool bool bool Bool
    public partial class GetLiveEnableReply : DataModel
    {
        ...
        public static GetLiveEnableReply? FromPointer(IntPtr p0)
        {
            ...
            value.IsLiveEnable                              = GetBool(new IntPtr(p + 0x018)); // 0x18 IsLiveEnable                ( ModelPrimitiveType bool bool bool Bool )
