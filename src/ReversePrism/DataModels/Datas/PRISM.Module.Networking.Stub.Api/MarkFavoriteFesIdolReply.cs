...
namespace ReversePrism.DataModels
{
    ...
    // 018 FesIdol                                  ModelClassType FesIdolStatus FesIdolStatus FesIdolStatus Pointer
    public partial class MarkFavoriteFesIdolReply : DataModel
    {
        ...
        public static MarkFavoriteFesIdolReply? FromPointer(IntPtr p0)
        {
            ...
            value.FesIdol                                   = GetObject<FesIdolStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.FesIdolStatus.FromPointer); // 0x18 FesIdol                     ( ModelClassType FesIdolStatus FesIdolStatus FesIdolStatus Pointer )
