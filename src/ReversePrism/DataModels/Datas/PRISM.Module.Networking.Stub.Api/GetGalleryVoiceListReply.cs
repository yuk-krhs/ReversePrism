...
namespace ReversePrism.DataModels
{
    ...
    // 020 VoiceList                                ModelClassListType RepeatedField`1<GalleryVoiceStatus> RepeatedField`1<GalleryVoiceStatus> List<GalleryVoiceStatus> Pointer
    public partial class GetGalleryVoiceListReply : DataModel
    {
        ...
        public static GetGalleryVoiceListReply? FromPointer(IntPtr p0)
        {
            ...
            value.VoiceList                                 = GetObjectList<GalleryVoiceStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.GalleryVoiceStatus.FromPointer); // 0x20 VoiceList                   ( ModelClassListType RepeatedField`1<GalleryVoiceStatus> RepeatedField`1<GalleryVoiceStatus> List<GalleryVoiceStatus> Pointer )
