...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetGalleryVoiceListReply : DataModel
    {
        ...
        public static GetGalleryVoiceListReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetGalleryVoiceListReply() { Pointer= p0 };

            value.MstCharacterInfoId                        = GetInt32(new IntPtr(p + 0x018)); // 024661518558 0x18 MstCharacterInfoId          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.VoiceList                                 = GetObjectList<GalleryVoiceStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.GalleryVoiceStatus.FromPointer); // 0246615185B8 0x20 VoiceList                   ( 000185CDA198 ModelClassListType RepeatedField`1<GalleryVoiceStatus> RepeatedField`1<GalleryVoiceStatus> List<GalleryVoiceStatus> Pointer )
