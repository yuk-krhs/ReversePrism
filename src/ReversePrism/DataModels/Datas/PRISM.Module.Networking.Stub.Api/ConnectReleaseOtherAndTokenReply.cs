...
namespace ReversePrism.DataModels
{
    ...
    public partial class ConnectReleaseOtherAndTokenReply
    {
        ...
        public static ConnectReleaseOtherAndTokenReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ConnectReleaseOtherAndTokenReply();

            value.Result                                    = GetBool(new IntPtr(p + 0x018)); // 0270D0B29250 0x18 Result                      ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
