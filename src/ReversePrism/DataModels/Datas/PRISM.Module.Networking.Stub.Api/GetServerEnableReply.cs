...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetServerEnableReply
    {
        ...
        public static GetServerEnableReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetServerEnableReply();

            value.IsServerEnable                            = GetBool(new IntPtr(p + 0x018)); // 0270D0B52B98 0x18 IsServerEnable              ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
