...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetProducerInfoReply
    {
        ...
        public static GetProducerInfoReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetProducerInfoReply();

            value.FirstWorkedDay                            = GetDateTime(new IntPtr(p + 0x010)); // 0270D2700820 0x10 FirstWorkedDay              ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.TotalHighScoreRating                      = GetObject<TotalHighScoreRatingStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.TotalHighScoreRatingStatus.FromPointer); // 0270D27008A0 0x28 TotalHighScoreRating        ( 00018668CAE0 ModelClassType TotalHighScoreRatingStatus TotalHighScoreRatingStatus TotalHighScoreRatingStatus Pointer )
            value.TotalTechnicalRating                      = GetObject<TotalTechnicalRatingStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.TotalTechnicalRatingStatus.FromPointer); // 0270D27008E0 0x30 TotalTechnicalRating        ( 00018668D290 ModelClassType TotalTechnicalRatingStatus TotalTechnicalRatingStatus TotalTechnicalRatingStatus Pointer )
            value.LiveFinishList                            = GetObjectList<UserProfileLiveStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.UserProfileLiveStatus.FromPointer); // 0270D2700940 0x38 LiveFinishList              ( 000185CF7058 ModelClassListType RepeatedField`1<UserProfileLiveStatus> RepeatedField`1<UserProfileLiveStatus> List<UserProfileLiveStatus> Pointer )
            value.LiveFullComboList                         = GetObjectList<UserProfileLiveStatus>(new IntPtr(p + 0x040), ReversePrism.DataModels.UserProfileLiveStatus.FromPointer); // 0270D27009A0 0x40 LiveFullComboList           ( 000185CF7058 ModelClassListType RepeatedField`1<UserProfileLiveStatus> RepeatedField`1<UserProfileLiveStatus> List<UserProfileLiveStatus> Pointer )
            value.LiveAllGreatList                          = GetObjectList<UserProfileLiveStatus>(new IntPtr(p + 0x048), ReversePrism.DataModels.UserProfileLiveStatus.FromPointer); // 0270D2700A00 0x48 LiveAllGreatList            ( 000185CF7058 ModelClassListType RepeatedField`1<UserProfileLiveStatus> RepeatedField`1<UserProfileLiveStatus> List<UserProfileLiveStatus> Pointer )
            value.LiveAllPerfectList                        = GetObjectList<UserProfileLiveStatus>(new IntPtr(p + 0x050), ReversePrism.DataModels.UserProfileLiveStatus.FromPointer); // 0270D2700A60 0x50 LiveAllPerfectList          ( 000185CF7058 ModelClassListType RepeatedField`1<UserProfileLiveStatus> RepeatedField`1<UserProfileLiveStatus> List<UserProfileLiveStatus> Pointer )
            value.BestProduceParameterRank                  = (ProduceParameterRank)GetInt32(new IntPtr(p + 0x058)); // 0270D2700AA0 0x58 BestProduceParameterRank    ( 000186562070 ModelEnumType ProduceParameterRank ProduceParameterRank ProduceParameterRank Int32 )
            value.ProduceScenarioFinishList                 = GetObjectList<UserProfileProduceStatus>(new IntPtr(p + 0x060), ReversePrism.DataModels.UserProfileProduceStatus.FromPointer); // 0270D2700B00 0x60 ProduceScenarioFinishList   ( 000185CF74D8 ModelClassListType RepeatedField`1<UserProfileProduceStatus> RepeatedField`1<UserProfileProduceStatus> List<UserProfileProduceStatus> Pointer )
            value.WorkedNumber                              = GetInt32(new IntPtr(p + 0x068)); // 0270D2700B40 0x68 WorkedNumber                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value._FirstWorkedDay                           = GetObject<Timestamp>(new IntPtr(p + 0x070), ReversePrism.DataModels.Timestamp.FromPointer); // 0270D2700B80 0x70 _FirstWorkedDay             ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.ProducedIdolNumber                        = GetInt32(new IntPtr(p + 0x078)); // 0270D2700BC0 0x78 ProducedIdolNumber          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.EvolveNumber                              = GetInt32(new IntPtr(p + 0x07C)); // 0270D2700C00 0x7C EvolveNumber                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.LimitBreakNumber                          = GetInt32(new IntPtr(p + 0x080)); // 0270D2700C40 0x80 LimitBreakNumber            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.CostumeNumber                             = GetInt32(new IntPtr(p + 0x084)); // 0270D2700C80 0x84 CostumeNumber               ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SupportCharacterNumber                    = GetInt32(new IntPtr(p + 0x088)); // 0270D2700CC0 0x88 SupportCharacterNumber      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MasterTrainingNumber                      = GetInt32(new IntPtr(p + 0x08C)); // 0270D2700D00 0x8C MasterTrainingNumber        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.TotalFanNumber                            = GetInt64(new IntPtr(p + 0x090)); // 0270D2700D40 0x90 TotalFanNumber              ( 0001865F7700 ModelPrimitiveType long long long Int64 )
            value.StoryReadNumberList                       = GetObjectList<UserProfileStoryStatus>(new IntPtr(p + 0x098), ReversePrism.DataModels.UserProfileStoryStatus.FromPointer); // 0270D2700DA0 0x98 StoryReadNumberList         ( 000185CF7968 ModelClassListType RepeatedField`1<UserProfileStoryStatus> RepeatedField`1<UserProfileStoryStatus> List<UserProfileStoryStatus> Pointer )
            value.TotalLiveFinishList                       = GetObjectList<UserProfileLiveStatus>(new IntPtr(p + 0x0A0), ReversePrism.DataModels.UserProfileLiveStatus.FromPointer); // 0270D2700E00 0xA0 TotalLiveFinishList         ( 000185CF7058 ModelClassListType RepeatedField`1<UserProfileLiveStatus> RepeatedField`1<UserProfileLiveStatus> List<UserProfileLiveStatus> Pointer )
            value.TotalLiveFullComboList                    = GetObjectList<UserProfileLiveStatus>(new IntPtr(p + 0x0A8), ReversePrism.DataModels.UserProfileLiveStatus.FromPointer); // 0270D2700E60 0xA8 TotalLiveFullComboList      ( 000185CF7058 ModelClassListType RepeatedField`1<UserProfileLiveStatus> RepeatedField`1<UserProfileLiveStatus> List<UserProfileLiveStatus> Pointer )
            value.TotalLiveAllGreatList                     = GetObjectList<UserProfileLiveStatus>(new IntPtr(p + 0x0B0), ReversePrism.DataModels.UserProfileLiveStatus.FromPointer); // 0270D2700EC0 0xB0 TotalLiveAllGreatList       ( 000185CF7058 ModelClassListType RepeatedField`1<UserProfileLiveStatus> RepeatedField`1<UserProfileLiveStatus> List<UserProfileLiveStatus> Pointer )
            value.TotalLiveAllPerfectList                   = GetObjectList<UserProfileLiveStatus>(new IntPtr(p + 0x0B8), ReversePrism.DataModels.UserProfileLiveStatus.FromPointer); // 0270D2700F20 0xB8 TotalLiveAllPerfectList     ( 000185CF7058 ModelClassListType RepeatedField`1<UserProfileLiveStatus> RepeatedField`1<UserProfileLiveStatus> List<UserProfileLiveStatus> Pointer )
            value.TotalProduceFinishList                    = GetObjectList<UserProfileProduceStatus>(new IntPtr(p + 0x0C0), ReversePrism.DataModels.UserProfileProduceStatus.FromPointer); // 0270D2700F80 0xC0 TotalProduceFinishList      ( 000185CF74D8 ModelClassListType RepeatedField`1<UserProfileProduceStatus> RepeatedField`1<UserProfileProduceStatus> List<UserProfileProduceStatus> Pointer )
            value.ParameterRankList                         = GetObjectList<UserProfileProduceTotalParameterRankStatus>(new IntPtr(p + 0x0C8), ReversePrism.DataModels.UserProfileProduceTotalParameterRankStatus.FromPointer); // 0270D2700FE0 0xC8 ParameterRankList           ( 000185CF76F8 ModelClassListType RepeatedField`1<UserProfileProduceTotalParameterRankStatus> RepeatedField`1<UserProfileProduceTotalParameterRankStatus> List<UserProfileProduceTotalParameterRankStatus> Pointer )
            value.ProduceCardNum                            = GetInt32(new IntPtr(p + 0x0D0)); // 0270D2701020 0xD0 ProduceCardNum              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ProduceCardOpenedNum                      = GetInt32(new IntPtr(p + 0x0D4)); // 0270D2701060 0xD4 ProduceCardOpenedNum        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ParameterRankDetailList                   = GetObjectList<UserProfileFesUnitRankStatus>(new IntPtr(p + 0x0D8), ReversePrism.DataModels.UserProfileFesUnitRankStatus.FromPointer); // 0270D27010C0 0xD8 ParameterRankDetailList     ( 000185CF6E18 ModelClassListType RepeatedField`1<UserProfileFesUnitRankStatus> RepeatedField`1<UserProfileFesUnitRankStatus> List<UserProfileFesUnitRankStatus> Pointer )
            value.ProduceCardDetailList                     = GetObjectList<UserProfileProduceCardSummaryStatus>(new IntPtr(p + 0x0E0), ReversePrism.DataModels.UserProfileProduceCardSummaryStatus.FromPointer); // 0270D2701120 0xE0 ProduceCardDetailList       ( 000185CF7288 ModelClassListType RepeatedField`1<UserProfileProduceCardSummaryStatus> RepeatedField`1<UserProfileProduceCardSummaryStatus> List<UserProfileProduceCardSummaryStatus> Pointer )
