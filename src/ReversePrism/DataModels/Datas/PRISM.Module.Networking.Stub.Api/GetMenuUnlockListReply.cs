...
namespace ReversePrism.DataModels
{
    ...
    // 018 MenuUnlockList                           ModelClassListType RepeatedField`1<MenuUnlockStatus> RepeatedField`1<MenuUnlockStatus> List<MenuUnlockStatus> Pointer
    public partial class GetMenuUnlockListReply : DataModel
    {
        ...
        public static GetMenuUnlockListReply? FromPointer(IntPtr p0)
        {
            ...
            value.MenuUnlockList                            = GetObjectList<MenuUnlockStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.MenuUnlockStatus.FromPointer); // 0x18 MenuUnlockList              ( ModelClassListType RepeatedField`1<MenuUnlockStatus> RepeatedField`1<MenuUnlockStatus> List<MenuUnlockStatus> Pointer )
