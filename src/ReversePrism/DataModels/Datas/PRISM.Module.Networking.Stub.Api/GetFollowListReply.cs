...
namespace ReversePrism.DataModels
{
    ...
    // 030 FollowList                               ModelClassListType RepeatedField`1<FriendStatus> RepeatedField`1<FriendStatus> List<FriendStatus> Pointer
    ...
    public partial class GetFollowListReply : DataModel
    {
        ...
        public static GetFollowListReply? FromPointer(IntPtr p0)
        {
            ...
            value.FollowList                                = GetObjectList<FriendStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.FriendStatus.FromPointer); // 0x30 FollowList                  ( ModelClassListType RepeatedField`1<FriendStatus> RepeatedField`1<FriendStatus> List<FriendStatus> Pointer )
