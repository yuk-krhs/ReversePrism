...
namespace ReversePrism.DataModels
{
    ...
    // 018 Step                                     ModelClassType SpecialMissionStepStatus SpecialMissionStepStatus SpecialMissionStepStatus Pointer
    ...
    public partial class ReceiveSpecialMissionRewardReply : DataModel
    {
        ...
        public static ReceiveSpecialMissionRewardReply? FromPointer(IntPtr p0)
        {
            ...
            value.Step                                      = GetObject<SpecialMissionStepStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.SpecialMissionStepStatus.FromPointer); // 0x18 Step                        ( ModelClassType SpecialMissionStepStatus SpecialMissionStepStatus SpecialMissionStepStatus Pointer )
