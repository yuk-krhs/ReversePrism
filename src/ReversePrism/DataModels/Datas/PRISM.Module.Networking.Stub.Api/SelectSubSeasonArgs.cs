...
namespace ReversePrism.DataModels
{
    ...
    public partial class SelectSubSeasonArgs
    {
        ...
        public static SelectSubSeasonArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SelectSubSeasonArgs();

            value.MstSubSeasonId                            = GetInt32(new IntPtr(p + 0x018)); // 0270D25A52D8 0x18 MstSubSeasonId              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
