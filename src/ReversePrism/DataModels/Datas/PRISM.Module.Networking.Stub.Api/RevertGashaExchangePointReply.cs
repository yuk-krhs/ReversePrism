...
namespace ReversePrism.DataModels
{
    ...
    public partial class RevertGashaExchangePointReply
    {
        ...
        public static RevertGashaExchangePointReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new RevertGashaExchangePointReply();

            value.RevertPointList                           = GetObjectList<GashaRevertExchangePointStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.GashaRevertExchangePointStatus.FromPointer); // 0270D1A23C18 0x18 RevertPointList             ( 000185CDCF88 ModelClassListType RepeatedField`1<GashaRevertExchangePointStatus> RepeatedField`1<GashaRevertExchangePointStatus> List<GashaRevertExchangePointStatus> Pointer )
            value.HavingGroup                               = GetObject<HavingProductGroupStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.HavingProductGroupStatus.FromPointer); // 0270D1A23C58 0x20 HavingGroup                 ( 0001866ACFE0 ModelClassType HavingProductGroupStatus HavingProductGroupStatus HavingProductGroupStatus Pointer )
