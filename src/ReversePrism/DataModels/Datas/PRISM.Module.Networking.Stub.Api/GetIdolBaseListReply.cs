...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetIdolBaseListReply
    {
        ...
        public static GetIdolBaseListReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetIdolBaseListReply();

            value.IdolBaseList                              = GetObjectList<IdolBaseStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.IdolBaseStatus.FromPointer); // 0270D20FB280 0x18 IdolBaseList                ( 000185CDF648 ModelClassListType RepeatedField`1<IdolBaseStatus> RepeatedField`1<IdolBaseStatus> List<IdolBaseStatus> Pointer )
