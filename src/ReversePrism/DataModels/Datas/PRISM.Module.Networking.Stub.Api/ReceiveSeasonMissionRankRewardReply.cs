...
namespace ReversePrism.DataModels
{
    ...
    public partial class ReceiveSeasonMissionRankRewardReply
    {
        ...
        public static ReceiveSeasonMissionRankRewardReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ReceiveSeasonMissionRankRewardReply();

            value.SeasonRewardList                          = GetObjectList<SeasonRewardStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.SeasonRewardStatus.FromPointer); // 0270D2787B68 0x18 SeasonRewardList            ( 000185CF0608 ModelClassListType RepeatedField`1<SeasonRewardStatus> RepeatedField`1<SeasonRewardStatus> List<SeasonRewardStatus> Pointer )
            value.RewardList                                = GetObjectList<RewardProductStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.RewardProductStatus.FromPointer); // 0270D2787BC8 0x20 RewardList                  ( 000185CEEEA8 ModelClassListType RepeatedField`1<RewardProductStatus> RepeatedField`1<RewardProductStatus> List<RewardProductStatus> Pointer )
            value.HavingGroup                               = GetObject<HavingProductGroupStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.HavingProductGroupStatus.FromPointer); // 0270D2787C08 0x28 HavingGroup                 ( 0001866ACFE0 ModelClassType HavingProductGroupStatus HavingProductGroupStatus HavingProductGroupStatus Pointer )
