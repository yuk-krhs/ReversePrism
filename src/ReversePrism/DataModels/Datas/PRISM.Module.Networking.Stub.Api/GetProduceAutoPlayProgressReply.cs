...
namespace ReversePrism.DataModels
{
    ...
    // 018 BaseInfo                                 ModelClassType ProduceBaseInfoStatus ProduceBaseInfoStatus ProduceBaseInfoStatus Pointer
    ...
    // 020 ProgressedSeasonList                     ModelClassListType RepeatedField`1<ProduceAutoPlayProgressedSeasonStatus> RepeatedField`1<ProduceAutoPlayProgressedSeasonStatus> List<ProduceAutoPlayProgressedSeasonStatus> Pointer
    public partial class GetProduceAutoPlayProgressReply : DataModel
    {
        ...
        public static GetProduceAutoPlayProgressReply? FromPointer(IntPtr p0)
        {
            ...
            value.BaseInfo                                  = GetObject<ProduceBaseInfoStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ProduceBaseInfoStatus.FromPointer); // 0x18 BaseInfo                    ( ModelClassType ProduceBaseInfoStatus ProduceBaseInfoStatus ProduceBaseInfoStatus Pointer )
            value.ProgressedSeasonList                      = GetObjectList<ProduceAutoPlayProgressedSeasonStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProduceAutoPlayProgressedSeasonStatus.FromPointer); // 0x20 ProgressedSeasonList        ( ModelClassListType RepeatedField`1<ProduceAutoPlayProgressedSeasonStatus> RepeatedField`1<ProduceAutoPlayProgressedSeasonStatus> List<ProduceAutoPlayProgressedSeasonStatus> Pointer )
