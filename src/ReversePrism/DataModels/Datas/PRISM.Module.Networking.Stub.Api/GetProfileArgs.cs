...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetProfileArgs
    {
        ...
        public static GetProfileArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetProfileArgs();

            value.SearchUserId                              = GetString(new IntPtr(p + 0x018)); // 0270D2D19E90 0x18 SearchUserId                ( 000186671910 ModelPrimitiveType string string string String )
