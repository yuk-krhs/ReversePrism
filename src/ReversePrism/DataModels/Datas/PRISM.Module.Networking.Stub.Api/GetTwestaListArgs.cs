...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetTwestaListArgs
    {
        ...
        public static GetTwestaListArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetTwestaListArgs();

            value.Cursor                                    = GetString(new IntPtr(p + 0x018)); // 0270D22EDDF8 0x18 Cursor                      ( 000186671910 ModelPrimitiveType string string string String )
            value.IsFavorite                                = GetBool(new IntPtr(p + 0x020)); // 0270D22EDE38 0x20 IsFavorite                  ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.MstTwestaUserId                           = GetInt32(new IntPtr(p + 0x024)); // 0270D22EDE78 0x24 MstTwestaUserId             ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
