...
namespace ReversePrism.DataModels
{
    ...
    // 018 User                                     ModelClassType SelfStatus SelfStatus SelfStatus Pointer
    public partial class FinishTutorialReply : DataModel
    {
        ...
        public static FinishTutorialReply? FromPointer(IntPtr p0)
        {
            ...
            value.User                                      = GetObject<SelfStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.SelfStatus.FromPointer); // 0x18 User                        ( ModelClassType SelfStatus SelfStatus SelfStatus Pointer )
