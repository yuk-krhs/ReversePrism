...
namespace ReversePrism.DataModels
{
    ...
    public partial class MarkFavoriteFesIdolArgs : DataModel
    {
        ...
        public static MarkFavoriteFesIdolArgs? FromPointer(IntPtr p0)
        {
            ...
            value.FesIdolId                                 = GetString(new IntPtr(p + 0x018)); // 0246612219D0 0x18 FesIdolId                   ( 000186671910 ModelPrimitiveType string string string String )
            value.MstFavoriteMarkId                         = GetInt32(new IntPtr(p + 0x020)); // 024661221A10 0x20 MstFavoriteMarkId           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
