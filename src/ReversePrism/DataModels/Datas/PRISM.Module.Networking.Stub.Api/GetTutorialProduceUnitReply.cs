...
namespace ReversePrism.DataModels
{
    ...
    // 020 FriendSupport                            ModelClassType FriendSupportStatus FriendSupportStatus FriendSupportStatus Pointer
    public partial class GetTutorialProduceUnitReply : DataModel
    {
        ...
        public static GetTutorialProduceUnitReply? FromPointer(IntPtr p0)
        {
            ...
            value.FriendSupport                             = GetObject<FriendSupportStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.FriendSupportStatus.FromPointer); // 0x20 FriendSupport               ( ModelClassType FriendSupportStatus FriendSupportStatus FriendSupportStatus Pointer )
