...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetDocumentArgs
    {
        ...
        public static GetDocumentArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetDocumentArgs();

            value.DocumentType                              = (ShopDocumentType)GetInt32(new IntPtr(p + 0x018)); // 0270D27C7028 0x18 DocumentType                ( 00018675A170 ModelEnumType ShopDocumentType ShopDocumentType ShopDocumentType Int32 )
