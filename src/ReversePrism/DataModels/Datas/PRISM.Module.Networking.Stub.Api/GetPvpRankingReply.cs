...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetPvpRankingReply
    {
        ...
        public static GetPvpRankingReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetPvpRankingReply();

            value.Ranking                                   = GetObject<EventRankingStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.EventRankingStatus.FromPointer); // 0270041AA818 0x18 Ranking                     ( 000186762860 ModelClassType EventRankingStatus EventRankingStatus EventRankingStatus Pointer )
            value.RankedUserList                            = GetObjectList<PvpRankedUserStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.PvpRankedUserStatus.FromPointer); // 0270041AA878 0x20 RankedUserList              ( 000185CEE0D8 ModelClassListType RepeatedField`1<PvpRankedUserStatus> RepeatedField`1<PvpRankedUserStatus> List<PvpRankedUserStatus> Pointer )
