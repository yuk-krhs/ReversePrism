...
namespace ReversePrism.DataModels
{
    ...
    public partial class FinishLiveReply
    {
        ...
        public static FinishLiveReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new FinishLiveReply();

            value.StartParam                                = GetObject<LiveStartParamStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.LiveStartParamStatus.FromPointer); // 0270D21CB1A0 0x18 StartParam                  ( 000186582820 ModelClassType LiveStartParamStatus LiveStartParamStatus LiveStartParamStatus Pointer )
            value.IsLiveSuccess                             = GetBool(new IntPtr(p + 0x020)); // 0270D21CB1E0 0x20 IsLiveSuccess               ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.ScoreInfo                                 = GetObject<LiveScoreInfoStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.LiveScoreInfoStatus.FromPointer); // 0270D21CB220 0x28 ScoreInfo                   ( 0001865776F0 ModelClassType LiveScoreInfoStatus LiveScoreInfoStatus LiveScoreInfoStatus Pointer )
            value.ComboInfo                                 = GetObject<LiveComboInfoStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.LiveComboInfoStatus.FromPointer); // 0270D21CB260 0x30 ComboInfo                   ( 000186545FC0 ModelClassType LiveComboInfoStatus LiveComboInfoStatus LiveComboInfoStatus Pointer )
            value.TechnicalScoreInfo                        = GetObject<LiveTechnicalScoreInfoStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.LiveTechnicalScoreInfoStatus.FromPointer); // 0270D21CB2A0 0x38 TechnicalScoreInfo          ( 000186586510 ModelClassType LiveTechnicalScoreInfoStatus LiveTechnicalScoreInfoStatus LiveTechnicalScoreInfoStatus Pointer )
            value.BeforeClearInfoList                       = GetObjectList<LiveClearInfoStatus>(new IntPtr(p + 0x040), ReversePrism.DataModels.LiveClearInfoStatus.FromPointer); // 0270D21CB300 0x40 BeforeClearInfoList         ( 000185CE2E68 ModelClassListType RepeatedField`1<LiveClearInfoStatus> RepeatedField`1<LiveClearInfoStatus> List<LiveClearInfoStatus> Pointer )
            value.AfterClearInfo                            = GetObject<LiveClearInfoStatus>(new IntPtr(p + 0x048), ReversePrism.DataModels.LiveClearInfoStatus.FromPointer); // 0270D21CB340 0x48 AfterClearInfo              ( 000186545830 ModelClassType LiveClearInfoStatus LiveClearInfoStatus LiveClearInfoStatus Pointer )
            value.TimingJudgement                           = GetObject<LiveTimingJudgementStatus>(new IntPtr(p + 0x050), ReversePrism.DataModels.LiveTimingJudgementStatus.FromPointer); // 0270D21CB380 0x50 TimingJudgement             ( 000186586D00 ModelClassType LiveTimingJudgementStatus LiveTimingJudgementStatus LiveTimingJudgementStatus Pointer )
            value.BeforeRatingInfo                          = GetObject<LiveRatingInfoStatus>(new IntPtr(p + 0x058), ReversePrism.DataModels.LiveRatingInfoStatus.FromPointer); // 0270D21CB3C0 0x58 BeforeRatingInfo            ( 00018656C3D0 ModelClassType LiveRatingInfoStatus LiveRatingInfoStatus LiveRatingInfoStatus Pointer )
            value.AfterRatingInfo                           = GetObject<LiveRatingInfoStatus>(new IntPtr(p + 0x060), ReversePrism.DataModels.LiveRatingInfoStatus.FromPointer); // 0270D21CB400 0x60 AfterRatingInfo             ( 00018656C3D0 ModelClassType LiveRatingInfoStatus LiveRatingInfoStatus LiveRatingInfoStatus Pointer )
            value.PlayRewardPack                            = GetObject<LivePlayRewardPackStatus>(new IntPtr(p + 0x068), ReversePrism.DataModels.LivePlayRewardPackStatus.FromPointer); // 0270D21CB440 0x68 PlayRewardPack              ( 000186567D50 ModelClassType LivePlayRewardPackStatus LivePlayRewardPackStatus LivePlayRewardPackStatus Pointer )
            value.RankRewardPack                            = GetObject<LiveRankRewardPackStatus>(new IntPtr(p + 0x070), ReversePrism.DataModels.LiveRankRewardPackStatus.FromPointer); // 0270D21CB480 0x70 RankRewardPack              ( 00018656A7E0 ModelClassType LiveRankRewardPackStatus LiveRankRewardPackStatus LiveRankRewardPackStatus Pointer )
            value.RateRewardPack                            = GetObject<LiveRateRewardPackStatus>(new IntPtr(p + 0x078), ReversePrism.DataModels.LiveRateRewardPackStatus.FromPointer); // 0270D21CB4C0 0x78 RateRewardPack              ( 00018656BC20 ModelClassType LiveRateRewardPackStatus LiveRateRewardPackStatus LiveRateRewardPackStatus Pointer )
            value.BeforeMoneyReward                         = GetObject<HavingProductStatus>(new IntPtr(p + 0x080), ReversePrism.DataModels.HavingProductStatus.FromPointer); // 0270D21CB500 0x80 BeforeMoneyReward           ( 0001866AD720 ModelClassType HavingProductStatus HavingProductStatus HavingProductStatus Pointer )
            value.AfterMoneyReward                          = GetObject<HavingProductStatus>(new IntPtr(p + 0x088), ReversePrism.DataModels.HavingProductStatus.FromPointer); // 0270D21CB540 0x88 AfterMoneyReward            ( 0001866AD720 ModelClassType HavingProductStatus HavingProductStatus HavingProductStatus Pointer )
            value.IdolBaseRewardList                        = GetObjectList<IdolBaseRewardStatus>(new IntPtr(p + 0x090), ReversePrism.DataModels.IdolBaseRewardStatus.FromPointer); // 0270D21CB5A0 0x90 IdolBaseRewardList          ( 000185CDF438 ModelClassListType RepeatedField`1<IdolBaseRewardStatus> RepeatedField`1<IdolBaseRewardStatus> List<IdolBaseRewardStatus> Pointer )
            value.Song                                      = GetObject<SongStatus>(new IntPtr(p + 0x098), ReversePrism.DataModels.SongStatus.FromPointer); // 0270D21CB5E0 0x98 Song                        ( 00018652B0A0 ModelClassType SongStatus SongStatus SongStatus Pointer )
            value.TotalHighScoreRating                      = GetObject<TotalHighScoreRatingStatus>(new IntPtr(p + 0x0A0), ReversePrism.DataModels.TotalHighScoreRatingStatus.FromPointer); // 0270D21CB620 0xA0 TotalHighScoreRating        ( 00018668CAE0 ModelClassType TotalHighScoreRatingStatus TotalHighScoreRatingStatus TotalHighScoreRatingStatus Pointer )
            value.TotalTechnicalRating                      = GetObject<TotalTechnicalRatingStatus>(new IntPtr(p + 0x0A8), ReversePrism.DataModels.TotalTechnicalRatingStatus.FromPointer); // 0270D21CB660 0xA8 TotalTechnicalRating        ( 00018668D290 ModelClassType TotalTechnicalRatingStatus TotalTechnicalRatingStatus TotalTechnicalRatingStatus Pointer )
            value.EventResult                               = GetObject<LiveEventResultStatus>(new IntPtr(p + 0x0B0), ReversePrism.DataModels.LiveEventResultStatus.FromPointer); // 0270D21CB6A0 0xB0 EventResult                 ( 000186553260 ModelClassType LiveEventResultStatus LiveEventResultStatus LiveEventResultStatus Pointer )
            value.HavingGroup                               = GetObject<HavingProductGroupStatus>(new IntPtr(p + 0x0B8), ReversePrism.DataModels.HavingProductGroupStatus.FromPointer); // 0270D21CB6E0 0xB8 HavingGroup                 ( 0001866ACFE0 ModelClassType HavingProductGroupStatus HavingProductGroupStatus HavingProductGroupStatus Pointer )
