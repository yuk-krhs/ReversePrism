...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<FinishScheduleActingPracticeArgs> IL2CPP_TYPE_GENERICINST
    ...
    // 018 RankUpCardIdList                         ModelPrimitiveListType RepeatedField`1<string> RepeatedField`1<string> List<string> Pointer
    ...
    public partial class FinishScheduleActingPracticeArgs : DataModel
    {
        public List<string>?                            RankUpCardIdList                        { get; set; }
        public List<string>?                            DeleteProduceCardIdList                 { get; set; }

        public static FinishScheduleActingPracticeArgs? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new FinishScheduleActingPracticeArgs() { Pointer= p0 };

            value.RankUpCardIdList                          = GetStringList(new IntPtr(p + 0x018)); // 0x18 RankUpCardIdList            ( ModelPrimitiveListType RepeatedField`1<string> RepeatedField`1<string> List<string> Pointer )
