...
namespace ReversePrism.DataModels
{
    ...
    public partial class ExchangeSelectionTicketArgs
    {
        ...
        public static ExchangeSelectionTicketArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ExchangeSelectionTicketArgs();

            value.MstSelectionTicketId                      = GetInt32(new IntPtr(p + 0x018)); // 0270D1218A58 0x18 MstSelectionTicketId        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstSelectionTicketProductId               = GetInt32(new IntPtr(p + 0x01C)); // 0270D1218A98 0x1C MstSelectionTicketProductId ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
