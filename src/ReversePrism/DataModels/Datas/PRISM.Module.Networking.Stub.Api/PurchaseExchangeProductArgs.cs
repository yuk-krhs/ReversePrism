...
namespace ReversePrism.DataModels
{
    ...
    public partial class PurchaseExchangeProductArgs
    {
        ...
        public static PurchaseExchangeProductArgs? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new PurchaseExchangeProductArgs();

            value.MstExchangeProductId                      = GetInt32(new IntPtr(p + 0x018)); // 0270D1223C68 0x18 MstExchangeProductId        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Amount                                    = GetInt32(new IntPtr(p + 0x01C)); // 0270D1223CA8 0x1C Amount                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
