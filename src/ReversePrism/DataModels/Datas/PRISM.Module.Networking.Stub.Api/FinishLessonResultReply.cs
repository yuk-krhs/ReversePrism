...
namespace ReversePrism.DataModels
{
    ...
    // 028 ScheduleVariation                        ModelClassType ScheduleVariationStatus ScheduleVariationStatus ScheduleVariationStatus Pointer
    ...
    public partial class FinishLessonResultReply : DataModel
    {
        ...
        public static FinishLessonResultReply? FromPointer(IntPtr p0)
        {
            ...
            value.ScheduleVariation                         = GetObject<ScheduleVariationStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ScheduleVariationStatus.FromPointer); // 0x28 ScheduleVariation           ( ModelClassType ScheduleVariationStatus ScheduleVariationStatus ScheduleVariationStatus Pointer )
