...
namespace ReversePrism.DataModels
{
    ...
    // 020 ProduceStrategyList                      ModelClassListType RepeatedField`1<ProduceStrategyStatus> RepeatedField`1<ProduceStrategyStatus> List<ProduceStrategyStatus> Pointer
    public partial class ProduceStrategyListReply : DataModel
    {
        ...
        public static ProduceStrategyListReply? FromPointer(IntPtr p0)
        {
            ...
            value.ProduceStrategyList                       = GetObjectList<ProduceStrategyStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProduceStrategyStatus.FromPointer); // 0x20 ProduceStrategyList         ( ModelClassListType RepeatedField`1<ProduceStrategyStatus> RepeatedField`1<ProduceStrategyStatus> List<ProduceStrategyStatus> Pointer )
