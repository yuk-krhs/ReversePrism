...
namespace ReversePrism.DataModels
{
    ...
    // 018 Article                                  ModelClassListType RepeatedField`1<TwestaArticleStatus> RepeatedField`1<TwestaArticleStatus> List<TwestaArticleStatus> Pointer
    public partial class ToggleFavoriteTwestaArticleReply : DataModel
    {
        ...
        public static ToggleFavoriteTwestaArticleReply? FromPointer(IntPtr p0)
        {
            ...
            value.Article                                   = GetObjectList<TwestaArticleStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.TwestaArticleStatus.FromPointer); // 0x18 Article                     ( ModelClassListType RepeatedField`1<TwestaArticleStatus> RepeatedField`1<TwestaArticleStatus> List<TwestaArticleStatus> Pointer )
