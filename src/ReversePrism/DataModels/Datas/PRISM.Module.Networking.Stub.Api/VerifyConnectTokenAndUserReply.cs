...
namespace ReversePrism.DataModels
{
    ...
    public partial class VerifyConnectTokenAndUserReply
    {
        ...
        public static VerifyConnectTokenAndUserReply? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new VerifyConnectTokenAndUserReply();

            value.ReleasableDate                            = GetDateTime(new IntPtr(p + 0x010)); // 0270D0B82550 0x10 ReleasableDate              ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.Result                                    = (ConnectionResultType)GetInt32(new IntPtr(p + 0x028)); // 0270D0B825D0 0x28 Result                      ( 000186604590 ModelEnumType ConnectionResultType ConnectionResultType ConnectionResultType Int32 )
            value.SearchId                                  = GetString(new IntPtr(p + 0x030)); // 0270D0B82610 0x30 SearchId                    ( 000186671910 ModelPrimitiveType string string string String )
            value.UserName                                  = GetString(new IntPtr(p + 0x038)); // 0270D0B82650 0x38 UserName                    ( 000186671910 ModelPrimitiveType string string string String )
            value.Type                                      = (TransferProviderType)GetInt32(new IntPtr(p + 0x040)); // 0270D0B82690 0x40 Type                        ( 0001866A6ED0 ModelEnumType TransferProviderType TransferProviderType TransferProviderType Int32 )
            value.Token                                     = GetString(new IntPtr(p + 0x048)); // 0270D0B826D0 0x48 Token                       ( 000186671910 ModelPrimitiveType string string string String )
            value._ReleasableDate                           = GetObject<Timestamp>(new IntPtr(p + 0x050), ReversePrism.DataModels.Timestamp.FromPointer); // 0270D0B82710 0x50 _ReleasableDate             ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
