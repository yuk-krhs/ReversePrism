...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<FinishScheduleActingPracticeReply> IL2CPP_TYPE_GENERICINST
    ...
    // 000 RankUpProduceCardListFieldNumber         int IL2CPP_TYPE_I4
    // 008 _repeated_rankUpProduceCardList_codec    FieldCodec`1<ProduceCardStatus> IL2CPP_TYPE_GENERICINST
    // 028 RankUpProduceCardList                    ModelClassListType RepeatedField`1<ProduceCardStatus> RepeatedField`1<ProduceCardStatus> List<ProduceCardStatus> Pointer
    ...
    public partial class FinishScheduleActingPracticeReply : DataModel
    {
        public ProduceBaseInfoStatus?                   ProduceBaseInfo                         { get; set; }
        public ScheduleDetailType                       ScheduleDetailType                      { get; set; }
        public List<ProduceCardStatus>?                 RankUpProduceCardList                   { get; set; }
        public List<ProduceCardStatus>?                 DeletedProduceCardList                  { get; set; }

        public static FinishScheduleActingPracticeReply? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new FinishScheduleActingPracticeReply() { Pointer= p0 };
            ...
            value.RankUpProduceCardList                     = GetObjectList<ProduceCardStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ProduceCardStatus.FromPointer); // 0x28 RankUpProduceCardList       ( ModelClassListType RepeatedField`1<ProduceCardStatus> RepeatedField`1<ProduceCardStatus> List<ProduceCardStatus> Pointer )
