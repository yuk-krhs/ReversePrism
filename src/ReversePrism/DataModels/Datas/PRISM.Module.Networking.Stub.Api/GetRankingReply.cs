...
namespace ReversePrism.DataModels
{
    ...
    // 020 RankedUserList                           ModelClassListType RepeatedField`1<RankedUserStatus> RepeatedField`1<RankedUserStatus> List<RankedUserStatus> Pointer
    public partial class GetRankingReply : DataModel
    {
        ...
        public static GetRankingReply? FromPointer(IntPtr p0)
        {
            ...
            value.RankedUserList                            = GetObjectList<RankedUserStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.RankedUserStatus.FromPointer); // 0x20 RankedUserList              ( ModelClassListType RepeatedField`1<RankedUserStatus> RepeatedField`1<RankedUserStatus> List<RankedUserStatus> Pointer )
