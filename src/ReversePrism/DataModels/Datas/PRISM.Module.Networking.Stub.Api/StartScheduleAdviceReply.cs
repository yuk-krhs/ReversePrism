...
namespace ReversePrism.DataModels
{
    ...
    public partial class StartScheduleAdviceReply : DataModel
    {
        ...
        public static StartScheduleAdviceReply? FromPointer(IntPtr p0)
        {
            ...
            value.ProduceBaseInfo                           = GetObject<ProduceBaseInfoStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ProduceBaseInfoStatus.FromPointer); // 024662585B80 0x18 ProduceBaseInfo             ( 0001865332D0 ModelClassType ProduceBaseInfoStatus ProduceBaseInfoStatus ProduceBaseInfoStatus Pointer )
            value.DisplayMstIdolId                          = GetInt32(new IntPtr(p + 0x020)); // 024662585BC0 0x20 DisplayMstIdolId            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ScheduleDetailType                        = (ScheduleDetailType)GetInt32(new IntPtr(p + 0x024)); // 024662585C00 0x24 ScheduleDetailType          ( 0001866D43F0 ModelEnumType ScheduleDetailType ScheduleDetailType ScheduleDetailType Int32 )
            value.DeletableProduceCardAmount                = GetInt32(new IntPtr(p + 0x028)); // 024662585C40 0x28 DeletableProduceCardAmount  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.UnitParameterVariation                    = GetObject<ParameterVariationStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.ParameterVariationStatus.FromPointer); // 024662585C80 0x30 UnitParameterVariation      ( 00018671DE80 ModelClassType ParameterVariationStatus ParameterVariationStatus ParameterVariationStatus Pointer )
