...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<StartScheduleScriptReadingReply> IL2CPP_TYPE_GENERICINST
    ...
    public partial class StartScheduleScriptReadingReply : DataModel
    {
        ...
        public static StartScheduleScriptReadingReply? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new StartScheduleScriptReadingReply() { Pointer= p0 };
