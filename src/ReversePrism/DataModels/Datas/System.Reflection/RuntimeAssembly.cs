...
namespace ReversePrism.DataModels
{
    ...
    public partial class RuntimeAssembly
    {
        ...
        public static RuntimeAssembly? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new RuntimeAssembly();

            value.Resolve_event_holder                      = GetObject<ResolveEventHolder>(new IntPtr(p + 0x020), ReversePrism.DataModels.ResolveEventHolder.FromPointer); // 0270034CE150 0x20 Resolve_event_holder        ( 0001866BD0A0 ModelClassType ResolveEventHolder ResolveEventHolder ResolveEventHolder Pointer )
            value.FromByteArray                             = GetBool(new IntPtr(p + 0x050)); // 0270034CE210 0x50 FromByteArray               ( 000186595210 ModelPrimitiveType bool bool bool Bool )
            value.AssemblyName                              = GetString(new IntPtr(p + 0x058)); // 0270034CE230 0x58 AssemblyName                ( 000186671BA0 ModelPrimitiveType string string string String )
