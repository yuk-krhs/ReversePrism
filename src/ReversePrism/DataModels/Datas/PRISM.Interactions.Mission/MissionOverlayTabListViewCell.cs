...
namespace ReversePrism.DataModels
{
    ...
    // 058 BadgeNumber                              ModelClassType BadgeNumber BadgeNumber BadgeNumber Pointer
    // 060 Disposable                               ModelClassType IDisposable IDisposable IDisposable Pointer
    public partial class MissionOverlayTabListViewCell : DataModel
    {
        ...
        public static MissionOverlayTabListViewCell? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new MissionOverlayTabListViewCell() { Pointer= p0 };
            ...
            value.BadgeNumber                               = GetObject<BadgeNumber>(new IntPtr(p + 0x058), ReversePrism.DataModels.BadgeNumber.FromPointer); // 0x58 BadgeNumber                 ( ModelClassType BadgeNumber BadgeNumber BadgeNumber Pointer )
