...
namespace ReversePrism.DataModels
{
    ...
    public partial class X509CertificateImplBtls
    {
        ...
        public static X509CertificateImplBtls? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new X509CertificateImplBtls();

            value.X509                                      = GetObject<MonoBtlsX509>(new IntPtr(p + 0x0B0), ReversePrism.DataModels.MonoBtlsX509.FromPointer); // 0270D7940C80 0xB0 X509                        ( 000186642C00 ModelClassType MonoBtlsX509 MonoBtlsX509 MonoBtlsX509 Pointer )
            value.NativePrivateKey                          = GetObject<MonoBtlsKey>(new IntPtr(p + 0x0B8), ReversePrism.DataModels.MonoBtlsKey.FromPointer); // 0270D7940CA0 0xB8 NativePrivateKey            ( 00018663F7F0 ModelClassType MonoBtlsKey MonoBtlsKey MonoBtlsKey Pointer )
            value.IntermediateCerts                         = GetObject<X509CertificateImplCollection>(new IntPtr(p + 0x0C0), ReversePrism.DataModels.X509CertificateImplCollection.FromPointer); // 0270D7940CC0 0xC0 IntermediateCerts           ( 000186566880 ModelClassType X509CertificateImplCollection X509CertificateImplCollection X509CertificateImplCollection Pointer )
