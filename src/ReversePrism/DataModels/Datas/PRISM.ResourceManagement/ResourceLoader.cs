...
namespace ReversePrism.DataModels
{
    ...
    public partial class ResourceLoader
    {
        ...
        public static ResourceLoader? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ResourceLoader();

            value.Core                                      = GetObject<LimelightCore>(new IntPtr(p + 0x010), ReversePrism.DataModels.LimelightCore.FromPointer); // 027003CF5578 0x10 Core                        ( 00018652BD10 ModelClassType LimelightCore LimelightCore LimelightCore Pointer )
            value.Downloader                                = GetObject<ResourceDownloader>(new IntPtr(p + 0x028), ReversePrism.DataModels.ResourceDownloader.FromPointer); // 027003CF55D8 0x28 Downloader                  ( 00018666E3A0 ModelClassType ResourceDownloader ResourceDownloader ResourceDownloader Pointer )
