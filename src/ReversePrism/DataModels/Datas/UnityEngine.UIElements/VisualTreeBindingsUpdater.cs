...
namespace ReversePrism.DataModels
{
    ...
    public partial class VisualTreeBindingsUpdater : DataModel
    {
        ...
        public static VisualTreeBindingsUpdater? FromPointer(IntPtr p0)
        {
            ...
            value.S_ProfilerMarker                          = (ProfilerMarker)GetInt32(new IntPtr(p + 0x010)); // 0245A66A4C08 0x10 S_ProfilerMarker            ( 0001865C9C30 ModelEnumType ProfilerMarker ProfilerMarker ProfilerMarker Int32 )
            value.S_ProfilerBindingRequestsMarker           = (ProfilerMarker)GetInt32(new IntPtr(p + 0x018)); // 0245A66A4C28 0x18 S_ProfilerBindingRequestsMarker ( 0001865C9C30 ModelEnumType ProfilerMarker ProfilerMarker ProfilerMarker Int32 )
            value.S_MarkerUpdate                            = (ProfilerMarker)GetInt32(new IntPtr(p + 0x020)); // 0245A66A4C48 0x20 S_MarkerUpdate              ( 0001865C9730 ModelEnumType ProfilerMarker ProfilerMarker ProfilerMarker Int32 )
            value.S_MarkerPoll                              = (ProfilerMarker)GetInt32(new IntPtr(p + 0x028)); // 0245A66A4C68 0x28 S_MarkerPoll                ( 0001865C9730 ModelEnumType ProfilerMarker ProfilerMarker ProfilerMarker Int32 )
            value.DisableBindingsThrottling                 = GetBool(new IntPtr(p + 0x030)); // 0245A66A4C88 0x30 DisableBindingsThrottling   ( 000186595C30 ModelPrimitiveType bool bool bool Bool )
            value.M_LastUpdateTime                          = GetInt64(new IntPtr(p + 0x050)); // 0245A66A4D08 0x50 M_LastUpdateTime            ( 0001865F7700 ModelPrimitiveType long long long Int64 )
            value.UpdatedBindings                           = GetObjectList<IBinding>(new IntPtr(p + 0x068), ReversePrism.DataModels.IBinding.FromPointer); // 0245A66A4D68 0x68 UpdatedBindings             ( 000185CE12F8 ModelClassListType List`1<IBinding> List`1<IBinding> List<IBinding> Pointer )
