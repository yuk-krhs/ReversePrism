...
namespace ReversePrism.DataModels
{
    ...
    // 030 ItemsSourceSizeChanged                   ModelClassType Action Action Action Pointer
    ...
    public partial class BaseListViewController : DataModel
    {
        ...
        public static BaseListViewController? FromPointer(IntPtr p0)
        {
            ...
            value.ItemsSourceSizeChanged                    = GetObject<Action>(new IntPtr(p + 0x030), ReversePrism.DataModels.Action.FromPointer); // 0x30 ItemsSourceSizeChanged      ( ModelClassType Action Action Action Pointer )
