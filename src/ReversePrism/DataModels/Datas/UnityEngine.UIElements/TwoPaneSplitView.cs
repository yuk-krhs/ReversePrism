...
namespace ReversePrism.DataModels
{
    ...
    // 010 S_HandleDragLineClassName                0001866738F0 ModelPrimitiveType string string string String
    // 018 S_HandleDragLineVerticalClassName        0001866738F0 ModelPrimitiveType string string string String
    // 020 S_HandleDragLineHorizontalClassName      0001866738F0 ModelPrimitiveType string string string String
    // 028 S_HandleDragLineAnchorClassName          0001866738F0 ModelPrimitiveType string string string String
    // 030 S_HandleDragLineAnchorVerticalClassName  0001866738F0 ModelPrimitiveType string string string String
    // 038 S_HandleDragLineAnchorHorizontalClassName 0001866738F0 ModelPrimitiveType string string string String
    // 040 S_VerticalClassName                      0001866738F0 ModelPrimitiveType string string string String
    // 048 S_HorizontalClassName                    0001866738F0 ModelPrimitiveType string string string String
    // 3C8 M_LeftPane                               0001866B2D70 ModelClassType VisualElement VisualElement VisualElement Pointer
    // 3D0 M_RightPane                              0001866B2D70 ModelClassType VisualElement VisualElement VisualElement Pointer
    // 3D8 M_FixedPane                              0001866B2D70 ModelClassType VisualElement VisualElement VisualElement Pointer
    // 3E0 M_FlexedPane                             0001866B2D70 ModelClassType VisualElement VisualElement VisualElement Pointer
    // 3E8 M_FixedPaneDimension                     0001866656B0 ModelPrimitiveType float float float Single
    // 3F0 M_DragLine                               0001866B2D70 ModelClassType VisualElement VisualElement VisualElement Pointer
    // 3F8 M_DragLineAnchor                         0001866B2D70 ModelClassType VisualElement VisualElement VisualElement Pointer
    // 400 M_CollapseMode                           000186594D10 ModelPrimitiveType bool bool bool Bool
    // 408 M_Content                                0001866B2D70 ModelClassType VisualElement VisualElement VisualElement Pointer
    // 410 M_Orientation                            0001866CFC00 ModelEnumType TwoPaneSplitViewOrientation TwoPaneSplitViewOrientation TwoPaneSplitViewOrientation Int32
