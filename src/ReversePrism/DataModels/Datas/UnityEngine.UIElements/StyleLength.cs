...
namespace ReversePrism.DataModels
{
    ...
    // 010 M_Value                                  ModelEnumType Length Length Length Int32
    ...
    public partial class StyleLength : DataModel
    {
        ...
        public static StyleLength? FromPointer(IntPtr p0)
        {
            ...
            value.M_Value                                   = (Length)GetInt32(new IntPtr(p + 0x010)); // 0x10 M_Value                     ( ModelEnumType Length Length Length Int32 )
