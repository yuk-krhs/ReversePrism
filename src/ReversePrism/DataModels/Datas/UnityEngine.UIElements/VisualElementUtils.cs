...
namespace ReversePrism.DataModels
{
    ...
    // 010 S_InspectorElementUssClassName           ModelPrimitiveType string string string String
    public partial class VisualElementUtils : DataModel
    {
        ...
        public static VisualElementUtils? FromPointer(IntPtr p0)
        {
            ...
            value.S_InspectorElementUssClassName            = GetString(new IntPtr(p + 0x010)); // 0x10 S_InspectorElementUssClassName ( ModelPrimitiveType string string string String )
