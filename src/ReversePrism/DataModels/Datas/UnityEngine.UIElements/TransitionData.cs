...
namespace ReversePrism.DataModels
{
    ...
    public partial class TransitionData : DataModel
    {
        ...
        public static TransitionData? FromPointer(IntPtr p0)
        {
            ...
            value.TransitionDelay                           = GetEnumList<TimeValue>(new IntPtr(p + 0x010)); // 0245A3F23ED8 0x10 TransitionDelay             ( 000185D14658 ModelEnumListType List`1<TimeValue> List`1<TimeValue> List<TimeValue> Pointer )
            value.TransitionDuration                        = GetEnumList<TimeValue>(new IntPtr(p + 0x018)); // 0245A3F23EF8 0x18 TransitionDuration          ( 000185D14658 ModelEnumListType List`1<TimeValue> List`1<TimeValue> List<TimeValue> Pointer )
            value.TransitionProperty                        = GetEnumList<StylePropertyName>(new IntPtr(p + 0x020)); // 0245A3F23F18 0x20 TransitionProperty          ( 000185D0E158 ModelEnumListType List`1<StylePropertyName> List`1<StylePropertyName> List<StylePropertyName> Pointer )
            value.TransitionTimingFunction                  = GetEnumList<EasingFunction>(new IntPtr(p + 0x028)); // 0245A3F23F38 0x28 TransitionTimingFunction    ( 000185CD7CC8 ModelEnumListType List`1<EasingFunction> List`1<EasingFunction> List<EasingFunction> Pointer )
