...
namespace ReversePrism.DataModels
{
    ...
    // 010 S_PlayerPanelWithSoftPointerCapture      ModelClassListType IPanel[] IPanel[] List<IPanel> Pointer
    public partial class PointerDeviceState : DataModel
    {
        ...
        public static PointerDeviceState? FromPointer(IntPtr p0)
        {
            ...
            value.S_PlayerPanelWithSoftPointerCapture       = GetObjectList<IPanel>(new IntPtr(p + 0x010), ReversePrism.DataModels.IPanel.FromPointer); // 0x10 S_PlayerPanelWithSoftPointerCapture ( ModelClassListType IPanel[] IPanel[] List<IPanel> Pointer )
