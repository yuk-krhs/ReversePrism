...
namespace ReversePrism.DataModels
{
    ...
    // 020 M_Version                                ModelPrimitiveType uint uint uint UInt32
    // 024 M_LastVersion                            ModelPrimitiveType uint uint uint UInt32
    ...
    public partial class VisualTreeHierarchyFlagsUpdater : DataModel
    {
        ...
        public static VisualTreeHierarchyFlagsUpdater? FromPointer(IntPtr p0)
        {
            ...
            value.M_Version                                 = GetUInt32(new IntPtr(p + 0x020)); // 0x20 M_Version                   ( ModelPrimitiveType uint uint uint UInt32 )
            value.M_LastVersion                             = GetUInt32(new IntPtr(p + 0x024)); // 0x24 M_LastVersion               ( ModelPrimitiveType uint uint uint UInt32 )
