...
namespace ReversePrism.DataModels
{
    ...
    // 014 DurationMs                               ModelPrimitiveType int int int Int32
    // 018 DelayMs                                  ModelPrimitiveType int int int Int32
    ...
    public partial class ComputedTransitionProperty : DataModel
    {
        ...
        public static ComputedTransitionProperty? FromPointer(IntPtr p0)
        {
            ...
            value.DurationMs                                = GetInt32(new IntPtr(p + 0x014)); // 0x14 DurationMs                  ( ModelPrimitiveType int int int Int32 )
            value.DelayMs                                   = GetInt32(new IntPtr(p + 0x018)); // 0x18 DelayMs                     ( ModelPrimitiveType int int int Int32 )
