...
namespace ReversePrism.DataModels
{
    ...
    public partial class ScheduledItem : DataModel
    {
        ...
        public static ScheduledItem? FromPointer(IntPtr p0)
        {
            ...
            value.StartMs                                   = GetInt64(new IntPtr(p + 0x018)); // 0245A67AC9B8 0x18 StartMs                     ( 0001865F7700 ModelPrimitiveType long long long Int64 )
            value.DelayMs                                   = GetInt64(new IntPtr(p + 0x020)); // 0245A67AC9D8 0x20 DelayMs                     ( 0001865F7700 ModelPrimitiveType long long long Int64 )
            value.IntervalMs                                = GetInt64(new IntPtr(p + 0x028)); // 0245A67AC9F8 0x28 IntervalMs                  ( 0001865F7700 ModelPrimitiveType long long long Int64 )
            value.EndTimeMs                                 = GetInt64(new IntPtr(p + 0x030)); // 0245A67ACA18 0x30 EndTimeMs                   ( 0001865F7700 ModelPrimitiveType long long long Int64 )
