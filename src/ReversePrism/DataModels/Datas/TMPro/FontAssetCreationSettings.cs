...
namespace ReversePrism.DataModels
{
    ...
    // 010 SourceFontFileName                       ModelPrimitiveType string string string String
    // 018 SourceFontFileGUID                       ModelPrimitiveType string string string String
    // 020 PointSizeSamplingMode                    ModelPrimitiveType int int int Int32
    // 024 PointSize                                ModelPrimitiveType int int int Int32
    // 028 Padding                                  ModelPrimitiveType int int int Int32
    ...
    public partial class FontAssetCreationSettings : DataModel
    {
        ...
        public static FontAssetCreationSettings? FromPointer(IntPtr p0)
        {
            ...
            value.SourceFontFileName                        = GetString(new IntPtr(p + 0x010)); // 0x10 SourceFontFileName          ( ModelPrimitiveType string string string String )
            value.SourceFontFileGUID                        = GetString(new IntPtr(p + 0x018)); // 0x18 SourceFontFileGUID          ( ModelPrimitiveType string string string String )
            value.PointSizeSamplingMode                     = GetInt32(new IntPtr(p + 0x020)); // 0x20 PointSizeSamplingMode       ( ModelPrimitiveType int int int Int32 )
            value.PointSize                                 = GetInt32(new IntPtr(p + 0x024)); // 0x24 PointSize                   ( ModelPrimitiveType int int int Int32 )
            value.Padding                                   = GetInt32(new IntPtr(p + 0x028)); // 0x28 Padding                     ( ModelPrimitiveType int int int Int32 )
