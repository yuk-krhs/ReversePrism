...
namespace ReversePrism.DataModels
{
    ...
    // 010 Uninitialized                            ModelEnumType Extents Extents Extents Int32
    ...
    public partial class Extents : DataModel
    {
        ...
        public static Extents? FromPointer(IntPtr p0)
        {
            ...
            value.Uninitialized                             = (Extents)GetInt32(new IntPtr(p + 0x010)); // 0x10 Uninitialized               ( ModelEnumType Extents Extents Extents Int32 )
