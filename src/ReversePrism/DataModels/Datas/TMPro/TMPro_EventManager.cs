...
namespace ReversePrism.DataModels
{
    ...
    // 040 TMP_SETTINGS_PROPERTY_EVENT              ModelClassType FastAction FastAction FastAction Pointer
    // 048 RESOURCE_LOAD_EVENT                      ModelClassType FastAction FastAction FastAction Pointer
    ...
    public partial class TMPro_EventManager : DataModel
    {
        ...
        public static TMPro_EventManager? FromPointer(IntPtr p0)
        {
            ...
            value.TMP_SETTINGS_PROPERTY_EVENT               = GetObject<FastAction>(new IntPtr(p + 0x040), ReversePrism.DataModels.FastAction.FromPointer); // 0x40 TMP_SETTINGS_PROPERTY_EVENT ( ModelClassType FastAction FastAction FastAction Pointer )
            value.RESOURCE_LOAD_EVENT                       = GetObject<FastAction>(new IntPtr(p + 0x048), ReversePrism.DataModels.FastAction.FromPointer); // 0x48 RESOURCE_LOAD_EVENT         ( ModelClassType FastAction FastAction FastAction Pointer )
