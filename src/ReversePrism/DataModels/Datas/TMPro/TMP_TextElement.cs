...
namespace ReversePrism.DataModels
{
    ...
    // 018 M_TextAsset                              ModelClassType TMP_Asset TMP_Asset TMP_Asset Pointer
    ...
    public partial class TMP_TextElement : DataModel
    {
        ...
        public static TMP_TextElement? FromPointer(IntPtr p0)
        {
            ...
            value.M_TextAsset                               = GetObject<TMP_Asset>(new IntPtr(p + 0x018), ReversePrism.DataModels.TMP_Asset.FromPointer); // 0x18 M_TextAsset                 ( ModelClassType TMP_Asset TMP_Asset TMP_Asset Pointer )
