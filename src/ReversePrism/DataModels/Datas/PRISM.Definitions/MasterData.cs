...
namespace ReversePrism.DataModels
{
    ...
    public partial class MasterData
    {
        ...
        public static MasterData? FromPointer(IntPtr p0)
        {
            ...
            value.FavoriteMarks                             = GetObjectList<MstFavoriteMark>(new IntPtr(p + 0x060), ReversePrism.DataModels.MstFavoriteMark.FromPointer); // 0270044483C8 0x60 FavoriteMarks               ( 000185B95630 ModelClassListType MstFavoriteMark[] MstFavoriteMark[] List<MstFavoriteMark> Pointer )
            value.ItemProviders                             = GetObjectList<MstItemProvider>(new IntPtr(p + 0x0A0), ReversePrism.DataModels.MstItemProvider.FromPointer); // 0270044484C8 0xA0 ItemProviders               ( 000185B95F60 ModelClassListType MstItemProvider[] MstItemProvider[] List<MstItemProvider> Pointer )
            value.ProduceActionEffectDisplays               = GetObjectList<MstProduceActionEffectDisplay>(new IntPtr(p + 0x0B0), ReversePrism.DataModels.MstProduceActionEffectDisplay.FromPointer); // 027004448508 0xB0 ProduceActionEffectDisplays ( 000185B96540 ModelClassListType MstProduceActionEffectDisplay[] MstProduceActionEffectDisplay[] List<MstProduceActionEffectDisplay> Pointer )
            value.SupportCharacterLimitBreakBonuses         = GetObjectList<MstSupportCharacterLimitBreakBonus>(new IntPtr(p + 0x0D0), ReversePrism.DataModels.MstSupportCharacterLimitBreakBonus.FromPointer); // 027004448588 0xD0 SupportCharacterLimitBreakBonuses ( 000185B97160 ModelClassListType MstSupportCharacterLimitBreakBonus[] MstSupportCharacterLimitBreakBonus[] List<MstSupportCharacterLimitBreakBonus> Pointer )
            value.Tips                                      = GetObjectList<MstTips>(new IntPtr(p + 0x0D8), ReversePrism.DataModels.MstTips.FromPointer); // 0270044485A8 0xD8 Tips                        ( 000185B97340 ModelClassListType MstTips[] MstTips[] List<MstTips> Pointer )
            value.ExchangeProductFilters                    = GetObjectList<MstExchangeProductFilter>(new IntPtr(p + 0x0E8), ReversePrism.DataModels.MstExchangeProductFilter.FromPointer); // 0270044485E8 0xE8 ExchangeProductFilters      ( 000185B95440 ModelClassListType MstExchangeProductFilter[] MstExchangeProductFilter[] List<MstExchangeProductFilter> Pointer )
            value.PotentialLiveSkills                       = GetObjectList<MstPotentialLiveSkill>(new IntPtr(p + 0x0F0), ReversePrism.DataModels.MstPotentialLiveSkill.FromPointer); // 027004448608 0xF0 PotentialLiveSkills         ( 000185B96350 ModelClassListType MstPotentialLiveSkill[] MstPotentialLiveSkill[] List<MstPotentialLiveSkill> Pointer )
            value.Helps                                     = GetObjectList<MstHelp>(new IntPtr(p + 0x120), ReversePrism.DataModels.MstHelp.FromPointer); // 0270044486C8 0x120 Helps                       ( 000185B95BE0 ModelClassListType MstHelp[] MstHelp[] List<MstHelp> Pointer )
            value.BirthdayVoice                             = GetObjectList<MstBirthdayVoice>(new IntPtr(p + 0x128), ReversePrism.DataModels.MstBirthdayVoice.FromPointer); // 0270044486E8 0x128 BirthdayVoice               ( 000185B94CA0 ModelClassListType MstBirthdayVoice[] MstBirthdayVoice[] List<MstBirthdayVoice> Pointer )
            value.HelpGroups                                = GetObjectList<MstHelpGroup>(new IntPtr(p + 0x130), ReversePrism.DataModels.MstHelpGroup.FromPointer); // 027004448708 0x130 HelpGroups                  ( 000185B95DA0 ModelClassListType MstHelpGroup[] MstHelpGroup[] List<MstHelpGroup> Pointer )
            value.TitleImages                               = GetObjectList<MstTitleImage>(new IntPtr(p + 0x140), ReversePrism.DataModels.MstTitleImage.FromPointer); // 027004448748 0x140 TitleImages                 ( 000185B97500 ModelClassListType MstTitleImage[] MstTitleImage[] List<MstTitleImage> Pointer )
            value.Episodes                                  = GetObjectList<MstEpisode>(new IntPtr(p + 0x190), ReversePrism.DataModels.MstEpisode.FromPointer); // 027004448888 0x190 Episodes                    ( 000185B95260 ModelClassListType MstEpisode[] MstEpisode[] List<MstEpisode> Pointer )
            value.ProduceCardContentGroups                  = GetObjectList<MstProduceCardContentGroup>(new IntPtr(p + 0x198), ReversePrism.DataModels.MstProduceCardContentGroup.FromPointer); // 0270044488A8 0x198 ProduceCardContentGroups    ( 000185B966D0 ModelClassListType MstProduceCardContentGroup[] MstProduceCardContentGroup[] List<MstProduceCardContentGroup> Pointer )
            value.GeneralItems                              = GetObjectList<MstGeneralItem>(new IntPtr(p + 0x1C8), ReversePrism.DataModels.MstGeneralItem.FromPointer); // 027004448968 0x1C8 GeneralItems                ( 000185B95A20 ModelClassListType MstGeneralItem[] MstGeneralItem[] List<MstGeneralItem> Pointer )
            value.ChallengeTourRivals                       = GetObjectList<MstChallengeTourRival>(new IntPtr(p + 0x228), ReversePrism.DataModels.MstChallengeTourRival.FromPointer); // 027004448AE8 0x228 ChallengeTourRivals         ( 000185B94E80 ModelClassListType MstChallengeTourRival[] MstChallengeTourRival[] List<MstChallengeTourRival> Pointer )
            value.ProduceStrategyTypes                      = GetObjectList<MstProduceStrategyType>(new IntPtr(p + 0x270), ReversePrism.DataModels.MstProduceStrategyType.FromPointer); // 027004448C08 0x270 ProduceStrategyTypes        ( 000185B968C0 ModelClassListType MstProduceStrategyType[] MstProduceStrategyType[] List<MstProduceStrategyType> Pointer )
            value.ProduceAuditionSettings                   = GetObjectList<MstAuditionSettings>(new IntPtr(p + 0x290), ReversePrism.DataModels.MstAuditionSettings.FromPointer); // 027004448C88 0x290 ProduceAuditionSettings     ( 000185B94AB0 ModelClassListType MstAuditionSettings[] MstAuditionSettings[] List<MstAuditionSettings> Pointer )
            value.Letters                                   = GetObjectList<MstLetter>(new IntPtr(p + 0x2B0), ReversePrism.DataModels.MstLetter.FromPointer); // 027004448D08 0x2B0 Letters                     ( 000185B96140 ModelClassListType MstLetter[] MstLetter[] List<MstLetter> Pointer )
            value.GalleryEtcCategories                      = GetObjectList<MstGalleryEtcCategory>(new IntPtr(p + 0x2B8), ReversePrism.DataModels.MstGalleryEtcCategory.FromPointer); // 027004448D28 0x2B8 GalleryEtcCategories        ( 000185B95820 ModelClassListType MstGalleryEtcCategory[] MstGalleryEtcCategory[] List<MstGalleryEtcCategory> Pointer )
            value.ShinyPartyTokens                          = GetObjectList<MstShinyPartyToken>(new IntPtr(p + 0x2D0), ReversePrism.DataModels.MstShinyPartyToken.FromPointer); // 027004448D88 0x2D0 ShinyPartyTokens            ( 000185B96D90 ModelClassListType MstShinyPartyToken[] MstShinyPartyToken[] List<MstShinyPartyToken> Pointer )
            value.PvpIngameSettings                         = GetObjectList<MstPvpIngameSettings>(new IntPtr(p + 0x2E0), ReversePrism.DataModels.MstPvpIngameSettings.FromPointer); // 027004448DC8 0x2E0 PvpIngameSettings           ( 000185B96BB0 ModelClassListType MstPvpIngameSettings[] MstPvpIngameSettings[] List<MstPvpIngameSettings> Pointer )
            value.SubSeasonOpeningAdvOption                 = GetObjectList<MstSubSeasonOpeningAdvOption>(new IntPtr(p + 0x2F0), ReversePrism.DataModels.MstSubSeasonOpeningAdvOption.FromPointer); // 027004448E08 0x2F0 SubSeasonOpeningAdvOption   ( 000185B96F70 ModelClassListType MstSubSeasonOpeningAdvOption[] MstSubSeasonOpeningAdvOption[] List<MstSubSeasonOpeningAdvOption> Pointer )
            value.CostumeShopItems                          = GetObjectList<MstCostumeShopItemGroup>(new IntPtr(p + 0x2F8), ReversePrism.DataModels.MstCostumeShopItemGroup.FromPointer); // 027004448E28 0x2F8 CostumeShopItems            ( 000185B95070 ModelClassListType MstCostumeShopItemGroup[] MstCostumeShopItemGroup[] List<MstCostumeShopItemGroup> Pointer )
            value.Tutorials                                 = GetObjectList<MstTutorial>(new IntPtr(p + 0x300), ReversePrism.DataModels.MstTutorial.FromPointer); // 027004448E48 0x300 Tutorials                   ( 000185B977E0 ModelClassListType MstTutorial[] MstTutorial[] List<MstTutorial> Pointer )
            value.FavoriteMarkIds                           = GetInt32List(new IntPtr(p + 0x308)); // 027004448E68 0x308 FavoriteMarkIds             ( 000185B7D2C0 ModelPrimitiveListType int[] int[] List<int> Pointer )
