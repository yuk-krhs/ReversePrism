...
namespace ReversePrism.DataModels
{
    ...
    // 018 VoiceType                                ModelPrimitiveType int int int Int32
    // 01C MstVoiceResourceId                       ModelPrimitiveType int int int Int32
    ...
    public partial class MstDressUpRoomVoice : DataModel
    {
        ...
        public static MstDressUpRoomVoice? FromPointer(IntPtr p0)
        {
            ...
            value.VoiceType                                 = GetInt32(new IntPtr(p + 0x018)); // 0x18 VoiceType                   ( ModelPrimitiveType int int int Int32 )
            value.MstVoiceResourceId                        = GetInt32(new IntPtr(p + 0x01C)); // 0x1C MstVoiceResourceId          ( ModelPrimitiveType int int int Int32 )
