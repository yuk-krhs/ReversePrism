...
namespace ReversePrism.DataModels
{
    ...
    // 010 SilhouetteId                             ModelPrimitiveType int int int Int32
    public partial class MstChallengeTourRival : DataModel
    {
        ...
        public static MstChallengeTourRival? FromPointer(IntPtr p0)
        {
            ...
            value.SilhouetteId                              = GetInt32(new IntPtr(p + 0x010)); // 0x10 SilhouetteId                ( ModelPrimitiveType int int int Int32 )
