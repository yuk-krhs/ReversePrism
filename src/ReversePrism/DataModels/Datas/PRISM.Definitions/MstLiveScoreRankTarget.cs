...
namespace ReversePrism.DataModels
{
    ...
    public partial class MstLiveScoreRankTarget : DataModel
    {
        ...
        public static MstLiveScoreRankTarget? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new MstLiveScoreRankTarget() { Pointer= p0 };
