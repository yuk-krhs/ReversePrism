...
namespace ReversePrism.DataModels
{
    ...
    // 080 ClickButton                              ModelClassType UIButton UIButton UIButton Pointer
    public partial class MissionEventListViewCell : DataModel
    {
        ...
        public static MissionEventListViewCell? FromPointer(IntPtr p0)
        {
            ...
            value.ClickButton                               = GetObject<UIButton>(new IntPtr(p + 0x080), ReversePrism.DataModels.UIButton.FromPointer); // 0x80 ClickButton                 ( ModelClassType UIButton UIButton UIButton Pointer )
