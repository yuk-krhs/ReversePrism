...
namespace ReversePrism.DataModels
{
    ...
    // 010 AcquiredSkill                            ModelPrimitiveType bool bool bool Bool
    // 014 MstProducePassiveEffectTypeId            ModelPrimitiveType int int int Int32
    // 018 ScheduleType                             ModelPrimitiveType int int int Int32
    // 01C ScheduleDetailType                       ModelPrimitiveType int int int Int32
    public partial class SupportEffectPassiveEffect : DataModel
    {
        ...
        public static SupportEffectPassiveEffect? FromPointer(IntPtr p0)
        {
            ...
            value.AcquiredSkill                             = GetBool(new IntPtr(p + 0x010)); // 0x10 AcquiredSkill               ( ModelPrimitiveType bool bool bool Bool )
            ...
            value.ScheduleType                              = GetInt32(new IntPtr(p + 0x018)); // 0x18 ScheduleType                ( ModelPrimitiveType int int int Int32 )
            value.ScheduleDetailType                        = GetInt32(new IntPtr(p + 0x01C)); // 0x1C ScheduleDetailType          ( ModelPrimitiveType int int int Int32 )
