...
namespace ReversePrism.DataModels
{
    ...
    // 010 Costume                                  ModelClassType ICostumeStatus ICostumeStatus ICostumeStatus Pointer
    ...
    public partial class CostumeSetData : DataModel
    {
        ...
        public static CostumeSetData? FromPointer(IntPtr p0)
        {
            ...
            value.Costume                                   = GetObject<ICostumeStatus>(new IntPtr(p + 0x010), ReversePrism.DataModels.ICostumeStatus.FromPointer); // 0x10 Costume                     ( ModelClassType ICostumeStatus ICostumeStatus ICostumeStatus Pointer )
