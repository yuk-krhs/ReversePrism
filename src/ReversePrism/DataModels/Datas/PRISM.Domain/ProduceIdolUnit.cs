...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceIdolUnit
    {
        ...
        public static ProduceIdolUnit? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProduceIdolUnit();

            value.MstUnitId                                 = GetInt32(new IntPtr(p + 0x010)); // 0270D562AED8 0x10 MstUnitId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.UnitNumber                                = GetInt32(new IntPtr(p + 0x014)); // 0270D562AEF8 0x14 UnitNumber                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Name                                      = GetString(new IntPtr(p + 0x018)); // 0270D562AF18 0x18 Name                        ( 000186671910 ModelPrimitiveType string string string String )
            value.ProduceUnitIdolList                       = GetObjectList<ProduceUnitIdol>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProduceUnitIdol.FromPointer); // 0270D562AF38 0x20 ProduceUnitIdolList         ( 000185D151B8 ModelClassListType IReadOnlyList`1<ProduceUnitIdol> IReadOnlyList`1<ProduceUnitIdol> List<ProduceUnitIdol> Pointer )
            value.SupportCharacterList                      = GetObjectList<ISupportCharacterStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ISupportCharacterStatus.FromPointer); // 0270D562AF58 0x28 SupportCharacterList        ( 000185D0D808 ModelClassListType IReadOnlyList`1<ISupportCharacterStatus> IReadOnlyList`1<ISupportCharacterStatus> List<ISupportCharacterStatus> Pointer )
            value.UnitParameter                             = GetObject<IProduceParameterStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.IProduceParameterStatus.FromPointer); // 0270D562AF78 0x30 UnitParameter               ( 0001865EF0E0 ModelClassType IProduceParameterStatus IProduceParameterStatus IProduceParameterStatus Pointer )
