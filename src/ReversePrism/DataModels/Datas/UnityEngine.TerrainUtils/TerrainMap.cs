...
namespace ReversePrism.DataModels
{
    ...
    public partial class TerrainMap
    {
        ...
        public static TerrainMap? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new TerrainMap();

            value.M_patchSize                               = (Vector3)GetInt32(new IntPtr(p + 0x010)); // 0270069777F0 0x10 M_patchSize                 ( 0001866AB820 ModelEnumType Vector3 Vector3 Vector3 Int32 )
            value.M_errorCode                               = (TerrainMapStatusCode)GetInt32(new IntPtr(p + 0x01C)); // 027006977810 0x1C M_errorCode                 ( 000186630F60 ModelEnumType TerrainMapStatusCode TerrainMapStatusCode TerrainMapStatusCode Int32 )
