...
namespace ReversePrism.DataModels
{
    ...
    public partial class HomeMainView
    {
        ...
        public static HomeMainView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new HomeMainView();

            value.MainBannerView                            = GetObject<HomeBannerView>(new IntPtr(p + 0x020), ReversePrism.DataModels.HomeBannerView.FromPointer); // 027004F7EF98 0x20 MainBannerView              ( 0001866BB5A0 ModelClassType HomeBannerView HomeBannerView HomeBannerView Pointer )
            value.SeasonMissionBannerView                   = GetObject<HomeSeasonMissionBannerView>(new IntPtr(p + 0x028), ReversePrism.DataModels.HomeSeasonMissionBannerView.FromPointer); // 027004F7EFB8 0x28 SeasonMissionBannerView     ( 0001866CA390 ModelClassType HomeSeasonMissionBannerView HomeSeasonMissionBannerView HomeSeasonMissionBannerView Pointer )
            value.SpecialMissionBannerView                  = GetObject<HomeSpecialMissionBannerView>(new IntPtr(p + 0x030), ReversePrism.DataModels.HomeSpecialMissionBannerView.FromPointer); // 027004F7EFD8 0x30 SpecialMissionBannerView    ( 0001866D1BA0 ModelClassType HomeSpecialMissionBannerView HomeSpecialMissionBannerView HomeSpecialMissionBannerView Pointer )
            value.OurStreamBannerView                       = GetObject<HomeOurStreamBannerView>(new IntPtr(p + 0x038), ReversePrism.DataModels.HomeOurStreamBannerView.FromPointer); // 027004F7EFF8 0x38 OurStreamBannerView         ( 0001866C6F30 ModelClassType HomeOurStreamBannerView HomeOurStreamBannerView HomeOurStreamBannerView Pointer )
            value.HeaderView                                = GetObject<HomeHeaderPanelView>(new IntPtr(p + 0x040), ReversePrism.DataModels.HomeHeaderPanelView.FromPointer); // 027004F7F018 0x40 HeaderView                  ( 0001866C0E80 ModelClassType HomeHeaderPanelView HomeHeaderPanelView HomeHeaderPanelView Pointer )
            value.MainFooterView                            = GetObject<HomeFooterPanelView>(new IntPtr(p + 0x048), ReversePrism.DataModels.HomeFooterPanelView.FromPointer); // 027004F7F038 0x48 MainFooterView              ( 0001866C0960 ModelClassType HomeFooterPanelView HomeFooterPanelView HomeFooterPanelView Pointer )
            value.DmButton                                  = GetObject<UIButton>(new IntPtr(p + 0x050), ReversePrism.DataModels.UIButton.FromPointer); // 027004F7F058 0x50 DmButton                    ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.HideUIButton                              = GetObject<ButtonBase>(new IntPtr(p + 0x058), ReversePrism.DataModels.ButtonBase.FromPointer); // 027004F7F078 0x58 HideUIButton                ( 000186515660 ModelClassType ButtonBase ButtonBase ButtonBase Pointer )
            value.HideAreaObject                            = GetObject<GameObject>(new IntPtr(p + 0x060), ReversePrism.DataModels.GameObject.FromPointer); // 027004F7F098 0x60 HideAreaObject              ( 0001865D7D30 ModelClassType GameObject GameObject GameObject Pointer )
            value.SettingsButton                            = GetObject<UIButton>(new IntPtr(p + 0x068), ReversePrism.DataModels.UIButton.FromPointer); // 027004F7F0B8 0x68 SettingsButton              ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.SeasonMissionButton                       = GetObject<UIButton>(new IntPtr(p + 0x070), ReversePrism.DataModels.UIButton.FromPointer); // 027004F7F0D8 0x70 SeasonMissionButton         ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.CharacterButton                           = GetObject<UIButton>(new IntPtr(p + 0x078), ReversePrism.DataModels.UIButton.FromPointer); // 027004F7F0F8 0x78 CharacterButton             ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.GlobalButton                              = GetObject<ButtonBase>(new IntPtr(p + 0x080), ReversePrism.DataModels.ButtonBase.FromPointer); // 027004F7F118 0x80 GlobalButton                ( 000186515660 ModelClassType ButtonBase ButtonBase ButtonBase Pointer )
            value.CanvasGroup                               = GetObject<CanvasGroup>(new IntPtr(p + 0x088), ReversePrism.DataModels.CanvasGroup.FromPointer); // 027004F7F138 0x88 CanvasGroup                 ( 000186540EE0 ModelClassType CanvasGroup CanvasGroup CanvasGroup Pointer )
            value.HomeSettingsPopupFactory                  = GetObject<HomeSettingsPopupViewFactory>(new IntPtr(p + 0x098), ReversePrism.DataModels.HomeSettingsPopupViewFactory.FromPointer); // 027004F7F178 0x98 HomeSettingsPopupFactory    ( 0001866CFE90 ModelClassType HomeSettingsPopupViewFactory HomeSettingsPopupViewFactory HomeSettingsPopupViewFactory Pointer )
            value.IdolSelectPopupFactory                    = GetObject<HomeSettingsIdolSelectPopupViewFactory>(new IntPtr(p + 0x0A0), ReversePrism.DataModels.HomeSettingsIdolSelectPopupViewFactory.FromPointer); // 027004F7F198 0xA0 IdolSelectPopupFactory      ( 0001866CE8C0 ModelClassType HomeSettingsIdolSelectPopupViewFactory HomeSettingsIdolSelectPopupViewFactory HomeSettingsIdolSelectPopupViewFactory Pointer )
            value.RemindItemPopupFactory                    = GetObject<HomeRemindItemPopupViewFactory>(new IntPtr(p + 0x0A8), ReversePrism.DataModels.HomeRemindItemPopupViewFactory.FromPointer); // 027004F7F1B8 0xA8 RemindItemPopupFactory      ( 0001866C9500 ModelClassType HomeRemindItemPopupViewFactory HomeRemindItemPopupViewFactory HomeRemindItemPopupViewFactory Pointer )
            value.ViewModel                                 = GetObject<HomeViewModel>(new IntPtr(p + 0x0F8), ReversePrism.DataModels.HomeViewModel.FromPointer); // 027004F7F2F8 0xF8 ViewModel                   ( 0001866D38A0 ModelClassType HomeViewModel HomeViewModel HomeViewModel Pointer )
            value.SubFooterPanelView                        = GetObject<HomeSubFooterPanelView>(new IntPtr(p + 0x100), ReversePrism.DataModels.HomeSubFooterPanelView.FromPointer); // 027004F7F318 0x100 SubFooterPanelView          ( 0001866D2570 ModelClassType HomeSubFooterPanelView HomeSubFooterPanelView HomeSubFooterPanelView Pointer )
            value.DmViewDisposable                          = GetObject<IDisposable>(new IntPtr(p + 0x108), ReversePrism.DataModels.IDisposable.FromPointer); // 027004F7F338 0x108 DmViewDisposable            ( 0001867532E0 ModelClassType IDisposable IDisposable IDisposable Pointer )
            value.ResourceTag                               = GetObject<IResourceTag>(new IntPtr(p + 0x110), ReversePrism.DataModels.IResourceTag.FromPointer); // 027004F7F358 0x110 ResourceTag                 ( 00018661C960 ModelClassType IResourceTag IResourceTag IResourceTag Pointer )
