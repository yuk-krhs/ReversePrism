...
namespace ReversePrism.DataModels
{
    ...
    public partial class Model3dLoaderForHome : DataModel
    {
        public Model3dLoaderCore?                       Core                                    { get; set; }

        public static Model3dLoaderForHome? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new Model3dLoaderForHome() { Pointer= p0 };
