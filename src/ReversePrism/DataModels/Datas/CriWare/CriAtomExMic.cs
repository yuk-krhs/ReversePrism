...
namespace ReversePrism.DataModels
{
    ...
    // 030 GcHandles                                ModelEnumListType GCHandle[] GCHandle[] List<GCHandle> Pointer
    // 038 OutputWriteStream                        ModelClassType CriAudioWriteStream CriAudioWriteStream CriAudioWriteStream Pointer
    ...
    public partial class CriAtomExMic : DataModel
    {
        ...
        public static CriAtomExMic? FromPointer(IntPtr p0)
        {
            ...
            value.GcHandles                                 = GetEnumList<GCHandle>(new IntPtr(p + 0x030)); // 0x30 GcHandles                   ( ModelEnumListType GCHandle[] GCHandle[] List<GCHandle> Pointer )
            value.OutputWriteStream                         = GetObject<CriAudioWriteStream>(new IntPtr(p + 0x038), ReversePrism.DataModels.CriAudioWriteStream.FromPointer); // 0x38 OutputWriteStream           ( ModelClassType CriAudioWriteStream CriAudioWriteStream CriAudioWriteStream Pointer )
