...
namespace ReversePrism.DataModels
{
    ...
    // 040 ProductLabelBase                         ModelClassType GashaHistoryProductLabel GashaHistoryProductLabel GashaHistoryProductLabel Pointer
    public partial class GashaHistoryCell : DataModel
    {
        ...
        public static GashaHistoryCell? FromPointer(IntPtr p0)
        {
            ...
            value.ProductLabelBase                          = GetObject<GashaHistoryProductLabel>(new IntPtr(p + 0x040), ReversePrism.DataModels.GashaHistoryProductLabel.FromPointer); // 0x40 ProductLabelBase            ( ModelClassType GashaHistoryProductLabel GashaHistoryProductLabel GashaHistoryProductLabel Pointer )
