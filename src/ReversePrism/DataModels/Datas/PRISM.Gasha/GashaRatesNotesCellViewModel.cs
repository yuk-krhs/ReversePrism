...
namespace ReversePrism.DataModels
{
    ...
    public partial class GashaRatesNotesCellViewModel : DataModel
    {
        public string                                   Text                                    { get; set; }
        public bool                                     IsBottom                                { get; set; }

        public static GashaRatesNotesCellViewModel? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new GashaRatesNotesCellViewModel() { Pointer= p0 };
