...
namespace ReversePrism.DataModels
{
    ...
    public partial class PKCS1
    {
        ...
        public static PKCS1? FromPointer(IntPtr p0)
        {
            ...
            value.EmptySHA384                               = GetSByteList(new IntPtr(p + 0x010)); // 0270DB381010 0x10 EmptySHA384                 ( 000185B79D90 ModelPrimitiveListType sbyte[] sbyte[] List<sbyte> Pointer )
            value.EmptySHA512                               = GetSByteList(new IntPtr(p + 0x018)); // 0270DB381030 0x18 EmptySHA512                 ( 000185B79D90 ModelPrimitiveListType sbyte[] sbyte[] List<sbyte> Pointer )
