...
namespace ReversePrism.DataModels
{
    ...
    // 010 IsMute                                   ModelPrimitiveType bool bool bool Bool
    // 014 VolumeIndex                              ModelPrimitiveType int int int Int32
    public partial class EachSoundSettingsLocalSaveType : DataModel
    {
        ...
        public static EachSoundSettingsLocalSaveType? FromPointer(IntPtr p0)
        {
            ...
            value.IsMute                                    = GetBool(new IntPtr(p + 0x010)); // 0x10 IsMute                      ( ModelPrimitiveType bool bool bool Bool )
            value.VolumeIndex                               = GetInt32(new IntPtr(p + 0x014)); // 0x14 VolumeIndex                 ( ModelPrimitiveType int int int Int32 )
