...
namespace ReversePrism.DataModels
{
    ...
    public partial class GUILayoutUtility
    {
        ...
        public static GUILayoutUtility? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GUILayoutUtility();

            value.Current                                   = GetObject<LayoutCache>(new IntPtr(p + 0x010), ReversePrism.DataModels.LayoutCache.FromPointer); // 027006927FA0 0x10 Current                     ( 0001866E17E0 ModelClassType LayoutCache LayoutCache LayoutCache Pointer )
            value.KDummyRect                                = (Rect)GetInt32(new IntPtr(p + 0x018)); // 027006927FC0 0x18 KDummyRect                  ( 0001866504C0 ModelEnumType Rect Rect Rect Int32 )
            value.Unbalancedgroupscount                     = GetInt32(new IntPtr(p + 0x028)); // 027006927FE0 0x28 Unbalancedgroupscount       ( 0001865F38E0 ModelPrimitiveType int int int Int32 )
