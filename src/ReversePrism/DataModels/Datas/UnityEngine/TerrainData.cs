...
namespace ReversePrism.DataModels
{
    ...
    public partial class TerrainData
    {
        ...
        public static TerrainData? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new TerrainData();

            value.K_MinimumAlphamapResolution               = GetInt32(new IntPtr(p + 0x010)); // 027002207448 0x10 K_MinimumAlphamapResolution ( 0001865F4E00 ModelPrimitiveType int int int Int32 )
            value.K_MaximumAlphamapResolution               = GetInt32(new IntPtr(p + 0x014)); // 027002207468 0x14 K_MaximumAlphamapResolution ( 0001865F4E00 ModelPrimitiveType int int int Int32 )
            value.K_MinimumBaseMapResolution                = GetInt32(new IntPtr(p + 0x018)); // 027002207488 0x18 K_MinimumBaseMapResolution  ( 0001865F4E00 ModelPrimitiveType int int int Int32 )
            value.K_MaximumBaseMapResolution                = GetInt32(new IntPtr(p + 0x01C)); // 0270022074A8 0x1C K_MaximumBaseMapResolution  ( 0001865F4E00 ModelPrimitiveType int int int Int32 )
