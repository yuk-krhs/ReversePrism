...
namespace ReversePrism.DataModels
{
    ...
    // 090 MJavaStackTrace                          ModelPrimitiveType string string string String
    public partial class AndroidJavaException : DataModel
    {
        ...
        public static AndroidJavaException? FromPointer(IntPtr p0)
        {
            ...
            value.MJavaStackTrace                           = GetString(new IntPtr(p + 0x090)); // 0x90 MJavaStackTrace             ( ModelPrimitiveType string string string String )
