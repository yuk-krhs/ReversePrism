...
namespace ReversePrism.DataModels
{
    ...
    public partial class ContactPairHeader : DataModel
    {
        ...
        public static ContactPairHeader? FromPointer(IntPtr p0)
        {
            ...
            value.M_BodyID                                  = GetInt32(new IntPtr(p + 0x010)); // 0245A691D4D0 0x10 M_BodyID                    ( 0001865F44E0 ModelPrimitiveType int int int Int32 )
            value.M_OtherBodyID                             = GetInt32(new IntPtr(p + 0x014)); // 0245A691D4F0 0x14 M_OtherBodyID               ( 0001865F44E0 ModelPrimitiveType int int int Int32 )
            value.M_NbPairs                                 = GetUInt32(new IntPtr(p + 0x020)); // 0245A691D530 0x20 M_NbPairs                   ( 000186699C60 ModelPrimitiveType uint uint uint UInt32 )
            value.M_Flags                                   = (CollisionPairHeaderFlags)GetInt32(new IntPtr(p + 0x024)); // 0245A691D550 0x24 M_Flags                     ( 0001865CB090 ModelEnumType CollisionPairHeaderFlags CollisionPairHeaderFlags CollisionPairHeaderFlags Int32 )
            value.M_RelativeVelocity                        = (Vector3)GetInt32(new IntPtr(p + 0x028)); // 0245A691D570 0x28 M_RelativeVelocity          ( 0001866AC6C0 ModelEnumType Vector3 Vector3 Vector3 Int32 )
