...
namespace ReversePrism.DataModels
{
    ...
    // 010 M_XMin                                   ModelPrimitiveType int int int Int32
    // 014 M_YMin                                   ModelPrimitiveType int int int Int32
    ...
    public partial class RectInt : DataModel
    {
        ...
        public static RectInt? FromPointer(IntPtr p0)
        {
            ...
            value.M_XMin                                    = GetInt32(new IntPtr(p + 0x010)); // 0x10 M_XMin                      ( ModelPrimitiveType int int int Int32 )
            value.M_YMin                                    = GetInt32(new IntPtr(p + 0x014)); // 0x14 M_YMin                      ( ModelPrimitiveType int int int Int32 )
