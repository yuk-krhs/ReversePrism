...
namespace ReversePrism.DataModels
{
    ...
    // 010 G_PowerOf10_U32                          ModelPrimitiveListType uint[] uint[] List<uint> Pointer
    // 018 InfinityString                           ModelPrimitiveListType sbyte[] sbyte[] List<sbyte> Pointer
    // 020 NanString                                ModelPrimitiveListType sbyte[] sbyte[] List<sbyte> Pointer
    ...
    public partial class BurstString : DataModel
    {
        ...
        public static BurstString? FromPointer(IntPtr p0)
        {
            ...
            value.G_PowerOf10_U32                           = GetUInt32List(new IntPtr(p + 0x010)); // 0x10 G_PowerOf10_U32             ( ModelPrimitiveListType uint[] uint[] List<uint> Pointer )
            value.InfinityString                            = GetSByteList(new IntPtr(p + 0x018)); // 0x18 InfinityString              ( ModelPrimitiveListType sbyte[] sbyte[] List<sbyte> Pointer )
            value.NanString                                 = GetSByteList(new IntPtr(p + 0x020)); // 0x20 NanString                   ( ModelPrimitiveListType sbyte[] sbyte[] List<sbyte> Pointer )
