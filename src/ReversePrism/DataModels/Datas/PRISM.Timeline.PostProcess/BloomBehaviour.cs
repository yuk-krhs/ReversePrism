...
namespace ReversePrism.DataModels
{
    ...
    // 014 DownSampleLevel                          ModelPrimitiveType int int int Int32
    // 018 Intensity                                ModelPrimitiveType float float float Single
    // 01C Threshold                                ModelPrimitiveType float float float Single
    // 020 SoftKnee                                 ModelPrimitiveType float float float Single
    // 024 Clamp                                    ModelPrimitiveType float float float Single
    // 028 Diffusion                                ModelPrimitiveType float float float Single
    // 02C AnamorphicRatio                          ModelPrimitiveType float float float Single
    ...
    public partial class BloomBehaviour : DataModel
    {
        ...
        public static BloomBehaviour? FromPointer(IntPtr p0)
        {
            ...
            value.DownSampleLevel                           = GetInt32(new IntPtr(p + 0x014)); // 0x14 DownSampleLevel             ( ModelPrimitiveType int int int Int32 )
            value.Intensity                                 = GetSingle(new IntPtr(p + 0x018)); // 0x18 Intensity                   ( ModelPrimitiveType float float float Single )
            value.Threshold                                 = GetSingle(new IntPtr(p + 0x01C)); // 0x1C Threshold                   ( ModelPrimitiveType float float float Single )
            value.SoftKnee                                  = GetSingle(new IntPtr(p + 0x020)); // 0x20 SoftKnee                    ( ModelPrimitiveType float float float Single )
            value.Clamp                                     = GetSingle(new IntPtr(p + 0x024)); // 0x24 Clamp                       ( ModelPrimitiveType float float float Single )
            value.Diffusion                                 = GetSingle(new IntPtr(p + 0x028)); // 0x28 Diffusion                   ( ModelPrimitiveType float float float Single )
            value.AnamorphicRatio                           = GetSingle(new IntPtr(p + 0x02C)); // 0x2C AnamorphicRatio             ( ModelPrimitiveType float float float Single )
