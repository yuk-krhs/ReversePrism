...
namespace ReversePrism.DataModels
{
    ...
    public partial class Random : DataModel
    {
        ...
        public static Random? FromPointer(IntPtr p0)
        {
            ...
            value.Inext                                     = GetInt32(new IntPtr(p + 0x010)); // 0245A3D372F8 0x10 Inext                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Inextp                                    = GetInt32(new IntPtr(p + 0x014)); // 0245A3D37318 0x14 Inextp                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SeedArray                                 = GetInt32List(new IntPtr(p + 0x018)); // 0245A3D37338 0x18 SeedArray                   ( 000185B7D2C0 ModelPrimitiveListType int[] int[] List<int> Pointer )
