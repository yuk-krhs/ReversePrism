...
namespace ReversePrism.DataModels
{
    ...
    // 020 LastField                                ModelClassType UnknownField UnknownField UnknownField Pointer
    public partial class UnknownFieldSet : DataModel
    {
        ...
        public static UnknownFieldSet? FromPointer(IntPtr p0)
        {
            ...
            value.LastField                                 = GetObject<UnknownField>(new IntPtr(p + 0x020), ReversePrism.DataModels.UnknownField.FromPointer); // 0x20 LastField                   ( ModelClassType UnknownField UnknownField UnknownField Pointer )
