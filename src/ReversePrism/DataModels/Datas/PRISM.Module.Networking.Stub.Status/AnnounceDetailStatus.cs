...
namespace ReversePrism.DataModels
{
    ...
    public partial class AnnounceDetailStatus : DataModel
    {
        ...
        public static AnnounceDetailStatus? FromPointer(IntPtr p0)
        {
            ...
            value.Category                                  = GetEnumList<AnnounceCategory>(new IntPtr(p + 0x068)); // 024660EFAD70 0x68 Category                    ( 000185CCDF88 ModelEnumListType RepeatedField`1<AnnounceCategory> RepeatedField`1<AnnounceCategory> List<AnnounceCategory> Pointer )
            value.BeginDateTime                             = GetDateTime(new IntPtr(p + 0x018)); // 024660EFABD0 0x18 BeginDateTime               ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.LastUpdateDateTime                        = GetDateTime(new IntPtr(p + 0x028)); // 024660EFABF0 0x28 LastUpdateDateTime          ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.DisplayNewMarkEndDateTime                 = GetDateTime(new IntPtr(p + 0x038)); // 024660EFAC10 0x38 DisplayNewMarkEndDateTime   ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.ArticleId                                 = GetString(new IntPtr(p + 0x050)); // 024660EFAC90 0x50 ArticleId                   ( 000186671910 ModelPrimitiveType string string string String )
            value.Title                                     = GetString(new IntPtr(p + 0x058)); // 024660EFACD0 0x58 Title                       ( 000186671910 ModelPrimitiveType string string string String )
            value.Body                                      = GetString(new IntPtr(p + 0x060)); // 024660EFAD10 0x60 Body                        ( 000186671910 ModelPrimitiveType string string string String )
            value.Genre                                     = (AnnounceGenre)GetInt32(new IntPtr(p + 0x070)); // 024660EFADB0 0x70 Genre                       ( 0001866BFD50 ModelEnumType AnnounceGenre AnnounceGenre AnnounceGenre Int32 )
            value.BannerUrl                                 = GetString(new IntPtr(p + 0x078)); // 024660EFADF0 0x78 BannerUrl                   ( 000186671910 ModelPrimitiveType string string string String )
            value._BeginDateTime                            = GetObject<Timestamp>(new IntPtr(p + 0x080), ReversePrism.DataModels.Timestamp.FromPointer); // 024660EFAE30 0x80 _BeginDateTime              ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value._LastUpdateDateTime                       = GetObject<Timestamp>(new IntPtr(p + 0x088), ReversePrism.DataModels.Timestamp.FromPointer); // 024660EFAE70 0x88 _LastUpdateDateTime         ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value._DisplayNewMarkEndDateTime                = GetObject<Timestamp>(new IntPtr(p + 0x090), ReversePrism.DataModels.Timestamp.FromPointer); // 024660EFAEB0 0x90 _DisplayNewMarkEndDateTime  ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.IsDisplayUpdateDateTime                   = GetBool(new IntPtr(p + 0x098)); // 024660EFAEF0 0x98 IsDisplayUpdateDateTime     ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.JumpList                                  = GetObjectList<JumpStatus>(new IntPtr(p + 0x0A0), ReversePrism.DataModels.JumpStatus.FromPointer); // 024660EFAF50 0xA0 JumpList                    ( 000185CE2348 ModelClassListType RepeatedField`1<JumpStatus> RepeatedField`1<JumpStatus> List<JumpStatus> Pointer )
