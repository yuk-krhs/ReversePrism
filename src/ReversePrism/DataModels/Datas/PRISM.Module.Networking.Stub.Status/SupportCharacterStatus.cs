...
namespace ReversePrism.DataModels
{
    ...
    public partial class SupportCharacterStatus
    {
        ...
        public static SupportCharacterStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SupportCharacterStatus();

            value.CreateDate                                = GetDateTime(new IntPtr(p + 0x010)); // 0270D143B770 0x10 CreateDate                  ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.MstSupportCharacterId                     = GetInt32(new IntPtr(p + 0x028)); // 0270D143B7F0 0x28 MstSupportCharacterId       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Rarity                                    = (SupportCharacterRarity)GetInt32(new IntPtr(p + 0x02C)); // 0270D143B830 0x2C Rarity                      ( 0001865EB1C0 ModelEnumType SupportCharacterRarity SupportCharacterRarity SupportCharacterRarity Int32 )
            value.Level                                     = GetObject<LimitedValueStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.LimitedValueStatus.FromPointer); // 0270D143B870 0x30 Level                       ( 00018652EBE0 ModelClassType LimitedValueStatus LimitedValueStatus LimitedValueStatus Pointer )
            value.Exp                                       = GetInt32(new IntPtr(p + 0x038)); // 0270D143B8B0 0x38 Exp                         ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Diamond                                   = GetObject<LimitedValueStatus>(new IntPtr(p + 0x040), ReversePrism.DataModels.LimitedValueStatus.FromPointer); // 0270D143B8F0 0x40 Diamond                     ( 00018652EBE0 ModelClassType LimitedValueStatus LimitedValueStatus LimitedValueStatus Pointer )
            value.SupportSkillSlotAmount                    = GetObject<LimitedValueStatus>(new IntPtr(p + 0x048), ReversePrism.DataModels.LimitedValueStatus.FromPointer); // 0270D143B930 0x48 SupportSkillSlotAmount      ( 00018652EBE0 ModelClassType LimitedValueStatus LimitedValueStatus LimitedValueStatus Pointer )
            value.MstFavoriteMarkId                         = GetInt32(new IntPtr(p + 0x050)); // 0270D143B970 0x50 MstFavoriteMarkId           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SupportEffectList                         = GetObjectList<SupportEffectStatus>(new IntPtr(p + 0x058), ReversePrism.DataModels.SupportEffectStatus.FromPointer); // 0270D143B9D0 0x58 SupportEffectList           ( 000185CF44F8 ModelClassListType RepeatedField`1<SupportEffectStatus> RepeatedField`1<SupportEffectStatus> List<SupportEffectStatus> Pointer )
            value.PotentialSupportSkillList                 = GetObjectList<PotentialSupportSkillStatus>(new IntPtr(p + 0x060), ReversePrism.DataModels.PotentialSupportSkillStatus.FromPointer); // 0270D143BA30 0x60 PotentialSupportSkillList   ( 000185CE95A8 ModelClassListType RepeatedField`1<PotentialSupportSkillStatus> RepeatedField`1<PotentialSupportSkillStatus> List<PotentialSupportSkillStatus> Pointer )
            value.SupportCharacterEventList                 = GetObjectList<SupportCharacterEventStatus>(new IntPtr(p + 0x068), ReversePrism.DataModels.SupportCharacterEventStatus.FromPointer); // 0270D143BA90 0x68 SupportCharacterEventList   ( 000185CF3DF8 ModelClassListType RepeatedField`1<SupportCharacterEventStatus> RepeatedField`1<SupportCharacterEventStatus> List<SupportCharacterEventStatus> Pointer )
            value._CreateDate                               = GetObject<Timestamp>(new IntPtr(p + 0x070), ReversePrism.DataModels.Timestamp.FromPointer); // 0270D143BAD0 0x70 _CreateDate                 ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.LimitBreakRecipeProduct                   = GetObject<ProductStatus>(new IntPtr(p + 0x078), ReversePrism.DataModels.ProductStatus.FromPointer); // 0270D143BB10 0x78 LimitBreakRecipeProduct     ( 0001865A5470 ModelClassType ProductStatus ProductStatus ProductStatus Pointer )
            value.MstCharacterInfoId                        = GetInt32(new IntPtr(p + 0x080)); // 0270D143BB50 0x80 MstCharacterInfoId          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.CardId                                    = GetInt32(new IntPtr(p + 0x084)); // 0270D143BB90 0x84 CardId                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.GoodScheduleDetailType                    = (ScheduleDetailType)GetInt32(new IntPtr(p + 0x088)); // 0270D143BBD0 0x88 GoodScheduleDetailType      ( 0001866D43F0 ModelEnumType ScheduleDetailType ScheduleDetailType ScheduleDetailType Int32 )
            value.ProduceEntrust                            = GetObject<ProduceEntrustStatus>(new IntPtr(p + 0x090), ReversePrism.DataModels.ProduceEntrustStatus.FromPointer); // 0270D143BC10 0x90 ProduceEntrust              ( 00018653E020 ModelClassType ProduceEntrustStatus ProduceEntrustStatus ProduceEntrustStatus Pointer )
