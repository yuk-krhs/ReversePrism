...
namespace ReversePrism.DataModels
{
    ...
    // 058 SupportEffectList                        ModelClassListType RepeatedField`1<SupportEffectStatus> RepeatedField`1<SupportEffectStatus> List<SupportEffectStatus> Pointer
    ...
    public partial class SupportCharacterStatus : DataModel
    {
        ...
        public static SupportCharacterStatus? FromPointer(IntPtr p0)
        {
            ...
            value.SupportEffectList                         = GetObjectList<SupportEffectStatus>(new IntPtr(p + 0x058), ReversePrism.DataModels.SupportEffectStatus.FromPointer); // 0x58 SupportEffectList           ( ModelClassListType RepeatedField`1<SupportEffectStatus> RepeatedField`1<SupportEffectStatus> List<SupportEffectStatus> Pointer )
