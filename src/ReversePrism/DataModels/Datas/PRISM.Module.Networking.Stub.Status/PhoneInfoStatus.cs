...
namespace ReversePrism.DataModels
{
    ...
    // 028 MstPhoneUserId                           ModelPrimitiveType int int int Int32
    ...
    // 038 PhoneCallList                            ModelClassListType RepeatedField`1<PhoneCallStatus> RepeatedField`1<PhoneCallStatus> List<PhoneCallStatus> Pointer
    public partial class PhoneInfoStatus : DataModel
    {
        ...
        public static PhoneInfoStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstPhoneUserId                            = GetInt32(new IntPtr(p + 0x028)); // 0x28 MstPhoneUserId              ( ModelPrimitiveType int int int Int32 )
            ...
            value.PhoneCallList                             = GetObjectList<PhoneCallStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.PhoneCallStatus.FromPointer); // 0x38 PhoneCallList               ( ModelClassListType RepeatedField`1<PhoneCallStatus> RepeatedField`1<PhoneCallStatus> List<PhoneCallStatus> Pointer )
