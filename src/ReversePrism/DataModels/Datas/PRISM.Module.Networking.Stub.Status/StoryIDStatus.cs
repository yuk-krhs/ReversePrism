...
namespace ReversePrism.DataModels
{
    ...
    public partial class StoryIDStatus
    {
        ...
        public static StoryIDStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new StoryIDStatus();

            value.StoryType                                 = (StoryType)GetInt32(new IntPtr(p + 0x018)); // 0270D2A3D970 0x18 StoryType                   ( 0001865B0320 ModelEnumType StoryType StoryType StoryType Int32 )
            value.StoryMstId                                = GetInt32(new IntPtr(p + 0x01C)); // 0270D2A3D9B0 0x1C StoryMstId                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
