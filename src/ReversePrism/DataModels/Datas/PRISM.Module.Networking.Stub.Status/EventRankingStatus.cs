...
namespace ReversePrism.DataModels
{
    ...
    public partial class EventRankingStatus : DataModel
    {
        ...
        public static EventRankingStatus? FromPointer(IntPtr p0)
        {
            ...
            value.RankingViewTypeList                       = GetEnumList<EventRankingViewType>(new IntPtr(p + 0x028)); // 024660FAFDA8 0x28 RankingViewTypeList         ( 000185CD5B38 ModelEnumListType RepeatedField`1<EventRankingViewType> RepeatedField`1<EventRankingViewType> List<EventRankingViewType> Pointer )
            value.MstEventId                                = GetInt32(new IntPtr(p + 0x020)); // 024660FAFD08 0x20 MstEventId                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.RankingType                               = (EventRankingType)GetInt32(new IntPtr(p + 0x024)); // 024660FAFD48 0x24 RankingType                 ( 000186762F80 ModelEnumType EventRankingType EventRankingType EventRankingType Int32 )
