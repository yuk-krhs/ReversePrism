...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<ChallengeTourInGameIdolStatus> IL2CPP_TYPE_GENERICINST
    ...
    // 028 IdolSkill                                ModelClassType ChallengeTourInGameIdolSkillStatus ChallengeTourInGameIdolSkillStatus ChallengeTourInGameIdolSkillStatus Pointer
    ...
    public partial class ChallengeTourInGameIdolStatus : DataModel
    {
        ...
        public ChallengeTourInGameIdolSkillStatus?      IdolSkill                               { get; set; }
        public ProduceParameterStatus?                  IdolBaseParameter                       { get; set; }

        public static ChallengeTourInGameIdolStatus? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;
            ...
            value.IdolSkill                                 = GetObject<ChallengeTourInGameIdolSkillStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ChallengeTourInGameIdolSkillStatus.FromPointer); // 0x28 IdolSkill                   ( ModelClassType ChallengeTourInGameIdolSkillStatus ChallengeTourInGameIdolSkillStatus ChallengeTourInGameIdolSkillStatus Pointer )
