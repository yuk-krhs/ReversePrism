...
namespace ReversePrism.DataModels
{
    ...
    // 040 FesIdolList                              ModelClassListType RepeatedField`1<FesUnitIdolStatus> RepeatedField`1<FesUnitIdolStatus> List<FesUnitIdolStatus> Pointer
    ...
    // 048 SupportCharacterList                     ModelClassListType RepeatedField`1<FesUnitSupportCharacterStatus> RepeatedField`1<FesUnitSupportCharacterStatus> List<FesUnitSupportCharacterStatus> Pointer
    ...
    // 050 SupportSkillList                         ModelClassListType RepeatedField`1<FesUnitAttachedSupportSkillStatus> RepeatedField`1<FesUnitAttachedSupportSkillStatus> List<FesUnitAttachedSupportSkillStatus> Pointer
    ...
    public partial class FesIdolUnitStatus : DataModel
    {
        ...
        public static FesIdolUnitStatus? FromPointer(IntPtr p0)
        {
            ...
            value.FesIdolList                               = GetObjectList<FesUnitIdolStatus>(new IntPtr(p + 0x040), ReversePrism.DataModels.FesUnitIdolStatus.FromPointer); // 0x40 FesIdolList                 ( ModelClassListType RepeatedField`1<FesUnitIdolStatus> RepeatedField`1<FesUnitIdolStatus> List<FesUnitIdolStatus> Pointer )
            value.SupportCharacterList                      = GetObjectList<FesUnitSupportCharacterStatus>(new IntPtr(p + 0x048), ReversePrism.DataModels.FesUnitSupportCharacterStatus.FromPointer); // 0x48 SupportCharacterList        ( ModelClassListType RepeatedField`1<FesUnitSupportCharacterStatus> RepeatedField`1<FesUnitSupportCharacterStatus> List<FesUnitSupportCharacterStatus> Pointer )
            value.SupportSkillList                          = GetObjectList<FesUnitAttachedSupportSkillStatus>(new IntPtr(p + 0x050), ReversePrism.DataModels.FesUnitAttachedSupportSkillStatus.FromPointer); // 0x50 SupportSkillList            ( ModelClassListType RepeatedField`1<FesUnitAttachedSupportSkillStatus> RepeatedField`1<FesUnitAttachedSupportSkillStatus> List<FesUnitAttachedSupportSkillStatus> Pointer )
