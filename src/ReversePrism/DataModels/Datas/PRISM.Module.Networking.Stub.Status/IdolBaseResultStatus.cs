...
namespace ReversePrism.DataModels
{
    ...
    public partial class IdolBaseResultStatus : DataModel
    {
        ...
        public static IdolBaseResultStatus? FromPointer(IntPtr p0)
        {
            ...
            value.IdolLevel                                 = GetObject<LimitedValueStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.LimitedValueStatus.FromPointer); // 024661CA24A0 0x18 IdolLevel                   ( 00018652EBE0 ModelClassType LimitedValueStatus LimitedValueStatus LimitedValueStatus Pointer )
            value.IdolLevelExp                              = GetObject<LimitedValueStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.LimitedValueStatus.FromPointer); // 024661CA24E0 0x20 IdolLevelExp                ( 00018652EBE0 ModelClassType LimitedValueStatus LimitedValueStatus LimitedValueStatus Pointer )
            value.DearnessLevel                             = GetObject<LimitedValueStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.LimitedValueStatus.FromPointer); // 024661CA2520 0x28 DearnessLevel               ( 00018652EBE0 ModelClassType LimitedValueStatus LimitedValueStatus LimitedValueStatus Pointer )
            value.DearnessLevelExp                          = GetObject<LimitedValueStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.LimitedValueStatus.FromPointer); // 024661CA2560 0x30 DearnessLevelExp            ( 00018652EBE0 ModelClassType LimitedValueStatus LimitedValueStatus LimitedValueStatus Pointer )
            value.Fan                                       = GetInt64(new IntPtr(p + 0x038)); // 024661CA25A0 0x38 Fan                         ( 0001865F7700 ModelPrimitiveType long long long Int64 )
            value.Parameter                                 = GetObject<IdolParameterStatus>(new IntPtr(p + 0x040), ReversePrism.DataModels.IdolParameterStatus.FromPointer); // 024661CA25E0 0x40 Parameter                   ( 0001866B60B0 ModelClassType IdolParameterStatus IdolParameterStatus IdolParameterStatus Pointer )
