...
namespace ReversePrism.DataModels
{
    ...
    // 020 LoginBonusPassStoreItemList              ModelClassListType RepeatedField`1<LoginBonusPassStoreItemStatus> RepeatedField`1<LoginBonusPassStoreItemStatus> List<LoginBonusPassStoreItemStatus> Pointer
    public partial class ShopItemLoginBonusPassGroupStatus : DataModel
    {
        ...
        public static ShopItemLoginBonusPassGroupStatus? FromPointer(IntPtr p0)
        {
            ...
            value.LoginBonusPassStoreItemList               = GetObjectList<LoginBonusPassStoreItemStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.LoginBonusPassStoreItemStatus.FromPointer); // 0x20 LoginBonusPassStoreItemList ( ModelClassListType RepeatedField`1<LoginBonusPassStoreItemStatus> RepeatedField`1<LoginBonusPassStoreItemStatus> List<LoginBonusPassStoreItemStatus> Pointer )
