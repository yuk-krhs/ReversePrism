...
namespace ReversePrism.DataModels
{
    ...
    public partial class IdolBaseRewardStatus : DataModel
    {
        ...
        public static IdolBaseRewardStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstIdolId                                 = GetInt32(new IntPtr(p + 0x018)); // 024661CA36A8 0x18 MstIdolId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.BeforeParameter                           = GetObject<IdolBaseResultStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.IdolBaseResultStatus.FromPointer); // 024661CA36E8 0x20 BeforeParameter             ( 0001866AC460 ModelClassType IdolBaseResultStatus IdolBaseResultStatus IdolBaseResultStatus Pointer )
            value.AfterParameter                            = GetObject<IdolBaseResultStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.IdolBaseResultStatus.FromPointer); // 024661CA3728 0x28 AfterParameter              ( 0001866AC460 ModelClassType IdolBaseResultStatus IdolBaseResultStatus IdolBaseResultStatus Pointer )
            value.IdolLevelExp                              = GetInt32(new IntPtr(p + 0x030)); // 024661CA3768 0x30 IdolLevelExp                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.DearnessLevelExp                          = GetInt32(new IntPtr(p + 0x034)); // 024661CA37A8 0x34 DearnessLevelExp            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Fan                                       = GetInt64(new IntPtr(p + 0x038)); // 024661CA37E8 0x38 Fan                         ( 0001865F7700 ModelPrimitiveType long long long Int64 )
            value.IdolLevelRewardList                       = GetObjectList<IdolBaseLevelRewardStatus>(new IntPtr(p + 0x040), ReversePrism.DataModels.IdolBaseLevelRewardStatus.FromPointer); // 024661CA3848 0x40 IdolLevelRewardList         ( 000185CDF1F8 ModelClassListType RepeatedField`1<IdolBaseLevelRewardStatus> RepeatedField`1<IdolBaseLevelRewardStatus> List<IdolBaseLevelRewardStatus> Pointer )
            value.DearnessLevelRewardList                   = GetObjectList<IdolBaseLevelRewardStatus>(new IntPtr(p + 0x048), ReversePrism.DataModels.IdolBaseLevelRewardStatus.FromPointer); // 024661CA38A8 0x48 DearnessLevelRewardList     ( 000185CDF1F8 ModelClassListType RepeatedField`1<IdolBaseLevelRewardStatus> RepeatedField`1<IdolBaseLevelRewardStatus> List<IdolBaseLevelRewardStatus> Pointer )
