...
namespace ReversePrism.DataModels
{
    ...
    // 018 ProduceIdolList                          ModelClassListType RepeatedField`1<InProduceIdolStatus> RepeatedField`1<InProduceIdolStatus> List<InProduceIdolStatus> Pointer
    // 000 VitalityFieldNumber                      int IL2CPP_TYPE_I4
    // 020 Vitality                                 ModelClassType VitalityStatus VitalityStatus VitalityStatus Pointer
    ...
    // 030 SupportSkill                             ModelClassType SupportSkillStatus SupportSkillStatus SupportSkillStatus Pointer
    public partial class ProduceUnitStatus : DataModel
    {
        ...
        public static ProduceUnitStatus? FromPointer(IntPtr p0)
        {
            ...
            value.ProduceIdolList                           = GetObjectList<InProduceIdolStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.InProduceIdolStatus.FromPointer); // 0x18 ProduceIdolList             ( ModelClassListType RepeatedField`1<InProduceIdolStatus> RepeatedField`1<InProduceIdolStatus> List<InProduceIdolStatus> Pointer )
            value.Vitality                                  = GetObject<VitalityStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.VitalityStatus.FromPointer); // 0x20 Vitality                    ( ModelClassType VitalityStatus VitalityStatus VitalityStatus Pointer )
            ...
            value.SupportSkill                              = GetObject<SupportSkillStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.SupportSkillStatus.FromPointer); // 0x30 SupportSkill                ( ModelClassType SupportSkillStatus SupportSkillStatus SupportSkillStatus Pointer )
