...
namespace ReversePrism.DataModels
{
    ...
    public partial class IdolBaseLevelRewardStatus : DataModel
    {
        ...
        public static IdolBaseLevelRewardStatus? FromPointer(IntPtr p0)
        {
            ...
            value.Level                                     = GetInt32(new IntPtr(p + 0x018)); // 024661CA14A0 0x18 Level                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.RewardList                                = GetObjectList<ProductWithAmountStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 024661CA1500 0x20 RewardList                  ( 000185CECB38 ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer )
