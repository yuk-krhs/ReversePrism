...
namespace ReversePrism.DataModels
{
    ...
    // 024 MstFavoriteMarkId                        ModelPrimitiveType int int int Int32
    ...
    // 050 TransferProductList                      ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer
    // 000 ProduceHistoryFieldNumber                int IL2CPP_TYPE_I4
    // 058 ProduceHistory                           ModelClassType ProduceHistoryStatus ProduceHistoryStatus ProduceHistoryStatus Pointer
    // 000 StarFieldNumber                          int IL2CPP_TYPE_I4
    // 060 Star                                     ModelPrimitiveType int int int Int32
    ...
    // 06C MstCharacterInfoId                       ModelPrimitiveType int int int Int32
    ...
    // 070 FesIdolList                              ModelClassListType RepeatedField`1<FesUnitIdolStatus> RepeatedField`1<FesUnitIdolStatus> List<FesUnitIdolStatus> Pointer
    public partial class FesIdolStatus : DataModel
    {
        ...
        public static FesIdolStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstFavoriteMarkId                         = GetInt32(new IntPtr(p + 0x024)); // 0x24 MstFavoriteMarkId           ( ModelPrimitiveType int int int Int32 )
            ...
            value.TransferProductList                       = GetObjectList<ProductWithAmountStatus>(new IntPtr(p + 0x050), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 0x50 TransferProductList         ( ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer )
            value.ProduceHistory                            = GetObject<ProduceHistoryStatus>(new IntPtr(p + 0x058), ReversePrism.DataModels.ProduceHistoryStatus.FromPointer); // 0x58 ProduceHistory              ( ModelClassType ProduceHistoryStatus ProduceHistoryStatus ProduceHistoryStatus Pointer )
            value.Star                                      = GetInt32(new IntPtr(p + 0x060)); // 0x60 Star                        ( ModelPrimitiveType int int int Int32 )
            ...
            value.MstCharacterInfoId                        = GetInt32(new IntPtr(p + 0x06C)); // 0x6C MstCharacterInfoId          ( ModelPrimitiveType int int int Int32 )
            value.FesIdolList                               = GetObjectList<FesUnitIdolStatus>(new IntPtr(p + 0x070), ReversePrism.DataModels.FesUnitIdolStatus.FromPointer); // 0x70 FesIdolList                 ( ModelClassListType RepeatedField`1<FesUnitIdolStatus> RepeatedField`1<FesUnitIdolStatus> List<FesUnitIdolStatus> Pointer )
