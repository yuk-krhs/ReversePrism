...
namespace ReversePrism.DataModels
{
    ...
    public partial class FesIdolStatus : DataModel
    {
        ...
        public static FesIdolStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new FesIdolStatus() { Pointer= p0 };

            value.FesIdolId                                 = GetString(new IntPtr(p + 0x018)); // 024661227830 0x18 FesIdolId                   ( 000186671910 ModelPrimitiveType string string string String )
            value.MstProduceIdolId                          = GetInt32(new IntPtr(p + 0x020)); // 024661227870 0x20 MstProduceIdolId            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstFavoriteMarkId                         = GetInt32(new IntPtr(p + 0x024)); // 0246612278B0 0x24 MstFavoriteMarkId           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Parameter                                 = GetObject<ProduceParameterStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ProduceParameterStatus.FromPointer); // 0246612278F0 0x28 Parameter                   ( 0001865627F0 ModelClassType ProduceParameterStatus ProduceParameterStatus ProduceParameterStatus Pointer )
            value.Rank                                      = (ProduceParameterRank)GetInt32(new IntPtr(p + 0x030)); // 024661227930 0x30 Rank                        ( 000186562070 ModelEnumType ProduceParameterRank ProduceParameterRank ProduceParameterRank Int32 )
            value.FesUnit                                   = GetObject<FesIdolUnitStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.FesIdolUnitStatus.FromPointer); // 024661227970 0x38 FesUnit                     ( 000186567370 ModelClassType FesIdolUnitStatus FesIdolUnitStatus FesIdolUnitStatus Pointer )
            value.AttachedIdolSkill                         = GetObject<FesIdolAttachedIdolSkillStatus>(new IntPtr(p + 0x040), ReversePrism.DataModels.FesIdolAttachedIdolSkillStatus.FromPointer); // 0246612279B0 0x40 AttachedIdolSkill           ( 000186560C30 ModelClassType FesIdolAttachedIdolSkillStatus FesIdolAttachedIdolSkillStatus FesIdolAttachedIdolSkillStatus Pointer )
            value.AttachedPotentialLiveSkill                = GetObject<FesIdolAttachedPotentialLiveSkillStatus>(new IntPtr(p + 0x048), ReversePrism.DataModels.FesIdolAttachedPotentialLiveSkillStatus.FromPointer); // 0246612279F0 0x48 AttachedPotentialLiveSkill  ( 0001865613F0 ModelClassType FesIdolAttachedPotentialLiveSkillStatus FesIdolAttachedPotentialLiveSkillStatus FesIdolAttachedPotentialLiveSkillStatus Pointer )
            value.TransferProductList                       = GetObjectList<ProductWithAmountStatus>(new IntPtr(p + 0x050), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 024661227A50 0x50 TransferProductList         ( 000185CECB38 ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer )
            value.ProduceHistory                            = GetObject<ProduceHistoryStatus>(new IntPtr(p + 0x058), ReversePrism.DataModels.ProduceHistoryStatus.FromPointer); // 024661227A90 0x58 ProduceHistory              ( 000186545C20 ModelClassType ProduceHistoryStatus ProduceHistoryStatus ProduceHistoryStatus Pointer )
            value.Star                                      = GetInt32(new IntPtr(p + 0x060)); // 024661227AD0 0x60 Star                        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.InitialStar                               = GetInt32(new IntPtr(p + 0x064)); // 024661227B10 0x64 InitialStar                 ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.CardId                                    = GetInt32(new IntPtr(p + 0x068)); // 024661227B50 0x68 CardId                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstCharacterInfoId                        = GetInt32(new IntPtr(p + 0x06C)); // 024661227B90 0x6C MstCharacterInfoId          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.FesIdolList                               = GetObjectList<FesUnitIdolStatus>(new IntPtr(p + 0x070), ReversePrism.DataModels.FesUnitIdolStatus.FromPointer); // 024661227BF0 0x70 FesIdolList                 ( 000185CD8208 ModelClassListType RepeatedField`1<FesUnitIdolStatus> RepeatedField`1<FesUnitIdolStatus> List<FesUnitIdolStatus> Pointer )
