...
namespace ReversePrism.DataModels
{
    ...
    // 018 DressUpRoomCostumeId                     ModelPrimitiveType string string string String
    ...
    // 024 MstCostumeId                             ModelPrimitiveType int int int Int32
    ...
    // 030 MstAccessoryIdList                       ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer
    // 000 DressUpRoomCostumeTypeFieldNumber        int IL2CPP_TYPE_I4
    // 038 DressUpRoomCostumeType                   ModelEnumType DressUpRoomCostumeType DressUpRoomCostumeType DressUpRoomCostumeType Int32
    public partial class DressUpRoomCostumeStatus : DataModel
    {
        ...
        public static DressUpRoomCostumeStatus? FromPointer(IntPtr p0)
        {
            ...
            value.DressUpRoomCostumeId                      = GetString(new IntPtr(p + 0x018)); // 0x18 DressUpRoomCostumeId        ( ModelPrimitiveType string string string String )
            value.MstIdolId                                 = GetInt32(new IntPtr(p + 0x020)); // 0x20 MstIdolId                   ( ModelPrimitiveType int int int Int32 )
            value.MstCostumeId                              = GetInt32(new IntPtr(p + 0x024)); // 0x24 MstCostumeId                ( ModelPrimitiveType int int int Int32 )
            value.MstHairstyleId                            = GetInt32(new IntPtr(p + 0x028)); // 0x28 MstHairstyleId              ( ModelPrimitiveType int int int Int32 )
            value.MstAccessoryIdList                        = GetInt32List(new IntPtr(p + 0x030)); // 0x30 MstAccessoryIdList          ( ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
            value.DressUpRoomCostumeType                    = (DressUpRoomCostumeType)GetInt32(new IntPtr(p + 0x038)); // 0x38 DressUpRoomCostumeType      ( ModelEnumType DressUpRoomCostumeType DressUpRoomCostumeType DressUpRoomCostumeType Int32 )
