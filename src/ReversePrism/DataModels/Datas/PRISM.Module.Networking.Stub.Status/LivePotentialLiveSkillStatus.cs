...
namespace ReversePrism.DataModels
{
    ...
    public partial class LivePotentialLiveSkillStatus : DataModel
    {
        ...
        public static LivePotentialLiveSkillStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstPotentialLiveSkillId                   = GetInt32(new IntPtr(p + 0x018)); // 0246612D21C0 0x18 MstPotentialLiveSkillId     ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstPotentialLiveSkillLevelId              = GetInt32(new IntPtr(p + 0x01C)); // 0246612D2200 0x1C MstPotentialLiveSkillLevelId ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Level                                     = GetInt32(new IntPtr(p + 0x020)); // 0246612D2240 0x20 Level                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SkillEffectList                           = GetObjectList<LiveSkillEffectStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.LiveSkillEffectStatus.FromPointer); // 0246612D22A0 0x28 SkillEffectList             ( 000185CE39A8 ModelClassListType RepeatedField`1<LiveSkillEffectStatus> RepeatedField`1<LiveSkillEffectStatus> List<LiveSkillEffectStatus> Pointer )
