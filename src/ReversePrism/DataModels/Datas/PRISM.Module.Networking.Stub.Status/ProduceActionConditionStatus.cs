...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceActionConditionStatus : DataModel
    {
        ...
        public static ProduceActionConditionStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstProduceActionConditionTypeId           = GetInt32(new IntPtr(p + 0x018)); // 02466107F820 0x18 MstProduceActionConditionTypeId ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ConditionValue                            = GetInt32(new IntPtr(p + 0x01C)); // 02466107F860 0x1C ConditionValue              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
