...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceActionConditionStatus
    {
        ...
        public static ProduceActionConditionStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProduceActionConditionStatus();

            value.MstProduceActionConditionTypeId           = GetInt32(new IntPtr(p + 0x018)); // 0270D10F4240 0x18 MstProduceActionConditionTypeId ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ConditionValue                            = GetInt32(new IntPtr(p + 0x01C)); // 0270D10F4280 0x1C ConditionValue              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
