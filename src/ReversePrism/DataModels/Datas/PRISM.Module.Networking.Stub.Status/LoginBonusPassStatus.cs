...
namespace ReversePrism.DataModels
{
    ...
    // 038 _BeginDate                               ModelClassType Timestamp Timestamp Timestamp Pointer
    // 000 EndDateFieldNumber                       int IL2CPP_TYPE_I4
    // 040 _EndDate                                 ModelClassType Timestamp Timestamp Timestamp Pointer
    // 000 RewardFieldNumber                        int IL2CPP_TYPE_I4
    // 048 Reward                                   ModelClassType ProductWithAmountStatus ProductWithAmountStatus ProductWithAmountStatus Pointer
    public partial class LoginBonusPassStatus : DataModel
    {
        ...
        public static LoginBonusPassStatus? FromPointer(IntPtr p0)
        {
            ...
            value._BeginDate                                = GetObject<Timestamp>(new IntPtr(p + 0x038), ReversePrism.DataModels.Timestamp.FromPointer); // 0x38 _BeginDate                  ( ModelClassType Timestamp Timestamp Timestamp Pointer )
            ...
            value.Reward                                    = GetObject<ProductWithAmountStatus>(new IntPtr(p + 0x048), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 0x48 Reward                      ( ModelClassType ProductWithAmountStatus ProductWithAmountStatus ProductWithAmountStatus Pointer )
