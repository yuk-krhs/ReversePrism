...
namespace ReversePrism.DataModels
{
    ...
    public partial class ChainTalkStatus
    {
        ...
        public static ChainTalkStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ChainTalkStatus();

            value.PostDate                                  = GetDateTime(new IntPtr(p + 0x010)); // 0270D2307C20 0x10 PostDate                    ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.Users                                     = GetInt32List(new IntPtr(p + 0x028)); // 0270D2307CC0 0x28 Users                       ( 000185CE1CE8 ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
            value.IsUnread                                  = GetBool(new IntPtr(p + 0x030)); // 0270D2307D00 0x30 IsUnread                    ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.Choice                                    = GetObjectList<ChainChoiceStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.ChainChoiceStatus.FromPointer); // 0270D2307D60 0x38 Choice                      ( 000185CD0648 ModelClassListType RepeatedField`1<ChainChoiceStatus> RepeatedField`1<ChainChoiceStatus> List<ChainChoiceStatus> Pointer )
            value._PostDate                                 = GetObject<Timestamp>(new IntPtr(p + 0x040), ReversePrism.DataModels.Timestamp.FromPointer); // 0270D2307DA0 0x40 _PostDate                   ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.GroupType                                 = GetInt32(new IntPtr(p + 0x048)); // 0270D2307DE0 0x48 GroupType                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ChainTalkTextList                         = GetObjectList<ChainTalkTextStatus>(new IntPtr(p + 0x050), ReversePrism.DataModels.ChainTalkTextStatus.FromPointer); // 0270D2307E40 0x50 ChainTalkTextList           ( 000185CD0B58 ModelClassListType RepeatedField`1<ChainTalkTextStatus> RepeatedField`1<ChainTalkTextStatus> List<ChainTalkTextStatus> Pointer )
