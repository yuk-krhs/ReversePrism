...
namespace ReversePrism.DataModels
{
    ...
    // 028 Users                                    ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer
    // 000 IsUnreadFieldNumber                      int IL2CPP_TYPE_I4
    // 030 IsUnread                                 ModelPrimitiveType bool bool bool Bool
    ...
    // 038 Choice                                   ModelClassListType RepeatedField`1<ChainChoiceStatus> RepeatedField`1<ChainChoiceStatus> List<ChainChoiceStatus> Pointer
    ...
    // 048 GroupType                                ModelPrimitiveType int int int Int32
    ...
    // 050 ChainTalkTextList                        ModelClassListType RepeatedField`1<ChainTalkTextStatus> RepeatedField`1<ChainTalkTextStatus> List<ChainTalkTextStatus> Pointer
    public partial class ChainTalkStatus : DataModel
    {
        ...
        public static ChainTalkStatus? FromPointer(IntPtr p0)
        {
            ...
            value.Users                                     = GetInt32List(new IntPtr(p + 0x028)); // 0x28 Users                       ( ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
            value.IsUnread                                  = GetBool(new IntPtr(p + 0x030)); // 0x30 IsUnread                    ( ModelPrimitiveType bool bool bool Bool )
            value.Choice                                    = GetObjectList<ChainChoiceStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.ChainChoiceStatus.FromPointer); // 0x38 Choice                      ( ModelClassListType RepeatedField`1<ChainChoiceStatus> RepeatedField`1<ChainChoiceStatus> List<ChainChoiceStatus> Pointer )
            ...
            value.GroupType                                 = GetInt32(new IntPtr(p + 0x048)); // 0x48 GroupType                   ( ModelPrimitiveType int int int Int32 )
            value.ChainTalkTextList                         = GetObjectList<ChainTalkTextStatus>(new IntPtr(p + 0x050), ReversePrism.DataModels.ChainTalkTextStatus.FromPointer); // 0x50 ChainTalkTextList           ( ModelClassListType RepeatedField`1<ChainTalkTextStatus> RepeatedField`1<ChainTalkTextStatus> List<ChainTalkTextStatus> Pointer )
