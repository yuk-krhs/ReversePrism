...
namespace ReversePrism.DataModels
{
    ...
    // 028 ProduceUnitIdolList                      000185CEC6B8 ModelClassListType RepeatedField`1<ProduceUnitIdolStatus> RepeatedField`1<ProduceUnitIdolStatus> List<ProduceUnitIdolStatus> Pointer
