...
namespace ReversePrism.DataModels
{
    ...
    public partial class FavoriteSongStatus
    {
        ...
        public static FavoriteSongStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new FavoriteSongStatus();

            value.Slot                                      = (FavoriteSongSlot)GetInt32(new IntPtr(p + 0x018)); // 0270D133C668 0x18 Slot                        ( 00018655C790 ModelEnumType FavoriteSongSlot FavoriteSongSlot FavoriteSongSlot Int32 )
            value.Name                                      = GetString(new IntPtr(p + 0x020)); // 0270D133C6A8 0x20 Name                        ( 000186671910 ModelPrimitiveType string string string String )
            value.MstSongIdList                             = GetInt32List(new IntPtr(p + 0x028)); // 0270D133C708 0x28 MstSongIdList               ( 000185CE1CE8 ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
