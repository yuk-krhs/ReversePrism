...
namespace ReversePrism.DataModels
{
    ...
    public partial class InGameResultStatus : DataModel
    {
        ...
        public static InGameResultStatus? FromPointer(IntPtr p0)
        {
            ...
            value.IsSuccess                                 = GetBool(new IntPtr(p + 0x018)); // 02466105C220 0x18 IsSuccess                   ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.AppealPoint                               = GetObject<InGameAppealPointStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.InGameAppealPointStatus.FromPointer); // 02466105C260 0x20 AppealPoint                 ( 0001866D3050 ModelClassType InGameAppealPointStatus InGameAppealPointStatus InGameAppealPointStatus Pointer )
            value.ClearSecond                               = GetInt32(new IntPtr(p + 0x028)); // 02466105C2A0 0x28 ClearSecond                 ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.IdolSkillList                             = GetObjectList<InGameIdolSkillStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.InGameIdolSkillStatus.FromPointer); // 02466105C300 0x30 IdolSkillList               ( 000185CE08C8 ModelClassListType RepeatedField`1<InGameIdolSkillStatus> RepeatedField`1<InGameIdolSkillStatus> List<InGameIdolSkillStatus> Pointer )
            value.ProduceCardIdList                         = GetStringList(new IntPtr(p + 0x038)); // 02466105C360 0x38 ProduceCardIdList           ( 000185CF3478 ModelPrimitiveListType RepeatedField`1<string> RepeatedField`1<string> List<string> Pointer )
