...
namespace ReversePrism.DataModels
{
    ...
    public partial class IdolSkillActionConditionStatus : DataModel
    {
        ...
        public static IdolSkillActionConditionStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new IdolSkillActionConditionStatus() { Pointer= p0 };

            value.MstProduceActionConditionTypeId           = GetInt32(new IntPtr(p + 0x018)); // 024660FB5058 0x18 MstProduceActionConditionTypeId ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ConditionValue                            = GetInt32(new IntPtr(p + 0x01C)); // 024660FB5098 0x1C ConditionValue              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
