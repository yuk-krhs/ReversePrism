...
namespace ReversePrism.DataModels
{
    ...
    public partial class ChallengeTourOpponentStatus
    {
        ...
        public static ChallengeTourOpponentStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ChallengeTourOpponentStatus();

            value.TargetAppealPoint                         = GetInt32(new IntPtr(p + 0x018)); // 0270D0F32840 0x18 TargetAppealPoint           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
