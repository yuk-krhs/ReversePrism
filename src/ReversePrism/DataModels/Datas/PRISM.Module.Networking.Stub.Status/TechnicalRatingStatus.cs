...
namespace ReversePrism.DataModels
{
    ...
    public partial class TechnicalRatingStatus
    {
        ...
        public static TechnicalRatingStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new TechnicalRatingStatus();

            value.DifficultyLevel                           = (SongDifficultyLevel)GetInt32(new IntPtr(p + 0x018)); // 0270D1376448 0x18 DifficultyLevel             ( 000186529820 ModelEnumType SongDifficultyLevel SongDifficultyLevel SongDifficultyLevel Int32 )
            value.MstSongId                                 = GetInt32(new IntPtr(p + 0x01C)); // 0270D1376488 0x1C MstSongId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SongLevel                                 = GetInt32(new IntPtr(p + 0x020)); // 0270D13764C8 0x20 SongLevel                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.TechnicalScore                            = GetInt32(new IntPtr(p + 0x024)); // 0270D1376508 0x24 TechnicalScore              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Rating                                    = GetSingle(new IntPtr(p + 0x028)); // 0270D1376548 0x28 Rating                      ( 0001866656B0 ModelPrimitiveType float float float Single )
            value.MstSongTypeId                             = GetInt32(new IntPtr(p + 0x02C)); // 0270D1376588 0x2C MstSongTypeId               ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.RatingTheoreticalValue                    = GetSingle(new IntPtr(p + 0x030)); // 0270D13765C8 0x30 RatingTheoreticalValue      ( 0001866656B0 ModelPrimitiveType float float float Single )
