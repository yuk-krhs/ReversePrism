...
namespace ReversePrism.DataModels
{
    ...
    public partial class VitalityVariationStatus : DataModel
    {
        ...
        public static VitalityVariationStatus? FromPointer(IntPtr p0)
        {
            ...
            value.BeforeValue                               = GetInt32(new IntPtr(p + 0x018)); // 0246610D14C0 0x18 BeforeValue                 ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.AfterValue                                = GetInt32(new IntPtr(p + 0x01C)); // 0246610D1500 0x1C AfterValue                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
