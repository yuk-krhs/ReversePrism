...
namespace ReversePrism.DataModels
{
    ...
    // 020 IsDone                                   ModelPrimitiveType bool bool bool Bool
    ...
    // 028 ScheduleList                             ModelClassListType RepeatedField`1<ScheduleStatus> RepeatedField`1<ScheduleStatus> List<ScheduleStatus> Pointer
    public partial class WeekScheduleStatus : DataModel
    {
        ...
        public static WeekScheduleStatus? FromPointer(IntPtr p0)
        {
            ...
            value.IsDone                                    = GetBool(new IntPtr(p + 0x020)); // 0x20 IsDone                      ( ModelPrimitiveType bool bool bool Bool )
            value.ScheduleList                              = GetObjectList<ScheduleStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ScheduleStatus.FromPointer); // 0x28 ScheduleList                ( ModelClassListType RepeatedField`1<ScheduleStatus> RepeatedField`1<ScheduleStatus> List<ScheduleStatus> Pointer )
