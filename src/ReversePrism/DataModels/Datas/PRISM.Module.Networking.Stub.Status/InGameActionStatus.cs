...
namespace ReversePrism.DataModels
{
    ...
    public partial class InGameActionStatus
    {
        ...
        public static InGameActionStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new InGameActionStatus();

            value.VocalAppealPoint                          = GetInt32(new IntPtr(p + 0x018)); // 0270D10CB168 0x18 VocalAppealPoint            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.DanceAppealPoint                          = GetInt32(new IntPtr(p + 0x01C)); // 0270D10CB1A8 0x1C DanceAppealPoint            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.VisualAppealPoint                         = GetInt32(new IntPtr(p + 0x020)); // 0270D10CB1E8 0x20 VisualAppealPoint           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ClearSecond                               = GetInt32(new IntPtr(p + 0x024)); // 0270D10CB228 0x24 ClearSecond                 ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.IdolSkillCount                            = GetInt32(new IntPtr(p + 0x028)); // 0270D10CB268 0x28 IdolSkillCount              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ProduceCardCount                          = GetInt32(new IntPtr(p + 0x02C)); // 0270D10CB2A8 0x2C ProduceCardCount            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstIdolSkillIdList                        = GetInt32List(new IntPtr(p + 0x030)); // 0270D10CB308 0x30 MstIdolSkillIdList          ( 000185CE1CE8 ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
            value.ProduceCardIdList                         = GetStringList(new IntPtr(p + 0x038)); // 0270D10CB368 0x38 ProduceCardIdList           ( 000185CF3478 ModelPrimitiveListType RepeatedField`1<string> RepeatedField`1<string> List<string> Pointer )
