...
namespace ReversePrism.DataModels
{
    ...
    public partial class IntroductionStatus
    {
        ...
        public static IntroductionStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new IntroductionStatus();

            value.IntroductionType                          = (IntroductionType)GetInt32(new IntPtr(p + 0x018)); // 0270D2174BD8 0x18 IntroductionType            ( 00018672C7F0 ModelEnumType IntroductionType IntroductionType IntroductionType Int32 )
            value.ResourceId                                = GetString(new IntPtr(p + 0x020)); // 0270D2174C18 0x20 ResourceId                  ( 000186671910 ModelPrimitiveType string string string String )
            value.RewardList                                = GetObjectList<ProductWithAmountStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 0270D2174C78 0x28 RewardList                  ( 000185CECB38 ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer )
            value.MstUnitId                                 = GetInt32(new IntPtr(p + 0x030)); // 0270D2174CB8 0x30 MstUnitId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
