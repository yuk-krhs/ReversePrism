...
namespace ReversePrism.DataModels
{
    ...
    // 018 IntroductionType                         ModelEnumType IntroductionType IntroductionType IntroductionType Int32
    ...
    // 030 MstUnitId                                ModelPrimitiveType int int int Int32
    public partial class IntroductionStatus : DataModel
    {
        ...
        public static IntroductionStatus? FromPointer(IntPtr p0)
        {
            ...
            value.IntroductionType                          = (IntroductionType)GetInt32(new IntPtr(p + 0x018)); // 0x18 IntroductionType            ( ModelEnumType IntroductionType IntroductionType IntroductionType Int32 )
            ...
            value.MstUnitId                                 = GetInt32(new IntPtr(p + 0x030)); // 0x30 MstUnitId                   ( ModelPrimitiveType int int int Int32 )
