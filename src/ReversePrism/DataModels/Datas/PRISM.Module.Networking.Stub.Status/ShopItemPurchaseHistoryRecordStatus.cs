...
namespace ReversePrism.DataModels
{
    ...
    public partial class ShopItemPurchaseHistoryRecordStatus : DataModel
    {
        ...
        public static ShopItemPurchaseHistoryRecordStatus? FromPointer(IntPtr p0)
        {
            ...
            value.PurchaseDate                              = GetDateTime(new IntPtr(p + 0x010)); // 024662763E20 0x10 PurchaseDate                ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.MstShopItemId                             = GetInt32(new IntPtr(p + 0x028)); // 024662763EA0 0x28 MstShopItemId               ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.PriceProductList                          = GetObjectList<ProductWithAmountStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 024662763F00 0x30 PriceProductList            ( 000185CECB38 ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer )
            value.ContentProductList                        = GetObjectList<ProductWithAmountStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 024662763F60 0x38 ContentProductList          ( 000185CECB38 ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer )
            value.BonusProductList                          = GetObjectList<ProductWithAmountStatus>(new IntPtr(p + 0x040), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 024662763FC0 0x40 BonusProductList            ( 000185CECB38 ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer )
            value._PurchaseDate                             = GetObject<Timestamp>(new IntPtr(p + 0x048), ReversePrism.DataModels.Timestamp.FromPointer); // 024662764000 0x48 _PurchaseDate               ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.PurchaseAmount                            = GetInt32(new IntPtr(p + 0x050)); // 024662764040 0x50 PurchaseAmount              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
