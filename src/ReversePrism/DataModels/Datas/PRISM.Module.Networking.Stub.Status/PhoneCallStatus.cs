...
namespace ReversePrism.DataModels
{
    ...
    public partial class PhoneCallStatus
    {
        ...
        public static PhoneCallStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new PhoneCallStatus();

            value.PostDate                                  = GetDateTime(new IntPtr(p + 0x010)); // 0270D230A3E0 0x10 PostDate                    ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.MstPhoneCallId                            = GetInt32(new IntPtr(p + 0x028)); // 0270D230A460 0x28 MstPhoneCallId              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.IsUnread                                  = GetBool(new IntPtr(p + 0x02C)); // 0270D230A4A0 0x2C IsUnread                    ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value._PostDate                                 = GetObject<Timestamp>(new IntPtr(p + 0x030), ReversePrism.DataModels.Timestamp.FromPointer); // 0270D230A4E0 0x30 _PostDate                   ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.TypeId                                    = GetInt32(new IntPtr(p + 0x038)); // 0270D230A520 0x38 TypeId                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ScenarioId                                = GetInt32(new IntPtr(p + 0x03C)); // 0270D230A560 0x3C ScenarioId                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ScenarioNumber                            = GetInt32(new IntPtr(p + 0x040)); // 0270D230A5A0 0x40 ScenarioNumber              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.PhoneCallTextList                         = GetObjectList<PhoneCallTextStatus>(new IntPtr(p + 0x048), ReversePrism.DataModels.PhoneCallTextStatus.FromPointer); // 0270D230A600 0x48 PhoneCallTextList           ( 000185CE8A68 ModelClassListType RepeatedField`1<PhoneCallTextStatus> RepeatedField`1<PhoneCallTextStatus> List<PhoneCallTextStatus> Pointer )
