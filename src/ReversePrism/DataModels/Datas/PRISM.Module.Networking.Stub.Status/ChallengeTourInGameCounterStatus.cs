...
namespace ReversePrism.DataModels
{
    ...
    // 018 VocalCounterReleaseCount                 ModelPrimitiveType int int int Int32
    // 000 DanceCounterReleaseCountFieldNumber      int IL2CPP_TYPE_I4
    // 01C DanceCounterReleaseCount                 ModelPrimitiveType int int int Int32
    // 000 VisualCounterReleaseCountFieldNumber     int IL2CPP_TYPE_I4
    // 020 VisualCounterReleaseCount                ModelPrimitiveType int int int Int32
    public partial class ChallengeTourInGameCounterStatus : DataModel
    {
        ...
        public static ChallengeTourInGameCounterStatus? FromPointer(IntPtr p0)
        {
            ...
            value.VocalCounterReleaseCount                  = GetInt32(new IntPtr(p + 0x018)); // 0x18 VocalCounterReleaseCount    ( ModelPrimitiveType int int int Int32 )
            value.DanceCounterReleaseCount                  = GetInt32(new IntPtr(p + 0x01C)); // 0x1C DanceCounterReleaseCount    ( ModelPrimitiveType int int int Int32 )
            value.VisualCounterReleaseCount                 = GetInt32(new IntPtr(p + 0x020)); // 0x20 VisualCounterReleaseCount   ( ModelPrimitiveType int int int Int32 )
