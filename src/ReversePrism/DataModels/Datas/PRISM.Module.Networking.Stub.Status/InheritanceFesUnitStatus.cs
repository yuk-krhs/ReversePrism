...
namespace ReversePrism.DataModels
{
    ...
    public partial class InheritanceFesUnitStatus : DataModel
    {
        ...
        public static InheritanceFesUnitStatus? FromPointer(IntPtr p0)
        {
            ...
            value.FesUnitId                                 = GetString(new IntPtr(p + 0x018)); // 024661077648 0x18 FesUnitId                   ( 000186671910 ModelPrimitiveType string string string String )
            value.MstUnitId                                 = GetInt32(new IntPtr(p + 0x020)); // 024661077688 0x20 MstUnitId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Name                                      = GetString(new IntPtr(p + 0x028)); // 0246610776C8 0x28 Name                        ( 000186671910 ModelPrimitiveType string string string String )
            value.MstFavoriteMarkId                         = GetInt32(new IntPtr(p + 0x030)); // 024661077708 0x30 MstFavoriteMarkId           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Parameter                                 = GetObject<ProduceParameterStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.ProduceParameterStatus.FromPointer); // 024661077748 0x38 Parameter                   ( 0001865627F0 ModelClassType ProduceParameterStatus ProduceParameterStatus ProduceParameterStatus Pointer )
            value.Rank                                      = (ProduceParameterRank)GetInt32(new IntPtr(p + 0x040)); // 024661077788 0x40 Rank                        ( 000186562070 ModelEnumType ProduceParameterRank ProduceParameterRank ProduceParameterRank Int32 )
            value.FesIdolList                               = GetObjectList<InheritanceFesUnitIdolStatus>(new IntPtr(p + 0x048), ReversePrism.DataModels.InheritanceFesUnitIdolStatus.FromPointer); // 0246610777E8 0x48 FesIdolList                 ( 000185CE1628 ModelClassListType RepeatedField`1<InheritanceFesUnitIdolStatus> RepeatedField`1<InheritanceFesUnitIdolStatus> List<InheritanceFesUnitIdolStatus> Pointer )
            value.ProduceHistory                            = GetObject<InheritanceProduceHistoryStatus>(new IntPtr(p + 0x050), ReversePrism.DataModels.InheritanceProduceHistoryStatus.FromPointer); // 024661077828 0x50 ProduceHistory              ( 0001866EE550 ModelClassType InheritanceProduceHistoryStatus InheritanceProduceHistoryStatus InheritanceProduceHistoryStatus Pointer )
            value.SupportCharacterList                      = GetObjectList<InheritanceFesUnitSupportCharacterStatus>(new IntPtr(p + 0x058), ReversePrism.DataModels.InheritanceFesUnitSupportCharacterStatus.FromPointer); // 024661077888 0x58 SupportCharacterList        ( 000185CE1868 ModelClassListType RepeatedField`1<InheritanceFesUnitSupportCharacterStatus> RepeatedField`1<InheritanceFesUnitSupportCharacterStatus> List<InheritanceFesUnitSupportCharacterStatus> Pointer )
            value.SupportSkillList                          = GetObjectList<InheritanceFesUnitAttachedSupportSkillStatus>(new IntPtr(p + 0x060), ReversePrism.DataModels.InheritanceFesUnitAttachedSupportSkillStatus.FromPointer); // 0246610778E8 0x60 SupportSkillList            ( 000185CE13E8 ModelClassListType RepeatedField`1<InheritanceFesUnitAttachedSupportSkillStatus> RepeatedField`1<InheritanceFesUnitAttachedSupportSkillStatus> List<InheritanceFesUnitAttachedSupportSkillStatus> Pointer )
            value.CardDeck                                  = GetObject<ProduceCardDeckStatus>(new IntPtr(p + 0x068), ReversePrism.DataModels.ProduceCardDeckStatus.FromPointer); // 024661077928 0x68 CardDeck                    ( 000186536800 ModelClassType ProduceCardDeckStatus ProduceCardDeckStatus ProduceCardDeckStatus Pointer )
            value.TransferProductList                       = GetObjectList<ProductWithAmountStatus>(new IntPtr(p + 0x070), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 024661077988 0x70 TransferProductList         ( 000185CECB38 ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer )
            value.InheritanceCount                          = GetInt32(new IntPtr(p + 0x078)); // 0246610779C8 0x78 InheritanceCount            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
