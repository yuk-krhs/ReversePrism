...
namespace ReversePrism.DataModels
{
    ...
    public partial class EpisodeStatus
    {
        ...
        public static EpisodeStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new EpisodeStatus();

            value.MstEpisodeId                              = GetInt32(new IntPtr(p + 0x018)); // 0270D10B8E78 0x18 MstEpisodeId                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstUnitId                                 = GetInt32(new IntPtr(p + 0x01C)); // 0270D10B8EB8 0x1C MstUnitId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Stamina                                   = GetInt32(new IntPtr(p + 0x020)); // 0270D10B8EF8 0x20 Stamina                     ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.EpisodeStateType                          = (EpisodeStateType)GetInt32(new IntPtr(p + 0x024)); // 0270D10B8F38 0x24 EpisodeStateType            ( 000186741BC0 ModelEnumType EpisodeStateType EpisodeStateType EpisodeStateType Int32 )
            value.DifficultyList                            = GetObjectList<EpisodeDifficultyStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.EpisodeDifficultyStatus.FromPointer); // 0270D10B8F98 0x28 DifficultyList              ( 000185CD4BB8 ModelClassListType RepeatedField`1<EpisodeDifficultyStatus> RepeatedField`1<EpisodeDifficultyStatus> List<EpisodeDifficultyStatus> Pointer )
            value.Chapter                                   = GetInt32(new IntPtr(p + 0x030)); // 0270D10B8FD8 0x30 Chapter                     ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
