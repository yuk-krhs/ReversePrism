...
namespace ReversePrism.DataModels
{
    ...
    public partial class RankRewardStatus : DataModel
    {
        ...
        public static RankRewardStatus? FromPointer(IntPtr p0)
        {
            ...
            value.DifficultyLevel                           = (SongDifficultyLevel)GetInt32(new IntPtr(p + 0x018)); // 0246612F4A58 0x18 DifficultyLevel             ( 000186529820 ModelEnumType SongDifficultyLevel SongDifficultyLevel SongDifficultyLevel Int32 )
            value.ScoreRankRewardList                       = GetObjectList<ScoreRankRewardStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ScoreRankRewardStatus.FromPointer); // 0246612F4AB8 0x20 ScoreRankRewardList         ( 000185CEFCB8 ModelClassListType RepeatedField`1<ScoreRankRewardStatus> RepeatedField`1<ScoreRankRewardStatus> List<ScoreRankRewardStatus> Pointer )
            value.ComboRankRewardList                       = GetObjectList<ComboRankRewardStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ComboRankRewardStatus.FromPointer); // 0246612F4B18 0x28 ComboRankRewardList         ( 000185CD2078 ModelClassListType RepeatedField`1<ComboRankRewardStatus> RepeatedField`1<ComboRankRewardStatus> List<ComboRankRewardStatus> Pointer )
