...
namespace ReversePrism.DataModels
{
    ...
    public partial class PvpUnitStatus
    {
        ...
        public static PvpUnitStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new PvpUnitStatus();

            value.UnitType                                  = (PvpUnitType)GetInt32(new IntPtr(p + 0x018)); // 0270D14465C0 0x18 UnitType                    ( 0001865F87B0 ModelEnumType PvpUnitType PvpUnitType PvpUnitType Int32 )
            value.UnitMemberType                            = (PvpUnitMemberType)GetInt32(new IntPtr(p + 0x01C)); // 0270D1446600 0x1C UnitMemberType              ( 0001865F79D0 ModelEnumType PvpUnitMemberType PvpUnitMemberType PvpUnitMemberType Int32 )
            value.SelectedProduceIdolUnitId                 = GetInt32(new IntPtr(p + 0x020)); // 0270D1446640 0x20 SelectedProduceIdolUnitId   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.FesUnit                                   = GetObject<PvpFesUnitStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.PvpFesUnitStatus.FromPointer); // 0270D1446680 0x28 FesUnit                     ( 0001865E42D0 ModelClassType PvpFesUnitStatus PvpFesUnitStatus PvpFesUnitStatus Pointer )
            value.ProduceIdolUnitList                       = GetObjectList<PvpProduceIdolUnitStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.PvpProduceIdolUnitStatus.FromPointer); // 0270D14466E0 0x30 ProduceIdolUnitList         ( 000185CEDEA8 ModelClassListType RepeatedField`1<PvpProduceIdolUnitStatus> RepeatedField`1<PvpProduceIdolUnitStatus> List<PvpProduceIdolUnitStatus> Pointer )
