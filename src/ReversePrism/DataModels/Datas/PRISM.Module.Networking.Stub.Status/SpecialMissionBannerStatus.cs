...
namespace ReversePrism.DataModels
{
    ...
    // 038 MstSpecialMissionId                      ModelPrimitiveType int int int Int32
    ...
    public partial class SpecialMissionBannerStatus : DataModel
    {
        ...
        public static SpecialMissionBannerStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstSpecialMissionId                       = GetInt32(new IntPtr(p + 0x038)); // 0x38 MstSpecialMissionId         ( ModelPrimitiveType int int int Int32 )
