...
namespace ReversePrism.DataModels
{
    ...
    // 01C ProduceParameterRank                     ModelEnumType ProduceParameterRank ProduceParameterRank ProduceParameterRank Int32
    // 000 TotalFieldNumber                         int IL2CPP_TYPE_I4
    // 020 Total                                    ModelPrimitiveType int int int Int32
    public partial class UserProfileFesUnitRankStatus : DataModel
    {
        ...
        public static UserProfileFesUnitRankStatus? FromPointer(IntPtr p0)
        {
            ...
            value.ProduceParameterRank                      = (ProduceParameterRank)GetInt32(new IntPtr(p + 0x01C)); // 0x1C ProduceParameterRank        ( ModelEnumType ProduceParameterRank ProduceParameterRank ProduceParameterRank Int32 )
            value.Total                                     = GetInt32(new IntPtr(p + 0x020)); // 0x20 Total                       ( ModelPrimitiveType int int int Int32 )
