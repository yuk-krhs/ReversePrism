...
namespace ReversePrism.DataModels
{
    ...
    // 018 TargetRate                               ModelPrimitiveType float float float Single
    ...
    public partial class TechnicalRatingRewardStatus : DataModel
    {
        ...
        public static TechnicalRatingRewardStatus? FromPointer(IntPtr p0)
        {
            ...
            value.TargetRate                                = GetSingle(new IntPtr(p + 0x018)); // 0x18 TargetRate                  ( ModelPrimitiveType float float float Single )
