...
namespace ReversePrism.DataModels
{
    ...
    public partial class UserProfileEventDetailLiveStatus
    {
        ...
        public static UserProfileEventDetailLiveStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new UserProfileEventDetailLiveStatus();

            value.Point                                     = GetInt64(new IntPtr(p + 0x018)); // 0270D271F380 0x18 Point                       ( 0001865F7700 ModelPrimitiveType long long long Int64 )
            value.RankList                                  = GetObjectList<ProfileRankingStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProfileRankingStatus.FromPointer); // 0270D271F3E0 0x20 RankList                    ( 000185CECFF8 ModelClassListType RepeatedField`1<ProfileRankingStatus> RepeatedField`1<ProfileRankingStatus> List<ProfileRankingStatus> Pointer )
