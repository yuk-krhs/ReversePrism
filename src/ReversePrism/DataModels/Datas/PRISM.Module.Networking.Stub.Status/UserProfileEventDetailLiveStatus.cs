...
namespace ReversePrism.DataModels
{
    ...
    // 020 RankList                                 ModelClassListType RepeatedField`1<ProfileRankingStatus> RepeatedField`1<ProfileRankingStatus> List<ProfileRankingStatus> Pointer
    public partial class UserProfileEventDetailLiveStatus : DataModel
    {
        ...
        public static UserProfileEventDetailLiveStatus? FromPointer(IntPtr p0)
        {
            ...
            value.RankList                                  = GetObjectList<ProfileRankingStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProfileRankingStatus.FromPointer); // 0x20 RankList                    ( ModelClassListType RepeatedField`1<ProfileRankingStatus> RepeatedField`1<ProfileRankingStatus> List<ProfileRankingStatus> Pointer )
