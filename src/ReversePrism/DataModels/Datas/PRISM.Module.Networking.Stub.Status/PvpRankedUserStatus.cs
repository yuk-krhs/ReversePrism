...
namespace ReversePrism.DataModels
{
    ...
    // 050 PvpUnitList                              ModelClassListType RepeatedField`1<PvpUnitStatus> RepeatedField`1<PvpUnitStatus> List<PvpUnitStatus> Pointer
    public partial class PvpRankedUserStatus : DataModel
    {
        ...
        public static PvpRankedUserStatus? FromPointer(IntPtr p0)
        {
            ...
            value.PvpUnitList                               = GetObjectList<PvpUnitStatus>(new IntPtr(p + 0x050), ReversePrism.DataModels.PvpUnitStatus.FromPointer); // 0x50 PvpUnitList                 ( ModelClassListType RepeatedField`1<PvpUnitStatus> RepeatedField`1<PvpUnitStatus> List<PvpUnitStatus> Pointer )
