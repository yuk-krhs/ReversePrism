...
namespace ReversePrism.DataModels
{
    ...
    public partial class UserProfileProduceTotalParameterRankStatus
    {
        ...
        public static UserProfileProduceTotalParameterRankStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new UserProfileProduceTotalParameterRankStatus();

            value.ProduceParameterRank                      = (ProduceParameterRank)GetInt32(new IntPtr(p + 0x018)); // 0270D2729D48 0x18 ProduceParameterRank        ( 000186562070 ModelEnumType ProduceParameterRank ProduceParameterRank ProduceParameterRank Int32 )
            value.Total                                     = GetInt32(new IntPtr(p + 0x01C)); // 0270D2729D88 0x1C Total                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
