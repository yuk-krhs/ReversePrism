...
namespace ReversePrism.DataModels
{
    ...
    // 018 ProduceParameterRank                     ModelEnumType ProduceParameterRank ProduceParameterRank ProduceParameterRank Int32
    ...
    public partial class UserProfileProduceTotalParameterRankStatus : DataModel
    {
        ...
        public static UserProfileProduceTotalParameterRankStatus? FromPointer(IntPtr p0)
        {
            ...
            value.ProduceParameterRank                      = (ProduceParameterRank)GetInt32(new IntPtr(p + 0x018)); // 0x18 ProduceParameterRank        ( ModelEnumType ProduceParameterRank ProduceParameterRank ProduceParameterRank Int32 )
