...
namespace ReversePrism.DataModels
{
    ...
    public partial class LiveUnitIdolCostumeSetStatus : DataModel
    {
        ...
        public static LiveUnitIdolCostumeSetStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstCostumeSetId                           = GetInt32(new IntPtr(p + 0x018)); // 0246612EB078 0x18 MstCostumeSetId             ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstCostumeId                              = GetInt32(new IntPtr(p + 0x01C)); // 0246612EB0B8 0x1C MstCostumeId                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstHairstyleId                            = GetInt32(new IntPtr(p + 0x020)); // 0246612EB0F8 0x20 MstHairstyleId              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstAccessoryIdList                        = GetInt32List(new IntPtr(p + 0x028)); // 0246612EB158 0x28 MstAccessoryIdList          ( 000185CE1CE8 ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
            value.UnlockPremiseStar                         = GetInt32(new IntPtr(p + 0x030)); // 0246612EB198 0x30 UnlockPremiseStar           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
