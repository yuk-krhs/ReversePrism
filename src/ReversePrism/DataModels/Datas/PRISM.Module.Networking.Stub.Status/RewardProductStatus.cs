...
namespace ReversePrism.DataModels
{
    ...
    // 020 ConvertProduct                           ModelClassType ProductWithAmountStatus ProductWithAmountStatus ProductWithAmountStatus Pointer
    // 000 IsNewFieldNumber                         int IL2CPP_TYPE_I4
    // 028 IsNew                                    ModelPrimitiveType bool bool bool Bool
    public partial class RewardProductStatus : DataModel
    {
        ...
        public static RewardProductStatus? FromPointer(IntPtr p0)
        {
            ...
            value.ConvertProduct                            = GetObject<ProductWithAmountStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 0x20 ConvertProduct              ( ModelClassType ProductWithAmountStatus ProductWithAmountStatus ProductWithAmountStatus Pointer )
            value.IsNew                                     = GetBool(new IntPtr(p + 0x028)); // 0x28 IsNew                       ( ModelPrimitiveType bool bool bool Bool )
