...
namespace ReversePrism.DataModels
{
    ...
    public partial class PvpInGameResultStatus
    {
        ...
        public static PvpInGameResultStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new PvpInGameResultStatus();

            value.IsWin                                     = GetBool(new IntPtr(p + 0x018)); // 0270D1435CD8 0x18 IsWin                       ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.AppealPoint                               = GetObject<InGameAppealPointStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.InGameAppealPointStatus.FromPointer); // 0270D1435D18 0x20 AppealPoint                 ( 0001866D3050 ModelClassType InGameAppealPointStatus InGameAppealPointStatus InGameAppealPointStatus Pointer )
            value.Second                                    = GetInt32(new IntPtr(p + 0x028)); // 0270D1435D58 0x28 Second                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.IdolSkillList                             = GetObjectList<InGameIdolSkillStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.InGameIdolSkillStatus.FromPointer); // 0270D1435DB8 0x30 IdolSkillList               ( 000185CE08C8 ModelClassListType RepeatedField`1<InGameIdolSkillStatus> RepeatedField`1<InGameIdolSkillStatus> List<InGameIdolSkillStatus> Pointer )
            value.ProduceCardIdList                         = GetStringList(new IntPtr(p + 0x038)); // 0270D1435E18 0x38 ProduceCardIdList           ( 000185CF3478 ModelPrimitiveListType RepeatedField`1<string> RepeatedField`1<string> List<string> Pointer )
