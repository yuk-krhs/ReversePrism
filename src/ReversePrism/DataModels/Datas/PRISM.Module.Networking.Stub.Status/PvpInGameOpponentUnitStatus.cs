...
namespace ReversePrism.DataModels
{
    ...
    // 000 _parser                                  MessageParser`1<PvpInGameOpponentUnitStatus> IL2CPP_TYPE_GENERICINST
    ...
    // 020 IdolList                                 ModelClassListType RepeatedField`1<PvpInGameIdolStatus> RepeatedField`1<PvpInGameIdolStatus> List<PvpInGameIdolStatus> Pointer
    ...
    // 030 SupportSkillList                         ModelClassListType RepeatedField`1<PvpInGameSupportSkillStatus> RepeatedField`1<PvpInGameSupportSkillStatus> List<PvpInGameSupportSkillStatus> Pointer
    // 000 MstEpisodeIdFieldNumber                  int IL2CPP_TYPE_I4
    // 038 MstEpisodeId                             ModelPrimitiveType int int int Int32
    public partial class PvpInGameOpponentUnitStatus : DataModel
    {
        ...
        public static PvpInGameOpponentUnitStatus? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;
            ...
            value.IdolList                                  = GetObjectList<PvpInGameIdolStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.PvpInGameIdolStatus.FromPointer); // 0x20 IdolList                    ( ModelClassListType RepeatedField`1<PvpInGameIdolStatus> RepeatedField`1<PvpInGameIdolStatus> List<PvpInGameIdolStatus> Pointer )
            ...
            value.SupportSkillList                          = GetObjectList<PvpInGameSupportSkillStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.PvpInGameSupportSkillStatus.FromPointer); // 0x30 SupportSkillList            ( ModelClassListType RepeatedField`1<PvpInGameSupportSkillStatus> RepeatedField`1<PvpInGameSupportSkillStatus> List<PvpInGameSupportSkillStatus> Pointer )
            value.MstEpisodeId                              = GetInt32(new IntPtr(p + 0x038)); // 0x38 MstEpisodeId                ( ModelPrimitiveType int int int Int32 )
