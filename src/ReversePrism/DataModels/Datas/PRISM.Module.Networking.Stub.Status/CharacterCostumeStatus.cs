...
namespace ReversePrism.DataModels
{
    ...
    public partial class CharacterCostumeStatus : DataModel
    {
        ...
        public static CharacterCostumeStatus? FromPointer(IntPtr p0)
        {
            ...
            value.CharaId                                   = GetInt32(new IntPtr(p + 0x018)); // 024660EE0B08 0x18 CharaId                     ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.HairId                                    = GetInt32(new IntPtr(p + 0x01C)); // 024660EE0B48 0x1C HairId                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ClothId                                   = GetInt32(new IntPtr(p + 0x020)); // 024660EE0B88 0x20 ClothId                     ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.AccessoryIdList                           = GetInt32List(new IntPtr(p + 0x028)); // 024660EE0BE8 0x28 AccessoryIdList             ( 000185CE1CE8 ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
