...
namespace ReversePrism.DataModels
{
    ...
    public partial class HomeCutSceneStatus
    {
        ...
        public static HomeCutSceneStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new HomeCutSceneStatus();

            value.MstHomeCutSceneId                         = GetInt32(new IntPtr(p + 0x018)); // 0270D205D4E0 0x18 MstHomeCutSceneId           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ResourceId                                = GetString(new IntPtr(p + 0x020)); // 0270D205D520 0x20 ResourceId                  ( 000186671910 ModelPrimitiveType string string string String )
