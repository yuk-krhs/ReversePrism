...
namespace ReversePrism.DataModels
{
    ...
    public partial class GashaNotesStatus : DataModel
    {
        ...
        public static GashaNotesStatus? FromPointer(IntPtr p0)
        {
            ...
            value.Body                                      = GetString(new IntPtr(p + 0x018)); // 024661534810 0x18 Body                        ( 000186671910 ModelPrimitiveType string string string String )
            value.StepNo                                    = GetInt32(new IntPtr(p + 0x020)); // 024661534850 0x20 StepNo                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
