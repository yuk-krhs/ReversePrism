...
namespace ReversePrism.DataModels
{
    ...
    public partial class GashaNotesStatus
    {
        ...
        public static GashaNotesStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GashaNotesStatus();

            value.Body                                      = GetString(new IntPtr(p + 0x018)); // 0270D1593078 0x18 Body                        ( 000186671910 ModelPrimitiveType string string string String )
            value.StepNo                                    = GetInt32(new IntPtr(p + 0x020)); // 0270D15930B8 0x20 StepNo                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
