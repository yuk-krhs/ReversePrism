...
namespace ReversePrism.DataModels
{
    ...
    // 01C CostOneCardUseCount                      ModelPrimitiveType int int int Int32
    // 000 CardCostDownCountFieldNumber             int IL2CPP_TYPE_I4
    // 020 CardCostDownCount                        ModelPrimitiveType int int int Int32
    // 000 CardExcludeCountFieldNumber              int IL2CPP_TYPE_I4
    // 024 CardExcludeCount                         ModelPrimitiveType int int int Int32
    public partial class ChallengeTourInGameCardActionStatus : DataModel
    {
        ...
        public static ChallengeTourInGameCardActionStatus? FromPointer(IntPtr p0)
        {
            ...
            value.CostOneCardUseCount                       = GetInt32(new IntPtr(p + 0x01C)); // 0x1C CostOneCardUseCount         ( ModelPrimitiveType int int int Int32 )
            value.CardCostDownCount                         = GetInt32(new IntPtr(p + 0x020)); // 0x20 CardCostDownCount           ( ModelPrimitiveType int int int Int32 )
            value.CardExcludeCount                          = GetInt32(new IntPtr(p + 0x024)); // 0x24 CardExcludeCount            ( ModelPrimitiveType int int int Int32 )
