...
namespace ReversePrism.DataModels
{
    ...
    public partial class PvpInGameSelfUnitStatus : DataModel
    {
        ...
        public static PvpInGameSelfUnitStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstUnitId                                 = GetInt32(new IntPtr(p + 0x018)); // 024661395588 0x18 MstUnitId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.IdolList                                  = GetObjectList<PvpInGameIdolStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.PvpInGameIdolStatus.FromPointer); // 0246613955E8 0x20 IdolList                    ( 000185CED738 ModelClassListType RepeatedField`1<PvpInGameIdolStatus> RepeatedField`1<PvpInGameIdolStatus> List<PvpInGameIdolStatus> Pointer )
            value.ProduceCardDeck                           = GetObject<ProduceCardDeckStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ProduceCardDeckStatus.FromPointer); // 024661395628 0x28 ProduceCardDeck             ( 000186536800 ModelClassType ProduceCardDeckStatus ProduceCardDeckStatus ProduceCardDeckStatus Pointer )
            value.SupportSkillList                          = GetObjectList<PvpInGameSupportSkillStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.PvpInGameSupportSkillStatus.FromPointer); // 024661395688 0x30 SupportSkillList            ( 000185CED9A8 ModelClassListType RepeatedField`1<PvpInGameSupportSkillStatus> RepeatedField`1<PvpInGameSupportSkillStatus> List<PvpInGameSupportSkillStatus> Pointer )
            value.MstEpisodeId                              = GetInt32(new IntPtr(p + 0x038)); // 0246613956C8 0x38 MstEpisodeId                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
