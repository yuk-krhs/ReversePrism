...
namespace ReversePrism.DataModels
{
    ...
    public partial class ShopItemJewelGroupStatus : DataModel
    {
        ...
        public static ShopItemJewelGroupStatus? FromPointer(IntPtr p0)
        {
            ...
            value.ShopItemType                              = (ShopItemType)GetInt32(new IntPtr(p + 0x018)); // 02466275F9F8 0x18 ShopItemType                ( 000186761B60 ModelEnumType ShopItemType ShopItemType ShopItemType Int32 )
            value.StoreItemList                             = GetObjectList<StoreItemStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.StoreItemStatus.FromPointer); // 02466275FA58 0x20 StoreItemList               ( 000185CF2D58 ModelClassListType RepeatedField`1<StoreItemStatus> RepeatedField`1<StoreItemStatus> List<StoreItemStatus> Pointer )
