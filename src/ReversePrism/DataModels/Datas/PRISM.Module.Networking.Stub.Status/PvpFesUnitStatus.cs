...
namespace ReversePrism.DataModels
{
    ...
    // 020 IdolBaseList                             ModelClassListType RepeatedField`1<IdolBaseStatus> RepeatedField`1<IdolBaseStatus> List<IdolBaseStatus> Pointer
    public partial class PvpFesUnitStatus : DataModel
    {
        ...
        public static PvpFesUnitStatus? FromPointer(IntPtr p0)
        {
            ...
            value.IdolBaseList                              = GetObjectList<IdolBaseStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.IdolBaseStatus.FromPointer); // 0x20 IdolBaseList                ( ModelClassListType RepeatedField`1<IdolBaseStatus> RepeatedField`1<IdolBaseStatus> List<IdolBaseStatus> Pointer )
