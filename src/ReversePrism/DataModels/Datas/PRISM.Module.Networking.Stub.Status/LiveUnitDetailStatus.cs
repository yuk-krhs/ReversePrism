...
namespace ReversePrism.DataModels
{
    ...
    // 028 SlotList                                 ModelClassListType RepeatedField`1<LiveUnitSlotDetailStatus> RepeatedField`1<LiveUnitSlotDetailStatus> List<LiveUnitSlotDetailStatus> Pointer
    public partial class LiveUnitDetailStatus : DataModel
    {
        ...
        public static LiveUnitDetailStatus? FromPointer(IntPtr p0)
        {
            ...
            value.SlotList                                  = GetObjectList<LiveUnitSlotDetailStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.LiveUnitSlotDetailStatus.FromPointer); // 0x28 SlotList                    ( ModelClassListType RepeatedField`1<LiveUnitSlotDetailStatus> RepeatedField`1<LiveUnitSlotDetailStatus> List<LiveUnitSlotDetailStatus> Pointer )
