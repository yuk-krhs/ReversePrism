...
namespace ReversePrism.DataModels
{
    ...
    // 028 ParameterList                            ModelClassListType RepeatedField`1<PotentialLiveSkillParameterStatus> RepeatedField`1<PotentialLiveSkillParameterStatus> List<PotentialLiveSkillParameterStatus> Pointer
    public partial class PotentialLiveSkillLevelStatus : DataModel
    {
        ...
        public static PotentialLiveSkillLevelStatus? FromPointer(IntPtr p0)
        {
            ...
            value.ParameterList                             = GetObjectList<PotentialLiveSkillParameterStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.PotentialLiveSkillParameterStatus.FromPointer); // 0x28 ParameterList               ( ModelClassListType RepeatedField`1<PotentialLiveSkillParameterStatus> RepeatedField`1<PotentialLiveSkillParameterStatus> List<PotentialLiveSkillParameterStatus> Pointer )
