...
namespace ReversePrism.DataModels
{
    ...
    public partial class PotentialLiveSkillLevelStatus
    {
        ...
        public static PotentialLiveSkillLevelStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new PotentialLiveSkillLevelStatus();

            value.Level                                     = GetInt32(new IntPtr(p + 0x018)); // 0270D103E9C0 0x18 Level                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.UnlockPremiseStar                         = GetInt32(new IntPtr(p + 0x01C)); // 0270D103EA00 0x1C UnlockPremiseStar           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstPotentialLiveSkillLevelId              = GetInt32(new IntPtr(p + 0x020)); // 0270D103EA40 0x20 MstPotentialLiveSkillLevelId ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ParameterList                             = GetObjectList<PotentialLiveSkillParameterStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.PotentialLiveSkillParameterStatus.FromPointer); // 0270D103EAA0 0x28 ParameterList               ( 000185CE9128 ModelClassListType RepeatedField`1<PotentialLiveSkillParameterStatus> RepeatedField`1<PotentialLiveSkillParameterStatus> List<PotentialLiveSkillParameterStatus> Pointer )
