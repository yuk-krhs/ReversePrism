...
namespace ReversePrism.DataModels
{
    ...
    public partial class LiveSkillEffectStatus : DataModel
    {
        ...
        public static LiveSkillEffectStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstLiveSkillEffectId                      = GetInt32(new IntPtr(p + 0x018)); // 0246612E3E38 0x18 MstLiveSkillEffectId        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SkillType                                 = (LiveSkillEffectType)GetInt32(new IntPtr(p + 0x01C)); // 0246612E3E78 0x1C SkillType                   ( 00018657D180 ModelEnumType LiveSkillEffectType LiveSkillEffectType LiveSkillEffectType Int32 )
            value.EffectValue                               = GetInt32(new IntPtr(p + 0x020)); // 0246612E3EB8 0x20 EffectValue                 ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.EffectTime                                = GetInt32(new IntPtr(p + 0x024)); // 0246612E3EF8 0x24 EffectTime                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.EffectValue2                              = GetInt32(new IntPtr(p + 0x028)); // 0246612E3F38 0x28 EffectValue2                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.EffectValue3                              = GetInt32(new IntPtr(p + 0x02C)); // 0246612E3F78 0x2C EffectValue3                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.EffectValue4                              = GetInt32(new IntPtr(p + 0x030)); // 0246612E3FB8 0x30 EffectValue4                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
