...
namespace ReversePrism.DataModels
{
    ...
    public partial class EventBonusStatus
    {
        ...
        public static EventBonusStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new EventBonusStatus();

            value.MstEventId                                = GetInt32(new IntPtr(p + 0x018)); // 0270D137F580 0x18 MstEventId                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.TotalBonus                                = GetObject<LimitedValueStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.LimitedValueStatus.FromPointer); // 0270D137F5C0 0x20 TotalBonus                  ( 00018652EBE0 ModelClassType LimitedValueStatus LimitedValueStatus LimitedValueStatus Pointer )
            value.ProduceIdolList                           = GetObjectList<EventBonusProduceIdolStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.EventBonusProduceIdolStatus.FromPointer); // 0270D137F620 0x28 ProduceIdolList             ( 000185CD54B8 ModelClassListType RepeatedField`1<EventBonusProduceIdolStatus> RepeatedField`1<EventBonusProduceIdolStatus> List<EventBonusProduceIdolStatus> Pointer )
