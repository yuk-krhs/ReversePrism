...
namespace ReversePrism.DataModels
{
    ...
    // 020 TotalBonus                               ModelClassType LimitedValueStatus LimitedValueStatus LimitedValueStatus Pointer
    ...
    // 028 ProduceIdolList                          ModelClassListType RepeatedField`1<EventBonusProduceIdolStatus> RepeatedField`1<EventBonusProduceIdolStatus> List<EventBonusProduceIdolStatus> Pointer
    public partial class EventBonusStatus : DataModel
    {
        ...
        public static EventBonusStatus? FromPointer(IntPtr p0)
        {
            ...
            value.TotalBonus                                = GetObject<LimitedValueStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.LimitedValueStatus.FromPointer); // 0x20 TotalBonus                  ( ModelClassType LimitedValueStatus LimitedValueStatus LimitedValueStatus Pointer )
            value.ProduceIdolList                           = GetObjectList<EventBonusProduceIdolStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.EventBonusProduceIdolStatus.FromPointer); // 0x28 ProduceIdolList             ( ModelClassListType RepeatedField`1<EventBonusProduceIdolStatus> RepeatedField`1<EventBonusProduceIdolStatus> List<EventBonusProduceIdolStatus> Pointer )
