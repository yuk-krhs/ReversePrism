...
namespace ReversePrism.DataModels
{
    ...
    public partial class TutorialStatus
    {
        ...
        public static TutorialStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new TutorialStatus();

            value.Category                                  = GetInt32(new IntPtr(p + 0x018)); // 0270D0D41990 0x18 Category                    ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Phase                                     = GetInt32(new IntPtr(p + 0x01C)); // 0270D0D419D0 0x1C Phase                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
