...
namespace ReversePrism.DataModels
{
    ...
    public partial class ChallengeTourInGameSupportSkillStatus : DataModel
    {
        ...
        public static ChallengeTourInGameSupportSkillStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstPotentialSupportSkillId                = GetInt32(new IntPtr(p + 0x018)); // 024660ED5F00 0x18 MstPotentialSupportSkillId  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstSupportSkillTypeId                     = GetInt32(new IntPtr(p + 0x01C)); // 024660ED5F40 0x1C MstSupportSkillTypeId       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ValueList                                 = GetInt32List(new IntPtr(p + 0x020)); // 024660ED5FA0 0x20 ValueList                   ( 000185CE1CE8 ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
            value.SkillBufferDisplay                        = GetObject<SkillBufferDisplayStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.SkillBufferDisplayStatus.FromPointer); // 024660ED5FE0 0x28 SkillBufferDisplay          ( 0001865119F0 ModelClassType SkillBufferDisplayStatus SkillBufferDisplayStatus SkillBufferDisplayStatus Pointer )
            value.GrantSkillBufferDisplay                   = GetObject<SkillBufferDisplayStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.SkillBufferDisplayStatus.FromPointer); // 024660ED6020 0x30 GrantSkillBufferDisplay     ( 0001865119F0 ModelClassType SkillBufferDisplayStatus SkillBufferDisplayStatus SkillBufferDisplayStatus Pointer )
