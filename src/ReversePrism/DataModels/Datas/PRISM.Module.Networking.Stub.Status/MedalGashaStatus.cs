...
namespace ReversePrism.DataModels
{
    ...
    // 03C MstMedalGashaId                          ModelPrimitiveType int int int Int32
    ...
    // 050 PriceList                                ModelClassListType RepeatedField`1<GashaPriceStatus> RepeatedField`1<GashaPriceStatus> List<GashaPriceStatus> Pointer
    // 000 BoxCountFieldNumber                      int IL2CPP_TYPE_I4
    // 058 BoxCount                                 ModelPrimitiveType int int int Int32
    // 000 IsLockEnabledFieldNumber                 int IL2CPP_TYPE_I4
    // 05C IsLockEnabled                            ModelPrimitiveType bool bool bool Bool
    public partial class MedalGashaStatus : DataModel
    {
        ...
        public static MedalGashaStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstMedalGashaId                           = GetInt32(new IntPtr(p + 0x03C)); // 0x3C MstMedalGashaId             ( ModelPrimitiveType int int int Int32 )
            ...
            value.PriceList                                 = GetObjectList<GashaPriceStatus>(new IntPtr(p + 0x050), ReversePrism.DataModels.GashaPriceStatus.FromPointer); // 0x50 PriceList                   ( ModelClassListType RepeatedField`1<GashaPriceStatus> RepeatedField`1<GashaPriceStatus> List<GashaPriceStatus> Pointer )
            value.BoxCount                                  = GetInt32(new IntPtr(p + 0x058)); // 0x58 BoxCount                    ( ModelPrimitiveType int int int Int32 )
            value.IsLockEnabled                             = GetBool(new IntPtr(p + 0x05C)); // 0x5C IsLockEnabled               ( ModelPrimitiveType bool bool bool Bool )
