...
namespace ReversePrism.DataModels
{
    ...
    public partial class LiveResumeParamStatus
    {
        ...
        public static LiveResumeParamStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new LiveResumeParamStatus();

            value.MstSongId                                 = GetInt32(new IntPtr(p + 0x018)); // 0270D13588D0 0x18 MstSongId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstSongTypeId                             = GetInt32(new IntPtr(p + 0x01C)); // 0270D1358910 0x1C MstSongTypeId               ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.DifficultyLevel                           = (SongDifficultyLevel)GetInt32(new IntPtr(p + 0x020)); // 0270D1358950 0x20 DifficultyLevel             ( 000186529820 ModelEnumType SongDifficultyLevel SongDifficultyLevel SongDifficultyLevel Int32 )
            value.StartType                                 = (LiveStartType)GetInt32(new IntPtr(p + 0x024)); // 0270D1358990 0x24 StartType                   ( 000186582F90 ModelEnumType LiveStartType LiveStartType LiveStartType Int32 )
            value.LiveBonus                                 = GetInt32(new IntPtr(p + 0x028)); // 0270D13589D0 0x28 LiveBonus                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.UnitNumber                                = GetInt32(new IntPtr(p + 0x02C)); // 0270D1358A10 0x2C UnitNumber                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.TotalPower                                = GetInt32(new IntPtr(p + 0x030)); // 0270D1358A50 0x30 TotalPower                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SongLevel                                 = GetInt32(new IntPtr(p + 0x034)); // 0270D1358A90 0x34 SongLevel                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.OriginalMemberCount                       = GetInt32(new IntPtr(p + 0x038)); // 0270D1358AD0 0x38 OriginalMemberCount         ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
