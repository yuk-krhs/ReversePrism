...
namespace ReversePrism.DataModels
{
    ...
    // 028 Product                                  ModelClassType ProductWithAmountStatus ProductWithAmountStatus ProductWithAmountStatus Pointer
    ...
    // 038 BannerUrl                                ModelPrimitiveType string string string String
    public partial class GashaRevertExchangePointStatus : DataModel
    {
        ...
        public static GashaRevertExchangePointStatus? FromPointer(IntPtr p0)
        {
            ...
            value.Product                                   = GetObject<ProductWithAmountStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 0x28 Product                     ( ModelClassType ProductWithAmountStatus ProductWithAmountStatus ProductWithAmountStatus Pointer )
            value.ResourceId                                = GetString(new IntPtr(p + 0x030)); // 0x30 ResourceId                  ( ModelPrimitiveType string string string String )
            value.BannerUrl                                 = GetString(new IntPtr(p + 0x038)); // 0x38 BannerUrl                   ( ModelPrimitiveType string string string String )
