...
namespace ReversePrism.DataModels
{
    ...
    public partial class StoreItemPurchaseHistoryRecordStatus : DataModel
    {
        ...
        public static StoreItemPurchaseHistoryRecordStatus? FromPointer(IntPtr p0)
        {
            ...
            value.PurchaseDate                              = GetDateTime(new IntPtr(p + 0x010)); // 02466276B778 0x10 PurchaseDate                ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.MstStoreItemId                            = GetInt32(new IntPtr(p + 0x028)); // 02466276B7F8 0x28 MstStoreItemId              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Price                                     = GetInt32(new IntPtr(p + 0x02C)); // 02466276B838 0x2C Price                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.BonusProductList                          = GetObjectList<ProductWithAmountStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 02466276B898 0x30 BonusProductList            ( 000185CECB38 ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer )
            value._PurchaseDate                             = GetObject<Timestamp>(new IntPtr(p + 0x038), ReversePrism.DataModels.Timestamp.FromPointer); // 02466276B8D8 0x38 _PurchaseDate               ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.PurchaseAmount                            = GetInt32(new IntPtr(p + 0x040)); // 02466276B918 0x40 PurchaseAmount              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ContentProductList                        = GetObjectList<ProductWithAmountStatus>(new IntPtr(p + 0x048), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 02466276B978 0x48 ContentProductList          ( 000185CECB38 ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer )
