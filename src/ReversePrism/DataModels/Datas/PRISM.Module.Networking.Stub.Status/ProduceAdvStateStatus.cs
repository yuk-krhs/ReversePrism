...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceAdvStateStatus
    {
        ...
        public static ProduceAdvStateStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProduceAdvStateStatus();

            value.IsRead                                    = GetBool(new IntPtr(p + 0x018)); // 0270D1102A08 0x18 IsRead                      ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.ReadOptionNumberList                      = GetInt32List(new IntPtr(p + 0x020)); // 0270D1102A68 0x20 ReadOptionNumberList        ( 000185CE1CE8 ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
