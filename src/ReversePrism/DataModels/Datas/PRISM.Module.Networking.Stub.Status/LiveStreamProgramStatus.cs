...
namespace ReversePrism.DataModels
{
    ...
    public partial class LiveStreamProgramStatus
    {
        ...
        public static LiveStreamProgramStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new LiveStreamProgramStatus();

            value.BeginDate                                 = GetDateTime(new IntPtr(p + 0x010)); // 0270D2ACCD30 0x10 BeginDate                   ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.MstStreamProgramId                        = GetInt32(new IntPtr(p + 0x028)); // 0270D2ACCDB0 0x28 MstStreamProgramId          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Title                                     = GetString(new IntPtr(p + 0x030)); // 0270D2ACCDF0 0x30 Title                       ( 000186671910 ModelPrimitiveType string string string String )
            value.Description                               = GetString(new IntPtr(p + 0x038)); // 0270D2ACCE30 0x38 Description                 ( 000186671910 ModelPrimitiveType string string string String )
            value._BeginDate                                = GetObject<Timestamp>(new IntPtr(p + 0x040), ReversePrism.DataModels.Timestamp.FromPointer); // 0270D2ACCE70 0x40 _BeginDate                  ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.PerformerIdList                           = GetInt32List(new IntPtr(p + 0x048)); // 0270D2ACCED0 0x48 PerformerIdList             ( 000185CE1CE8 ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
            value.LiveStreamState                           = (LiveStreamProgramState)GetInt32(new IntPtr(p + 0x050)); // 0270D2ACCF10 0x50 LiveStreamState             ( 000186583730 ModelEnumType LiveStreamProgramState LiveStreamProgramState LiveStreamProgramState Int32 )
