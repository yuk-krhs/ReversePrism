...
namespace ReversePrism.DataModels
{
    ...
    public partial class ShopItemCostumeGroupStatus
    {
        ...
        public static ShopItemCostumeGroupStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ShopItemCostumeGroupStatus();

            value.ShopItemType                              = (ShopItemType)GetInt32(new IntPtr(p + 0x018)); // 0270D28040E0 0x18 ShopItemType                ( 000186761B60 ModelEnumType ShopItemType ShopItemType ShopItemType Int32 )
            value.CostumeShopItemList                       = GetObjectList<CostumeShopItemStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.CostumeShopItemStatus.FromPointer); // 0270D2804140 0x20 CostumeShopItemList         ( 000185CD2BE8 ModelClassListType RepeatedField`1<CostumeShopItemStatus> RepeatedField`1<CostumeShopItemStatus> List<CostumeShopItemStatus> Pointer )
            value.CostumeStoreItemList                      = GetObjectList<CostumeStoreItemStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.CostumeStoreItemStatus.FromPointer); // 0270D28041A0 0x28 CostumeStoreItemList        ( 000185CD3058 ModelClassListType RepeatedField`1<CostumeStoreItemStatus> RepeatedField`1<CostumeStoreItemStatus> List<CostumeStoreItemStatus> Pointer )
