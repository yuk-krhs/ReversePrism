...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceIdolDressSetStatus : DataModel
    {
        ...
        public static ProduceIdolDressSetStatus? FromPointer(IntPtr p0)
        {
            ...
            value.UnlockPremiseStar                         = GetInt32(new IntPtr(p + 0x018)); // 024660FC7678 0x18 UnlockPremiseStar           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstCostumeSetId                           = GetInt32(new IntPtr(p + 0x01C)); // 024660FC76B8 0x1C MstCostumeSetId             ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
