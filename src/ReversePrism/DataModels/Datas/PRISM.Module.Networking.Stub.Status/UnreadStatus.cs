...
namespace ReversePrism.DataModels
{
    ...
    public partial class UnreadStatus
    {
        ...
        public static UnreadStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new UnreadStatus();

            value.LastUpdateDateType                        = (LastUpdateDateType)GetInt32(new IntPtr(p + 0x018)); // 0270D0B611E8 0x18 LastUpdateDateType          ( 00018677A280 ModelEnumType LastUpdateDateType LastUpdateDateType LastUpdateDateType Int32 )
            value.IsUnread                                  = GetBool(new IntPtr(p + 0x01C)); // 0270D0B61228 0x1C IsUnread                    ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
