...
namespace ReversePrism.DataModels
{
    ...
    public partial class AppealCorrectionStatus
    {
        ...
        public static AppealCorrectionStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new AppealCorrectionStatus();

            value.Vocal                                     = GetInt32(new IntPtr(p + 0x018)); // 0270D10AE9C8 0x18 Vocal                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Dance                                     = GetInt32(new IntPtr(p + 0x01C)); // 0270D10AEA08 0x1C Dance                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Visual                                    = GetInt32(new IntPtr(p + 0x020)); // 0270D10AEA48 0x20 Visual                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Special                                   = GetInt32(new IntPtr(p + 0x024)); // 0270D10AEA88 0x24 Special                     ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
