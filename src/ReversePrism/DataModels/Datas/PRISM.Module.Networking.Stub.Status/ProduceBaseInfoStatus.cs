...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceBaseInfoStatus : DataModel
    {
        ...
        public static ProduceBaseInfoStatus? FromPointer(IntPtr p0)
        {
            ...
            value.SelectedEpisode                           = GetObject<SelectedEpisodeStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.SelectedEpisodeStatus.FromPointer); // 024661094188 0x18 SelectedEpisode             ( 000186720370 ModelClassType SelectedEpisodeStatus SelectedEpisodeStatus SelectedEpisodeStatus Pointer )
            value.Term                                      = GetObject<ProduceTermStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProduceTermStatus.FromPointer); // 0246610941C8 0x20 Term                        ( 000186589270 ModelClassType ProduceTermStatus ProduceTermStatus ProduceTermStatus Pointer )
            value.ProduceUnit                               = GetObject<ProduceUnitStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ProduceUnitStatus.FromPointer); // 024661094208 0x28 ProduceUnit                 ( 00018659C2D0 ModelClassType ProduceUnitStatus ProduceUnitStatus ProduceUnitStatus Pointer )
            value.ProduceCardDeck                           = GetObject<ProduceCardDeckStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.ProduceCardDeckStatus.FromPointer); // 024661094248 0x30 ProduceCardDeck             ( 000186536800 ModelClassType ProduceCardDeckStatus ProduceCardDeckStatus ProduceCardDeckStatus Pointer )
            value.NextOrder                                 = GetObject<ProduceNextOrderStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.ProduceNextOrderStatus.FromPointer); // 024661094288 0x38 NextOrder                   ( 00018655F880 ModelClassType ProduceNextOrderStatus ProduceNextOrderStatus ProduceNextOrderStatus Pointer )
            value.SupportUnit                               = GetObject<SupportUnitStatus>(new IntPtr(p + 0x040), ReversePrism.DataModels.SupportUnitStatus.FromPointer); // 0246610942C8 0x40 SupportUnit                 ( 0001865F8540 ModelClassType SupportUnitStatus SupportUnitStatus SupportUnitStatus Pointer )
            value.SelectedProduceStrategyList               = GetObjectList<ProduceStrategyStatus>(new IntPtr(p + 0x048), ReversePrism.DataModels.ProduceStrategyStatus.FromPointer); // 024661094328 0x48 SelectedProduceStrategyList ( 000185CEC478 ModelClassListType RepeatedField`1<ProduceStrategyStatus> RepeatedField`1<ProduceStrategyStatus> List<ProduceStrategyStatus> Pointer )
            value.CurrentFan                                = GetInt32(new IntPtr(p + 0x050)); // 024661094368 0x50 CurrentFan                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SubSeason                                 = GetObject<SubSeasonStatus>(new IntPtr(p + 0x058), ReversePrism.DataModels.SubSeasonStatus.FromPointer); // 0246610943A8 0x58 SubSeason                   ( 0001865D7FC0 ModelClassType SubSeasonStatus SubSeasonStatus SubSeasonStatus Pointer )
            value.InheritanceFesUnit                        = GetObject<InheritanceFesUnitStatus>(new IntPtr(p + 0x060), ReversePrism.DataModels.InheritanceFesUnitStatus.FromPointer); // 0246610943E8 0x60 InheritanceFesUnit          ( 0001866ED970 ModelClassType InheritanceFesUnitStatus InheritanceFesUnitStatus InheritanceFesUnitStatus Pointer )
            value.IsAutoPlay                                = GetBool(new IntPtr(p + 0x068)); // 024661094428 0x68 IsAutoPlay                  ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
