...
namespace ReversePrism.DataModels
{
    ...
    public partial class DearnessLevelRewardStatus
    {
        ...
        public static DearnessLevelRewardStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new DearnessLevelRewardStatus();

            value.DearnessLevel                             = GetInt32(new IntPtr(p + 0x018)); // 0270D1CE4E90 0x18 DearnessLevel               ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ProductWithAmountList                     = GetObjectList<ProductWithAmountStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 0270D1CE4EF0 0x20 ProductWithAmountList       ( 000185CECB38 ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer )
            value.IsArchived                                = GetBool(new IntPtr(p + 0x028)); // 0270D1CE4F30 0x28 IsArchived                  ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
