...
namespace ReversePrism.DataModels
{
    ...
    // 020 LevelList                                ModelClassListType RepeatedField`1<PotentialLiveSkillLevelStatus> RepeatedField`1<PotentialLiveSkillLevelStatus> List<PotentialLiveSkillLevelStatus> Pointer
    ...
    public partial class PotentialLiveSkillStatus : DataModel
    {
        ...
        public static PotentialLiveSkillStatus? FromPointer(IntPtr p0)
        {
            ...
            value.LevelList                                 = GetObjectList<PotentialLiveSkillLevelStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.PotentialLiveSkillLevelStatus.FromPointer); // 0x20 LevelList                   ( ModelClassListType RepeatedField`1<PotentialLiveSkillLevelStatus> RepeatedField`1<PotentialLiveSkillLevelStatus> List<PotentialLiveSkillLevelStatus> Pointer )
