...
namespace ReversePrism.DataModels
{
    ...
    public partial class PotentialLiveSkillStatus
    {
        ...
        public static PotentialLiveSkillStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new PotentialLiveSkillStatus();

            value.MstPotentialLiveSkillId                   = GetInt32(new IntPtr(p + 0x018)); // 0270D1040550 0x18 MstPotentialLiveSkillId     ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.LevelList                                 = GetObjectList<PotentialLiveSkillLevelStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.PotentialLiveSkillLevelStatus.FromPointer); // 0270D10405B0 0x20 LevelList                   ( 000185CE8ED8 ModelClassListType RepeatedField`1<PotentialLiveSkillLevelStatus> RepeatedField`1<PotentialLiveSkillLevelStatus> List<PotentialLiveSkillLevelStatus> Pointer )
            value.Level                                     = GetObject<LimitedValueStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.LimitedValueStatus.FromPointer); // 0270D10405F0 0x28 Level                       ( 00018652EBE0 ModelClassType LimitedValueStatus LimitedValueStatus LimitedValueStatus Pointer )
            value.UnlockPremiseStar                         = GetInt32(new IntPtr(p + 0x030)); // 0270D1040630 0x30 UnlockPremiseStar           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
