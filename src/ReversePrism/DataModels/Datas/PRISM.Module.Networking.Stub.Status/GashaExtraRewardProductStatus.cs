...
namespace ReversePrism.DataModels
{
    ...
    public partial class GashaExtraRewardProductStatus : DataModel
    {
        ...
        public static GashaExtraRewardProductStatus? FromPointer(IntPtr p0)
        {
            ...
            value.Product                                   = GetObject<ProductWithAmountStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 024661531EC8 0x18 Product                     ( 0001865A6D10 ModelClassType ProductWithAmountStatus ProductWithAmountStatus ProductWithAmountStatus Pointer )
            value.RewardType                                = (GashaRewardType)GetInt32(new IntPtr(p + 0x020)); // 024661531F08 0x20 RewardType                  ( 000186617BD0 ModelEnumType GashaRewardType GashaRewardType GashaRewardType Int32 )
