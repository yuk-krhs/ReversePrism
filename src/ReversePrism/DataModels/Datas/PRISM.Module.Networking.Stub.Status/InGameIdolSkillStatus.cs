...
namespace ReversePrism.DataModels
{
    ...
    public partial class InGameIdolSkillStatus
    {
        ...
        public static InGameIdolSkillStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new InGameIdolSkillStatus();

            value.MstIdolSkillId                            = GetInt32(new IntPtr(p + 0x018)); // 0270D10CCF20 0x18 MstIdolSkillId              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstProduceIdolId                          = GetInt32(new IntPtr(p + 0x01C)); // 0270D10CCF60 0x1C MstProduceIdolId            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
