...
namespace ReversePrism.DataModels
{
    ...
    public partial class InheritanceFesIdolAttachedIdolSkillStatus
    {
        ...
        public static InheritanceFesIdolAttachedIdolSkillStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new InheritanceFesIdolAttachedIdolSkillStatus();

            value.MstIdolSkillId                            = GetInt32(new IntPtr(p + 0x018)); // 0270D10E0D50 0x18 MstIdolSkillId              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Level                                     = GetInt32(new IntPtr(p + 0x01C)); // 0270D10E0D90 0x1C Level                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Pp                                        = GetInt32(new IntPtr(p + 0x020)); // 0270D10E0DD0 0x20 Pp                          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.AppealTypeList                            = GetInt32List(new IntPtr(p + 0x028)); // 0270D10E0E30 0x28 AppealTypeList              ( 000185CE1CE8 ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
            value.ActionEffectList                          = GetObjectList<IdolSkillActionEffectStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.IdolSkillActionEffectStatus.FromPointer); // 0270D10E0E90 0x30 ActionEffectList            ( 000185CDFF98 ModelClassListType RepeatedField`1<IdolSkillActionEffectStatus> RepeatedField`1<IdolSkillActionEffectStatus> List<IdolSkillActionEffectStatus> Pointer )
            value.ActionCondition                           = GetObject<IdolSkillActionConditionStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.IdolSkillActionConditionStatus.FromPointer); // 0270D10E0ED0 0x38 ActionCondition             ( 0001866B7DC0 ModelClassType IdolSkillActionConditionStatus IdolSkillActionConditionStatus IdolSkillActionConditionStatus Pointer )
