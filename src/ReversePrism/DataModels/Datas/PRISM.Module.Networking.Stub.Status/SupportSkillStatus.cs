...
namespace ReversePrism.DataModels
{
    ...
    public partial class SupportSkillStatus : DataModel
    {
        ...
        public static SupportSkillStatus? FromPointer(IntPtr p0)
        {
            ...
            value.SlotAmount                                = GetInt32(new IntPtr(p + 0x018)); // 0246610C6940 0x18 SlotAmount                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.PotentialSupportSkillList                 = GetObjectList<InProducePotentialSupportSkillStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.InProducePotentialSupportSkillStatus.FromPointer); // 0246610C69A0 0x20 PotentialSupportSkillList   ( 000185CE0D58 ModelClassListType RepeatedField`1<InProducePotentialSupportSkillStatus> RepeatedField`1<InProducePotentialSupportSkillStatus> List<InProducePotentialSupportSkillStatus> Pointer )
