...
namespace ReversePrism.DataModels
{
    ...
    public partial class SeasonPassPurchaseCountBenefitStatus : DataModel
    {
        ...
        public static SeasonPassPurchaseCountBenefitStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SeasonPassPurchaseCountBenefitStatus() { Pointer= p0 };

            value.StepProductList                           = GetObjectList<ProductWithAmountStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 024662759120 0x18 StepProductList             ( 000185CECB38 ModelClassListType RepeatedField`1<ProductWithAmountStatus> RepeatedField`1<ProductWithAmountStatus> List<ProductWithAmountStatus> Pointer )
            value.NextStep                                  = GetInt32(new IntPtr(p + 0x020)); // 024662759160 0x20 NextStep                    ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
