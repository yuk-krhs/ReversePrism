...
namespace ReversePrism.DataModels
{
    ...
    // 038 MstShinyPartyTokenProductId              ModelPrimitiveType int int int Int32
    ...
    // 078 IsAlreadyHaving                          ModelPrimitiveType bool bool bool Bool
    public partial class ShinyPartyTokenProductStatus : DataModel
    {
        ...
        public static ShinyPartyTokenProductStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstShinyPartyTokenProductId               = GetInt32(new IntPtr(p + 0x038)); // 0x38 MstShinyPartyTokenProductId ( ModelPrimitiveType int int int Int32 )
            ...
            value.IsAlreadyHaving                           = GetBool(new IntPtr(p + 0x078)); // 0x78 IsAlreadyHaving             ( ModelPrimitiveType bool bool bool Bool )
