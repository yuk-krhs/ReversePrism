...
namespace ReversePrism.DataModels
{
    ...
    public partial class InheritanceProduceHistoryStrategyStatus
    {
        ...
        public static InheritanceProduceHistoryStrategyStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new InheritanceProduceHistoryStrategyStatus();

            value.MstProduceStrategyId                      = GetInt32(new IntPtr(p + 0x018)); // 0270D10F1778 0x18 MstProduceStrategyId        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstProduceStrategyTypeId                  = GetInt32(new IntPtr(p + 0x01C)); // 0270D10F17B8 0x1C MstProduceStrategyTypeId    ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
