...
namespace ReversePrism.DataModels
{
    ...
    public partial class VitalityStatus
    {
        ...
        public static VitalityStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new VitalityStatus();

            value.CurrentVitality                           = GetInt32(new IntPtr(p + 0x018)); // 0270D1166F08 0x18 CurrentVitality             ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MaxVitality                               = GetInt32(new IntPtr(p + 0x01C)); // 0270D1166F48 0x1C MaxVitality                 ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
