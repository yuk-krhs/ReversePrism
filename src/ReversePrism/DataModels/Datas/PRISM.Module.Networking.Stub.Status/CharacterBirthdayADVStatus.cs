...
namespace ReversePrism.DataModels
{
    ...
    // 018 MstCharacterBirthdayAdvId                ModelPrimitiveType int int int Int32
    ...
    public partial class CharacterBirthdayADVStatus : DataModel
    {
        ...
        public static CharacterBirthdayADVStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstCharacterBirthdayAdvId                 = GetInt32(new IntPtr(p + 0x018)); // 0x18 MstCharacterBirthdayAdvId   ( ModelPrimitiveType int int int Int32 )
