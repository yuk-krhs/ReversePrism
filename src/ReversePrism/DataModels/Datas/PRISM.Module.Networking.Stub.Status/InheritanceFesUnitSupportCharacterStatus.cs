...
namespace ReversePrism.DataModels
{
    ...
    public partial class InheritanceFesUnitSupportCharacterStatus
    {
        ...
        public static InheritanceFesUnitSupportCharacterStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new InheritanceFesUnitSupportCharacterStatus();

            value.GoodScheduleTypeList                      = GetEnumList<ScheduleType>(new IntPtr(p + 0x040)); // 0270D10EE298 0x40 GoodScheduleTypeList        ( 000185CEFA68 ModelEnumListType RepeatedField`1<ScheduleType> RepeatedField`1<ScheduleType> List<ScheduleType> Pointer )
            value.MstSupportCharacterId                     = GetInt32(new IntPtr(p + 0x020)); // 0270D10EE0B8 0x20 MstSupportCharacterId       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Rarity                                    = (SupportCharacterRarity)GetInt32(new IntPtr(p + 0x024)); // 0270D10EE0F8 0x24 Rarity                      ( 0001865EB1C0 ModelEnumType SupportCharacterRarity SupportCharacterRarity SupportCharacterRarity Int32 )
            value.Level                                     = GetInt32(new IntPtr(p + 0x028)); // 0270D10EE138 0x28 Level                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Diamond                                   = GetInt32(new IntPtr(p + 0x02C)); // 0270D10EE178 0x2C Diamond                     ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.CardId                                    = GetInt32(new IntPtr(p + 0x030)); // 0270D10EE1B8 0x30 CardId                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstCharacterInfoId                        = GetInt32(new IntPtr(p + 0x034)); // 0270D10EE1F8 0x34 MstCharacterInfoId          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SupportSkillSlotAmount                    = GetObject<LimitedValueStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.LimitedValueStatus.FromPointer); // 0270D10EE238 0x38 SupportSkillSlotAmount      ( 00018652EBE0 ModelClassType LimitedValueStatus LimitedValueStatus LimitedValueStatus Pointer )
            value.IsFriendSupport                           = GetBool(new IntPtr(p + 0x048)); // 0270D10EE2D8 0x48 IsFriendSupport             ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
