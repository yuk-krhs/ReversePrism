...
namespace ReversePrism.DataModels
{
    ...
    // 018 MstShopItemIdList                        ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer
    ...
    // 020 MstStoreItemIdList                       ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer
    public partial class HomeShopNotificationStatus : DataModel
    {
        ...
        public static HomeShopNotificationStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstShopItemIdList                         = GetInt32List(new IntPtr(p + 0x018)); // 0x18 MstShopItemIdList           ( ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
            value.MstStoreItemIdList                        = GetInt32List(new IntPtr(p + 0x020)); // 0x20 MstStoreItemIdList          ( ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
