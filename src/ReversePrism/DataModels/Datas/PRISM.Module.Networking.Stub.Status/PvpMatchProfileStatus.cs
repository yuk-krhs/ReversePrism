...
namespace ReversePrism.DataModels
{
    ...
    public partial class PvpMatchProfileStatus
    {
        ...
        public static PvpMatchProfileStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new PvpMatchProfileStatus();

            value.Rank                                      = GetInt32(new IntPtr(p + 0x018)); // 0270D143CA98 0x18 Rank                        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Name                                      = GetString(new IntPtr(p + 0x020)); // 0270D143CAD8 0x20 Name                        ( 000186671910 ModelPrimitiveType string string string String )
            value.MstAchievementIdList                      = GetInt32List(new IntPtr(p + 0x028)); // 0270D143CB38 0x28 MstAchievementIdList        ( 000185CE1CE8 ModelPrimitiveListType RepeatedField`1<int> RepeatedField`1<int> List<int> Pointer )
