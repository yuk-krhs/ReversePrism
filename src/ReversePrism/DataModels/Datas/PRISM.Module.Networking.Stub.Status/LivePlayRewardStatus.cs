...
namespace ReversePrism.DataModels
{
    ...
    public partial class LivePlayRewardStatus
    {
        ...
        public static LivePlayRewardStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new LivePlayRewardStatus();

            value.RewardType                                = (LivePlayDisplayLotteryRewardType)GetInt32(new IntPtr(p + 0x018)); // 0270D134FB30 0x18 RewardType                  ( 0001865675F0 ModelEnumType LivePlayDisplayLotteryRewardType LivePlayDisplayLotteryRewardType LivePlayDisplayLotteryRewardType Int32 )
            value.Reward                                    = GetObject<ProductWithAmountStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProductWithAmountStatus.FromPointer); // 0270D134FB70 0x20 Reward                      ( 0001865A6D10 ModelClassType ProductWithAmountStatus ProductWithAmountStatus ProductWithAmountStatus Pointer )
