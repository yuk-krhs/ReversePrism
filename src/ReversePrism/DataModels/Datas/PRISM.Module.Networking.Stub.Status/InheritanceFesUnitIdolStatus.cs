...
namespace ReversePrism.DataModels
{
    ...
    // 038 FesUnit                                  ModelClassType InheritanceFesIdolUnitStatus InheritanceFesIdolUnitStatus InheritanceFesIdolUnitStatus Pointer
    // 000 AttachedIdolSkillFieldNumber             int IL2CPP_TYPE_I4
    // 040 AttachedIdolSkill                        ModelClassType InheritanceFesIdolAttachedIdolSkillStatus InheritanceFesIdolAttachedIdolSkillStatus InheritanceFesIdolAttachedIdolSkillStatus Pointer
    // 000 AttachedPotentialLiveSkillFieldNumber    int IL2CPP_TYPE_I4
    // 048 AttachedPotentialLiveSkill               ModelClassType InheritanceFesIdolAttachedPotentialLiveSkillStatus InheritanceFesIdolAttachedPotentialLiveSkillStatus InheritanceFesIdolAttachedPotentialLiveSkillStatus Pointer
    ...
    public partial class InheritanceFesUnitIdolStatus : DataModel
    {
        ...
        public static InheritanceFesUnitIdolStatus? FromPointer(IntPtr p0)
        {
            ...
            value.FesUnit                                   = GetObject<InheritanceFesIdolUnitStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.InheritanceFesIdolUnitStatus.FromPointer); // 0x38 FesUnit                     ( ModelClassType InheritanceFesIdolUnitStatus InheritanceFesIdolUnitStatus InheritanceFesIdolUnitStatus Pointer )
            value.AttachedIdolSkill                         = GetObject<InheritanceFesIdolAttachedIdolSkillStatus>(new IntPtr(p + 0x040), ReversePrism.DataModels.InheritanceFesIdolAttachedIdolSkillStatus.FromPointer); // 0x40 AttachedIdolSkill           ( ModelClassType InheritanceFesIdolAttachedIdolSkillStatus InheritanceFesIdolAttachedIdolSkillStatus InheritanceFesIdolAttachedIdolSkillStatus Pointer )
            value.AttachedPotentialLiveSkill                = GetObject<InheritanceFesIdolAttachedPotentialLiveSkillStatus>(new IntPtr(p + 0x048), ReversePrism.DataModels.InheritanceFesIdolAttachedPotentialLiveSkillStatus.FromPointer); // 0x48 AttachedPotentialLiveSkill  ( ModelClassType InheritanceFesIdolAttachedPotentialLiveSkillStatus InheritanceFesIdolAttachedPotentialLiveSkillStatus InheritanceFesIdolAttachedPotentialLiveSkillStatus Pointer )
