...
namespace ReversePrism.DataModels
{
    ...
    public partial class SongStatus : DataModel
    {
        ...
        public static SongStatus? FromPointer(IntPtr p0)
        {
            ...
            value.PurchaseLinkActiveDate                    = GetDateTime(new IntPtr(p + 0x010)); // 0246612FB8F0 0x10 PurchaseLinkActiveDate      ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.BeginDate                                 = GetDateTime(new IntPtr(p + 0x020)); // 0246612FB910 0x20 BeginDate                   ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.FirstClearedDate                          = GetDateTime(new IntPtr(p + 0x030)); // 0246612FB930 0x30 FirstClearedDate            ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.MstSongId                                 = GetInt32(new IntPtr(p + 0x048)); // 0246612FB9B0 0x48 MstSongId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstSongTypeId                             = GetInt32(new IntPtr(p + 0x04C)); // 0246612FB9F0 0x4C MstSongTypeId               ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MstUnitId                                 = GetInt32(new IntPtr(p + 0x050)); // 0246612FBA30 0x50 MstUnitId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SortId                                    = GetInt32(new IntPtr(p + 0x054)); // 0246612FBA70 0x54 SortId                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Bpm                                       = GetInt32(new IntPtr(p + 0x058)); // 0246612FBAB0 0x58 Bpm                         ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.IsAdvanceDownload                         = GetBool(new IntPtr(p + 0x05C)); // 0246612FBAF0 0x5C IsAdvanceDownload           ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.IsSongParts                               = GetBool(new IntPtr(p + 0x05D)); // 0246612FBB30 0x5D IsSongParts                 ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.PurchaseLink                              = GetString(new IntPtr(p + 0x060)); // 0246612FBB70 0x60 PurchaseLink                ( 000186671910 ModelPrimitiveType string string string String )
            value._PurchaseLinkActiveDate                   = GetObject<Timestamp>(new IntPtr(p + 0x068), ReversePrism.DataModels.Timestamp.FromPointer); // 0246612FBBB0 0x68 _PurchaseLinkActiveDate     ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value._BeginDate                                = GetObject<Timestamp>(new IntPtr(p + 0x070), ReversePrism.DataModels.Timestamp.FromPointer); // 0246612FBBF0 0x70 _BeginDate                  ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.SongCategory                              = (SongCategory)GetInt32(new IntPtr(p + 0x078)); // 0246612FBC30 0x78 SongCategory                ( 000186529080 ModelEnumType SongCategory SongCategory SongCategory Int32 )
            value.DifficultyLevelList                       = GetObjectList<SongDifficultyLevelStatus>(new IntPtr(p + 0x080), ReversePrism.DataModels.SongDifficultyLevelStatus.FromPointer); // 0246612FBC90 0x80 DifficultyLevelList         ( 000185CF1868 ModelClassListType RepeatedField`1<SongDifficultyLevelStatus> RepeatedField`1<SongDifficultyLevelStatus> List<SongDifficultyLevelStatus> Pointer )
            value.IsPlayed                                  = GetBool(new IntPtr(p + 0x088)); // 0246612FBCD0 0x88 IsPlayed                    ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value._FirstClearedDate                         = GetObject<Timestamp>(new IntPtr(p + 0x090), ReversePrism.DataModels.Timestamp.FromPointer); // 0246612FBD10 0x90 _FirstClearedDate           ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.OriginalMemberIdolList                    = GetObjectList<MvIdolStatus>(new IntPtr(p + 0x098), ReversePrism.DataModels.MvIdolStatus.FromPointer); // 0246612FBD70 0x98 OriginalMemberIdolList      ( 000185CE77F8 ModelClassListType RepeatedField`1<MvIdolStatus> RepeatedField`1<MvIdolStatus> List<MvIdolStatus> Pointer )
            value.IsFocusCamera                             = GetBool(new IntPtr(p + 0x0A0)); // 0246612FBDB0 0xA0 IsFocusCamera               ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.Is3D                                      = GetBool(new IntPtr(p + 0x0A1)); // 0246612FBDF0 0xA1 Is3D                        ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.Is2D                                      = GetBool(new IntPtr(p + 0x0A2)); // 0246612FBE30 0xA2 Is2D                        ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
