...
namespace ReversePrism.DataModels
{
    ...
    public partial class ChallengeTourInGameUnitStatus : DataModel
    {
        ...
        public static ChallengeTourInGameUnitStatus? FromPointer(IntPtr p0)
        {
            ...
            value.MstUnitId                                 = GetInt32(new IntPtr(p + 0x018)); // 024660ED6D98 0x18 MstUnitId                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.IdolList                                  = GetObjectList<ChallengeTourInGameIdolStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ChallengeTourInGameIdolStatus.FromPointer); // 024660ED6DF8 0x20 IdolList                    ( 000185CD1008 ModelClassListType RepeatedField`1<ChallengeTourInGameIdolStatus> RepeatedField`1<ChallengeTourInGameIdolStatus> List<ChallengeTourInGameIdolStatus> Pointer )
            value.ProduceCardDeck                           = GetObject<ProduceCardDeckStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.ProduceCardDeckStatus.FromPointer); // 024660ED6E38 0x28 ProduceCardDeck             ( 000186536800 ModelClassType ProduceCardDeckStatus ProduceCardDeckStatus ProduceCardDeckStatus Pointer )
            value.MstEpisodeId                              = GetInt32(new IntPtr(p + 0x030)); // 024660ED6E78 0x30 MstEpisodeId                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.SupportSkillList                          = GetObjectList<ChallengeTourInGameSupportSkillStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.ChallengeTourInGameSupportSkillStatus.FromPointer); // 024660ED6ED8 0x38 SupportSkillList            ( 000185CD1238 ModelClassListType RepeatedField`1<ChallengeTourInGameSupportSkillStatus> RepeatedField`1<ChallengeTourInGameSupportSkillStatus> List<ChallengeTourInGameSupportSkillStatus> Pointer )
