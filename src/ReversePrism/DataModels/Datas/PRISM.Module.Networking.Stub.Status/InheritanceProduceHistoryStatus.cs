...
namespace ReversePrism.DataModels
{
    ...
    public partial class InheritanceProduceHistoryStatus
    {
        ...
        public static InheritanceProduceHistoryStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new InheritanceProduceHistoryStatus();

            value.CreateDate                                = GetDateTime(new IntPtr(p + 0x010)); // 0270D10F00D8 0x10 CreateDate                  ( 000185D00A08 ModelPrimitiveType Nullable`1<DateTime> Nullable`1<DateTime> DateTime DateTime )
            value.MstEpisodeId                              = GetInt32(new IntPtr(p + 0x028)); // 0270D10F0158 0x28 MstEpisodeId                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.DifficultyLevel                           = GetInt32(new IntPtr(p + 0x02C)); // 0270D10F0198 0x2C DifficultyLevel             ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value._CreateDate                               = GetObject<Timestamp>(new IntPtr(p + 0x030), ReversePrism.DataModels.Timestamp.FromPointer); // 0270D10F01D8 0x30 _CreateDate                 ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.StrategyList                              = GetObjectList<InheritanceProduceHistoryStrategyStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.InheritanceProduceHistoryStrategyStatus.FromPointer); // 0270D10F0238 0x38 StrategyList                ( 000185CE1A78 ModelClassListType RepeatedField`1<InheritanceProduceHistoryStrategyStatus> RepeatedField`1<InheritanceProduceHistoryStrategyStatus> List<InheritanceProduceHistoryStrategyStatus> Pointer )
            value.IsAuto                                    = GetBool(new IntPtr(p + 0x040)); // 0270D10F0278 0x40 IsAuto                      ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
