...
namespace ReversePrism.DataModels
{
    ...
    // 020 Rarity                                   ModelEnumType SupportCharacterRarity SupportCharacterRarity SupportCharacterRarity Int32
    public partial class GalleryAlbumSupportCharacterStatus : DataModel
    {
        ...
        public static GalleryAlbumSupportCharacterStatus? FromPointer(IntPtr p0)
        {
            ...
            value.Rarity                                    = (SupportCharacterRarity)GetInt32(new IntPtr(p + 0x020)); // 0x20 Rarity                      ( ModelEnumType SupportCharacterRarity SupportCharacterRarity SupportCharacterRarity Int32 )
