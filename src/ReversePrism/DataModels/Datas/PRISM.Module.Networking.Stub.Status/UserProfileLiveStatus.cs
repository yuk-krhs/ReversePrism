...
namespace ReversePrism.DataModels
{
    ...
    // 018 Difficulty                               ModelEnumType SongDifficultyLevel SongDifficultyLevel SongDifficultyLevel Int32
    ...
    public partial class UserProfileLiveStatus : DataModel
    {
        ...
        public static UserProfileLiveStatus? FromPointer(IntPtr p0)
        {
            ...
            value.Difficulty                                = (SongDifficultyLevel)GetInt32(new IntPtr(p + 0x018)); // 0x18 Difficulty                  ( ModelEnumType SongDifficultyLevel SongDifficultyLevel SongDifficultyLevel Int32 )
