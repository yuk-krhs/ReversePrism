...
namespace ReversePrism.DataModels
{
    ...
    public partial class ChallengeTourRivalUnitStatus
    {
        ...
        public static ChallengeTourRivalUnitStatus? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ChallengeTourRivalUnitStatus();

            value.RivalList                                 = GetObjectList<ChallengeTourRivalStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ChallengeTourRivalStatus.FromPointer); // 0270D0F34E48 0x18 RivalList                   ( 000185CD14C8 ModelClassListType RepeatedField`1<ChallengeTourRivalStatus> RepeatedField`1<ChallengeTourRivalStatus> List<ChallengeTourRivalStatus> Pointer )
            value.ProduceCardDeck                           = GetObject<ProduceCardDeckStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProduceCardDeckStatus.FromPointer); // 0270D0F34E88 0x20 ProduceCardDeck             ( 000186536800 ModelClassType ProduceCardDeckStatus ProduceCardDeckStatus ProduceCardDeckStatus Pointer )
            value.AppealCorrection                          = GetObject<AppealCorrectionStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.AppealCorrectionStatus.FromPointer); // 0270D0F34EC8 0x28 AppealCorrection            ( 0001866CC8F0 ModelClassType AppealCorrectionStatus AppealCorrectionStatus AppealCorrectionStatus Pointer )
            value.MstChallengeTourRivalUnitId               = GetInt32(new IntPtr(p + 0x030)); // 0270D0F34F08 0x30 MstChallengeTourRivalUnitId ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.RecommendationTotalPower                  = GetInt32(new IntPtr(p + 0x034)); // 0270D0F34F48 0x34 RecommendationTotalPower    ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
