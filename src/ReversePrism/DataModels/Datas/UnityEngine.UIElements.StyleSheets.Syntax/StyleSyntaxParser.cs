...
namespace ReversePrism.DataModels
{
    ...
    public partial class StyleSyntaxParser
    {
        ...
        public static StyleSyntaxParser? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new StyleSyntaxParser();

            value.M_ProcessExpressionList                   = GetObjectList<Expression>(new IntPtr(p + 0x010), ReversePrism.DataModels.Expression.FromPointer); // 0270068897A8 0x10 M_ProcessExpressionList     ( 000185CDBDF8 ModelClassListType List`1<Expression> List`1<Expression> List<Expression> Pointer )
