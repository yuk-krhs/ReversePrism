...
namespace ReversePrism.DataModels
{
    ...
    // 010 M_ProcessExpressionList                  ModelClassListType List`1<Expression> List`1<Expression> List<Expression> Pointer
    ...
    public partial class StyleSyntaxParser : DataModel
    {
        ...
        public static StyleSyntaxParser? FromPointer(IntPtr p0)
        {
            ...
            value.M_ProcessExpressionList                   = GetObjectList<Expression>(new IntPtr(p + 0x010), ReversePrism.DataModels.Expression.FromPointer); // 0x10 M_ProcessExpressionList     ( ModelClassListType List`1<Expression> List`1<Expression> List<Expression> Pointer )
