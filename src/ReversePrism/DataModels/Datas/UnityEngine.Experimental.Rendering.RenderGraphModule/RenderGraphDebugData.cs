...
namespace ReversePrism.DataModels
{
    ...
    public partial class RenderGraphDebugData
    {
        ...
        public static RenderGraphDebugData? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new RenderGraphDebugData();

            value.PassList                                  = GetEnumList<PassDebugData>(new IntPtr(p + 0x010)); // 0270D907BB70 0x10 PassList                    ( 000185D2A1D8 ModelEnumListType List`1<PassDebugData> List`1<PassDebugData> List<PassDebugData> Pointer )
