...
namespace ReversePrism.DataModels
{
    ...
    public partial class ResourceHandle
    {
        ...
        public static ResourceHandle? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ResourceHandle();

            value.M_Value                                   = GetUInt32(new IntPtr(p + 0x010)); // 0270D9078B20 0x10 M_Value                     ( 000186698B70 ModelPrimitiveType uint uint uint UInt32 )
            value.Type                                      = (RenderGraphResourceType)GetInt32(new IntPtr(p + 0x014)); // 0270D9078B80 0x14 Type                        ( 000186656710 ModelEnumType RenderGraphResourceType RenderGraphResourceType RenderGraphResourceType Int32 )
