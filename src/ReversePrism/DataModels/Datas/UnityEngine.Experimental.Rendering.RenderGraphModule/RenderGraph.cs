...
namespace ReversePrism.DataModels
{
    ...
    public partial class RenderGraph : DataModel
    {
        ...
        public static RenderGraph? FromPointer(IntPtr p0)
        {
            ...
            value.M_Resources                               = GetObject<RenderGraphResourceRegistry>(new IntPtr(p + 0x010), ReversePrism.DataModels.RenderGraphResourceRegistry.FromPointer); // 0246690BC6E0 0x10 M_Resources                 ( 000186655FC0 ModelClassType RenderGraphResourceRegistry RenderGraphResourceRegistry RenderGraphResourceRegistry Pointer )
            value.M_RenderGraphPool                         = GetObject<RenderGraphObjectPool>(new IntPtr(p + 0x018), ReversePrism.DataModels.RenderGraphObjectPool.FromPointer); // 0246690BC700 0x18 M_RenderGraphPool           ( 0001866544F0 ModelClassType RenderGraphObjectPool RenderGraphObjectPool RenderGraphObjectPool Pointer )
            value.M_RenderPasses                            = GetObjectList<RenderGraphPass>(new IntPtr(p + 0x020), ReversePrism.DataModels.RenderGraphPass.FromPointer); // 0246690BC720 0x20 M_RenderPasses              ( 000185D01BA8 ModelClassListType List`1<RenderGraphPass> List`1<RenderGraphPass> List<RenderGraphPass> Pointer )
            value.M_RendererLists                           = GetEnumList<RendererListHandle>(new IntPtr(p + 0x028)); // 0246690BC740 0x28 M_RendererLists             ( 000185D027F8 ModelEnumListType List`1<RendererListHandle> List`1<RendererListHandle> List<RendererListHandle> Pointer )
            value.M_DebugParameters                         = GetObject<RenderGraphDebugParams>(new IntPtr(p + 0x030), ReversePrism.DataModels.RenderGraphDebugParams.FromPointer); // 0246690BC760 0x30 M_DebugParameters           ( 000186652EE0 ModelClassType RenderGraphDebugParams RenderGraphDebugParams RenderGraphDebugParams Pointer )
            value.M_FrameInformationLogger                  = GetObject<RenderGraphLogger>(new IntPtr(p + 0x038), ReversePrism.DataModels.RenderGraphLogger.FromPointer); // 0246690BC780 0x38 M_FrameInformationLogger    ( 000186654050 ModelClassType RenderGraphLogger RenderGraphLogger RenderGraphLogger Pointer )
            value.M_DefaultResources                        = GetObject<RenderGraphDefaultResources>(new IntPtr(p + 0x040), ReversePrism.DataModels.RenderGraphDefaultResources.FromPointer); // 0246690BC7A0 0x40 M_DefaultResources          ( 0001866533E0 ModelClassType RenderGraphDefaultResources RenderGraphDefaultResources RenderGraphDefaultResources Pointer )
            value.M_ExecutionExceptionWasRaised             = GetBool(new IntPtr(p + 0x050)); // 0246690BC7E0 0x50 M_ExecutionExceptionWasRaised ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.M_RenderGraphContext                      = GetObject<RenderGraphContext>(new IntPtr(p + 0x058), ReversePrism.DataModels.RenderGraphContext.FromPointer); // 0246690BC800 0x58 M_RenderGraphContext        ( 000186652770 ModelClassType RenderGraphContext RenderGraphContext RenderGraphContext Pointer )
            value.M_PreviousCommandBuffer                   = GetObject<CommandBuffer>(new IntPtr(p + 0x060), ReversePrism.DataModels.CommandBuffer.FromPointer); // 0246690BC820 0x60 M_PreviousCommandBuffer     ( 0001865DFD10 ModelClassType CommandBuffer CommandBuffer CommandBuffer Pointer )
            value.M_CurrentImmediatePassIndex               = GetInt32(new IntPtr(p + 0x068)); // 0246690BC840 0x68 M_CurrentImmediatePassIndex ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.M_ExecutionCount                          = GetInt32(new IntPtr(p + 0x090)); // 0246690BC8E0 0x90 M_ExecutionCount            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.M_CurrentFrameIndex                       = GetInt32(new IntPtr(p + 0x094)); // 0246690BC900 0x94 M_CurrentFrameIndex         ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.M_HasRenderGraphBegun                     = GetBool(new IntPtr(p + 0x098)); // 0246690BC920 0x98 M_HasRenderGraphBegun       ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.M_CurrentExecutionName                    = GetString(new IntPtr(p + 0x0A0)); // 0246690BC940 0xA0 M_CurrentExecutionName      ( 000186671910 ModelPrimitiveType string string string String )
            value.M_RendererListCulling                     = GetBool(new IntPtr(p + 0x0A8)); // 0246690BC960 0xA8 M_RendererListCulling       ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.Name                                      = GetString(new IntPtr(p + 0x0B8)); // 0246690BC9C0 0xB8 Name                        ( 000186671910 ModelPrimitiveType string string string String )
            value.RequireDebugData                          = GetBool(new IntPtr(p + 0x010)); // 0246690BC9E0 0x10 RequireDebugData            ( 000186595C30 ModelPrimitiveType bool bool bool Bool )
            value.OnGraphRegistered                         = GetObject<OnGraphRegisteredDelegate>(new IntPtr(p + 0x018), ReversePrism.DataModels.OnGraphRegisteredDelegate.FromPointer); // 0246690BCA00 0x18 OnGraphRegistered           ( 0001866CCE00 ModelClassType OnGraphRegisteredDelegate OnGraphRegisteredDelegate OnGraphRegisteredDelegate Pointer )
            value.OnGraphUnregistered                       = GetObject<OnGraphRegisteredDelegate>(new IntPtr(p + 0x020), ReversePrism.DataModels.OnGraphRegisteredDelegate.FromPointer); // 0246690BCA20 0x20 OnGraphUnregistered         ( 0001866CCE00 ModelClassType OnGraphRegisteredDelegate OnGraphRegisteredDelegate OnGraphRegisteredDelegate Pointer )
            value.OnExecutionRegistered                     = GetObject<OnExecutionRegisteredDelegate>(new IntPtr(p + 0x028), ReversePrism.DataModels.OnExecutionRegisteredDelegate.FromPointer); // 0246690BCA40 0x28 OnExecutionRegistered       ( 0001866CC950 ModelClassType OnExecutionRegisteredDelegate OnExecutionRegisteredDelegate OnExecutionRegisteredDelegate Pointer )
            value.OnExecutionUnregistered                   = GetObject<OnExecutionRegisteredDelegate>(new IntPtr(p + 0x030), ReversePrism.DataModels.OnExecutionRegisteredDelegate.FromPointer); // 0246690BCA60 0x30 OnExecutionUnregistered     ( 0001866CC950 ModelClassType OnExecutionRegisteredDelegate OnExecutionRegisteredDelegate OnExecutionRegisteredDelegate Pointer )
