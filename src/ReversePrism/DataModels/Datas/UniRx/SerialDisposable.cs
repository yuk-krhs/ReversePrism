...
namespace ReversePrism.DataModels
{
    ...
    public partial class SerialDisposable : DataModel
    {
        ...
        public static SerialDisposable? FromPointer(IntPtr p0)
        {
            ...
            value.Current                                   = GetObject<IDisposable>(new IntPtr(p + 0x018), ReversePrism.DataModels.IDisposable.FromPointer); // 0245A3C2C6B8 0x18 Current                     ( 0001867532E0 ModelClassType IDisposable IDisposable IDisposable Pointer )
            value.Disposed                                  = GetBool(new IntPtr(p + 0x020)); // 0245A3C2C6D8 0x20 Disposed                    ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
