...
namespace ReversePrism.DataModels
{
    ...
    public partial class XmlIncludeAttribute : DataModel
    {
        ...
        public static XmlIncludeAttribute? FromPointer(IntPtr p0)
        {
            ...
            value.Type                                      = GetObject<Type>(new IntPtr(p + 0x010), ReversePrism.DataModels.Type.FromPointer); // 0246675191B8 0x10 Type                        ( 000186692850 ModelClassType Type Type Type Pointer )
