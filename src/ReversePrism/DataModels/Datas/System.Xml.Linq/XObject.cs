...
namespace ReversePrism.DataModels
{
    ...
    public partial class XObject
    {
        ...
        public static XObject? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new XObject();

            value.Parent                                    = GetObject<XContainer>(new IntPtr(p + 0x010), ReversePrism.DataModels.XContainer.FromPointer); // 0270D8672728 0x10 Parent                      ( 0001865735E0 ModelClassType XContainer XContainer XContainer Pointer )
