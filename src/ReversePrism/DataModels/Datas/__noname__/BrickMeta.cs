...
namespace ReversePrism.DataModels
{
    ...
    public partial class BrickMeta
    {
        ...
        public static BrickMeta? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new BrickMeta();

            value.Bricks                                    = GetEnumList<ReservedBrick>(new IntPtr(p + 0x018)); // 0270D91BB880 0x18 Bricks                      ( 000185D28698 ModelEnumListType List`1<ReservedBrick> List`1<ReservedBrick> List<ReservedBrick> Pointer )
