...
namespace ReversePrism.DataModels
{
    ...
    // 000 OuterSelectCoreDelegate                  Action`1<<object>> IL2CPP_TYPE_GENERICINST
    ...
    // 000 outerKeySelector                         Func`3<<var>, CancellationToken, UniTask`1<<var>>> IL2CPP_TYPE_GENERICINST
    // 000 innerKeySelector                         Func`3<<var>, CancellationToken, UniTask`1<<var>>> IL2CPP_TYPE_GENERICINST
    ...
    // 000 currentOuterValue                        <var> IL2CPP_TYPE_VAR
    ...
    public partial class _JoinAwaitWithCancellation : DataModel
    {

        public static _JoinAwaitWithCancellation? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new _JoinAwaitWithCancellation() { Pointer= p0 };
