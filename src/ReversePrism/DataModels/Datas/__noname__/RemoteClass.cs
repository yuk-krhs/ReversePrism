...
namespace ReversePrism.DataModels
{
    ...
    // 030 Interface_count                          ModelPrimitiveType uint uint uint UInt32
    public partial class RemoteClass : DataModel
    {
        ...
        public static RemoteClass? FromPointer(IntPtr p0)
        {
            ...
            value.Interface_count                           = GetUInt32(new IntPtr(p + 0x030)); // 0x30 Interface_count             ( ModelPrimitiveType uint uint uint UInt32 )
