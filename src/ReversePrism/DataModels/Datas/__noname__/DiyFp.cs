...
namespace ReversePrism.DataModels
{
    ...
    public partial class DiyFp
    {
        ...
        public static DiyFp? FromPointer(IntPtr p0)
        {
            ...
            value.F                                         = GetUInt64(new IntPtr(p + 0x010)); // 0270DAAABC78 0x10 F                           ( 00018669C740 ModelPrimitiveType ulong ulong ulong UInt64 )
            value.E                                         = GetInt32(new IntPtr(p + 0x018)); // 0270DAAABC98 0x18 E                           ( 0001865F4940 ModelPrimitiveType int int int Int32 )
