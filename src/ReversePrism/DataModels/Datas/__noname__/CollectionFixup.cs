...
namespace ReversePrism.DataModels
{
    ...
    public partial class CollectionFixup
    {
        ...
        public static CollectionFixup? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new CollectionFixup();

            value.Callback                                  = GetObject<XmlSerializationCollectionFixupCallback>(new IntPtr(p + 0x010), ReversePrism.DataModels.XmlSerializationCollectionFixupCallback.FromPointer); // 0270D74C8B70 0x10 Callback                    ( 0001865C5C70 ModelClassType XmlSerializationCollectionFixupCallback XmlSerializationCollectionFixupCallback XmlSerializationCollectionFixupCallback Pointer )
            value.Id                                        = GetString(new IntPtr(p + 0x028)); // 0270D74C8BD0 0x28 Id                          ( 000186671910 ModelPrimitiveType string string string String )
