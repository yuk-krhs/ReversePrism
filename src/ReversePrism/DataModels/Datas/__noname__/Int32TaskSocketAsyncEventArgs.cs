...
namespace ReversePrism.DataModels
{
    ...
    // 0A0 WrapExceptionsInIOExceptions             ModelPrimitiveType bool bool bool Bool
    public partial class Int32TaskSocketAsyncEventArgs : DataModel
    {
        ...
        public static Int32TaskSocketAsyncEventArgs? FromPointer(IntPtr p0)
        {
            ...
            value.WrapExceptionsInIOExceptions              = GetBool(new IntPtr(p + 0x0A0)); // 0xA0 WrapExceptionsInIOExceptions ( ModelPrimitiveType bool bool bool Bool )
