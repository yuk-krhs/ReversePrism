...
namespace ReversePrism.DataModels
{
    ...
    public partial class Api
    {
        ...
        public static Api? FromPointer(IntPtr p0)
        {
            ...
            value.Service                                   = GetString(new IntPtr(p + 0x018)); // 0270DA719580 0x18 Service                     ( 000186671910 ModelPrimitiveType string string string String )
            value.Operation                                 = GetString(new IntPtr(p + 0x020)); // 0270DA7195C0 0x20 Operation                   ( 000186671910 ModelPrimitiveType string string string String )
            value.Protocol                                  = GetString(new IntPtr(p + 0x028)); // 0270DA719600 0x28 Protocol                    ( 000186671910 ModelPrimitiveType string string string String )
            value.Version                                   = GetString(new IntPtr(p + 0x030)); // 0270DA719640 0x30 Version                     ( 000186671910 ModelPrimitiveType string string string String )
