...
namespace ReversePrism.DataModels
{
    ...
    // 015 LeftTrigger                              ModelPrimitiveType sbyte sbyte sbyte SByte
    // 016 RightTrigger                             ModelPrimitiveType sbyte sbyte sbyte SByte
    // 018 Buttons0                                 ModelPrimitiveType sbyte sbyte sbyte SByte
    // 019 Buttons1                                 ModelPrimitiveType sbyte sbyte sbyte SByte
    // 01A Buttons2                                 ModelPrimitiveType sbyte sbyte sbyte SByte
    public partial class DualSenseHIDUSBInputReport : DataModel
    {
        ...
        public static DualSenseHIDUSBInputReport? FromPointer(IntPtr p0)
        {
            ...
            value.LeftTrigger                               = GetSByte(new IntPtr(p + 0x015)); // 0x15 LeftTrigger                 ( ModelPrimitiveType sbyte sbyte sbyte SByte )
            value.RightTrigger                              = GetSByte(new IntPtr(p + 0x016)); // 0x16 RightTrigger                ( ModelPrimitiveType sbyte sbyte sbyte SByte )
            value.Buttons0                                  = GetSByte(new IntPtr(p + 0x018)); // 0x18 Buttons0                    ( ModelPrimitiveType sbyte sbyte sbyte SByte )
            value.Buttons1                                  = GetSByte(new IntPtr(p + 0x019)); // 0x19 Buttons1                    ( ModelPrimitiveType sbyte sbyte sbyte SByte )
            value.Buttons2                                  = GetSByte(new IntPtr(p + 0x01A)); // 0x1A Buttons2                    ( ModelPrimitiveType sbyte sbyte sbyte SByte )
