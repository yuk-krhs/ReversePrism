...
namespace ReversePrism.DataModels
{
    ...
    // 010 Format                                   ModelPrimitiveType string string string String
    ...
    public partial class ConcreteFormattableString : DataModel
    {
        ...
        public static ConcreteFormattableString? FromPointer(IntPtr p0)
        {
            ...
            value.Format                                    = GetString(new IntPtr(p + 0x010)); // 0x10 Format                      ( ModelPrimitiveType string string string String )
