...
namespace ReversePrism.DataModels
{
    ...
    public partial class Request
    {
        ...
        public static Request? FromPointer(IntPtr p0)
        {
            ...
            value.Id                                        = GetString(new IntPtr(p + 0x018)); // 0270DA71D068 0x18 Id                          ( 000186671910 ModelPrimitiveType string string string String )
            value.Method                                    = GetString(new IntPtr(p + 0x020)); // 0270DA71D0A8 0x20 Method                      ( 000186671910 ModelPrimitiveType string string string String )
            value.Path                                      = GetString(new IntPtr(p + 0x030)); // 0270DA71D148 0x30 Path                        ( 000186671910 ModelPrimitiveType string string string String )
            value.Host                                      = GetString(new IntPtr(p + 0x038)); // 0270DA71D188 0x38 Host                        ( 000186671910 ModelPrimitiveType string string string String )
            value.Scheme                                    = GetString(new IntPtr(p + 0x040)); // 0270DA71D1C8 0x40 Scheme                      ( 000186671910 ModelPrimitiveType string string string String )
            value.Query                                     = GetString(new IntPtr(p + 0x048)); // 0270DA71D208 0x48 Query                       ( 000186671910 ModelPrimitiveType string string string String )
            value._Time                                     = GetObject<Timestamp>(new IntPtr(p + 0x050), ReversePrism.DataModels.Timestamp.FromPointer); // 0270DA71D248 0x50 _Time                       ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.Size                                      = GetInt64(new IntPtr(p + 0x058)); // 0270DA71D288 0x58 Size                        ( 0001865F7700 ModelPrimitiveType long long long Int64 )
            value.Protocol                                  = GetString(new IntPtr(p + 0x060)); // 0270DA71D2C8 0x60 Protocol                    ( 000186671910 ModelPrimitiveType string string string String )
            value.Reason                                    = GetString(new IntPtr(p + 0x068)); // 0270DA71D308 0x68 Reason                      ( 000186671910 ModelPrimitiveType string string string String )
            value.Auth                                      = GetObject<Auth>(new IntPtr(p + 0x070), ReversePrism.DataModels.Auth.FromPointer); // 0270DA71D348 0x70 Auth                        ( 0001867645A0 ModelClassType Auth Auth Auth Pointer )
