...
namespace ReversePrism.DataModels
{
    ...
    public partial class Response
    {
        ...
        public static Response? FromPointer(IntPtr p0)
        {
            ...
            value.Code                                      = GetInt64(new IntPtr(p + 0x018)); // 0270DA71EE60 0x18 Code                        ( 0001865F7700 ModelPrimitiveType long long long Int64 )
            value.Size                                      = GetInt64(new IntPtr(p + 0x020)); // 0270DA71EEA0 0x20 Size                        ( 0001865F7700 ModelPrimitiveType long long long Int64 )
            value._Time                                     = GetObject<Timestamp>(new IntPtr(p + 0x030), ReversePrism.DataModels.Timestamp.FromPointer); // 0270DA71EF40 0x30 _Time                       ( 000186675810 ModelClassType Timestamp Timestamp Timestamp Pointer )
            value.BackendLatency                            = GetObject<Duration>(new IntPtr(p + 0x038), ReversePrism.DataModels.Duration.FromPointer); // 0270DA71EF80 0x38 BackendLatency              ( 00018670DB80 ModelClassType Duration Duration Duration Pointer )
