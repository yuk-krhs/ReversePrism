...
namespace ReversePrism.DataModels
{
    ...
    public partial class WaitUntilPromise : DataModel
    {
        ...
        public static WaitUntilPromise? FromPointer(IntPtr p0)
        {
            ...
            value.NextNode                                  = GetObject<WaitUntilPromise>(new IntPtr(p + 0x010), ReversePrism.DataModels.WaitUntilPromise.FromPointer); // 0245A3A401A0 0x10 NextNode                    ( 00018671A750 ModelClassType WaitUntilPromise WaitUntilPromise WaitUntilPromise Pointer )
            value.CancellationToken                         = (CancellationToken)GetInt32(new IntPtr(p + 0x020)); // 0245A3A401E0 0x20 CancellationToken           ( 00018653CB00 ModelEnumType CancellationToken CancellationToken CancellationToken Int32 )
