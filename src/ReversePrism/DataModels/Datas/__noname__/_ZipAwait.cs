...
namespace ReversePrism.DataModels
{
    ...
    // 000 resultAwaitCoreDelegate                  Action`1<<object>> IL2CPP_TYPE_GENERICINST
    ...
    public partial class _ZipAwait : DataModel
    {

        public static _ZipAwait? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new _ZipAwait() { Pointer= p0 };
