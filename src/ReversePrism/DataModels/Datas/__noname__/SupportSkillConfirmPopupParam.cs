...
namespace ReversePrism.DataModels
{
    ...
    // 098 PopupMode                                ModelEnumType Mode Mode Mode Int32
    // 0A0 OnFinishGetSkillFlow                     ModelClassType Action Action Action Pointer
    public partial class SupportSkillConfirmPopupParam : DataModel
    {
        ...
        public static SupportSkillConfirmPopupParam? FromPointer(IntPtr p0)
        {
            ...
            value.PopupMode                                 = (Mode)GetInt32(new IntPtr(p + 0x098)); // 0x98 PopupMode                   ( ModelEnumType Mode Mode Mode Int32 )
            value.OnFinishGetSkillFlow                      = GetObject<Action>(new IntPtr(p + 0x0A0), ReversePrism.DataModels.Action.FromPointer); // 0xA0 OnFinishGetSkillFlow        ( ModelClassType Action Action Action Pointer )
