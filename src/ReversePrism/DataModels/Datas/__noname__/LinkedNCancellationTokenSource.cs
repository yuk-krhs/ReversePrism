...
namespace ReversePrism.DataModels
{
    ...
    public partial class LinkedNCancellationTokenSource
    {
        ...
        public static LinkedNCancellationTokenSource? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new LinkedNCancellationTokenSource();

            value.LinkingRegistrations                      = GetEnumList<CancellationTokenRegistration>(new IntPtr(p + 0x040)); // 027004A3F820 0x40 LinkingRegistrations        ( 000185B73300 ModelEnumListType CancellationTokenRegistration[] CancellationTokenRegistration[] List<CancellationTokenRegistration> Pointer )
