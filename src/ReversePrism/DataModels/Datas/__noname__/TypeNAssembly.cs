...
namespace ReversePrism.DataModels
{
    ...
    // 018 AssemblyName                             ModelPrimitiveType string string string String
    public partial class TypeNAssembly : DataModel
    {
        ...
        public static TypeNAssembly? FromPointer(IntPtr p0)
        {
            ...
            value.AssemblyName                              = GetString(new IntPtr(p + 0x018)); // 0x18 AssemblyName                ( ModelPrimitiveType string string string String )
