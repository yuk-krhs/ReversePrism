...
namespace ReversePrism.DataModels
{
    ...
    public partial class AddressablesRow : DataModel
    {
        ...
        public static AddressablesRow? FromPointer(IntPtr p0)
        {
            ...
            value.Name                                      = GetInt64(new IntPtr(p + 0x010)); // 0245A3E02FF8 0x10 Name                        ( 0001865F7700 ModelPrimitiveType long long long Int64 )
            value.Label                                     = GetInt64(new IntPtr(p + 0x018)); // 0245A3E03018 0x18 Label                       ( 0001865F7700 ModelPrimitiveType long long long Int64 )
