...
namespace ReversePrism.DataModels
{
    ...
    // 000 selectorAwaitCoreDelegate                Action`1<<object>> IL2CPP_TYPE_GENERICINST
    // 000 resultSelectorAwaitCoreDelegate          Action`1<<object>> IL2CPP_TYPE_GENERICINST
    // 000 source                                   IUniTaskAsyncEnumerable`1<<var>> IL2CPP_TYPE_GENERICINST
    // 000 selector1                                Func`3<<var>, CancellationToken, UniTask`1<IUniTaskAsyncEnumerable`1<<var>>>> IL2CPP_TYPE_GENERICINST
    // 000 selector2                                Func`4<<var>, int, CancellationToken, UniTask`1<IUniTaskAsyncEnumerable`1<<var>>>> IL2CPP_TYPE_GENERICINST
    // 000 resultSelector                           Func`4<<var>, <var>, CancellationToken, UniTask`1<<var>>> IL2CPP_TYPE_GENERICINST
    ...
    public partial class _SelectManyAwaitWithCancellation : DataModel
    {

        public static _SelectManyAwaitWithCancellation? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new _SelectManyAwaitWithCancellation() { Pointer= p0 };
