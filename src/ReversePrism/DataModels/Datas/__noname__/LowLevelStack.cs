...
namespace ReversePrism.DataModels
{
    ...
    public partial class LowLevelStack : DataModel
    {
        ...
        public static LowLevelStack? FromPointer(IntPtr p0)
        {
            ...
            value.Arr                                       = GetEnumList<FormatParam>(new IntPtr(p + 0x010)); // 024666B087C8 0x10 Arr                         ( 000185B86B70 ModelEnumListType FormatParam[] FormatParam[] List<FormatParam> Pointer )
            value.Count                                     = GetInt32(new IntPtr(p + 0x018)); // 024666B087E8 0x18 Count                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
