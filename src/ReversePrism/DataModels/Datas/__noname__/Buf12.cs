...
namespace ReversePrism.DataModels
{
    ...
    // 014 Uhigh64LE                                ModelPrimitiveType ulong ulong ulong UInt64
    public partial class Buf12 : DataModel
    {
        ...
        public static Buf12? FromPointer(IntPtr p0)
        {
            ...
            value.Uhigh64LE                                 = GetUInt64(new IntPtr(p + 0x014)); // 0x14 Uhigh64LE                   ( ModelPrimitiveType ulong ulong ulong UInt64 )
