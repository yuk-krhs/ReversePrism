...
namespace ReversePrism.DataModels
{
    ...
    // 020 Disposable3                              ModelClassType IDisposable IDisposable IDisposable Pointer
    public partial class CombinedDisposable3 : DataModel
    {
        ...
        public static CombinedDisposable3? FromPointer(IntPtr p0)
        {
            ...
            value.Disposable3                               = GetObject<IDisposable>(new IntPtr(p + 0x020), ReversePrism.DataModels.IDisposable.FromPointer); // 0x20 Disposable3                 ( ModelClassType IDisposable IDisposable IDisposable Pointer )
