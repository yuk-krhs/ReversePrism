...
namespace ReversePrism.DataModels
{
    ...
    public partial class unitytls_interface_struct
    {
        ...
        public static unitytls_interface_struct? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new unitytls_interface_struct();

            value.UNITYTLS_INVALID_HANDLE                   = GetUInt64(new IntPtr(p + 0x010)); // 0270D78EC480 0x10 UNITYTLS_INVALID_HANDLE     ( 00018669C740 ModelPrimitiveType ulong ulong ulong UInt64 )
            value.UNITYTLS_TLSCTX_PROTOCOLRANGE_DEFAULT     = (unitytls_tlsctx_protocolrange)GetInt32(new IntPtr(p + 0x018)); // 0270D78EC4A0 0x18 UNITYTLS_TLSCTX_PROTOCOLRANGE_DEFAULT ( 0001866AF210 ModelEnumType unitytls_tlsctx_protocolrange unitytls_tlsctx_protocolrange unitytls_tlsctx_protocolrange Int32 )
            value.Unitytls_errorstate_create                = GetObject<unitytls_errorstate_create_t>(new IntPtr(p + 0x020), ReversePrism.DataModels.unitytls_errorstate_create_t.FromPointer); // 0270D78EC4C0 0x20 Unitytls_errorstate_create  ( 000186597170 ModelClassType unitytls_errorstate_create_t unitytls_errorstate_create_t unitytls_errorstate_create_t Pointer )
            value.Unitytls_errorstate_raise_error           = GetObject<unitytls_errorstate_raise_error_t>(new IntPtr(p + 0x028), ReversePrism.DataModels.unitytls_errorstate_raise_error_t.FromPointer); // 0270D78EC4E0 0x28 Unitytls_errorstate_raise_error ( 000186597660 ModelClassType unitytls_errorstate_raise_error_t unitytls_errorstate_raise_error_t unitytls_errorstate_raise_error_t Pointer )
            value.Unitytls_key_get_ref                      = GetObject<unitytls_key_get_ref_t>(new IntPtr(p + 0x030), ReversePrism.DataModels.unitytls_key_get_ref_t.FromPointer); // 0270D78EC500 0x30 Unitytls_key_get_ref        ( 000186598020 ModelClassType unitytls_key_get_ref_t unitytls_key_get_ref_t unitytls_key_get_ref_t Pointer )
            value.Unitytls_key_parse_der                    = GetObject<unitytls_key_parse_der_t>(new IntPtr(p + 0x038), ReversePrism.DataModels.unitytls_key_parse_der_t.FromPointer); // 0270D78EC520 0x38 Unitytls_key_parse_der      ( 000186598500 ModelClassType unitytls_key_parse_der_t unitytls_key_parse_der_t unitytls_key_parse_der_t Pointer )
            value.Unitytls_key_parse_pem                    = GetObject<unitytls_key_parse_pem_t>(new IntPtr(p + 0x040), ReversePrism.DataModels.unitytls_key_parse_pem_t.FromPointer); // 0270D78EC540 0x40 Unitytls_key_parse_pem      ( 0001865989F0 ModelClassType unitytls_key_parse_pem_t unitytls_key_parse_pem_t unitytls_key_parse_pem_t Pointer )
            value.Unitytls_key_free                         = GetObject<unitytls_key_free_t>(new IntPtr(p + 0x048), ReversePrism.DataModels.unitytls_key_free_t.FromPointer); // 0270D78EC560 0x48 Unitytls_key_free           ( 000186597B60 ModelClassType unitytls_key_free_t unitytls_key_free_t unitytls_key_free_t Pointer )
            value.Unitytls_x509_export_der                  = GetObject<unitytls_x509_export_der_t>(new IntPtr(p + 0x050), ReversePrism.DataModels.unitytls_x509_export_der_t.FromPointer); // 0270D78EC580 0x50 Unitytls_x509_export_der    ( 00018659D840 ModelClassType unitytls_x509_export_der_t unitytls_x509_export_der_t unitytls_x509_export_der_t Pointer )
            value.Unitytls_x509list_get_ref                 = GetObject<unitytls_x509list_get_ref_t>(new IntPtr(p + 0x058), ReversePrism.DataModels.unitytls_x509list_get_ref_t.FromPointer); // 0270D78EC5A0 0x58 Unitytls_x509list_get_ref   ( 00018659F120 ModelClassType unitytls_x509list_get_ref_t unitytls_x509list_get_ref_t unitytls_x509list_get_ref_t Pointer )
            value.Unitytls_x509list_get_x509                = GetObject<unitytls_x509list_get_x509_t>(new IntPtr(p + 0x060), ReversePrism.DataModels.unitytls_x509list_get_x509_t.FromPointer); // 0270D78EC5C0 0x60 Unitytls_x509list_get_x509  ( 00018659F590 ModelClassType unitytls_x509list_get_x509_t unitytls_x509list_get_x509_t unitytls_x509list_get_x509_t Pointer )
            value.Unitytls_x509list_create                  = GetObject<unitytls_x509list_create_t>(new IntPtr(p + 0x068), ReversePrism.DataModels.unitytls_x509list_create_t.FromPointer); // 0270D78EC5E0 0x68 Unitytls_x509list_create    ( 00018659E720 ModelClassType unitytls_x509list_create_t unitytls_x509list_create_t unitytls_x509list_create_t Pointer )
            value.Unitytls_x509list_append                  = GetObject<unitytls_x509list_append_t>(new IntPtr(p + 0x070), ReversePrism.DataModels.unitytls_x509list_append_t.FromPointer); // 0270D78EC600 0x70 Unitytls_x509list_append    ( 00018659E220 ModelClassType unitytls_x509list_append_t unitytls_x509list_append_t unitytls_x509list_append_t Pointer )
            value.Unitytls_x509list_append_der              = GetObject<unitytls_x509list_append_der_t>(new IntPtr(p + 0x078), ReversePrism.DataModels.unitytls_x509list_append_der_t.FromPointer); // 0270D78EC620 0x78 Unitytls_x509list_append_der ( 00018659DD20 ModelClassType unitytls_x509list_append_der_t unitytls_x509list_append_der_t unitytls_x509list_append_der_t Pointer )
            value.Unitytls_x509list_append_pem              = GetObject<unitytls_x509list_append_der_t>(new IntPtr(p + 0x080), ReversePrism.DataModels.unitytls_x509list_append_der_t.FromPointer); // 0270D78EC640 0x80 Unitytls_x509list_append_pem ( 00018659DD20 ModelClassType unitytls_x509list_append_der_t unitytls_x509list_append_der_t unitytls_x509list_append_der_t Pointer )
            value.Unitytls_x509list_free                    = GetObject<unitytls_x509list_free_t>(new IntPtr(p + 0x088), ReversePrism.DataModels.unitytls_x509list_free_t.FromPointer); // 0270D78EC660 0x88 Unitytls_x509list_free      ( 00018659EC20 ModelClassType unitytls_x509list_free_t unitytls_x509list_free_t unitytls_x509list_free_t Pointer )
            value.Unitytls_x509verify_default_ca            = GetObject<unitytls_x509verify_default_ca_t>(new IntPtr(p + 0x090), ReversePrism.DataModels.unitytls_x509verify_default_ca_t.FromPointer); // 0270D78EC680 0x90 Unitytls_x509verify_default_ca ( 00018659FAB0 ModelClassType unitytls_x509verify_default_ca_t unitytls_x509verify_default_ca_t unitytls_x509verify_default_ca_t Pointer )
            value.Unitytls_x509verify_explicit_ca           = GetObject<unitytls_x509verify_explicit_ca_t>(new IntPtr(p + 0x098), ReversePrism.DataModels.unitytls_x509verify_explicit_ca_t.FromPointer); // 0270D78EC6A0 0x98 Unitytls_x509verify_explicit_ca ( 00018659FF90 ModelClassType unitytls_x509verify_explicit_ca_t unitytls_x509verify_explicit_ca_t unitytls_x509verify_explicit_ca_t Pointer )
            value.Unitytls_tlsctx_create_server             = GetObject<unitytls_tlsctx_create_server_t>(new IntPtr(p + 0x0A0), ReversePrism.DataModels.unitytls_tlsctx_create_server_t.FromPointer); // 0270D78EC6C0 0xA0 Unitytls_tlsctx_create_server ( 0001865998C0 ModelClassType unitytls_tlsctx_create_server_t unitytls_tlsctx_create_server_t unitytls_tlsctx_create_server_t Pointer )
            value.Unitytls_tlsctx_create_client             = GetObject<unitytls_tlsctx_create_client_t>(new IntPtr(p + 0x0A8), ReversePrism.DataModels.unitytls_tlsctx_create_client_t.FromPointer); // 0270D78EC6E0 0xA8 Unitytls_tlsctx_create_client ( 0001865993E0 ModelClassType unitytls_tlsctx_create_client_t unitytls_tlsctx_create_client_t unitytls_tlsctx_create_client_t Pointer )
            value.Unitytls_tlsctx_server_require_client_authentication = GetObject<unitytls_tlsctx_server_require_client_authentication_t>(new IntPtr(p + 0x0B0), ReversePrism.DataModels.unitytls_tlsctx_server_require_client_authentication_t.FromPointer); // 0270D78EC700 0xB0 Unitytls_tlsctx_server_require_client_authentication ( 00018659BAE0 ModelClassType unitytls_tlsctx_server_require_client_authentication_t unitytls_tlsctx_server_require_client_authentication_t unitytls_tlsctx_server_require_client_authentication_t Pointer )
            value.Unitytls_tlsctx_set_certificate_callback  = GetObject<unitytls_tlsctx_set_certificate_callback_t>(new IntPtr(p + 0x0B8), ReversePrism.DataModels.unitytls_tlsctx_set_certificate_callback_t.FromPointer); // 0270D78EC720 0xB8 Unitytls_tlsctx_set_certificate_callback ( 00018659BFD0 ModelClassType unitytls_tlsctx_set_certificate_callback_t unitytls_tlsctx_set_certificate_callback_t unitytls_tlsctx_set_certificate_callback_t Pointer )
            value.Unitytls_tlsctx_set_trace_callback        = GetObject<unitytls_tlsctx_set_trace_callback_t>(new IntPtr(p + 0x0C0), ReversePrism.DataModels.unitytls_tlsctx_set_trace_callback_t.FromPointer); // 0270D78EC740 0xC0 Unitytls_tlsctx_set_trace_callback ( 00018659C940 ModelClassType unitytls_tlsctx_set_trace_callback_t unitytls_tlsctx_set_trace_callback_t unitytls_tlsctx_set_trace_callback_t Pointer )
            value.Unitytls_tlsctx_set_x509verify_callback   = GetObject<unitytls_tlsctx_set_x509verify_callback_t>(new IntPtr(p + 0x0C8), ReversePrism.DataModels.unitytls_tlsctx_set_x509verify_callback_t.FromPointer); // 0270D78EC760 0xC8 Unitytls_tlsctx_set_x509verify_callback ( 00018659CE60 ModelClassType unitytls_tlsctx_set_x509verify_callback_t unitytls_tlsctx_set_x509verify_callback_t unitytls_tlsctx_set_x509verify_callback_t Pointer )
            value.Unitytls_tlsctx_set_supported_ciphersuites = GetObject<unitytls_tlsctx_set_supported_ciphersuites_t>(new IntPtr(p + 0x0D0), ReversePrism.DataModels.unitytls_tlsctx_set_supported_ciphersuites_t.FromPointer); // 0270D78EC780 0xD0 Unitytls_tlsctx_set_supported_ciphersuites ( 00018659C4C0 ModelClassType unitytls_tlsctx_set_supported_ciphersuites_t unitytls_tlsctx_set_supported_ciphersuites_t unitytls_tlsctx_set_supported_ciphersuites_t Pointer )
            value.Unitytls_tlsctx_get_ciphersuite           = GetObject<unitytls_tlsctx_get_ciphersuite_t>(new IntPtr(p + 0x0D8), ReversePrism.DataModels.unitytls_tlsctx_get_ciphersuite_t.FromPointer); // 0270D78EC7A0 0xD8 Unitytls_tlsctx_get_ciphersuite ( 00018659A2A0 ModelClassType unitytls_tlsctx_get_ciphersuite_t unitytls_tlsctx_get_ciphersuite_t unitytls_tlsctx_get_ciphersuite_t Pointer )
            value.Unitytls_tlsctx_get_protocol              = GetObject<unitytls_tlsctx_get_protocol_t>(new IntPtr(p + 0x0E0), ReversePrism.DataModels.unitytls_tlsctx_get_protocol_t.FromPointer); // 0270D78EC7C0 0xE0 Unitytls_tlsctx_get_protocol ( 00018659A7A0 ModelClassType unitytls_tlsctx_get_protocol_t unitytls_tlsctx_get_protocol_t unitytls_tlsctx_get_protocol_t Pointer )
            value.Unitytls_tlsctx_process_handshake         = GetObject<unitytls_tlsctx_process_handshake_t>(new IntPtr(p + 0x0E8), ReversePrism.DataModels.unitytls_tlsctx_process_handshake_t.FromPointer); // 0270D78EC7E0 0xE8 Unitytls_tlsctx_process_handshake ( 00018659B140 ModelClassType unitytls_tlsctx_process_handshake_t unitytls_tlsctx_process_handshake_t unitytls_tlsctx_process_handshake_t Pointer )
            value.Unitytls_tlsctx_read                      = GetObject<unitytls_tlsctx_read_t>(new IntPtr(p + 0x0F0), ReversePrism.DataModels.unitytls_tlsctx_read_t.FromPointer); // 0270D78EC800 0xF0 Unitytls_tlsctx_read        ( 00018659B620 ModelClassType unitytls_tlsctx_read_t unitytls_tlsctx_read_t unitytls_tlsctx_read_t Pointer )
            value.Unitytls_tlsctx_write                     = GetObject<unitytls_tlsctx_write_t>(new IntPtr(p + 0x0F8), ReversePrism.DataModels.unitytls_tlsctx_write_t.FromPointer); // 0270D78EC820 0xF8 Unitytls_tlsctx_write       ( 00018659D340 ModelClassType unitytls_tlsctx_write_t unitytls_tlsctx_write_t unitytls_tlsctx_write_t Pointer )
            value.Unitytls_tlsctx_notify_close              = GetObject<unitytls_tlsctx_notify_close_t>(new IntPtr(p + 0x100), ReversePrism.DataModels.unitytls_tlsctx_notify_close_t.FromPointer); // 0270D78EC840 0x100 Unitytls_tlsctx_notify_close ( 00018659ACA0 ModelClassType unitytls_tlsctx_notify_close_t unitytls_tlsctx_notify_close_t unitytls_tlsctx_notify_close_t Pointer )
            value.Unitytls_tlsctx_free                      = GetObject<unitytls_tlsctx_free_t>(new IntPtr(p + 0x108), ReversePrism.DataModels.unitytls_tlsctx_free_t.FromPointer); // 0270D78EC860 0x108 Unitytls_tlsctx_free        ( 000186599DA0 ModelClassType unitytls_tlsctx_free_t unitytls_tlsctx_free_t unitytls_tlsctx_free_t Pointer )
            value.Unitytls_random_generate_bytes            = GetObject<unitytls_random_generate_bytes_t>(new IntPtr(p + 0x110), ReversePrism.DataModels.unitytls_random_generate_bytes_t.FromPointer); // 0270D78EC880 0x110 Unitytls_random_generate_bytes ( 000186598EC0 ModelClassType unitytls_random_generate_bytes_t unitytls_random_generate_bytes_t unitytls_random_generate_bytes_t Pointer )
