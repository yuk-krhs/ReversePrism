...
namespace ReversePrism.DataModels
{
    ...
    // 014 Buttons0                                 ModelPrimitiveType sbyte sbyte sbyte SByte
    // 015 Buttons1                                 ModelPrimitiveType sbyte sbyte sbyte SByte
    ...
    public partial class DualShock4HIDGenericInputReport : DataModel
    {
        ...
        public static DualShock4HIDGenericInputReport? FromPointer(IntPtr p0)
        {
            ...
            value.Buttons0                                  = GetSByte(new IntPtr(p + 0x014)); // 0x14 Buttons0                    ( ModelPrimitiveType sbyte sbyte sbyte SByte )
            value.Buttons1                                  = GetSByte(new IntPtr(p + 0x015)); // 0x15 Buttons1                    ( ModelPrimitiveType sbyte sbyte sbyte SByte )
