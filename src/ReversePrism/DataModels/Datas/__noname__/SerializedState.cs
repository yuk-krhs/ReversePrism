...
namespace ReversePrism.DataModels
{
    ...
    public partial class SerializedState : DataModel
    {
        ...
        public static SerializedState? FromPointer(IntPtr p0)
        {
            ...
            value.LastUpdateType                            = (InputUpdateType)GetInt32(new IntPtr(p + 0x010)); // 024667889E00 0x10 LastUpdateType              ( 000186705EF0 ModelEnumType InputUpdateType InputUpdateType InputUpdateType Int32 )
            value.PlayerUpdateStepCount                     = (UpdateStepCount)GetInt32(new IntPtr(p + 0x014)); // 024667889E20 0x14 PlayerUpdateStepCount       ( 00018663D110 ModelEnumType UpdateStepCount UpdateStepCount UpdateStepCount Int32 )
