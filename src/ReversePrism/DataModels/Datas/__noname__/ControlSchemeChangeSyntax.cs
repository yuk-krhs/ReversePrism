...
namespace ReversePrism.DataModels
{
    ...
    // 010 M_UserIndex                              ModelPrimitiveType int int int Int32
    public partial class ControlSchemeChangeSyntax : DataModel
    {
        ...
        public static ControlSchemeChangeSyntax? FromPointer(IntPtr p0)
        {
            ...
            value.M_UserIndex                               = GetInt32(new IntPtr(p + 0x010)); // 0x10 M_UserIndex                 ( ModelPrimitiveType int int int Int32 )
