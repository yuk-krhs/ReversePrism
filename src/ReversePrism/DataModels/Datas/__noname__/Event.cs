...
namespace ReversePrism.DataModels
{
    ...
    // 010 Action                                   ModelEnumType Action Action Action Int32
    ...
    public partial class Event : DataModel
    {
        ...
        public static Event? FromPointer(IntPtr p0)
        {
            ...
            value.Action                                    = (Action)GetInt32(new IntPtr(p + 0x010)); // 0x10 Action                      ( ModelEnumType Action Action Action Int32 )
