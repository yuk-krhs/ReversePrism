...
namespace ReversePrism.DataModels
{
    ...
    // 010 NextNode                                 ModelClassType WaitWhilePromise WaitWhilePromise WaitWhilePromise Pointer
    ...
    public partial class WaitWhilePromise : DataModel
    {
        ...
        public static WaitWhilePromise? FromPointer(IntPtr p0)
        {
            ...
            value.NextNode                                  = GetObject<WaitWhilePromise>(new IntPtr(p + 0x010), ReversePrism.DataModels.WaitWhilePromise.FromPointer); // 0x10 NextNode                    ( ModelClassType WaitWhilePromise WaitWhilePromise WaitWhilePromise Pointer )
