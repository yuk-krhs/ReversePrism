...
namespace ReversePrism.DataModels
{
    ...
    public partial class CachedData : DataModel
    {
        ...
        public static CachedData? FromPointer(IntPtr p0)
        {
            ...
            value.OneYearLocalFromUtc                       = GetObject<OffsetAndRule>(new IntPtr(p + 0x010), ReversePrism.DataModels.OffsetAndRule.FromPointer); // 0245A3CA7790 0x10 OneYearLocalFromUtc         ( 0001866098B0 ModelClassType OffsetAndRule OffsetAndRule OffsetAndRule Pointer )
            value.LocalTimeZone                             = GetObject<TimeZoneInfo>(new IntPtr(p + 0x018), ReversePrism.DataModels.TimeZoneInfo.FromPointer); // 0245A3CA77B0 0x18 LocalTimeZone               ( 00018668C9A0 ModelClassType TimeZoneInfo TimeZoneInfo TimeZoneInfo Pointer )
            value.AllSystemTimeZonesRead                    = GetBool(new IntPtr(p + 0x030)); // 0245A3CA7810 0x30 AllSystemTimeZonesRead      ( 000186595960 ModelPrimitiveType bool bool bool Bool )
