...
namespace ReversePrism.DataModels
{
    ...
    // 091 ReverseSolution                          ModelPrimitiveType bool bool bool Bool
    // 092 StrictlySimple                           ModelPrimitiveType bool bool bool Bool
    public partial class Clipper : DataModel
    {
        ...
        public static Clipper? FromPointer(IntPtr p0)
        {
            ...
            value.ReverseSolution                           = GetBool(new IntPtr(p + 0x091)); // 0x91 ReverseSolution             ( ModelPrimitiveType bool bool bool Bool )
            value.StrictlySimple                            = GetBool(new IntPtr(p + 0x092)); // 0x92 StrictlySimple              ( ModelPrimitiveType bool bool bool Bool )
