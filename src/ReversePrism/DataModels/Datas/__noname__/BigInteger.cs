...
namespace ReversePrism.DataModels
{
    ...
    // 010 S_Pow10BigNumTable                       ModelPrimitiveListType uint[] uint[] List<uint> Pointer
    // 010 Length                                   ModelPrimitiveType int int int Int32
    // 014 Blocks                                   ModelEnumType <_blocks>e__FixedBuffer <_blocks>e__FixedBuffer <_blocks>e__FixedBuffer Int32
    public partial class BigInteger : DataModel
    {
        ...
        public static BigInteger? FromPointer(IntPtr p0)
        {
            ...
            value.S_Pow10BigNumTable                        = GetUInt32List(new IntPtr(p + 0x010)); // 0x10 S_Pow10BigNumTable          ( ModelPrimitiveListType uint[] uint[] List<uint> Pointer )
            value.Length                                    = GetInt32(new IntPtr(p + 0x010)); // 0x10 Length                      ( ModelPrimitiveType int int int Int32 )
            value.Blocks                                    = (<_blocks>e__FixedBuffer)GetInt32(new IntPtr(p + 0x014)); // 0x14 Blocks                      ( ModelEnumType <_blocks>e__FixedBuffer <_blocks>e__FixedBuffer <_blocks>e__FixedBuffer Int32 )
