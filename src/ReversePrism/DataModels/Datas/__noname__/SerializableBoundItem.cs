...
namespace ReversePrism.DataModels
{
    ...
    // 018 Bounds                                   ModelEnumType Bounds Bounds Bounds Int32
    public partial class SerializableBoundItem : DataModel
    {
        ...
        public static SerializableBoundItem? FromPointer(IntPtr p0)
        {
            ...
            value.Bounds                                    = (Bounds)GetInt32(new IntPtr(p + 0x018)); // 0x18 Bounds                      ( ModelEnumType Bounds Bounds Bounds Int32 )
