...
namespace ReversePrism.DataModels
{
    ...
    // 030 CompletedCount                           ModelPrimitiveType int int int Int32
    ...
    public partial class WhenAll_ : DataModel
    {
        ...
        public static WhenAll_? FromPointer(IntPtr p0)
        {
            ...
            value.CompletedCount                            = GetInt32(new IntPtr(p + 0x030)); // 0x30 CompletedCount              ( ModelPrimitiveType int int int Int32 )
