...
namespace ReversePrism.DataModels
{
    ...
    public partial class EnumReservedRange
    {
        ...
        public static EnumReservedRange? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new EnumReservedRange();

            value.HasBits0                                  = GetInt32(new IntPtr(p + 0x018)); // 0270D0B8DD58 0x18 HasBits0                    ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Start                                     = GetInt32(new IntPtr(p + 0x01C)); // 0270D0B8DDB8 0x1C Start                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.End                                       = GetInt32(new IntPtr(p + 0x020)); // 0270D0B8DE18 0x20 End                         ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
