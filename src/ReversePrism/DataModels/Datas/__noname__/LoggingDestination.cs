...
namespace ReversePrism.DataModels
{
    ...
    public partial class LoggingDestination
    {
        ...
        public static LoggingDestination? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new LoggingDestination();

            value.MonitoredResource                         = GetString(new IntPtr(p + 0x018)); // 0270DA7E9060 0x18 MonitoredResource           ( 000186671910 ModelPrimitiveType string string string String )
            value.Logs                                      = GetStringList(new IntPtr(p + 0x020)); // 0270DA7E90C0 0x20 Logs                        ( 000185CF3478 ModelPrimitiveListType RepeatedField`1<string> RepeatedField`1<string> List<string> Pointer )
