...
namespace ReversePrism.DataModels
{
    ...
    // 040 gridMap                                  NativeParallelMultiHashMap`2<int3, int> IL2CPP_TYPE_GENERICINST
    // 050 joinPairMap                              NativeParallelMultiHashMap`2<ushort, ushort> IL2CPP_TYPE_GENERICINST
    public partial class SearchJoinJob : DataModel
    {
        public int                                      Vcnt                                    { get; set; }
        public float                                    GridSize                                { get; set; }
        public float                                    Radius                                  { get; set; }

        public static SearchJoinJob? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new SearchJoinJob() { Pointer= p0 };
