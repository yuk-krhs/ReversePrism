...
namespace ReversePrism.DataModels
{
    ...
    // 000 selector                                 Func`3<<var>, int, <var>> IL2CPP_TYPE_GENERICINST
    ...
    public partial class _Select : DataModel
    {

        public static _Select? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new _Select() { Pointer= p0 };
