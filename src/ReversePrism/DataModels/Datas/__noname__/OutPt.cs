...
namespace ReversePrism.DataModels
{
    ...
    // 028 Next                                     ModelClassType OutPt OutPt OutPt Pointer
    // 030 Prev                                     ModelClassType OutPt OutPt OutPt Pointer
    public partial class OutPt : DataModel
    {
        ...
        public static OutPt? FromPointer(IntPtr p0)
        {
            ...
            value.Next                                      = GetObject<OutPt>(new IntPtr(p + 0x028), ReversePrism.DataModels.OutPt.FromPointer); // 0x28 Next                        ( ModelClassType OutPt OutPt OutPt Pointer )
            value.Prev                                      = GetObject<OutPt>(new IntPtr(p + 0x030), ReversePrism.DataModels.OutPt.FromPointer); // 0x30 Prev                        ( ModelClassType OutPt OutPt OutPt Pointer )
