...
namespace ReversePrism.DataModels
{
    ...
    public partial class PrismTransparentRenderPass : DataModel
    {
        ...
        public static PrismTransparentRenderPass? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new PrismTransparentRenderPass() { Pointer= p0 };
