...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceCardConfirmPopupParam : DataModel
    {
        ...
        public static ProduceCardConfirmPopupParam? FromPointer(IntPtr p0)
        {
            ...
            value.CacheProduceCardStatusDtoList             = GetObjectList<IProduceCardStatus>(new IntPtr(p + 0x090), ReversePrism.DataModels.IProduceCardStatus.FromPointer); // 024665D2A500 0x90 CacheProduceCardStatusDtoList ( 000185CE71C8 ModelClassListType List`1<IProduceCardStatus> List`1<IProduceCardStatus> List<IProduceCardStatus> Pointer )
            value.CacheGetCardAmount                        = GetInt32(new IntPtr(p + 0x098)); // 024665D2A520 0x98 CacheGetCardAmount          ( 0001865F36C0 ModelPrimitiveType int int int Int32 )
            value.BasePopupClose                            = GetObject<Action>(new IntPtr(p + 0x0A0), ReversePrism.DataModels.Action.FromPointer); // 024665D2A540 0xA0 BasePopupClose              ( 000186679A00 ModelClassType Action Action Action Pointer )
