...
namespace ReversePrism.DataModels
{
    ...
    // 000 resultSelector                           Func`4<<var>, IEnumerable`1<<var>>, CancellationToken, UniTask`1<<var>>> IL2CPP_TYPE_GENERICINST
    ...
    public partial class _GroupJoinAwaitWithCancellation : DataModel
    {

        public static _GroupJoinAwaitWithCancellation? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new _GroupJoinAwaitWithCancellation() { Pointer= p0 };
