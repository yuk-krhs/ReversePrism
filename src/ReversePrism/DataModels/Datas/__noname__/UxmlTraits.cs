...
namespace ReversePrism.DataModels
{
    ...
    public partial class UxmlTraits
    {
        ...
        public static UxmlTraits? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new UxmlTraits();

            value.M_Text                                    = GetObject<UxmlStringAttributeDescription>(new IntPtr(p + 0x078), ReversePrism.DataModels.UxmlStringAttributeDescription.FromPointer); // 0270066FCB70 0x78 M_Text                      ( 00018675F2E0 ModelClassType UxmlStringAttributeDescription UxmlStringAttributeDescription UxmlStringAttributeDescription Pointer )
            value.M_EnableRichText                          = GetObject<UxmlBoolAttributeDescription>(new IntPtr(p + 0x080), ReversePrism.DataModels.UxmlBoolAttributeDescription.FromPointer); // 0270066FCB90 0x80 M_EnableRichText            ( 00018675B6E0 ModelClassType UxmlBoolAttributeDescription UxmlBoolAttributeDescription UxmlBoolAttributeDescription Pointer )
            value.M_ParseEscapeSequences                    = GetObject<UxmlBoolAttributeDescription>(new IntPtr(p + 0x088), ReversePrism.DataModels.UxmlBoolAttributeDescription.FromPointer); // 0270066FCBB0 0x88 M_ParseEscapeSequences      ( 00018675B6E0 ModelClassType UxmlBoolAttributeDescription UxmlBoolAttributeDescription UxmlBoolAttributeDescription Pointer )
            value.M_DisplayTooltipWhenElided                = GetObject<UxmlBoolAttributeDescription>(new IntPtr(p + 0x090), ReversePrism.DataModels.UxmlBoolAttributeDescription.FromPointer); // 0270066FCBD0 0x90 M_DisplayTooltipWhenElided  ( 00018675B6E0 ModelClassType UxmlBoolAttributeDescription UxmlBoolAttributeDescription UxmlBoolAttributeDescription Pointer )
