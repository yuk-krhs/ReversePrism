...
namespace ReversePrism.DataModels
{
    ...
    // 018 Comp                                     ModelClassType LensFlareComponentSRP LensFlareComponentSRP LensFlareComponentSRP Pointer
    public partial class LensFlareCompInfo : DataModel
    {
        ...
        public static LensFlareCompInfo? FromPointer(IntPtr p0)
        {
            ...
            value.Comp                                      = GetObject<LensFlareComponentSRP>(new IntPtr(p + 0x018), ReversePrism.DataModels.LensFlareComponentSRP.FromPointer); // 0x18 Comp                        ( ModelClassType LensFlareComponentSRP LensFlareComponentSRP LensFlareComponentSRP Pointer )
