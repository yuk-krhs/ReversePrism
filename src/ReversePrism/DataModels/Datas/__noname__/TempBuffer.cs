...
namespace ReversePrism.DataModels
{
    ...
    // 068 NormalAxis                               ModelEnumType ClothNormalAxis ClothNormalAxis ClothNormalAxis Int32
    // 070 ColliderList                             ModelClassListType List`1<ColliderComponent> List`1<ColliderComponent> List<ColliderComponent> Pointer
    // 078 CollisionBones                           ModelClassListType List`1<Transform> List`1<Transform> List<Transform> Pointer
    // 080 Synchronization                          ModelClassType MagicaCloth MagicaCloth MagicaCloth Pointer
    ...
    // 090 CullingMode                              ModelEnumType CameraCullingMode CameraCullingMode CameraCullingMode Int32
    // 094 CullingMethod                            ModelEnumType CameraCullingMethod CameraCullingMethod CameraCullingMethod Int32
    // 098 CullingRenderers                         ModelClassListType List`1<Renderer> List`1<Renderer> List<Renderer> Pointer
    // 0A0 Anchor                                   ModelClassType Transform Transform Transform Pointer
    // 0A8 AnchorInertia                            ModelPrimitiveType float float float Single
    public partial class TempBuffer : DataModel
    {
        ...
        public List<Transform>?                         CollisionBones                          { get; set; }
        public MagicaCloth?                             Synchronization                         { get; set; }
        ...
        public CameraCullingMethod                      CullingMethod                           { get; set; }
        public List<Renderer>?                          CullingRenderers                        { get; set; }
        public Transform?                               Anchor                                  { get; set; }
        public float                                    AnchorInertia                           { get; set; }

        public static TempBuffer? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new TempBuffer() { Pointer= p0 };
            ...
            value.NormalAxis                                = (ClothNormalAxis)GetInt32(new IntPtr(p + 0x068)); // 0x68 NormalAxis                  ( ModelEnumType ClothNormalAxis ClothNormalAxis ClothNormalAxis Int32 )
            value.ColliderList                              = GetObjectList<ColliderComponent>(new IntPtr(p + 0x070), ReversePrism.DataModels.ColliderComponent.FromPointer); // 0x70 ColliderList                ( ModelClassListType List`1<ColliderComponent> List`1<ColliderComponent> List<ColliderComponent> Pointer )
            value.CollisionBones                            = GetObjectList<Transform>(new IntPtr(p + 0x078), ReversePrism.DataModels.Transform.FromPointer); // 0x78 CollisionBones              ( ModelClassListType List`1<Transform> List`1<Transform> List<Transform> Pointer )
            value.Synchronization                           = GetObject<MagicaCloth>(new IntPtr(p + 0x080), ReversePrism.DataModels.MagicaCloth.FromPointer); // 0x80 Synchronization             ( ModelClassType MagicaCloth MagicaCloth MagicaCloth Pointer )
            ...
            value.CullingMode                               = (CameraCullingMode)GetInt32(new IntPtr(p + 0x090)); // 0x90 CullingMode                 ( ModelEnumType CameraCullingMode CameraCullingMode CameraCullingMode Int32 )
            value.CullingMethod                             = (CameraCullingMethod)GetInt32(new IntPtr(p + 0x094)); // 0x94 CullingMethod               ( ModelEnumType CameraCullingMethod CameraCullingMethod CameraCullingMethod Int32 )
            value.CullingRenderers                          = GetObjectList<Renderer>(new IntPtr(p + 0x098), ReversePrism.DataModels.Renderer.FromPointer); // 0x98 CullingRenderers            ( ModelClassListType List`1<Renderer> List`1<Renderer> List<Renderer> Pointer )
            value.Anchor                                    = GetObject<Transform>(new IntPtr(p + 0x0A0), ReversePrism.DataModels.Transform.FromPointer); // 0xA0 Anchor                      ( ModelClassType Transform Transform Transform Pointer )
            value.AnchorInertia                             = GetSingle(new IntPtr(p + 0x0A8)); // 0xA8 AnchorInertia               ( ModelPrimitiveType float float float Single )
