...
namespace ReversePrism.DataModels
{
    ...
    // 010 Parent                                   ModelClassType WhenAll_ WhenAll_ WhenAll_ Pointer
    ...
    public partial class WhenAllCollectionObserver : DataModel
    {
        ...
        public static WhenAllCollectionObserver? FromPointer(IntPtr p0)
        {
            ...
            value.Parent                                    = GetObject<WhenAll_>(new IntPtr(p + 0x010), ReversePrism.DataModels.WhenAll_.FromPointer); // 0x10 Parent                      ( ModelClassType WhenAll_ WhenAll_ WhenAll_ Pointer )
