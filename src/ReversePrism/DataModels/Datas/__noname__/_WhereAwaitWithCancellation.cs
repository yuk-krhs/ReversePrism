...
namespace ReversePrism.DataModels
{
    ...
    public partial class _WhereAwaitWithCancellation : DataModel
    {

        public static _WhereAwaitWithCancellation? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new _WhereAwaitWithCancellation() { Pointer= p0 };
