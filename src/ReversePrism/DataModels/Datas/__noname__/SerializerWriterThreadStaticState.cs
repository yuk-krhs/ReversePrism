...
namespace ReversePrism.DataModels
{
    ...
    public partial class SerializerWriterThreadStaticState
    {
        ...
        public static SerializerWriterThreadStaticState? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SerializerWriterThreadStaticState();

            value.BufferWriter                              = GetObject<ReusableLinkedArrayBufferWriter>(new IntPtr(p + 0x010), ReversePrism.DataModels.ReusableLinkedArrayBufferWriter.FromPointer); // 0270DAF31C08 0x10 BufferWriter                ( 00018667A670 ModelClassType ReusableLinkedArrayBufferWriter ReusableLinkedArrayBufferWriter ReusableLinkedArrayBufferWriter Pointer )
            value.OptionalState                             = GetObject<MemoryPackWriterOptionalState>(new IntPtr(p + 0x018), ReversePrism.DataModels.MemoryPackWriterOptionalState.FromPointer); // 0270DAF31C28 0x18 OptionalState               ( 0001865FA020 ModelClassType MemoryPackWriterOptionalState MemoryPackWriterOptionalState MemoryPackWriterOptionalState Pointer )
