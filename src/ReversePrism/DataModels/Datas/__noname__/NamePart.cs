...
namespace ReversePrism.DataModels
{
    ...
    // 020 _NamePart                                ModelPrimitiveType string string string String
    // 000 IsExtensionFieldNumber                   int IL2CPP_TYPE_I4
    // 010 IsExtensionDefaultValue                  ModelPrimitiveType bool bool bool Bool
    // 028 IsExtension                              ModelPrimitiveType bool bool bool Bool
    public partial class NamePart : DataModel
    {
        ...
        public static NamePart? FromPointer(IntPtr p0)
        {
            ...
            value._NamePart                                 = GetString(new IntPtr(p + 0x020)); // 0x20 _NamePart                   ( ModelPrimitiveType string string string String )
            value.IsExtensionDefaultValue                   = GetBool(new IntPtr(p + 0x010)); // 0x10 IsExtensionDefaultValue     ( ModelPrimitiveType bool bool bool Bool )
            value.IsExtension                               = GetBool(new IntPtr(p + 0x028)); // 0x28 IsExtension                 ( ModelPrimitiveType bool bool bool Bool )
