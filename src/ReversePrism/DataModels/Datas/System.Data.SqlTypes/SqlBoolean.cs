...
namespace ReversePrism.DataModels
{
    ...
    public partial class SqlBoolean
    {
        ...
        public static SqlBoolean? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SqlBoolean();

            value.M_value                                   = GetSByte(new IntPtr(p + 0x010)); // 0270D897FD70 0x10 M_value                     ( 00018659CA20 ModelPrimitiveType sbyte sbyte sbyte SByte )
