...
namespace ReversePrism.DataModels
{
    ...
    public partial class ByRefNewInstruction : DataModel
    {
        ...
        public static ByRefNewInstruction? FromPointer(IntPtr p0)
        {
            ...
            value.ByrefArgs                                 = GetObjectList<ByRefUpdater>(new IntPtr(p + 0x020), ReversePrism.DataModels.ByRefUpdater.FromPointer); // 02466A07E1E8 0x20 ByrefArgs                   ( 000185B72490 ModelClassListType ByRefUpdater[] ByRefUpdater[] List<ByRefUpdater> Pointer )
