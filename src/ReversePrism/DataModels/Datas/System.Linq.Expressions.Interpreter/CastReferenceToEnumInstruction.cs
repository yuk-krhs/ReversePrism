...
namespace ReversePrism.DataModels
{
    ...
    public partial class CastReferenceToEnumInstruction : DataModel
    {
        ...
        public static CastReferenceToEnumInstruction? FromPointer(IntPtr p0)
        {
            ...
            value.T                                         = GetObject<Type>(new IntPtr(p + 0x010), ReversePrism.DataModels.Type.FromPointer); // 02466A0A6330 0x10 T                           ( 0001866936B0 ModelClassType Type Type Type Pointer )
