...
namespace ReversePrism.DataModels
{
    ...
    // 018 S_Single                                 ModelClassType Instruction Instruction Instruction Pointer
    // 020 S_Double                                 ModelClassType Instruction Instruction Instruction Pointer
    public partial class NegateInstruction : DataModel
    {
        ...
        public static NegateInstruction? FromPointer(IntPtr p0)
        {
            ...
            value.S_Single                                  = GetObject<Instruction>(new IntPtr(p + 0x018), ReversePrism.DataModels.Instruction.FromPointer); // 0x18 S_Single                    ( ModelClassType Instruction Instruction Instruction Pointer )
            value.S_Double                                  = GetObject<Instruction>(new IntPtr(p + 0x020), ReversePrism.DataModels.Instruction.FromPointer); // 0x20 S_Double                    ( ModelClassType Instruction Instruction Instruction Pointer )
