...
namespace ReversePrism.DataModels
{
    ...
    public partial class LocalVariables
    {
        ...
        public static LocalVariables? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new LocalVariables();

            value.LocalCount                                = GetInt32(new IntPtr(p + 0x020)); // 0270D9FDCEA8 0x20 LocalCount                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.MaxLocalCount                             = GetInt32(new IntPtr(p + 0x024)); // 0270D9FDCEC8 0x24 MaxLocalCount               ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
