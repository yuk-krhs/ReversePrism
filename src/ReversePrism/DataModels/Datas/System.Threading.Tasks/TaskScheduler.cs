...
namespace ReversePrism.DataModels
{
    ...
    public partial class TaskScheduler : DataModel
    {
        ...
        public static TaskScheduler? FromPointer(IntPtr p0)
        {
            ...
            value.S_taskSchedulerIdCounter                  = GetInt32(new IntPtr(p + 0x010)); // 0245A3497FD8 0x10 S_taskSchedulerIdCounter    ( 0001865F3B80 ModelPrimitiveType int int int Int32 )
            value.M_taskSchedulerId                         = GetInt32(new IntPtr(p + 0x010)); // 0245A3497FF8 0x10 M_taskSchedulerId           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.UnobservedTaskExceptionLockObject         = GetObject<Lock>(new IntPtr(p + 0x020), ReversePrism.DataModels.Lock.FromPointer); // 0245A3498038 0x20 UnobservedTaskExceptionLockObject ( 0001865A9420 ModelClassType Lock Lock Lock Pointer )
