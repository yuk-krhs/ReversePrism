...
namespace ReversePrism.DataModels
{
    ...
    // 070 M_Field                                  ModelClassType ValueTuple ValueTuple ValueTuple Pointer
    // 078 ValueElements                            ModelClassListType Text[] Text[] List<Text> Pointer
    ...
    public partial class DebugUIHandlerValueTuple : DataModel
    {
        ...
        public static DebugUIHandlerValueTuple? FromPointer(IntPtr p0)
        {
            ...
            value.M_Field                                   = GetObject<ValueTuple>(new IntPtr(p + 0x070), ReversePrism.DataModels.ValueTuple.FromPointer); // 0x70 M_Field                     ( ModelClassType ValueTuple ValueTuple ValueTuple Pointer )
            value.ValueElements                             = GetObjectList<Text>(new IntPtr(p + 0x078), ReversePrism.DataModels.Text.FromPointer); // 0x78 ValueElements               ( ModelClassListType Text[] Text[] List<Text> Pointer )
