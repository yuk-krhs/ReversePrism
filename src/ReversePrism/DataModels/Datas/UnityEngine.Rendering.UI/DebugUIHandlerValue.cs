...
namespace ReversePrism.DataModels
{
    ...
    // 070 M_Field                                  ModelClassType Value Value Value Pointer
    // 078 M_Timer                                  ModelPrimitiveType float float float Single
    ...
    public partial class DebugUIHandlerValue : DataModel
    {
        ...
        public static DebugUIHandlerValue? FromPointer(IntPtr p0)
        {
            ...
            value.M_Field                                   = GetObject<Value>(new IntPtr(p + 0x070), ReversePrism.DataModels.Value.FromPointer); // 0x70 M_Field                     ( ModelClassType Value Value Value Pointer )
            value.M_Timer                                   = GetSingle(new IntPtr(p + 0x078)); // 0x78 M_Timer                     ( ModelPrimitiveType float float float Single )
