...
namespace ReversePrism.DataModels
{
    ...
    // 088 HistoryValues                            ModelClassListType Text[] Text[] List<Text> Pointer
    ...
    public partial class DebugUIHandlerEnumHistory : DataModel
    {
        ...
        public static DebugUIHandlerEnumHistory? FromPointer(IntPtr p0)
        {
            ...
            value.HistoryValues                             = GetObjectList<Text>(new IntPtr(p + 0x088), ReversePrism.DataModels.Text.FromPointer); // 0x88 HistoryValues               ( ModelClassListType Text[] Text[] List<Text> Pointer )
