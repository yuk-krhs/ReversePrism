...
namespace ReversePrism.DataModels
{
    ...
    // 088 FieldW                                   ModelClassType DebugUIHandlerIndirectFloatField DebugUIHandlerIndirectFloatField DebugUIHandlerIndirectFloatField Pointer
    // 090 M_Field                                  ModelClassType Vector4Field Vector4Field Vector4Field Pointer
    // 098 M_Container                              ModelClassType DebugUIHandlerContainer DebugUIHandlerContainer DebugUIHandlerContainer Pointer
    public partial class DebugUIHandlerVector4 : DataModel
    {
        ...
        public static DebugUIHandlerVector4? FromPointer(IntPtr p0)
        {
            ...
            value.FieldW                                    = GetObject<DebugUIHandlerIndirectFloatField>(new IntPtr(p + 0x088), ReversePrism.DataModels.DebugUIHandlerIndirectFloatField.FromPointer); // 0x88 FieldW                      ( ModelClassType DebugUIHandlerIndirectFloatField DebugUIHandlerIndirectFloatField DebugUIHandlerIndirectFloatField Pointer )
            value.M_Field                                   = GetObject<Vector4Field>(new IntPtr(p + 0x090), ReversePrism.DataModels.Vector4Field.FromPointer); // 0x90 M_Field                     ( ModelClassType Vector4Field Vector4Field Vector4Field Pointer )
            value.M_Container                               = GetObject<DebugUIHandlerContainer>(new IntPtr(p + 0x098), ReversePrism.DataModels.DebugUIHandlerContainer.FromPointer); // 0x98 M_Container                 ( ModelClassType DebugUIHandlerContainer DebugUIHandlerContainer DebugUIHandlerContainer Pointer )
