...
namespace ReversePrism.DataModels
{
    ...
    // 018 BaseUrl                                  ModelPrimitiveType string string string String
    ...
    public partial class PrivacyOptionCommunicator : DataModel
    {
        ...
        public static PrivacyOptionCommunicator? FromPointer(IntPtr p0)
        {
            ...
            value.BaseUrl                                   = GetString(new IntPtr(p + 0x018)); // 0x18 BaseUrl                     ( ModelPrimitiveType string string string String )
