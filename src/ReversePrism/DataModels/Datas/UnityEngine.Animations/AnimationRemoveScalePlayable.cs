...
namespace ReversePrism.DataModels
{
    ...
    public partial class AnimationRemoveScalePlayable
    {
        ...
        public static AnimationRemoveScalePlayable? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new AnimationRemoveScalePlayable();

            value.M_Handle                                  = (PlayableHandle)GetInt32(new IntPtr(p + 0x010)); // 027002243EC0 0x10 M_Handle                    ( 000186640190 ModelEnumType PlayableHandle PlayableHandle PlayableHandle Int32 )
