...
namespace ReversePrism.DataModels
{
    ...
    public partial class EnumValue
    {
        ...
        public static EnumValue? FromPointer(IntPtr p0)
        {
            ...
            value.Name                                      = GetString(new IntPtr(p + 0x018)); // 0270DA4BE938 0x18 Name                        ( 000186671910 ModelPrimitiveType string string string String )
            value.Number                                    = GetInt32(new IntPtr(p + 0x020)); // 0270DA4BE978 0x20 Number                      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Options                                   = GetObjectList<Option>(new IntPtr(p + 0x028), ReversePrism.DataModels.Option.FromPointer); // 0270DA4BE9D8 0x28 Options                     ( 000185CE83A8 ModelClassListType RepeatedField`1<Option> RepeatedField`1<Option> List<Option> Pointer )
