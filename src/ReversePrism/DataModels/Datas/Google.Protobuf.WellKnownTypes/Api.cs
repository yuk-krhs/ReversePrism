...
namespace ReversePrism.DataModels
{
    ...
    public partial class Api : DataModel
    {
        ...
        public static Api? FromPointer(IntPtr p0)
        {
            ...
            value.Name                                      = GetString(new IntPtr(p + 0x018)); // 02466A4AD618 0x18 Name                        ( 000186671910 ModelPrimitiveType string string string String )
            value.Methods                                   = GetObjectList<Method>(new IntPtr(p + 0x020), ReversePrism.DataModels.Method.FromPointer); // 02466A4AD678 0x20 Methods                     ( 000185CE6098 ModelClassListType RepeatedField`1<Method> RepeatedField`1<Method> List<Method> Pointer )
            value.Options                                   = GetObjectList<Option>(new IntPtr(p + 0x028), ReversePrism.DataModels.Option.FromPointer); // 02466A4AD6D8 0x28 Options                     ( 000185CE83A8 ModelClassListType RepeatedField`1<Option> RepeatedField`1<Option> List<Option> Pointer )
            value.Version                                   = GetString(new IntPtr(p + 0x030)); // 02466A4AD718 0x30 Version                     ( 000186671910 ModelPrimitiveType string string string String )
            value.SourceContext                             = GetObject<SourceContext>(new IntPtr(p + 0x038), ReversePrism.DataModels.SourceContext.FromPointer); // 02466A4AD758 0x38 SourceContext               ( 0001865399F0 ModelClassType SourceContext SourceContext SourceContext Pointer )
            value.Mixins                                    = GetObjectList<Mixin>(new IntPtr(p + 0x040), ReversePrism.DataModels.Mixin.FromPointer); // 02466A4AD7B8 0x40 Mixins                      ( 000185CE7348 ModelClassListType RepeatedField`1<Mixin> RepeatedField`1<Mixin> List<Mixin> Pointer )
            value.Syntax                                    = (Syntax)GetInt32(new IntPtr(p + 0x048)); // 02466A4AD7F8 0x48 Syntax                      ( 000186604390 ModelEnumType Syntax Syntax Syntax Int32 )
