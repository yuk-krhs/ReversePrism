...
namespace ReversePrism.DataModels
{
    ...
    public partial class LiveCameraModeSetting : DataModel
    {
        ...
        public static LiveCameraModeSetting? FromPointer(IntPtr p0)
        {
            ...
            value.MusicId                                   = GetInt32(new IntPtr(p + 0x010)); // 0245A3A8F8C8 0x10 MusicId                     ( 0001865F36C0 ModelPrimitiveType int int int Int32 )
            value.CameraMode                                = (LiveCameraMode)GetInt32(new IntPtr(p + 0x014)); // 0245A3A8F8E8 0x14 CameraMode                  ( 000186542C90 ModelEnumType LiveCameraMode LiveCameraMode LiveCameraMode Int32 )
            value.FocusPositionIndex                        = GetInt32(new IntPtr(p + 0x018)); // 0245A3A8F908 0x18 FocusPositionIndex          ( 0001865F36C0 ModelPrimitiveType int int int Int32 )
