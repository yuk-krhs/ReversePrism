...
namespace ReversePrism.DataModels
{
    ...
    public partial class LiveResultJudgeCountViewModel : DataModel
    {
        ...
        public static LiveResultJudgeCountViewModel? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new LiveResultJudgeCountViewModel() { Pointer= p0 };
