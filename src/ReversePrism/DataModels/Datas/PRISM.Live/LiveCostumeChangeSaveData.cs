...
namespace ReversePrism.DataModels
{
    ...
    // 020 IsShowUnlockedCostumeOnly                ModelPrimitiveType bool bool bool Bool
    public partial class LiveCostumeChangeSaveData : DataModel
    {
        ...
        public static LiveCostumeChangeSaveData? FromPointer(IntPtr p0)
        {
            ...
            value.IsShowUnlockedCostumeOnly                 = GetBool(new IntPtr(p + 0x020)); // 0x20 IsShowUnlockedCostumeOnly   ( ModelPrimitiveType bool bool bool Bool )
