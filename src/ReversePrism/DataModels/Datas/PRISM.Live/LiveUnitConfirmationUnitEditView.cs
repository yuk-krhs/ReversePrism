...
namespace ReversePrism.DataModels
{
    ...
    public partial class LiveUnitConfirmationUnitEditView : DataModel
    {
        ...
        public static LiveUnitConfirmationUnitEditView? FromPointer(IntPtr p0)
        {
            ...
            value.UnitEditCarousel                          = GetObject<LiveUnitEditCarousel>(new IntPtr(p + 0x068), ReversePrism.DataModels.LiveUnitEditCarousel.FromPointer); // 024665317670 0x68 UnitEditCarousel            ( 00018658DD80 ModelClassType LiveUnitEditCarousel LiveUnitEditCarousel LiveUnitEditCarousel Pointer )
            value.SwitchStatusInfoDisplayButton             = GetObject<ClickNumberCountedButton>(new IntPtr(p + 0x070), ReversePrism.DataModels.ClickNumberCountedButton.FromPointer); // 024665317690 0x70 SwitchStatusInfoDisplayButton ( 0001865B3940 ModelClassType ClickNumberCountedButton ClickNumberCountedButton ClickNumberCountedButton Pointer )
            value.TotalParameterText                        = GetObject<UITextMeshProUGUI>(new IntPtr(p + 0x078), ReversePrism.DataModels.UITextMeshProUGUI.FromPointer); // 0246653176B0 0x78 TotalParameterText          ( 0001866F90E0 ModelClassType UITextMeshProUGUI UITextMeshProUGUI UITextMeshProUGUI Pointer )
            value.ParameterDetailButton                     = GetObject<ButtonBase>(new IntPtr(p + 0x080), ReversePrism.DataModels.ButtonBase.FromPointer); // 0246653176D0 0x80 ParameterDetailButton       ( 000186515660 ModelClassType ButtonBase ButtonBase ButtonBase Pointer )
            value.TotalSupportBonus                         = GetObject<UITextMeshProUGUI>(new IntPtr(p + 0x088), ReversePrism.DataModels.UITextMeshProUGUI.FromPointer); // 0246653176F0 0x88 TotalSupportBonus           ( 0001866F90E0 ModelClassType UITextMeshProUGUI UITextMeshProUGUI UITextMeshProUGUI Pointer )
