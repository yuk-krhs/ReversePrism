...
namespace ReversePrism.DataModels
{
    ...
    public partial class AutoLiveStatus : DataModel
    {
        ...
        public static AutoLiveStatus? FromPointer(IntPtr p0)
        {
            ...
            value.SaveData                                  = GetObject<LiveUnitConfirmationSaveData>(new IntPtr(p + 0x010), ReversePrism.DataModels.LiveUnitConfirmationSaveData.FromPointer); // 0246652E0CC0 0x10 SaveData                    ( 00018658A200 ModelClassType LiveUnitConfirmationSaveData LiveUnitConfirmationSaveData LiveUnitConfirmationSaveData Pointer )
            value.LiveBonusUsageSettingStatus               = GetObject<NormalLiveLiveBonusUsageSettingStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.NormalLiveLiveBonusUsageSettingStatus.FromPointer); // 0246652E0CE0 0x18 LiveBonusUsageSettingStatus ( 0001866A88D0 ModelClassType NormalLiveLiveBonusUsageSettingStatus NormalLiveLiveBonusUsageSettingStatus NormalLiveLiveBonusUsageSettingStatus Pointer )
            value.RemainingCount                            = GetInt32(new IntPtr(p + 0x020)); // 0246652E0D00 0x20 RemainingCount              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
