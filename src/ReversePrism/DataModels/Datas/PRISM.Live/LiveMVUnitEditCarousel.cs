...
namespace ReversePrism.DataModels
{
    ...
    public partial class LiveMVUnitEditCarousel : DataModel
    {
        public GameObject?                              SummerCellPrefab                        { get; set; }

        public static LiveMVUnitEditCarousel? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new LiveMVUnitEditCarousel() { Pointer= p0 };
