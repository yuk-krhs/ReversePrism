...
namespace ReversePrism.DataModels
{
    ...
    public partial class DataViewManager
    {
        ...
        public static DataViewManager? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new DataViewManager();

            value.DataViewSettingsCollection                = GetObject<DataViewSettingCollection>(new IntPtr(p + 0x020), ReversePrism.DataModels.DataViewSettingCollection.FromPointer); // 0270D88DB570 0x20 DataViewSettingsCollection  ( 000186687770 ModelClassType DataViewSettingCollection DataViewSettingCollection DataViewSettingCollection Pointer )
            value.NViews                                    = GetInt32(new IntPtr(p + 0x028)); // 0270D88DB590 0x28 NViews                      ( 0001865F2F90 ModelPrimitiveType int int int Int32 )
