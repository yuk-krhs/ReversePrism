...
namespace ReversePrism.DataModels
{
    ...
    // 010 StartTimestamp                           ModelPrimitiveType long long long Int64
    public partial class ValueStopwatch : DataModel
    {
        ...
        public static ValueStopwatch? FromPointer(IntPtr p0)
        {
            ...
            value.StartTimestamp                            = GetInt64(new IntPtr(p + 0x010)); // 0x10 StartTimestamp              ( ModelPrimitiveType long long long Int64 )
