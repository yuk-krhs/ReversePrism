...
namespace ReversePrism.DataModels
{
    ...
    public partial class SingleAssignmentDisposable : DataModel
    {
        ...
        public static SingleAssignmentDisposable? FromPointer(IntPtr p0)
        {
            ...
            value.Current                                   = GetObject<IDisposable>(new IntPtr(p + 0x018), ReversePrism.DataModels.IDisposable.FromPointer); // 024668FE3CE8 0x18 Current                     ( 0001867532E0 ModelClassType IDisposable IDisposable IDisposable Pointer )
            value.Disposed                                  = GetBool(new IntPtr(p + 0x020)); // 024668FE3D08 0x20 Disposed                    ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
