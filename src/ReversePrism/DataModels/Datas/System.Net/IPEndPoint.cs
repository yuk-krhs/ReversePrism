...
namespace ReversePrism.DataModels
{
    ...
    // 010 Address                                  ModelClassType IPAddress IPAddress IPAddress Pointer
    ...
    public partial class IPEndPoint : DataModel
    {
        ...
        public static IPEndPoint? FromPointer(IntPtr p0)
        {
            ...
            value.Address                                   = GetObject<IPAddress>(new IntPtr(p + 0x010), ReversePrism.DataModels.IPAddress.FromPointer); // 0x10 Address                     ( ModelClassType IPAddress IPAddress IPAddress Pointer )
