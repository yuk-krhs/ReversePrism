...
namespace ReversePrism.DataModels
{
    ...
    public partial class DiskCache : DataModel
    {
        ...
        public static DiskCache? FromPointer(IntPtr p0)
        {
            ...
            value.K_CacheFilePath                           = GetString(new IntPtr(p + 0x010)); // 0245A6682F18 0x10 K_CacheFilePath             ( 000186672F10 ModelPrimitiveType string string string String )
            value.K_SystemCalls                             = GetObject<IFileSystemCalls>(new IntPtr(p + 0x018), ReversePrism.DataModels.IFileSystemCalls.FromPointer); // 0245A6682F38 0x18 K_SystemCalls               ( 00018650B3B0 ModelClassType IFileSystemCalls IFileSystemCalls IFileSystemCalls Pointer )
            value.K_CacheFileMaximumSize                    = GetInt64(new IntPtr(p + 0x020)); // 0245A6682F58 0x20 K_CacheFileMaximumSize      ( 0001865F8300 ModelPrimitiveType long long long Int64 )
