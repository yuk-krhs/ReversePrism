...
namespace ReversePrism.DataModels
{
    ...
    // 030 BucketCapacityMask                       ModelPrimitiveType int int int Int32
    public partial class UnsafeParallelHashMapBucketData : DataModel
    {
        ...
        public static UnsafeParallelHashMapBucketData? FromPointer(IntPtr p0)
        {
            ...
            value.BucketCapacityMask                        = GetInt32(new IntPtr(p + 0x030)); // 0x30 BucketCapacityMask          ( ModelPrimitiveType int int int Int32 )
