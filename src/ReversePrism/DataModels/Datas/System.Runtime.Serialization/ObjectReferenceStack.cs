...
namespace ReversePrism.DataModels
{
    ...
    public partial class ObjectReferenceStack : DataModel
    {
        ...
        public static ObjectReferenceStack? FromPointer(IntPtr p0)
        {
            ...
            value.Count                                     = GetInt32(new IntPtr(p + 0x010)); // 0245A4DCF120 0x10 Count                       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.IsReferenceArray                          = GetBoolList(new IntPtr(p + 0x020)); // 0245A4DCF160 0x20 IsReferenceArray            ( 000185B78CA0 ModelPrimitiveListType bool[] bool[] List<bool> Pointer )
