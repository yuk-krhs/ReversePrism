...
namespace ReversePrism.DataModels
{
    ...
    // 018 DictionaryWriter                         ModelClassType XmlDictionaryWriter XmlDictionaryWriter XmlDictionaryWriter Pointer
    // 020 Depth                                    ModelPrimitiveType int int int Int32
    // 024 Prefixes                                 ModelPrimitiveType int int int Int32
    ...
    public partial class XmlWriterDelegator : DataModel
    {
        ...
        public static XmlWriterDelegator? FromPointer(IntPtr p0)
        {
            ...
            value.DictionaryWriter                          = GetObject<XmlDictionaryWriter>(new IntPtr(p + 0x018), ReversePrism.DataModels.XmlDictionaryWriter.FromPointer); // 0x18 DictionaryWriter            ( ModelClassType XmlDictionaryWriter XmlDictionaryWriter XmlDictionaryWriter Pointer )
            value.Depth                                     = GetInt32(new IntPtr(p + 0x020)); // 0x20 Depth                       ( ModelPrimitiveType int int int Int32 )
            value.Prefixes                                  = GetInt32(new IntPtr(p + 0x024)); // 0x24 Prefixes                    ( ModelPrimitiveType int int int Int32 )
