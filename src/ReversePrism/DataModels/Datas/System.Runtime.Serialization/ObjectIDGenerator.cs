...
namespace ReversePrism.DataModels
{
    ...
    public partial class ObjectIDGenerator
    {
        ...
        public static ObjectIDGenerator? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ObjectIDGenerator();

            value.M_currentCount                            = GetInt32(new IntPtr(p + 0x010)); // 0270D6C1D0D0 0x10 M_currentCount              ( 0001865F2F90 ModelPrimitiveType int int int Int32 )
            value.M_currentSize                             = GetInt32(new IntPtr(p + 0x014)); // 0270D6C1D0F0 0x14 M_currentSize               ( 0001865F2F90 ModelPrimitiveType int int int Int32 )
            value.M_ids                                     = GetInt64List(new IntPtr(p + 0x018)); // 0270D6C1D110 0x18 M_ids                       ( 000185B7E3E0 ModelPrimitiveListType long[] long[] List<long> Pointer )
