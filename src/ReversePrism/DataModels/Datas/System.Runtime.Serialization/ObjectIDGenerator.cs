...
namespace ReversePrism.DataModels
{
    ...
    // 014 M_currentSize                            ModelPrimitiveType int int int Int32
    // 018 M_ids                                    ModelPrimitiveListType long[] long[] List<long> Pointer
    ...
    public partial class ObjectIDGenerator : DataModel
    {
        ...
        public static ObjectIDGenerator? FromPointer(IntPtr p0)
        {
            ...
            value.M_currentSize                             = GetInt32(new IntPtr(p + 0x014)); // 0x14 M_currentSize               ( ModelPrimitiveType int int int Int32 )
            value.M_ids                                     = GetInt64List(new IntPtr(p + 0x018)); // 0x18 M_ids                       ( ModelPrimitiveListType long[] long[] List<long> Pointer )
