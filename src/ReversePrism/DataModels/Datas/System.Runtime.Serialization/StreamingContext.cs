...
namespace ReversePrism.DataModels
{
    ...
    public partial class StreamingContext
    {
        ...
        public static StreamingContext? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new StreamingContext();

            value.M_state                                   = (StreamingContextStates)GetInt32(new IntPtr(p + 0x018)); // 027003B65888 0x18 M_state                     ( 0001865B9B70 ModelEnumType StreamingContextStates StreamingContextStates StreamingContextStates Int32 )
