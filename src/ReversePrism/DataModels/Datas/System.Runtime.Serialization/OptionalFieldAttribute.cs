...
namespace ReversePrism.DataModels
{
    ...
    // 010 VersionAdded                             ModelPrimitiveType int int int Int32
    public partial class OptionalFieldAttribute : DataModel
    {
        ...
        public static OptionalFieldAttribute? FromPointer(IntPtr p0)
        {
            ...
            value.VersionAdded                              = GetInt32(new IntPtr(p + 0x010)); // 0x10 VersionAdded                ( ModelPrimitiveType int int int Int32 )
