...
namespace ReversePrism.DataModels
{
    ...
    public partial class UniTaskSynchronizationContext : DataModel
    {
        ...
        public static UniTaskSynchronizationContext? FromPointer(IntPtr p0)
        {
            ...
            value.ActionList                                = GetEnumList<Callback>(new IntPtr(p + 0x010)); // 0245A3BF0D30 0x10 ActionList                  ( 000185CC5138 ModelEnumListType Callback[] Callback[] List<Callback> Pointer )
            value.WaitingListCount                          = GetInt32(new IntPtr(p + 0x018)); // 0245A3BF0D50 0x18 WaitingListCount            ( 0001865F38E0 ModelPrimitiveType int int int Int32 )
            value.WaitingList                               = GetEnumList<Callback>(new IntPtr(p + 0x020)); // 0245A3BF0D70 0x20 WaitingList                 ( 000185CC5138 ModelEnumListType Callback[] Callback[] List<Callback> Pointer )
            value.OpCount                                   = GetInt32(new IntPtr(p + 0x028)); // 0245A3BF0D90 0x28 OpCount                     ( 0001865F38E0 ModelPrimitiveType int int int Int32 )
