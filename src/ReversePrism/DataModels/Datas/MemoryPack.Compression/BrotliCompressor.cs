...
namespace ReversePrism.DataModels
{
    ...
    public partial class BrotliCompressor : DataModel
    {
        ...
        public static BrotliCompressor? FromPointer(IntPtr p0)
        {
            ...
            value.BufferWriter                              = GetObject<ReusableLinkedArrayBufferWriter>(new IntPtr(p + 0x010), ReversePrism.DataModels.ReusableLinkedArrayBufferWriter.FromPointer); // 02466B0581B0 0x10 BufferWriter                ( 00018667A3E0 ModelClassType ReusableLinkedArrayBufferWriter ReusableLinkedArrayBufferWriter ReusableLinkedArrayBufferWriter Pointer )
            value.Quality                                   = GetInt32(new IntPtr(p + 0x018)); // 02466B0581D0 0x18 Quality                     ( 0001865F4260 ModelPrimitiveType int int int Int32 )
            value.Window                                    = GetInt32(new IntPtr(p + 0x01C)); // 02466B0581F0 0x1C Window                      ( 0001865F4260 ModelPrimitiveType int int int Int32 )
