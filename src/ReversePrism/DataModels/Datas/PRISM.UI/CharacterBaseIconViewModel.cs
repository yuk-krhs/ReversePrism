...
namespace ReversePrism.DataModels
{
    ...
    public partial class CharacterBaseIconViewModel : DataModel
    {
        ...
        public static CharacterBaseIconViewModel? FromPointer(IntPtr p0)
        {
            ...
            value.CharaId                                   = GetInt32(new IntPtr(p + 0x010)); // 0245A5D50680 0x10 CharaId                     ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.ColorCode                                 = GetString(new IntPtr(p + 0x018)); // 0245A5D506A0 0x18 ColorCode                   ( 000186671910 ModelPrimitiveType string string string String )
            value.IsNamePlateActive                         = GetBool(new IntPtr(p + 0x020)); // 0245A5D506C0 0x20 IsNamePlateActive           ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
