...
namespace ReversePrism.DataModels
{
    ...
    public partial class GlobalMenuView
    {
        ...
        public static GlobalMenuView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GlobalMenuView();

            value.LeftMenu                                  = GetObject<RectTransform>(new IntPtr(p + 0x020), ReversePrism.DataModels.RectTransform.FromPointer); // 0270DBEB1088 0x20 LeftMenu                    ( 000186630450 ModelClassType RectTransform RectTransform RectTransform Pointer )
            value.MenuPanelView                             = GetObject<GlobalMenuPanelView>(new IntPtr(p + 0x028), ReversePrism.DataModels.GlobalMenuPanelView.FromPointer); // 0270DBEB10A8 0x28 MenuPanelView               ( 00018667CEC0 ModelClassType GlobalMenuPanelView GlobalMenuPanelView GlobalMenuPanelView Pointer )
            value.FooterPanelView                           = GetObject<GlobalMenuFooterPanelView>(new IntPtr(p + 0x030), ReversePrism.DataModels.GlobalMenuFooterPanelView.FromPointer); // 0270DBEB10C8 0x30 FooterPanelView             ( 00018667C9E0 ModelClassType GlobalMenuFooterPanelView GlobalMenuFooterPanelView GlobalMenuFooterPanelView Pointer )
            value.CloseButton                               = GetObject<ButtonBase>(new IntPtr(p + 0x038), ReversePrism.DataModels.ButtonBase.FromPointer); // 0270DBEB10E8 0x38 CloseButton                 ( 000186515660 ModelClassType ButtonBase ButtonBase ButtonBase Pointer )
            value.CanvasGroup                               = GetObject<CanvasGroup>(new IntPtr(p + 0x040), ReversePrism.DataModels.CanvasGroup.FromPointer); // 0270DBEB1108 0x40 CanvasGroup                 ( 000186540EE0 ModelClassType CanvasGroup CanvasGroup CanvasGroup Pointer )
            value.TransferAccount                           = GetObject<TransferAccount>(new IntPtr(p + 0x098), ReversePrism.DataModels.TransferAccount.FromPointer); // 0270DBEB1268 0x98 TransferAccount             ( 0001866A2500 ModelClassType TransferAccount TransferAccount TransferAccount Pointer )
            value.EventListButtonView                       = GetObject<EventListButtonView>(new IntPtr(p + 0x0A0), ReversePrism.DataModels.EventListButtonView.FromPointer); // 0270DBEB1288 0xA0 EventListButtonView         ( 00018675C2C0 ModelClassType EventListButtonView EventListButtonView EventListButtonView Pointer )
            value.ViewModel                                 = GetObject<GlobalMenuViewModel>(new IntPtr(p + 0x0A8), ReversePrism.DataModels.GlobalMenuViewModel.FromPointer); // 0270DBEB12A8 0xA8 ViewModel                   ( 00018667E9E0 ModelClassType GlobalMenuViewModel GlobalMenuViewModel GlobalMenuViewModel Pointer )
            value.BackKeyDisposable                         = GetObject<IDisposable>(new IntPtr(p + 0x0B8), ReversePrism.DataModels.IDisposable.FromPointer); // 0270DBEB12E8 0xB8 BackKeyDisposable           ( 0001867532E0 ModelClassType IDisposable IDisposable IDisposable Pointer )
            value.ResourceLoader                            = GetObject<IResourceLoader>(new IntPtr(p + 0x0C0), ReversePrism.DataModels.IResourceLoader.FromPointer); // 0270DBEB1308 0xC0 ResourceLoader              ( 00018661A8D0 ModelClassType IResourceLoader IResourceLoader IResourceLoader Pointer )
