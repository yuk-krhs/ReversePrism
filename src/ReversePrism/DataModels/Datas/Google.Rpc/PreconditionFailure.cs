...
namespace ReversePrism.DataModels
{
    ...
    public partial class PreconditionFailure
    {
        ...
        public static PreconditionFailure? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new PreconditionFailure();

            value.Violations                                = GetObjectList<Violation>(new IntPtr(p + 0x018), ReversePrism.DataModels.Violation.FromPointer); // 0270DA6DFCA8 0x18 Violations                  ( 000185CF96C8 ModelClassListType RepeatedField`1<Violation> RepeatedField`1<Violation> List<Violation> Pointer )
