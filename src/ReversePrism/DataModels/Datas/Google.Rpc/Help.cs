...
namespace ReversePrism.DataModels
{
    ...
    public partial class Help
    {
        ...
        public static Help? FromPointer(IntPtr p0)
        {
            ...
            value.Links                                     = GetObjectList<Link>(new IntPtr(p + 0x018), ReversePrism.DataModels.Link.FromPointer); // 0270DA6FD280 0x18 Links                       ( 000185CF9008 ModelClassListType RepeatedField`1<Link> RepeatedField`1<Link> List<Link> Pointer )
