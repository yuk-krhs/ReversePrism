...
namespace ReversePrism.DataModels
{
    ...
    // 018 BuildSettingsKey                         ModelPrimitiveType string string string String
    public partial class AdaptivePerformanceConfigurationDataAttribute : DataModel
    {
        ...
        public static AdaptivePerformanceConfigurationDataAttribute? FromPointer(IntPtr p0)
        {
            ...
            value.BuildSettingsKey                          = GetString(new IntPtr(p + 0x018)); // 0x18 BuildSettingsKey            ( ModelPrimitiveType string string string String )
