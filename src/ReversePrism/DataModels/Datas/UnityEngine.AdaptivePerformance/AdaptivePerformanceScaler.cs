...
namespace ReversePrism.DataModels
{
    ...
    public partial class AdaptivePerformanceScaler : DataModel
    {
        ...
        public static AdaptivePerformanceScaler? FromPointer(IntPtr p0)
        {
            ...
            value.M_Indexer                                 = GetObject<AdaptivePerformanceIndexer>(new IntPtr(p + 0x018), ReversePrism.DataModels.AdaptivePerformanceIndexer.FromPointer); // 02466B6F2A38 0x18 M_Indexer                   ( 000186683E60 ModelClassType AdaptivePerformanceIndexer AdaptivePerformanceIndexer AdaptivePerformanceIndexer Pointer )
            value.CurrentLevel                              = GetInt32(new IntPtr(p + 0x020)); // 02466B6F2A58 0x20 CurrentLevel                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.GpuImpact                                 = GetInt32(new IntPtr(p + 0x024)); // 02466B6F2A78 0x24 GpuImpact                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.CpuImpact                                 = GetInt32(new IntPtr(p + 0x028)); // 02466B6F2A98 0x28 CpuImpact                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.M_OverrideLevel                           = GetInt32(new IntPtr(p + 0x02C)); // 02466B6F2AB8 0x2C M_OverrideLevel             ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.M_defaultSetting                          = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x030), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 02466B6F2AD8 0x30 M_defaultSetting            ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_Settings                                = GetObject<IAdaptivePerformanceSettings>(new IntPtr(p + 0x038), ReversePrism.DataModels.IAdaptivePerformanceSettings.FromPointer); // 02466B6F2AF8 0x38 M_Settings                  ( 0001865E10B0 ModelClassType IAdaptivePerformanceSettings IAdaptivePerformanceSettings IAdaptivePerformanceSettings Pointer )
