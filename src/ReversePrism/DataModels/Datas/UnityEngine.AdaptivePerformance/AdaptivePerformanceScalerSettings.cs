...
namespace ReversePrism.DataModels
{
    ...
    public partial class AdaptivePerformanceScalerSettings
    {
        ...
        public static AdaptivePerformanceScalerSettings? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new AdaptivePerformanceScalerSettings();

            value.M_AdaptiveFramerate                       = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x010), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6A30 0x10 M_AdaptiveFramerate         ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveResolution                      = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x018), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6A50 0x18 M_AdaptiveResolution        ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveBatching                        = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x020), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6A70 0x20 M_AdaptiveBatching          ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveLOD                             = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x028), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6A90 0x28 M_AdaptiveLOD               ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveLut                             = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x030), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6AB0 0x30 M_AdaptiveLut               ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveMSAA                            = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x038), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6AD0 0x38 M_AdaptiveMSAA              ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveShadowCascade                   = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x040), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6AF0 0x40 M_AdaptiveShadowCascade     ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveShadowDistance                  = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x048), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6B30 0x48 M_AdaptiveShadowDistance    ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveShadowmapResolution             = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x050), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6B50 0x50 M_AdaptiveShadowmapResolution ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveShadowQuality                   = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x058), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6B70 0x58 M_AdaptiveShadowQuality     ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveSorting                         = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x060), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6B90 0x60 M_AdaptiveSorting           ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveTransparency                    = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x068), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6BB0 0x68 M_AdaptiveTransparency      ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveViewDistance                    = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x070), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6BD0 0x70 M_AdaptiveViewDistance      ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptivePhysics                         = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x078), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6BF0 0x78 M_AdaptivePhysics           ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveDecals                          = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x080), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6C10 0x80 M_AdaptiveDecals            ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
            value.M_AdaptiveLayerCulling                    = GetObject<AdaptivePerformanceScalerSettingsBase>(new IntPtr(p + 0x088), ReversePrism.DataModels.AdaptivePerformanceScalerSettingsBase.FromPointer); // 0270032D6C30 0x88 M_AdaptiveLayerCulling      ( 000186687970 ModelClassType AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase AdaptivePerformanceScalerSettingsBase Pointer )
