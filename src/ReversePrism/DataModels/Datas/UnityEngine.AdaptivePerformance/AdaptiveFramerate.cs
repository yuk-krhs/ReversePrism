...
namespace ReversePrism.DataModels
{
    ...
    // 040 M_DefaultFPS                             ModelPrimitiveType int int int Int32
    public partial class AdaptiveFramerate : DataModel
    {
        ...
        public static AdaptiveFramerate? FromPointer(IntPtr p0)
        {
            ...
            value.M_DefaultFPS                              = GetInt32(new IntPtr(p + 0x040)); // 0x40 M_DefaultFPS                ( ModelPrimitiveType int int int Int32 )
