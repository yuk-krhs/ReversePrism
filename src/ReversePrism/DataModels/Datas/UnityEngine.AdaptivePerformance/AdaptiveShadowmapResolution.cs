...
namespace ReversePrism.DataModels
{
    ...
    // 040 M_DefaultShadowmapResolution             ModelPrimitiveType float float float Single
    public partial class AdaptiveShadowmapResolution : DataModel
    {
        ...
        public static AdaptiveShadowmapResolution? FromPointer(IntPtr p0)
        {
            ...
            value.M_DefaultShadowmapResolution              = GetSingle(new IntPtr(p + 0x040)); // 0x40 M_DefaultShadowmapResolution ( ModelPrimitiveType float float float Single )
