...
namespace ReversePrism.DataModels
{
    ...
    // 010 Entries                                  ModelClassListType XmlName[] XmlName[] List<XmlName> Pointer
    // 018 Count                                    ModelPrimitiveType int int int Int32
    // 01C Mask                                     ModelPrimitiveType int int int Int32
    // 020 OwnerDocument                            ModelClassType XmlDocument XmlDocument XmlDocument Pointer
    ...
    public partial class DomNameTable : DataModel
    {
        ...
        public static DomNameTable? FromPointer(IntPtr p0)
        {
            ...
            value.Entries                                   = GetObjectList<XmlName>(new IntPtr(p + 0x010), ReversePrism.DataModels.XmlName.FromPointer); // 0x10 Entries                     ( ModelClassListType XmlName[] XmlName[] List<XmlName> Pointer )
            ...
            value.OwnerDocument                             = GetObject<XmlDocument>(new IntPtr(p + 0x020), ReversePrism.DataModels.XmlDocument.FromPointer); // 0x20 OwnerDocument               ( ModelClassType XmlDocument XmlDocument XmlDocument Pointer )
