...
namespace ReversePrism.DataModels
{
    ...
    // 024 OwnsStream                               ModelPrimitiveType bool bool bool Bool
    ...
    // 030 HasPendingWrite                          ModelPrimitiveType int int int Int32
    ...
    // 010 OnGetFlushComplete                       ModelClassType AsyncEventArgsCallback AsyncEventArgsCallback AsyncEventArgsCallback Pointer
    public partial class XmlStreamNodeWriter : DataModel
    {
        ...
        public static XmlStreamNodeWriter? FromPointer(IntPtr p0)
        {
            ...
            value.OwnsStream                                = GetBool(new IntPtr(p + 0x024)); // 0x24 OwnsStream                  ( ModelPrimitiveType bool bool bool Bool )
            ...
            value.HasPendingWrite                           = GetInt32(new IntPtr(p + 0x030)); // 0x30 HasPendingWrite             ( ModelPrimitiveType int int int Int32 )
            value.OnGetFlushComplete                        = GetObject<AsyncEventArgsCallback>(new IntPtr(p + 0x010), ReversePrism.DataModels.AsyncEventArgsCallback.FromPointer); // 0x10 OnGetFlushComplete          ( ModelClassType AsyncEventArgsCallback AsyncEventArgsCallback AsyncEventArgsCallback Pointer )
