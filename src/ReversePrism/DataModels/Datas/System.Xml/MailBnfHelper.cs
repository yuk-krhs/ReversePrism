...
namespace ReversePrism.DataModels
{
    ...
    public partial class MailBnfHelper
    {
        ...
        public static MailBnfHelper? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new MailBnfHelper();

            value.S_digits                                  = GetBoolList(new IntPtr(p + 0x010)); // 0270D7C97948 0x10 S_digits                    ( 000185B78EC0 ModelPrimitiveListType bool[] bool[] List<bool> Pointer )
            value.S_boundary                                = GetBoolList(new IntPtr(p + 0x018)); // 0270D7C97968 0x18 S_boundary                  ( 000185B78EC0 ModelPrimitiveListType bool[] bool[] List<bool> Pointer )
