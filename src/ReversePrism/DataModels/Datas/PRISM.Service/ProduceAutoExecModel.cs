...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceAutoExecModel : DataModel
    {
        ...
        public static ProduceAutoExecModel? FromPointer(IntPtr p0)
        {
            ...
            value.Service                                   = GetObject<ProduceService>(new IntPtr(p + 0x010), ReversePrism.DataModels.ProduceService.FromPointer); // 0246664C6378 0x10 Service                     ( 00018657F920 ModelClassType ProduceService ProduceService ProduceService Pointer )
            value.SelectStrategyModel                       = GetObject<ProduceSelectStrategyAutoExecModel>(new IntPtr(p + 0x030), ReversePrism.DataModels.ProduceSelectStrategyAutoExecModel.FromPointer); // 0246664C63F8 0x30 SelectStrategyModel         ( 00018657F1A0 ModelClassType ProduceSelectStrategyAutoExecModel ProduceSelectStrategyAutoExecModel ProduceSelectStrategyAutoExecModel Pointer )
            value.SelectScheduleModel                       = GetObject<ProduceSelectScheduleAutoExecModel>(new IntPtr(p + 0x038), ReversePrism.DataModels.ProduceSelectScheduleAutoExecModel.FromPointer); // 0246664C6418 0x38 SelectScheduleModel         ( 00018657EAB0 ModelClassType ProduceSelectScheduleAutoExecModel ProduceSelectScheduleAutoExecModel ProduceSelectScheduleAutoExecModel Pointer )
            value.InGameModel                               = GetObject<ProduceInGameAutoExecModel>(new IntPtr(p + 0x040), ReversePrism.DataModels.ProduceInGameAutoExecModel.FromPointer); // 0246664C6438 0x40 InGameModel                 ( 000186556690 ModelClassType ProduceInGameAutoExecModel ProduceInGameAutoExecModel ProduceInGameAutoExecModel Pointer )
            value.ScenarioModel                             = GetObject<ProduceScenarioAutoExecModel>(new IntPtr(p + 0x048), ReversePrism.DataModels.ProduceScenarioAutoExecModel.FromPointer); // 0246664C6458 0x48 ScenarioModel               ( 00018657CDA0 ModelClassType ProduceScenarioAutoExecModel ProduceScenarioAutoExecModel ProduceScenarioAutoExecModel Pointer )
            value.ResumeModel                               = GetObject<ProduceResumeAutoExecModel>(new IntPtr(p + 0x050), ReversePrism.DataModels.ProduceResumeAutoExecModel.FromPointer); // 0246664C6478 0x50 ResumeModel                 ( 000186579890 ModelClassType ProduceResumeAutoExecModel ProduceResumeAutoExecModel ProduceResumeAutoExecModel Pointer )
