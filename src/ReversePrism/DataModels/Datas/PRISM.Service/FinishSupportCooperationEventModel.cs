...
namespace ReversePrism.DataModels
{
    ...
    // 010 CacheFinishSupportCooperationEventReply  ModelClassType IFinishSupportCooperationEventReply IFinishSupportCooperationEventReply IFinishSupportCooperationEventReply Pointer
    public partial class FinishSupportCooperationEventModel : DataModel
    {
        ...
        public static FinishSupportCooperationEventModel? FromPointer(IntPtr p0)
        {
            ...
            value.CacheFinishSupportCooperationEventReply   = GetObject<IFinishSupportCooperationEventReply>(new IntPtr(p + 0x010), ReversePrism.DataModels.IFinishSupportCooperationEventReply.FromPointer); // 0x10 CacheFinishSupportCooperationEventReply ( ModelClassType IFinishSupportCooperationEventReply IFinishSupportCooperationEventReply IFinishSupportCooperationEventReply Pointer )
