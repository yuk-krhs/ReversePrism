...
namespace ReversePrism.DataModels
{
    ...
    public partial class SQLiteConnection
    {
        ...
        public static SQLiteConnection? FromPointer(IntPtr p0)
        {
            ...
            value.Open                                      = GetBool(new IntPtr(p + 0x010)); // 027003D2B8A8 0x10 Open                        ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.BusyTimeout                               = (TimeSpan)GetInt32(new IntPtr(p + 0x018)); // 027003D2B8C8 0x18 BusyTimeout                 ( 00018668A8A0 ModelEnumType TimeSpan TimeSpan TimeSpan Int32 )
            value.TransactionDepth                          = GetInt32(new IntPtr(p + 0x020)); // 027003D2B908 0x20 TransactionDepth            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Rand                                      = GetObject<Random>(new IntPtr(p + 0x028), ReversePrism.DataModels.Random.FromPointer); // 027003D2B928 0x28 Rand                        ( 0001866093D0 ModelClassType Random Random Random Pointer )
            value.DatabasePath                              = GetString(new IntPtr(p + 0x038)); // 027003D2B9A8 0x38 DatabasePath                ( 000186671910 ModelPrimitiveType string string string String )
            value.LibVersionNumber                          = GetInt32(new IntPtr(p + 0x040)); // 027003D2B9C8 0x40 LibVersionNumber            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.StoreDateTimeAsTicks                      = GetBool(new IntPtr(p + 0x044)); // 027003D2B9E8 0x44 StoreDateTimeAsTicks        ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.StoreTimeSpanAsTicks                      = GetBool(new IntPtr(p + 0x045)); // 027003D2BA08 0x45 StoreTimeSpanAsTicks        ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.DateTimeStringFormat                      = GetString(new IntPtr(p + 0x048)); // 027003D2BA28 0x48 DateTimeStringFormat        ( 000186671910 ModelPrimitiveType string string string String )
            value.DateTimeStyle                             = (DateTimeStyles)GetInt32(new IntPtr(p + 0x050)); // 027003D2BA48 0x50 DateTimeStyle               ( 0001865BE5C0 ModelEnumType DateTimeStyles DateTimeStyles DateTimeStyles Int32 )
