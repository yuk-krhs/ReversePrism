...
namespace ReversePrism.DataModels
{
    ...
    // 028 M_HistoryPingPong                        ModelPrimitiveListType int[] int[] List<int> Pointer
    ...
    public partial class DepthOfFieldRenderer : DataModel
    {
        ...
        public static DepthOfFieldRenderer? FromPointer(IntPtr p0)
        {
            ...
            value.M_HistoryPingPong                         = GetInt32List(new IntPtr(p + 0x028)); // 0x28 M_HistoryPingPong           ( ModelPrimitiveListType int[] int[] List<int> Pointer )
