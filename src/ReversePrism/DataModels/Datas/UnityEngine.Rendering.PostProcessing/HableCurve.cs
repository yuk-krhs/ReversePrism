...
namespace ReversePrism.DataModels
{
    ...
    // 020 M_Segments                               ModelClassListType Segment[] Segment[] List<Segment> Pointer
    ...
    public partial class HableCurve : DataModel
    {
        ...
        public static HableCurve? FromPointer(IntPtr p0)
        {
            ...
            value.M_Segments                                = GetObjectList<Segment>(new IntPtr(p + 0x020), ReversePrism.DataModels.Segment.FromPointer); // 0x20 M_Segments                  ( ModelClassListType Segment[] Segment[] List<Segment> Pointer )
