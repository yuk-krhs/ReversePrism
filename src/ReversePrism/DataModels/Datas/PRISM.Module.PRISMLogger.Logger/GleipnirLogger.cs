...
namespace ReversePrism.DataModels
{
    ...
    public partial class GleipnirLogger : DataModel
    {
        ...
        public static GleipnirLogger? FromPointer(IntPtr p0)
        {
            ...
            value.Logger                                    = GetObject<CategorizedLogger>(new IntPtr(p + 0x010), ReversePrism.DataModels.CategorizedLogger.FromPointer); // 0245A3C9C300 0x10 Logger                      ( 00018654E610 ModelClassType CategorizedLogger CategorizedLogger CategorizedLogger Pointer )
