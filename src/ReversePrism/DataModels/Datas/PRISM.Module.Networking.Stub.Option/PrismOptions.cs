...
namespace ReversePrism.DataModels
{
    ...
    public partial class PrismOptions
    {
        ...
        public static PrismOptions? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new PrismOptions();

            value.AuthType                                  = (AuthType)GetInt32(new IntPtr(p + 0x018)); // 0270D0B6F6C0 0x18 AuthType                    ( 000186569160 ModelEnumType AuthType AuthType AuthType Int32 )
