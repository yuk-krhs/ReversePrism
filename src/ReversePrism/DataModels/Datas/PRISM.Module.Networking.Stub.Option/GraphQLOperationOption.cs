...
namespace ReversePrism.DataModels
{
    ...
    // 018 OperationType                            ModelEnumType GraphQLOperationType GraphQLOperationType GraphQLOperationType Int32
    public partial class GraphQLOperationOption : DataModel
    {
        ...
        public static GraphQLOperationOption? FromPointer(IntPtr p0)
        {
            ...
            value.OperationType                             = (GraphQLOperationType)GetInt32(new IntPtr(p + 0x018)); // 0x18 OperationType               ( ModelEnumType GraphQLOperationType GraphQLOperationType GraphQLOperationType Int32 )
