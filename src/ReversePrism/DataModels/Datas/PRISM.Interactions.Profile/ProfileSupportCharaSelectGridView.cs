...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProfileSupportCharaSelectGridView
    {
        ...
        public static ProfileSupportCharaSelectGridView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProfileSupportCharaSelectGridView();

            value.CellPrefab                                = GetObject<ProfileSupportCharaSelectGridViewCell>(new IntPtr(p + 0x090), ReversePrism.DataModels.ProfileSupportCharaSelectGridViewCell.FromPointer); // 0270DB72DEB8 0x90 CellPrefab                  ( 0001865C46C0 ModelClassType ProfileSupportCharaSelectGridViewCell ProfileSupportCharaSelectGridViewCell ProfileSupportCharaSelectGridViewCell Pointer )
            value.EmptyView                                 = GetObject<GameObject>(new IntPtr(p + 0x098), ReversePrism.DataModels.GameObject.FromPointer); // 0270DB72DED8 0x98 EmptyView                   ( 0001865D81D0 ModelClassType GameObject GameObject GameObject Pointer )
