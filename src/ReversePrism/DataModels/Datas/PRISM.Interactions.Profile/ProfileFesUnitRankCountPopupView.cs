...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProfileFesUnitRankCountPopupView : DataModel
    {
        ...
        public static ProfileFesUnitRankCountPopupView? FromPointer(IntPtr p0)
        {
            ...
            value.GridView                                  = GetObject<ProfileFesUnitRankCountGridView>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProfileFesUnitRankCountGridView.FromPointer); // 02466B798520 0x20 GridView                    ( 0001865B3AA0 ModelClassType ProfileFesUnitRankCountGridView ProfileFesUnitRankCountGridView ProfileFesUnitRankCountGridView Pointer )
            value.RankStatusList                            = GetObjectList<IUserProfileProduceTotalParameterRankStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.IUserProfileProduceTotalParameterRankStatus.FromPointer); // 02466B798560 0x30 RankStatusList              ( 000185B8A350 ModelClassListType IUserProfileProduceTotalParameterRankStatus[] IUserProfileProduceTotalParameterRankStatus[] List<IUserProfileProduceTotalParameterRankStatus> Pointer )
            value.Parent                                    = GetObject<IPopupFrameView>(new IntPtr(p + 0x038), ReversePrism.DataModels.IPopupFrameView.FromPointer); // 02466B798580 0x38 Parent                      ( 0001865DAC10 ModelClassType IPopupFrameView IPopupFrameView IPopupFrameView Pointer )
