...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProfileUserSelfOverlayView
    {
        ...
        public static ProfileUserSelfOverlayView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProfileUserSelfOverlayView();

            value.TabListView                               = GetObject<ProfileCategoryTabListView>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProfileCategoryTabListView.FromPointer); // 0270DB6E8080 0x20 TabListView                 ( 0001865AAA80 ModelClassType ProfileCategoryTabListView ProfileCategoryTabListView ProfileCategoryTabListView Pointer )
            value.CloseButton                               = GetObject<ButtonBase>(new IntPtr(p + 0x028), ReversePrism.DataModels.ButtonBase.FromPointer); // 0270DB6E80A0 0x28 CloseButton                 ( 000186515660 ModelClassType ButtonBase ButtonBase ButtonBase Pointer )
            value.PanelViewObjects                          = GetObjectList<GameObject>(new IntPtr(p + 0x030), ReversePrism.DataModels.GameObject.FromPointer); // 0270DB6E80C0 0x30 PanelViewObjects            ( 000185B81520 ModelClassListType GameObject[] GameObject[] List<GameObject> Pointer )
            value.UserSelfPanelView                         = GetObject<ProfileUserSelfPanelView>(new IntPtr(p + 0x038), ReversePrism.DataModels.ProfileUserSelfPanelView.FromPointer); // 0270DB6E80E0 0x38 UserSelfPanelView           ( 0001865C7440 ModelClassType ProfileUserSelfPanelView ProfileUserSelfPanelView ProfileUserSelfPanelView Pointer )
            value.ProgressPanelView                         = GetObject<ProfileProgressPanelView>(new IntPtr(p + 0x040), ReversePrism.DataModels.ProfileProgressPanelView.FromPointer); // 0270DB6E8100 0x40 ProgressPanelView           ( 0001865BF5D0 ModelClassType ProfileProgressPanelView ProfileProgressPanelView ProfileProgressPanelView Pointer )
            value.HistoryPanelView                          = GetObject<ProfileHistoryPanelView>(new IntPtr(p + 0x048), ReversePrism.DataModels.ProfileHistoryPanelView.FromPointer); // 0270DB6E8120 0x48 HistoryPanelView            ( 0001865BA420 ModelClassType ProfileHistoryPanelView ProfileHistoryPanelView ProfileHistoryPanelView Pointer )
            value.ViewModel                                 = GetObject<ProfileUserSalfViewModel>(new IntPtr(p + 0x0C0), ReversePrism.DataModels.ProfileUserSalfViewModel.FromPointer); // 0270DB6E8300 0xC0 ViewModel                   ( 0001865C5E90 ModelClassType ProfileUserSalfViewModel ProfileUserSalfViewModel ProfileUserSalfViewModel Pointer )
            value.BackKeyDisposable                         = GetObject<IDisposable>(new IntPtr(p + 0x0C8), ReversePrism.DataModels.IDisposable.FromPointer); // 0270DB6E8320 0xC8 BackKeyDisposable           ( 0001867532E0 ModelClassType IDisposable IDisposable IDisposable Pointer )
            value.ResourceLoader                            = GetObject<IResourceLoader>(new IntPtr(p + 0x0D0), ReversePrism.DataModels.IResourceLoader.FromPointer); // 0270DB6E8340 0xD0 ResourceLoader              ( 00018661A8D0 ModelClassType IResourceLoader IResourceLoader IResourceLoader Pointer )
