...
namespace ReversePrism.DataModels
{
    ...
    public partial class PlayableHandle
    {
        ...
        public static PlayableHandle? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new PlayableHandle();

            value.M_Version                                 = GetUInt32(new IntPtr(p + 0x018)); // 0270020DC470 0x18 M_Version                   ( 000186698DF0 ModelPrimitiveType uint uint uint UInt32 )
