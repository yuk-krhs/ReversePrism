...
namespace ReversePrism.DataModels
{
    ...
    public partial class DressUpRoomBuilder
    {
        ...
        public static DressUpRoomBuilder? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new DressUpRoomBuilder();

            value.View                                      = GetObject<DressUpRoomView>(new IntPtr(p + 0x020), ReversePrism.DataModels.DressUpRoomView.FromPointer); // 0270DB645430 0x20 View                        ( 000186704080 ModelClassType DressUpRoomView DressUpRoomView DressUpRoomView Pointer )
            value.UiView                                    = GetObject<DressUpRoomUIView>(new IntPtr(p + 0x028), ReversePrism.DataModels.DressUpRoomUIView.FromPointer); // 0270DB645450 0x28 UiView                      ( 0001867038C0 ModelClassType DressUpRoomUIView DressUpRoomUIView DressUpRoomUIView Pointer )
            value.DressUpRoom3DViewer                       = GetObject<DressUpRoom3DViewer>(new IntPtr(p + 0x030), ReversePrism.DataModels.DressUpRoom3DViewer.FromPointer); // 0270DB645470 0x30 DressUpRoom3DViewer         ( 0001866FCC40 ModelClassType DressUpRoom3DViewer DressUpRoom3DViewer DressUpRoom3DViewer Pointer )
            value.CostumeChangeView                         = GetObject<DressUpRoomCostumeChangeView>(new IntPtr(p + 0x038), ReversePrism.DataModels.DressUpRoomCostumeChangeView.FromPointer); // 0270DB645490 0x38 CostumeChangeView           ( 0001866FE980 ModelClassType DressUpRoomCostumeChangeView DressUpRoomCostumeChangeView DressUpRoomCostumeChangeView Pointer )
            value.HomeSettingsIdolSelectPopupViewFactory    = GetObject<HomeSettingsIdolSelectPopupViewFactory>(new IntPtr(p + 0x040), ReversePrism.DataModels.HomeSettingsIdolSelectPopupViewFactory.FromPointer); // 0270DB6454B0 0x40 HomeSettingsIdolSelectPopupViewFactory ( 0001866CE8C0 ModelClassType HomeSettingsIdolSelectPopupViewFactory HomeSettingsIdolSelectPopupViewFactory HomeSettingsIdolSelectPopupViewFactory Pointer )
            value.CostumeDetailPopupViewFactory             = GetObject<CostumeDetailPopupViewFactory>(new IntPtr(p + 0x048), ReversePrism.DataModels.CostumeDetailPopupViewFactory.FromPointer); // 0270DB6454D0 0x48 CostumeDetailPopupViewFactory ( 00018662BEB0 ModelClassType CostumeDetailPopupViewFactory CostumeDetailPopupViewFactory CostumeDetailPopupViewFactory Pointer )
