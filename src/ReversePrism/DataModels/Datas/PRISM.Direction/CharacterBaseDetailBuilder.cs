...
namespace ReversePrism.DataModels
{
    ...
    public partial class CharacterBaseDetailBuilder : DataModel
    {
        ...
        public static CharacterBaseDetailBuilder? FromPointer(IntPtr p0)
        {
            ...
            value.TitleView                                 = GetObject<CommonTitleView>(new IntPtr(p + 0x020), ReversePrism.DataModels.CommonTitleView.FromPointer); // 02466B6B97C0 0x20 TitleView                   ( 0001865E9D00 ModelClassType CommonTitleView CommonTitleView CommonTitleView Pointer )
            value.UiCharacterView                           = GetObject<IdolBaseDetailUICharacterView>(new IntPtr(p + 0x028), ReversePrism.DataModels.IdolBaseDetailUICharacterView.FromPointer); // 02466B6B97E0 0x28 UiCharacterView             ( 0001866AA980 ModelClassType IdolBaseDetailUICharacterView IdolBaseDetailUICharacterView IdolBaseDetailUICharacterView Pointer )
            value.View                                      = GetObject<IdolBaseDetailView>(new IntPtr(p + 0x030), ReversePrism.DataModels.IdolBaseDetailView.FromPointer); // 02466B6B9800 0x30 View                        ( 0001866AB0C0 ModelClassType IdolBaseDetailView IdolBaseDetailView IdolBaseDetailView Pointer )
            value.ProfileView                               = GetObject<IdolBaseDetailProfileView>(new IntPtr(p + 0x038), ReversePrism.DataModels.IdolBaseDetailProfileView.FromPointer); // 02466B6B9820 0x38 ProfileView                 ( 0001866A8260 ModelClassType IdolBaseDetailProfileView IdolBaseDetailProfileView IdolBaseDetailProfileView Pointer )
            value.GalleryView                               = GetObject<IdolBaseDetailGalleryView>(new IntPtr(p + 0x040), ReversePrism.DataModels.IdolBaseDetailGalleryView.FromPointer); // 02466B6B9840 0x40 GalleryView                 ( 0001866A6EB0 ModelClassType IdolBaseDetailGalleryView IdolBaseDetailGalleryView IdolBaseDetailGalleryView Pointer )
            value.AlbumPopupViewFactory                     = GetObject<AlbumPopupViewFactory>(new IntPtr(p + 0x048), ReversePrism.DataModels.AlbumPopupViewFactory.FromPointer); // 02466B6B9860 0x48 AlbumPopupViewFactory       ( 00018669F660 ModelClassType AlbumPopupViewFactory AlbumPopupViewFactory AlbumPopupViewFactory Pointer )
            value.CostumePopupViewFactory                   = GetObject<CostumePopupViewFactory>(new IntPtr(p + 0x050), ReversePrism.DataModels.CostumePopupViewFactory.FromPointer); // 02466B6B9880 0x50 CostumePopupViewFactory     ( 00018662ED50 ModelClassType CostumePopupViewFactory CostumePopupViewFactory CostumePopupViewFactory Pointer )
            value.VoicePopupViewFactory                     = GetObject<VoicePopupViewFactory>(new IntPtr(p + 0x058), ReversePrism.DataModels.VoicePopupViewFactory.FromPointer); // 02466B6B98A0 0x58 VoicePopupViewFactory       ( 000186538BE0 ModelClassType VoicePopupViewFactory VoicePopupViewFactory VoicePopupViewFactory Pointer )
            value.VoicePlayTabListPopupViewFactory          = GetObject<VoicePlayTabListPopupViewFactory>(new IntPtr(p + 0x060), ReversePrism.DataModels.VoicePlayTabListPopupViewFactory.FromPointer); // 02466B6B98C0 0x60 VoicePlayTabListPopupViewFactory ( 000186537780 ModelClassType VoicePlayTabListPopupViewFactory VoicePlayTabListPopupViewFactory VoicePlayTabListPopupViewFactory Pointer )
            value.VoicePlayListPopupViewFactory             = GetObject<VoicePlayListPopupViewFactory>(new IntPtr(p + 0x068), ReversePrism.DataModels.VoicePlayListPopupViewFactory.FromPointer); // 02466B6B98E0 0x68 VoicePlayListPopupViewFactory ( 000186536120 ModelClassType VoicePlayListPopupViewFactory VoicePlayListPopupViewFactory VoicePlayListPopupViewFactory Pointer )
            value.MoviePopupViewFactory                     = GetObject<MoviePopupViewFactory>(new IntPtr(p + 0x070), ReversePrism.DataModels.MoviePopupViewFactory.FromPointer); // 02466B6B9900 0x70 MoviePopupViewFactory       ( 00018665AEF0 ModelClassType MoviePopupViewFactory MoviePopupViewFactory MoviePopupViewFactory Pointer )
            value.EtceteraPopupViewFactory                  = GetObject<EtceteraPopupViewFactory>(new IntPtr(p + 0x078), ReversePrism.DataModels.EtceteraPopupViewFactory.FromPointer); // 02466B6B9920 0x78 EtceteraPopupViewFactory    ( 00018674A050 ModelClassType EtceteraPopupViewFactory EtceteraPopupViewFactory EtceteraPopupViewFactory Pointer )
            value.FullSizeImageOverlayViewFactory           = GetObject<FullSizeImageOverlayViewFactory>(new IntPtr(p + 0x080), ReversePrism.DataModels.FullSizeImageOverlayViewFactory.FromPointer); // 02466B6B9940 0x80 FullSizeImageOverlayViewFactory ( 0001865D3620 ModelClassType FullSizeImageOverlayViewFactory FullSizeImageOverlayViewFactory FullSizeImageOverlayViewFactory Pointer )
            value.CostumeDetailPopupViewFactory             = GetObject<CostumeDetailPopupViewFactory>(new IntPtr(p + 0x088), ReversePrism.DataModels.CostumeDetailPopupViewFactory.FromPointer); // 02466B6B9960 0x88 CostumeDetailPopupViewFactory ( 00018662BEB0 ModelClassType CostumeDetailPopupViewFactory CostumeDetailPopupViewFactory CostumeDetailPopupViewFactory Pointer )
            value.SCharaDetailPopupViewFactory              = GetObject<SCharaDetailPopupViewFactory>(new IntPtr(p + 0x090), ReversePrism.DataModels.SCharaDetailPopupViewFactory.FromPointer); // 02466B6B9980 0x90 SCharaDetailPopupViewFactory ( 0001866A44F0 ModelClassType SCharaDetailPopupViewFactory SCharaDetailPopupViewFactory SCharaDetailPopupViewFactory Pointer )
