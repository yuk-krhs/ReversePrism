...
namespace ReversePrism.DataModels
{
    ...
    public partial class X509Certificate2ImplMono
    {
        ...
        public static X509Certificate2ImplMono? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new X509Certificate2ImplMono();

            value.IntermediateCerts                         = GetObject<X509CertificateImplCollection>(new IntPtr(p + 0x0B0), ReversePrism.DataModels.X509CertificateImplCollection.FromPointer); // 0270D79E3C48 0xB0 IntermediateCerts           ( 000186566880 ModelClassType X509CertificateImplCollection X509CertificateImplCollection X509CertificateImplCollection Pointer )
            value.Cert                                      = GetObject<X509Certificate>(new IntPtr(p + 0x0B8), ReversePrism.DataModels.X509Certificate.FromPointer); // 0270D79E3C68 0xB8 Cert                        ( 0001865639C0 ModelClassType X509Certificate X509Certificate X509Certificate Pointer )
