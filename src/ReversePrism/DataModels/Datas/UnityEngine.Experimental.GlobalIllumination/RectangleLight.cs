...
namespace ReversePrism.DataModels
{
    ...
    // 058 Width                                    ModelPrimitiveType float float float Single
    // 05C Height                                   ModelPrimitiveType float float float Single
    // 060 Falloff                                  ModelEnumType FalloffType FalloffType FalloffType Int32
    public partial class RectangleLight : DataModel
    {
        ...
        public static RectangleLight? FromPointer(IntPtr p0)
        {
            ...
            value.Width                                     = GetSingle(new IntPtr(p + 0x058)); // 0x58 Width                       ( ModelPrimitiveType float float float Single )
            value.Height                                    = GetSingle(new IntPtr(p + 0x05C)); // 0x5C Height                      ( ModelPrimitiveType float float float Single )
            value.Falloff                                   = (FalloffType)GetInt32(new IntPtr(p + 0x060)); // 0x60 Falloff                     ( ModelEnumType FalloffType FalloffType FalloffType Int32 )
