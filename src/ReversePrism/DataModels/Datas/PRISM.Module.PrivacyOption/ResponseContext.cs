...
namespace ReversePrism.DataModels
{
    ...
    // 018 StatusCode                               ModelPrimitiveType long long long Int64
    ...
    public partial class ResponseContext : DataModel
    {
        ...
        public static ResponseContext? FromPointer(IntPtr p0)
        {
            ...
            value.StatusCode                                = GetInt64(new IntPtr(p + 0x018)); // 0x18 StatusCode                  ( ModelPrimitiveType long long long Int64 )
