...
namespace ReversePrism.DataModels
{
    ...
    // 028 Hash                                     ModelClassType SHA256 SHA256 SHA256 Pointer
    public partial class SHA256CryptoServiceProvider : DataModel
    {
        ...
        public static SHA256CryptoServiceProvider? FromPointer(IntPtr p0)
        {
            ...
            value.Hash                                      = GetObject<SHA256>(new IntPtr(p + 0x028), ReversePrism.DataModels.SHA256.FromPointer); // 0x28 Hash                        ( ModelClassType SHA256 SHA256 SHA256 Pointer )
