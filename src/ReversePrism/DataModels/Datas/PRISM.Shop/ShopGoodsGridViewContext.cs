...
namespace ReversePrism.DataModels
{
    ...
    public partial class ShopGoodsGridViewContext : DataModel
    {
        ...
        public static ShopGoodsGridViewContext? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ShopGoodsGridViewContext() { Pointer= p0 };

            value.ShopLocalSave                             = GetObject<ShopLocalSave>(new IntPtr(p + 0x050), ReversePrism.DataModels.ShopLocalSave.FromPointer); // 02466557B718 0x50 ShopLocalSave               ( 0001867622A0 ModelClassType ShopLocalSave ShopLocalSave ShopLocalSave Pointer )
