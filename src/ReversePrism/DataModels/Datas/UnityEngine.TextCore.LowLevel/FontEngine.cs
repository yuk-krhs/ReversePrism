...
namespace ReversePrism.DataModels
{
    ...
    public partial class FontEngine
    {
        ...
        public static FontEngine? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new FontEngine();

            value.S_GlyphMarshallingStruct_IN               = GetEnumList<GlyphMarshallingStruct>(new IntPtr(p + 0x010)); // 027003A1D8B0 0x10 S_GlyphMarshallingStruct_IN ( 000185B822F0 ModelEnumListType GlyphMarshallingStruct[] GlyphMarshallingStruct[] List<GlyphMarshallingStruct> Pointer )
            value.S_GlyphMarshallingStruct_OUT              = GetEnumList<GlyphMarshallingStruct>(new IntPtr(p + 0x018)); // 027003A1D8D0 0x18 S_GlyphMarshallingStruct_OUT ( 000185B822F0 ModelEnumListType GlyphMarshallingStruct[] GlyphMarshallingStruct[] List<GlyphMarshallingStruct> Pointer )
            value.S_FreeGlyphRects                          = GetEnumList<GlyphRect>(new IntPtr(p + 0x020)); // 027003A1D8F0 0x20 S_FreeGlyphRects            ( 000185B82980 ModelEnumListType GlyphRect[] GlyphRect[] List<GlyphRect> Pointer )
            value.S_UsedGlyphRects                          = GetEnumList<GlyphRect>(new IntPtr(p + 0x028)); // 027003A1D910 0x28 S_UsedGlyphRects            ( 000185B82980 ModelEnumListType GlyphRect[] GlyphRect[] List<GlyphRect> Pointer )
            value.S_PairAdjustmentRecords_MarshallingArray  = GetEnumList<GlyphPairAdjustmentRecord>(new IntPtr(p + 0x030)); // 027003A1D930 0x30 S_PairAdjustmentRecords_MarshallingArray ( 000185B82780 ModelEnumListType GlyphPairAdjustmentRecord[] GlyphPairAdjustmentRecord[] List<GlyphPairAdjustmentRecord> Pointer )
