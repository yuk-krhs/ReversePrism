...
namespace ReversePrism.DataModels
{
    ...
    // 030 CurrentTransitionAnimationType           ModelEnumType TransitionAnimationType TransitionAnimationType TransitionAnimationType Int32
    public partial class TransitionAnimationPlayer : DataModel
    {
        ...
        public static TransitionAnimationPlayer? FromPointer(IntPtr p0)
        {
            ...
            value.CurrentTransitionAnimationType            = (TransitionAnimationType)GetInt32(new IntPtr(p + 0x030)); // 0x30 CurrentTransitionAnimationType ( ModelEnumType TransitionAnimationType TransitionAnimationType TransitionAnimationType Int32 )
