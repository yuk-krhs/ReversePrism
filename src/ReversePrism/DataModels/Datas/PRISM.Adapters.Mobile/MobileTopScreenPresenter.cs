...
namespace ReversePrism.DataModels
{
    ...
    // 010 View                                     ModelClassType IMobileTopScreenView IMobileTopScreenView IMobileTopScreenView Pointer
    // 018 Model                                    ModelClassType MobileTopScreenModel MobileTopScreenModel MobileTopScreenModel Pointer
    // 020 Parameter                                ModelClassType MobileTopParameter MobileTopParameter MobileTopParameter Pointer
    ...
    public partial class MobileTopScreenPresenter : DataModel
    {
        ...
        public static MobileTopScreenPresenter? FromPointer(IntPtr p0)
        {
            ...
            value.View                                      = GetObject<IMobileTopScreenView>(new IntPtr(p + 0x010), ReversePrism.DataModels.IMobileTopScreenView.FromPointer); // 0x10 View                        ( ModelClassType IMobileTopScreenView IMobileTopScreenView IMobileTopScreenView Pointer )
            value.Model                                     = GetObject<MobileTopScreenModel>(new IntPtr(p + 0x018), ReversePrism.DataModels.MobileTopScreenModel.FromPointer); // 0x18 Model                       ( ModelClassType MobileTopScreenModel MobileTopScreenModel MobileTopScreenModel Pointer )
            value.Parameter                                 = GetObject<MobileTopParameter>(new IntPtr(p + 0x020), ReversePrism.DataModels.MobileTopParameter.FromPointer); // 0x20 Parameter                   ( ModelClassType MobileTopParameter MobileTopParameter MobileTopParameter Pointer )
