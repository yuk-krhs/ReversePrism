...
namespace ReversePrism.DataModels
{
    ...
    // 010 BodyText                                 ModelPrimitiveType string string string String
    public partial class ChainTalkCellBalloonData : DataModel
    {
        ...
        public static ChainTalkCellBalloonData? FromPointer(IntPtr p0)
        {
            ...
            value.BodyText                                  = GetString(new IntPtr(p + 0x010)); // 0x10 BodyText                    ( ModelPrimitiveType string string string String )
