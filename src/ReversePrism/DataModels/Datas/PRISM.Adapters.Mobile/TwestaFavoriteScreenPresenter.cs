...
namespace ReversePrism.DataModels
{
    ...
    // 010 View                                     ModelClassType ITwestaFavoriteScreenView ITwestaFavoriteScreenView ITwestaFavoriteScreenView Pointer
    // 018 Parameter                                ModelClassType TwestaFavoriteParameter TwestaFavoriteParameter TwestaFavoriteParameter Pointer
    ...
    public partial class TwestaFavoriteScreenPresenter : DataModel
    {
        ...
        public static TwestaFavoriteScreenPresenter? FromPointer(IntPtr p0)
        {
            ...
            value.View                                      = GetObject<ITwestaFavoriteScreenView>(new IntPtr(p + 0x010), ReversePrism.DataModels.ITwestaFavoriteScreenView.FromPointer); // 0x10 View                        ( ModelClassType ITwestaFavoriteScreenView ITwestaFavoriteScreenView ITwestaFavoriteScreenView Pointer )
            value.Parameter                                 = GetObject<TwestaFavoriteParameter>(new IntPtr(p + 0x018), ReversePrism.DataModels.TwestaFavoriteParameter.FromPointer); // 0x18 Parameter                   ( ModelClassType TwestaFavoriteParameter TwestaFavoriteParameter TwestaFavoriteParameter Pointer )
