...
namespace ReversePrism.DataModels
{
    ...
    // 014 PhoneCallId                              ModelPrimitiveType int int int Int32
    public partial class CallPlaybackParameter : DataModel
    {
        ...
        public static CallPlaybackParameter? FromPointer(IntPtr p0)
        {
            ...
            value.PhoneCallId                               = GetInt32(new IntPtr(p + 0x014)); // 0x14 PhoneCallId                 ( ModelPrimitiveType int int int Int32 )
