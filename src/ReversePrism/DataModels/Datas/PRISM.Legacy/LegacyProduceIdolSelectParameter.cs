...
namespace ReversePrism.DataModels
{
    ...
    public partial class LegacyProduceIdolSelectParameter
    {
        ...
        public static LegacyProduceIdolSelectParameter? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new LegacyProduceIdolSelectParameter();

            value.EpisodeData                               = GetObject<IEpisodeStatus>(new IntPtr(p + 0x010), ReversePrism.DataModels.IEpisodeStatus.FromPointer); // 0270D5E3E260 0x10 EpisodeData                 ( 000186761B50 ModelClassType IEpisodeStatus IEpisodeStatus IEpisodeStatus Pointer )
            value.EpisodeSelectModel                        = GetObject<ViewProducePreparationEpisodeSelectModel>(new IntPtr(p + 0x018), ReversePrism.DataModels.ViewProducePreparationEpisodeSelectModel.FromPointer); // 0270D5E3E280 0x18 EpisodeSelectModel          ( 000186520000 ModelClassType ViewProducePreparationEpisodeSelectModel ViewProducePreparationEpisodeSelectModel ViewProducePreparationEpisodeSelectModel Pointer )
            value.Difficulty                                = (ProduceDifficultyType)GetInt32(new IntPtr(p + 0x020)); // 0270D5E3E2A0 0x20 Difficulty                  ( 00018660C140 ModelEnumType ProduceDifficultyType ProduceDifficultyType ProduceDifficultyType Int32 )
            value.IsAnyEpisodeCleared                       = GetBool(new IntPtr(p + 0x024)); // 0270D5E3E2C0 0x24 IsAnyEpisodeCleared         ( 000186595960 ModelPrimitiveType bool bool bool Bool )
            value.IsSelectUnitAnyEpisodeCleared             = GetBool(new IntPtr(p + 0x025)); // 0270D5E3E2E0 0x25 IsSelectUnitAnyEpisodeCleared ( 000186596AF0 ModelPrimitiveType bool bool bool Bool )
