...
namespace ReversePrism.DataModels
{
    ...
    // 018 M_TapStartTime                           ModelPrimitiveType double double double Double
    public partial class TapInteraction : DataModel
    {
        ...
        public static TapInteraction? FromPointer(IntPtr p0)
        {
            ...
            value.M_TapStartTime                            = GetDouble(new IntPtr(p + 0x018)); // 0x18 M_TapStartTime              ( ModelPrimitiveType double double double Double )
