...
namespace ReversePrism.DataModels
{
    ...
    // 010 OnDispose                                ModelClassType Action Action Action Pointer
    ...
    public partial class DisposableAction : DataModel
    {
        ...
        public static DisposableAction? FromPointer(IntPtr p0)
        {
            ...
            value.OnDispose                                 = GetObject<Action>(new IntPtr(p + 0x010), ReversePrism.DataModels.Action.FromPointer); // 0x10 OnDispose                   ( ModelClassType Action Action Action Pointer )
