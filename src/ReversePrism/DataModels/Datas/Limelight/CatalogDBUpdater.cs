...
namespace ReversePrism.DataModels
{
    ...
    public partial class CatalogDBUpdater : DataModel
    {
        ...
        public static CatalogDBUpdater? FromPointer(IntPtr p0)
        {
            ...
            value.Db                                        = GetObject<CatalogDB>(new IntPtr(p + 0x010), ReversePrism.DataModels.CatalogDB.FromPointer); // 02466B55CEE8 0x10 Db                          ( 00018654BDF0 ModelClassType CatalogDB CatalogDB CatalogDB Pointer )
            value.TotalDeletes                              = GetInt32(new IntPtr(p + 0x018)); // 02466B55CF08 0x18 TotalDeletes                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
