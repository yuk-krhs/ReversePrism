...
namespace ReversePrism.DataModels
{
    ...
    public partial class LoadContext : DataModel
    {
        ...
        public static LoadContext? FromPointer(IntPtr p0)
        {
            ...
            value.Repo                                      = GetObject<AssetRepository>(new IntPtr(p + 0x010), ReversePrism.DataModels.AssetRepository.FromPointer); // 0245A3F571E0 0x10 Repo                        ( 00018658C630 ModelClassType AssetRepository AssetRepository AssetRepository Pointer )
            value.BundleIdx                                 = GetInt32(new IntPtr(p + 0x018)); // 0245A3F57200 0x18 BundleIdx                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
