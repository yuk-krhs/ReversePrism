...
namespace ReversePrism.DataModels
{
    ...
    public partial class ReadOnlyCollectionBase : DataModel
    {
        ...
        public static ReadOnlyCollectionBase? FromPointer(IntPtr p0)
        {
            ...
            value.List                                      = GetObject<ArrayList>(new IntPtr(p + 0x010), ReversePrism.DataModels.ArrayList.FromPointer); // 024666D97CE0 0x10 List                        ( 00018658A070 ModelClassType ArrayList ArrayList ArrayList Pointer )
