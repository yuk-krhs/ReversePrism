...
namespace ReversePrism.DataModels
{
    ...
    public partial class ArrayList
    {
        ...
        public static ArrayList? FromPointer(IntPtr p0)
        {
            ...
            value.Size                                      = GetInt32(new IntPtr(p + 0x018)); // 027004D04000 0x18 Size                        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Version                                   = GetInt32(new IntPtr(p + 0x01C)); // 027004D04020 0x1C Version                     ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
