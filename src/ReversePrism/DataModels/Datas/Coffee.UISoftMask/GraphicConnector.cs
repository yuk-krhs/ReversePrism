...
namespace ReversePrism.DataModels
{
    ...
    // 010 S_EmptyConnector                         ModelClassType GraphicConnector GraphicConnector GraphicConnector Pointer
    public partial class GraphicConnector : DataModel
    {
        ...
        public static GraphicConnector? FromPointer(IntPtr p0)
        {
            ...
            value.S_EmptyConnector                          = GetObject<GraphicConnector>(new IntPtr(p + 0x010), ReversePrism.DataModels.GraphicConnector.FromPointer); // 0x10 S_EmptyConnector            ( ModelClassType GraphicConnector GraphicConnector GraphicConnector Pointer )
