...
namespace ReversePrism.DataModels
{
    ...
    public partial class MenuParameter
    {
        ...
        public static MenuParameter? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new MenuParameter();

            value.MenuKind                                  = GetString(new IntPtr(p + 0x010)); // 0270DB4A07D0 0x10 MenuKind                    ( 0001866722E0 ModelPrimitiveType string string string String )
