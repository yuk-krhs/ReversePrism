...
namespace ReversePrism.DataModels
{
    ...
    public partial class OsapiInspectionResult : DataModel
    {
        ...
        public static OsapiInspectionResult? FromPointer(IntPtr p0)
        {
            ...
            value.Response                                  = GetObject<InspectionResult>(new IntPtr(p + 0x040), ReversePrism.DataModels.InspectionResult.FromPointer); // 02466B516770 0x40 Response                    ( 00018670A3A0 ModelClassType InspectionResult InspectionResult InspectionResult Pointer )
