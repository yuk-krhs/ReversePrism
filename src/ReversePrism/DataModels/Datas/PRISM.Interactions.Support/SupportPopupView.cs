...
namespace ReversePrism.DataModels
{
    ...
    public partial class SupportPopupView
    {
        ...
        public static SupportPopupView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SupportPopupView();

            value.ButtonLabelPairs                          = GetObjectList<ButtonLabelPair>(new IntPtr(p + 0x020), ReversePrism.DataModels.ButtonLabelPair.FromPointer); // 0270DBE5C208 0x20 ButtonLabelPairs            ( 000185CC35D8 ModelClassListType ButtonLabelPair[] ButtonLabelPair[] List<ButtonLabelPair> Pointer )
            value.Parent                                    = GetObject<IPopupFrameView>(new IntPtr(p + 0x050), ReversePrism.DataModels.IPopupFrameView.FromPointer); // 0270DBE5C2C8 0x50 Parent                      ( 0001865DAC10 ModelClassType IPopupFrameView IPopupFrameView IPopupFrameView Pointer )
