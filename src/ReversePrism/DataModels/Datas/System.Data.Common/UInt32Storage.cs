...
namespace ReversePrism.DataModels
{
    ...
    // 050 Values                                   ModelPrimitiveListType uint[] uint[] List<uint> Pointer
    public partial class UInt32Storage : DataModel
    {
        ...
        public static UInt32Storage? FromPointer(IntPtr p0)
        {
            ...
            value.Values                                    = GetUInt32List(new IntPtr(p + 0x050)); // 0x50 Values                      ( ModelPrimitiveListType uint[] uint[] List<uint> Pointer )
