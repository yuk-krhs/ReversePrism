...
namespace ReversePrism.DataModels
{
    ...
    // 050 Values                                   ModelEnumListType TimeSpan[] TimeSpan[] List<TimeSpan> Pointer
    public partial class TimeSpanStorage : DataModel
    {
        ...
        public static TimeSpanStorage? FromPointer(IntPtr p0)
        {
            ...
            value.Values                                    = GetEnumList<TimeSpan>(new IntPtr(p + 0x050)); // 0x50 Values                      ( ModelEnumListType TimeSpan[] TimeSpan[] List<TimeSpan> Pointer )
