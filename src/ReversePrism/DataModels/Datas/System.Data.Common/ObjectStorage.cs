...
namespace ReversePrism.DataModels
{
    ...
    public partial class ObjectStorage
    {
        ...
        public static ObjectStorage? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ObjectStorage();

            value.ImplementsIXmlSerializable                = GetBool(new IntPtr(p + 0x058)); // 0270D89E2928 0x58 ImplementsIXmlSerializable  ( 0001865965D0 ModelPrimitiveType bool bool bool Bool )
            value.S_serializerFactory                       = GetObject<XmlSerializerFactory>(new IntPtr(p + 0x018), ReversePrism.DataModels.XmlSerializerFactory.FromPointer); // 0270D89E2988 0x18 S_serializerFactory         ( 0001865C8540 ModelClassType XmlSerializerFactory XmlSerializerFactory XmlSerializerFactory Pointer )
