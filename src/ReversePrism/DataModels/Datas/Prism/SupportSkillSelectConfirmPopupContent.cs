...
namespace ReversePrism.DataModels
{
    ...
    // 070 Prm                                      ModelClassType SupportSkillSelectConfirmPopupParam SupportSkillSelectConfirmPopupParam SupportSkillSelectConfirmPopupParam Pointer
    public partial class SupportSkillSelectConfirmPopupContent : DataModel
    {
        ...
        public static SupportSkillSelectConfirmPopupContent? FromPointer(IntPtr p0)
        {
            ...
            value.Prm                                       = GetObject<SupportSkillSelectConfirmPopupParam>(new IntPtr(p + 0x070), ReversePrism.DataModels.SupportSkillSelectConfirmPopupParam.FromPointer); // 0x70 Prm                         ( ModelClassType SupportSkillSelectConfirmPopupParam SupportSkillSelectConfirmPopupParam SupportSkillSelectConfirmPopupParam Pointer )
