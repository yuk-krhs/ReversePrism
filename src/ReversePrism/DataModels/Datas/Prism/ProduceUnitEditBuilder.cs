...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceUnitEditBuilder
    {
        ...
        public static ProduceUnitEditBuilder? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProduceUnitEditBuilder();

            value.View                                      = GetObject<ProduceUnitEditView>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProduceUnitEditView.FromPointer); // 0270DB60D4D8 0x20 View                        ( 0001865999B0 ModelClassType ProduceUnitEditView ProduceUnitEditView ProduceUnitEditView Pointer )
            value.TitleView                                 = GetObject<CommonTitleView>(new IntPtr(p + 0x028), ReversePrism.DataModels.CommonTitleView.FromPointer); // 0270DB60D4F8 0x28 TitleView                   ( 0001865E9D00 ModelClassType CommonTitleView CommonTitleView CommonTitleView Pointer )
            value.PIdolDetailPopupViewFactory               = GetObject<PIdolDetailPopupViewFactory>(new IntPtr(p + 0x030), ReversePrism.DataModels.PIdolDetailPopupViewFactory.FromPointer); // 0270DB60D518 0x30 PIdolDetailPopupViewFactory ( 00018670A490 ModelClassType PIdolDetailPopupViewFactory PIdolDetailPopupViewFactory PIdolDetailPopupViewFactory Pointer )
            value.SCharaDetailPopupViewFactory              = GetObject<SCharaDetailPopupViewFactory>(new IntPtr(p + 0x038), ReversePrism.DataModels.SCharaDetailPopupViewFactory.FromPointer); // 0270DB60D538 0x38 SCharaDetailPopupViewFactory ( 0001866A44F0 ModelClassType SCharaDetailPopupViewFactory SCharaDetailPopupViewFactory SCharaDetailPopupViewFactory Pointer )
            value.EditUnitNamePopupViewFactory              = GetObject<EditUnitNamePopupViewFactory>(new IntPtr(p + 0x040), ReversePrism.DataModels.EditUnitNamePopupViewFactory.FromPointer); // 0270DB60D558 0x40 EditUnitNamePopupViewFactory ( 00018671C4D0 ModelClassType EditUnitNamePopupViewFactory EditUnitNamePopupViewFactory EditUnitNamePopupViewFactory Pointer )
            value.ProducePreparationIdolSkillSelectPopupViewFactory = GetObject<ProducePreparationIdolSkillSelectPopupViewFactory>(new IntPtr(p + 0x048), ReversePrism.DataModels.ProducePreparationIdolSkillSelectPopupViewFactory.FromPointer); // 0270DB60D578 0x48 ProducePreparationIdolSkillSelectPopupViewFactory ( 00018656FA60 ModelClassType ProducePreparationIdolSkillSelectPopupViewFactory ProducePreparationIdolSkillSelectPopupViewFactory ProducePreparationIdolSkillSelectPopupViewFactory Pointer )
            value.ProduceSupportCharaSelectPopupViewFactory = GetObject<ProduceSupportCharaSelectPopupViewFactory>(new IntPtr(p + 0x050), ReversePrism.DataModels.ProduceSupportCharaSelectPopupViewFactory.FromPointer); // 0270DB60D598 0x50 ProduceSupportCharaSelectPopupViewFactory ( 000186588320 ModelClassType ProduceSupportCharaSelectPopupViewFactory ProduceSupportCharaSelectPopupViewFactory ProduceSupportCharaSelectPopupViewFactory Pointer )
            value.SupportCharaUnitSetupPopupViewFactory     = GetObject<SupportCharaUnitSetupPopupViewFactory>(new IntPtr(p + 0x058), ReversePrism.DataModels.SupportCharaUnitSetupPopupViewFactory.FromPointer); // 0270DB60D5B8 0x58 SupportCharaUnitSetupPopupViewFactory ( 0001865E6980 ModelClassType SupportCharaUnitSetupPopupViewFactory SupportCharaUnitSetupPopupViewFactory SupportCharaUnitSetupPopupViewFactory Pointer )
