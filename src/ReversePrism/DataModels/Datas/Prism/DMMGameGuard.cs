...
namespace ReversePrism.DataModels
{
    ...
    // 010 ErrCode                                  ModelPrimitiveType int int int Int32
    // 014 IsInit                                   ModelPrimitiveType bool bool bool Bool
    // 015 IsCheck                                  ModelPrimitiveType bool bool bool Bool
    // 018 CheckDisposable                          ModelClassType IDisposable IDisposable IDisposable Pointer
    public partial class DMMGameGuard : DataModel
    {
        ...
        public static DMMGameGuard? FromPointer(IntPtr p0)
        {
            ...
            value.ErrCode                                   = GetInt32(new IntPtr(p + 0x010)); // 0x10 ErrCode                     ( ModelPrimitiveType int int int Int32 )
            value.IsInit                                    = GetBool(new IntPtr(p + 0x014)); // 0x14 IsInit                      ( ModelPrimitiveType bool bool bool Bool )
            value.IsCheck                                   = GetBool(new IntPtr(p + 0x015)); // 0x15 IsCheck                     ( ModelPrimitiveType bool bool bool Bool )
            value.CheckDisposable                           = GetObject<IDisposable>(new IntPtr(p + 0x018), ReversePrism.DataModels.IDisposable.FromPointer); // 0x18 CheckDisposable             ( ModelClassType IDisposable IDisposable IDisposable Pointer )
