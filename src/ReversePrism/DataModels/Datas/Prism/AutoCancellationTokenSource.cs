...
namespace ReversePrism.DataModels
{
    ...
    public partial class AutoCancellationTokenSource : DataModel
    {
        ...
        public static AutoCancellationTokenSource? FromPointer(IntPtr p0)
        {
            ...
            value.Cts                                       = GetObject<CancellationTokenSource>(new IntPtr(p + 0x010), ReversePrism.DataModels.CancellationTokenSource.FromPointer); // 0245A2F30428 0x10 Cts                         ( 0001865A39A0 ModelClassType CancellationTokenSource CancellationTokenSource CancellationTokenSource Pointer )
