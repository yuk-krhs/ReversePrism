...
namespace ReversePrism.DataModels
{
    ...
    public partial class SubSeasonDetailContentElement : DataModel
    {
        ...
        public static SubSeasonDetailContentElement? FromPointer(IntPtr p0)
        {
            ...
            value.EventTitleText                            = GetObject<TextMeshProUGUI>(new IntPtr(p + 0x020), ReversePrism.DataModels.TextMeshProUGUI.FromPointer); // 024664D95430 0x20 EventTitleText              ( 0001866409F0 ModelClassType TextMeshProUGUI TextMeshProUGUI TextMeshProUGUI Pointer )
            value.EventText                                 = GetObject<TextMeshProUGUI>(new IntPtr(p + 0x028), ReversePrism.DataModels.TextMeshProUGUI.FromPointer); // 024664D95450 0x28 EventText                   ( 0001866409F0 ModelClassType TextMeshProUGUI TextMeshProUGUI TextMeshProUGUI Pointer )
            value.StateTitleText                            = GetObject<TextMeshProUGUI>(new IntPtr(p + 0x030), ReversePrism.DataModels.TextMeshProUGUI.FromPointer); // 024664D95470 0x30 StateTitleText              ( 0001866409F0 ModelClassType TextMeshProUGUI TextMeshProUGUI TextMeshProUGUI Pointer )
            value.StateText                                 = GetObject<TextMeshProUGUI>(new IntPtr(p + 0x038), ReversePrism.DataModels.TextMeshProUGUI.FromPointer); // 024664D95490 0x38 StateText                   ( 0001866409F0 ModelClassType TextMeshProUGUI TextMeshProUGUI TextMeshProUGUI Pointer )
            value.TimingTitleText                           = GetObject<TextMeshProUGUI>(new IntPtr(p + 0x040), ReversePrism.DataModels.TextMeshProUGUI.FromPointer); // 024664D954B0 0x40 TimingTitleText             ( 0001866409F0 ModelClassType TextMeshProUGUI TextMeshProUGUI TextMeshProUGUI Pointer )
            value.TimingText                                = GetObject<TextMeshProUGUI>(new IntPtr(p + 0x048), ReversePrism.DataModels.TextMeshProUGUI.FromPointer); // 024664D954D0 0x48 TimingText                  ( 0001866409F0 ModelClassType TextMeshProUGUI TextMeshProUGUI TextMeshProUGUI Pointer )
            value.ConditionTitleText                        = GetObject<TextMeshProUGUI>(new IntPtr(p + 0x050), ReversePrism.DataModels.TextMeshProUGUI.FromPointer); // 024664D954F0 0x50 ConditionTitleText          ( 0001866409F0 ModelClassType TextMeshProUGUI TextMeshProUGUI TextMeshProUGUI Pointer )
            value.NoConditionText                           = GetObject<TextMeshProUGUI>(new IntPtr(p + 0x058), ReversePrism.DataModels.TextMeshProUGUI.FromPointer); // 024664D95510 0x58 NoConditionText             ( 0001866409F0 ModelClassType TextMeshProUGUI TextMeshProUGUI TextMeshProUGUI Pointer )
            value.ParameterContent                          = GetObject<SubSeasonParameterConditionContent>(new IntPtr(p + 0x060), ReversePrism.DataModels.SubSeasonParameterConditionContent.FromPointer); // 024664D95530 0x60 ParameterContent            ( 0001865D6F30 ModelClassType SubSeasonParameterConditionContent SubSeasonParameterConditionContent SubSeasonParameterConditionContent Pointer )
            value.FanContant                                = GetObject<SubSeasonDearnessAndFanConditionContent>(new IntPtr(p + 0x068), ReversePrism.DataModels.SubSeasonDearnessAndFanConditionContent.FromPointer); // 024664D95550 0x68 FanContant                  ( 0001865D3700 ModelClassType SubSeasonDearnessAndFanConditionContent SubSeasonDearnessAndFanConditionContent SubSeasonDearnessAndFanConditionContent Pointer )
            value.DearnessContent                           = GetObject<SubSeasonDearnessAndFanConditionContent>(new IntPtr(p + 0x070), ReversePrism.DataModels.SubSeasonDearnessAndFanConditionContent.FromPointer); // 024664D95570 0x70 DearnessContent             ( 0001865D3700 ModelClassType SubSeasonDearnessAndFanConditionContent SubSeasonDearnessAndFanConditionContent SubSeasonDearnessAndFanConditionContent Pointer )
