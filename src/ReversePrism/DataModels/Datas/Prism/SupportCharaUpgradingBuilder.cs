...
namespace ReversePrism.DataModels
{
    ...
    public partial class SupportCharaUpgradingBuilder : DataModel
    {
        ...
        public static SupportCharaUpgradingBuilder? FromPointer(IntPtr p0)
        {
            ...
            value.TitleView                                 = GetObject<CommonTitleView>(new IntPtr(p + 0x020), ReversePrism.DataModels.CommonTitleView.FromPointer); // 02466B68B1C8 0x20 TitleView                   ( 0001865E9D00 ModelClassType CommonTitleView CommonTitleView CommonTitleView Pointer )
            value.View                                      = GetObject<SupportCharaUpgradingView>(new IntPtr(p + 0x028), ReversePrism.DataModels.SupportCharaUpgradingView.FromPointer); // 02466B68B1E8 0x28 View                        ( 0001865E85C0 ModelClassType SupportCharaUpgradingView SupportCharaUpgradingView SupportCharaUpgradingView Pointer )
            value.StatusView                                = GetObject<SupportCharaStatusView>(new IntPtr(p + 0x030), ReversePrism.DataModels.SupportCharaStatusView.FromPointer); // 02466B68B208 0x30 StatusView                  ( 0001865E33C0 ModelClassType SupportCharaStatusView SupportCharaStatusView SupportCharaStatusView Pointer )
            value.TrainingView                              = GetObject<SupportCharaTrainingView>(new IntPtr(p + 0x038), ReversePrism.DataModels.SupportCharaTrainingView.FromPointer); // 02466B68B228 0x38 TrainingView                ( 0001865E5410 ModelClassType SupportCharaTrainingView SupportCharaTrainingView SupportCharaTrainingView Pointer )
            value.MasterTrainingView                        = GetObject<SupportCharaMasterTrainingView>(new IntPtr(p + 0x040), ReversePrism.DataModels.SupportCharaMasterTrainingView.FromPointer); // 02466B68B248 0x40 MasterTrainingView          ( 0001865E0C60 ModelClassType SupportCharaMasterTrainingView SupportCharaMasterTrainingView SupportCharaMasterTrainingView Pointer )
            value.SCharaDetailPopupViewFactory              = GetObject<SCharaDetailPopupViewFactory>(new IntPtr(p + 0x048), ReversePrism.DataModels.SCharaDetailPopupViewFactory.FromPointer); // 02466B68B268 0x48 SCharaDetailPopupViewFactory ( 0001866A44F0 ModelClassType SCharaDetailPopupViewFactory SCharaDetailPopupViewFactory SCharaDetailPopupViewFactory Pointer )
            value.SelectFavoriteMarkPopupViewFactory        = GetObject<SelectFavoriteMarkPopupViewFactory>(new IntPtr(p + 0x050), ReversePrism.DataModels.SelectFavoriteMarkPopupViewFactory.FromPointer); // 02466B68B288 0x50 SelectFavoriteMarkPopupViewFactory ( 000186715A50 ModelClassType SelectFavoriteMarkPopupViewFactory SelectFavoriteMarkPopupViewFactory SelectFavoriteMarkPopupViewFactory Pointer )
            value.ScTrainingExecutionConfirmedPopupViewFactory = GetObject<SCTrainingExecutionConfirmedPopupViewFactory>(new IntPtr(p + 0x058), ReversePrism.DataModels.SCTrainingExecutionConfirmedPopupViewFactory.FromPointer); // 02466B68B2A8 0x58 ScTrainingExecutionConfirmedPopupViewFactory ( 0001866A27A0 ModelClassType SCTrainingExecutionConfirmedPopupViewFactory SCTrainingExecutionConfirmedPopupViewFactory SCTrainingExecutionConfirmedPopupViewFactory Pointer )
            value.SupportCharaLvUpCompletedPopupViewFactory = GetObject<SupportCharaLvUpCompletedPopupViewFactory>(new IntPtr(p + 0x060), ReversePrism.DataModels.SupportCharaLvUpCompletedPopupViewFactory.FromPointer); // 02466B68B2C8 0x60 SupportCharaLvUpCompletedPopupViewFactory ( 0001865DFE20 ModelClassType SupportCharaLvUpCompletedPopupViewFactory SupportCharaLvUpCompletedPopupViewFactory SupportCharaLvUpCompletedPopupViewFactory Pointer )
            value.MasterTrainingExecutionConfirmedPopupViewFactory = GetObject<MasterTrainingExecutionConfirmedPopupViewFactory>(new IntPtr(p + 0x068), ReversePrism.DataModels.MasterTrainingExecutionConfirmedPopupViewFactory.FromPointer); // 02466B68B2E8 0x68 MasterTrainingExecutionConfirmedPopupViewFactory ( 0001865DA760 ModelClassType MasterTrainingExecutionConfirmedPopupViewFactory MasterTrainingExecutionConfirmedPopupViewFactory MasterTrainingExecutionConfirmedPopupViewFactory Pointer )
