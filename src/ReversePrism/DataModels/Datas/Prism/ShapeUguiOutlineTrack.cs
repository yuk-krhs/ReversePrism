...
namespace ReversePrism.DataModels
{
    ...
    public partial class ShapeUguiOutlineTrack : DataModel
    {
        ...
        public static ShapeUguiOutlineTrack? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new ShapeUguiOutlineTrack() { Pointer= p0 };
