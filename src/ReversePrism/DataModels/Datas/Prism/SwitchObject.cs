...
namespace ReversePrism.DataModels
{
    ...
    public partial class SwitchObject : DataModel
    {
        ...
        public static SwitchObject? FromPointer(IntPtr p0)
        {
            ...
            value._SwitchObject                             = GetObjectList<SwitchObjectData>(new IntPtr(p + 0x020), ReversePrism.DataModels.SwitchObjectData.FromPointer); // 0245A6B01CB0 0x20 _SwitchObject               ( 000185CC3DE8 ModelClassListType SwitchObjectData[] SwitchObjectData[] List<SwitchObjectData> Pointer )
