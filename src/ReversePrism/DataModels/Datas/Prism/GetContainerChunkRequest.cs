...
namespace ReversePrism.DataModels
{
    ...
    public partial class GetContainerChunkRequest
    {
        ...
        public static GetContainerChunkRequest? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GetContainerChunkRequest();

            value.StreamingId                               = GetString(new IntPtr(p + 0x018)); // 0270D4B8F170 0x18 StreamingId                 ( 000186671910 ModelPrimitiveType string string string String )
            value.ResumeSequenceNumber                      = GetInt32(new IntPtr(p + 0x020)); // 0270D4B8F1B0 0x20 ResumeSequenceNumber        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
