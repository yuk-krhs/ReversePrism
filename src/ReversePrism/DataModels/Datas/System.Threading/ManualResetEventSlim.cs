...
namespace ReversePrism.DataModels
{
    ...
    public partial class ManualResetEventSlim
    {
        ...
        public static ManualResetEventSlim? FromPointer(IntPtr p0)
        {
            ...
            value.M_eventObj                                = GetObject<ManualResetEvent>(new IntPtr(p + 0x018), ReversePrism.DataModels.ManualResetEvent.FromPointer); // 0270D6AC4378 0x18 M_eventObj                  ( 00018660A400 ModelClassType ManualResetEvent ManualResetEvent ManualResetEvent Pointer )
            value.M_combinedState                           = GetInt32(new IntPtr(p + 0x020)); // 0270D6AC4398 0x20 M_combinedState             ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
