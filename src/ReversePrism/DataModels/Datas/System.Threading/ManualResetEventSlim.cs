...
namespace ReversePrism.DataModels
{
    ...
    // 018 M_eventObj                               ModelClassType ManualResetEvent ManualResetEvent ManualResetEvent Pointer
    // 020 M_combinedState                          ModelPrimitiveType int int int Int32
    ...
    public partial class ManualResetEventSlim : DataModel
    {
        ...
        public static ManualResetEventSlim? FromPointer(IntPtr p0)
        {
            ...
            value.M_eventObj                                = GetObject<ManualResetEvent>(new IntPtr(p + 0x018), ReversePrism.DataModels.ManualResetEvent.FromPointer); // 0x18 M_eventObj                  ( ModelClassType ManualResetEvent ManualResetEvent ManualResetEvent Pointer )
            value.M_combinedState                           = GetInt32(new IntPtr(p + 0x020)); // 0x20 M_combinedState             ( ModelPrimitiveType int int int Int32 )
