...
namespace ReversePrism.DataModels
{
    ...
    // 018 CurrArrayIndex                           ModelPrimitiveType int int int Int32
    public partial class CancellationCallbackCoreWorkArguments : DataModel
    {
        ...
        public static CancellationCallbackCoreWorkArguments? FromPointer(IntPtr p0)
        {
            ...
            value.CurrArrayIndex                            = GetInt32(new IntPtr(p + 0x018)); // 0x18 CurrArrayIndex              ( ModelPrimitiveType int int int Int32 )
