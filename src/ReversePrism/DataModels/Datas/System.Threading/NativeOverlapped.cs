...
namespace ReversePrism.DataModels
{
    ...
    public partial class NativeOverlapped
    {
        ...
        public static NativeOverlapped? FromPointer(IntPtr p0)
        {
            ...
            value.OffsetLow                                 = GetInt32(new IntPtr(p + 0x020)); // 0270D6AC5140 0x20 OffsetLow                   ( 0001865F36C0 ModelPrimitiveType int int int Int32 )
            value.OffsetHigh                                = GetInt32(new IntPtr(p + 0x024)); // 0270D6AC5160 0x24 OffsetHigh                  ( 0001865F36C0 ModelPrimitiveType int int int Int32 )
