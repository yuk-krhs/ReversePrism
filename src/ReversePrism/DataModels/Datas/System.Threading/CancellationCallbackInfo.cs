...
namespace ReversePrism.DataModels
{
    ...
    // 020 TargetExecutionContext                   ModelClassType ExecutionContext ExecutionContext ExecutionContext Pointer
    ...
    public partial class CancellationCallbackInfo : DataModel
    {
        ...
        public static CancellationCallbackInfo? FromPointer(IntPtr p0)
        {
            ...
            value.TargetExecutionContext                    = GetObject<ExecutionContext>(new IntPtr(p + 0x020), ReversePrism.DataModels.ExecutionContext.FromPointer); // 0x20 TargetExecutionContext      ( ModelClassType ExecutionContext ExecutionContext ExecutionContext Pointer )
