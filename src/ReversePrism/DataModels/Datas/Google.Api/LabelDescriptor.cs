...
namespace ReversePrism.DataModels
{
    ...
    // 018 Key                                      ModelPrimitiveType string string string String
    // 000 ValueTypeFieldNumber                     int IL2CPP_TYPE_I4
    // 020 ValueType                                ModelEnumType ValueType ValueType ValueType Int32
    ...
    public partial class LabelDescriptor : DataModel
    {
        ...
        public static LabelDescriptor? FromPointer(IntPtr p0)
        {
            ...
            value.Key                                       = GetString(new IntPtr(p + 0x018)); // 0x18 Key                         ( ModelPrimitiveType string string string String )
            value.ValueType                                 = (ValueType)GetInt32(new IntPtr(p + 0x020)); // 0x20 ValueType                   ( ModelEnumType ValueType ValueType ValueType Int32 )
