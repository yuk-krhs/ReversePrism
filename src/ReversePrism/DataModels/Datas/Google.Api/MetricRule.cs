...
namespace ReversePrism.DataModels
{
    ...
    public partial class MetricRule
    {
        ...
        public static MetricRule? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new MetricRule();

            value.Selector                                  = GetString(new IntPtr(p + 0x018)); // 0270DA82F198 0x18 Selector                    ( 000186671910 ModelPrimitiveType string string string String )
