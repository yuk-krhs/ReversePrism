...
namespace ReversePrism.DataModels
{
    ...
    public partial class Logging
    {
        ...
        public static Logging? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new Logging();

            value.ProducerDestinations                      = GetObjectList<LoggingDestination>(new IntPtr(p + 0x018), ReversePrism.DataModels.LoggingDestination.FromPointer); // 0270DA7E99E8 0x18 ProducerDestinations        ( 000185CF9238 ModelClassListType RepeatedField`1<LoggingDestination> RepeatedField`1<LoggingDestination> List<LoggingDestination> Pointer )
            value.ConsumerDestinations                      = GetObjectList<LoggingDestination>(new IntPtr(p + 0x020), ReversePrism.DataModels.LoggingDestination.FromPointer); // 0270DA7E9A48 0x20 ConsumerDestinations        ( 000185CF9238 ModelClassListType RepeatedField`1<LoggingDestination> RepeatedField`1<LoggingDestination> List<LoggingDestination> Pointer )
