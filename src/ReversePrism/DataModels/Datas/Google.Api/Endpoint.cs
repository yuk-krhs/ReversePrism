...
namespace ReversePrism.DataModels
{
    ...
    // 020 Aliases                                  ModelPrimitiveListType RepeatedField`1<string> RepeatedField`1<string> List<string> Pointer
    ...
    // 030 AllowCors                                ModelPrimitiveType bool bool bool Bool
    public partial class Endpoint : DataModel
    {
        ...
        public static Endpoint? FromPointer(IntPtr p0)
        {
            ...
            value.Aliases                                   = GetStringList(new IntPtr(p + 0x020)); // 0x20 Aliases                     ( ModelPrimitiveListType RepeatedField`1<string> RepeatedField`1<string> List<string> Pointer )
            value.Target                                    = GetString(new IntPtr(p + 0x028)); // 0x28 Target                      ( ModelPrimitiveType string string string String )
            value.AllowCors                                 = GetBool(new IntPtr(p + 0x030)); // 0x30 AllowCors                   ( ModelPrimitiveType bool bool bool Bool )
