...
namespace ReversePrism.DataModels
{
    ...
    public partial class Service
    {
        ...
        public static Service? FromPointer(IntPtr p0)
        {
            ...
            value.Name                                      = GetString(new IntPtr(p + 0x018)); // 0270DA852D50 0x18 Name                        ( 000186671910 ModelPrimitiveType string string string String )
            value.Title                                     = GetString(new IntPtr(p + 0x020)); // 0270DA852D90 0x20 Title                       ( 000186671910 ModelPrimitiveType string string string String )
            value.ProducerProjectId                         = GetString(new IntPtr(p + 0x028)); // 0270DA852DD0 0x28 ProducerProjectId           ( 000186671910 ModelPrimitiveType string string string String )
            value.Id                                        = GetString(new IntPtr(p + 0x030)); // 0270DA852E10 0x30 Id                          ( 000186671910 ModelPrimitiveType string string string String )
            value.Apis                                      = GetObjectList<Api>(new IntPtr(p + 0x038), ReversePrism.DataModels.Api.FromPointer); // 0270DA852E70 0x38 Apis                        ( 000185CCE6A8 ModelClassListType RepeatedField`1<Api> RepeatedField`1<Api> List<Api> Pointer )
            value.Types                                     = GetObjectList<Type>(new IntPtr(p + 0x040), ReversePrism.DataModels.Type.FromPointer); // 0270DA852ED0 0x40 Types                       ( 000185CF6068 ModelClassListType RepeatedField`1<Type> RepeatedField`1<Type> List<Type> Pointer )
            value.Enums                                     = GetObjectList<Enum>(new IntPtr(p + 0x048), ReversePrism.DataModels.Enum.FromPointer); // 0270DA852F30 0x48 Enums                       ( 000185CD42C8 ModelClassListType RepeatedField`1<Enum> RepeatedField`1<Enum> List<Enum> Pointer )
            value.Documentation                             = GetObject<Documentation>(new IntPtr(p + 0x050), ReversePrism.DataModels.Documentation.FromPointer); // 0270DA852F70 0x50 Documentation               ( 0001866E99A0 ModelClassType Documentation Documentation Documentation Pointer )
            value.Backend                                   = GetObject<Backend>(new IntPtr(p + 0x058), ReversePrism.DataModels.Backend.FromPointer); // 0270DA852FB0 0x58 Backend                     ( 000186733360 ModelClassType Backend Backend Backend Pointer )
            value.Http                                      = GetObject<Http>(new IntPtr(p + 0x060), ReversePrism.DataModels.Http.FromPointer); // 0270DA852FF0 0x60 Http                        ( 0001866DB7C0 ModelClassType Http Http Http Pointer )
            value.Quota                                     = GetObject<Quota>(new IntPtr(p + 0x068), ReversePrism.DataModels.Quota.FromPointer); // 0270DA853030 0x68 Quota                       ( 000186601160 ModelClassType Quota Quota Quota Pointer )
            value.Authentication                            = GetObject<Authentication>(new IntPtr(p + 0x070), ReversePrism.DataModels.Authentication.FromPointer); // 0270DA853070 0x70 Authentication              ( 000186722470 ModelClassType Authentication Authentication Authentication Pointer )
            value.Context                                   = GetObject<Context>(new IntPtr(p + 0x078), ReversePrism.DataModels.Context.FromPointer); // 0270DA8530B0 0x78 Context                     ( 000186613070 ModelClassType Context Context Context Pointer )
            value.Usage                                     = GetObject<Usage>(new IntPtr(p + 0x080), ReversePrism.DataModels.Usage.FromPointer); // 0270DA8530F0 0x80 Usage                       ( 000186749260 ModelClassType Usage Usage Usage Pointer )
            value.Endpoints                                 = GetObjectList<Endpoint>(new IntPtr(p + 0x088), ReversePrism.DataModels.Endpoint.FromPointer); // 0270DA853150 0x88 Endpoints                   ( 000185CD4058 ModelClassListType RepeatedField`1<Endpoint> RepeatedField`1<Endpoint> List<Endpoint> Pointer )
            value.Control                                   = GetObject<Control>(new IntPtr(p + 0x090), ReversePrism.DataModels.Control.FromPointer); // 0270DA853190 0x90 Control                     ( 00018661AF00 ModelClassType Control Control Control Pointer )
            value.Logs                                      = GetObjectList<LogDescriptor>(new IntPtr(p + 0x098), ReversePrism.DataModels.LogDescriptor.FromPointer); // 0270DA8531F0 0x98 Logs                        ( 000185CE49E8 ModelClassListType RepeatedField`1<LogDescriptor> RepeatedField`1<LogDescriptor> List<LogDescriptor> Pointer )
            value.Metrics                                   = GetObjectList<MetricDescriptor>(new IntPtr(p + 0x0A0), ReversePrism.DataModels.MetricDescriptor.FromPointer); // 0270DA853250 0xA0 Metrics                     ( 000185CE6568 ModelClassListType RepeatedField`1<MetricDescriptor> RepeatedField`1<MetricDescriptor> List<MetricDescriptor> Pointer )
            value.MonitoredResources                        = GetObjectList<MonitoredResourceDescriptor>(new IntPtr(p + 0x0A8), ReversePrism.DataModels.MonitoredResourceDescriptor.FromPointer); // 0270DA8532B0 0xA8 MonitoredResources          ( 000185CE7598 ModelClassListType RepeatedField`1<MonitoredResourceDescriptor> RepeatedField`1<MonitoredResourceDescriptor> List<MonitoredResourceDescriptor> Pointer )
            value.Billing                                   = GetObject<Billing>(new IntPtr(p + 0x0B0), ReversePrism.DataModels.Billing.FromPointer); // 0270DA8532F0 0xB0 Billing                     ( 000186751090 ModelClassType Billing Billing Billing Pointer )
            value.Logging                                   = GetObject<Logging>(new IntPtr(p + 0x0B8), ReversePrism.DataModels.Logging.FromPointer); // 0270DA853330 0xB8 Logging                     ( 0001865B46A0 ModelClassType Logging Logging Logging Pointer )
            value.Monitoring                                = GetObject<Monitoring>(new IntPtr(p + 0x0C0), ReversePrism.DataModels.Monitoring.FromPointer); // 0270DA853370 0xC0 Monitoring                  ( 00018663CD00 ModelClassType Monitoring Monitoring Monitoring Pointer )
            value.SystemParameters                          = GetObject<SystemParameters>(new IntPtr(p + 0x0C8), ReversePrism.DataModels.SystemParameters.FromPointer); // 0270DA8533B0 0xC8 SystemParameters            ( 000186608530 ModelClassType SystemParameters SystemParameters SystemParameters Pointer )
            value.SourceInfo                                = GetObject<SourceInfo>(new IntPtr(p + 0x0D0), ReversePrism.DataModels.SourceInfo.FromPointer); // 0270DA8533F0 0xD0 SourceInfo                  ( 00018653A1C0 ModelClassType SourceInfo SourceInfo SourceInfo Pointer )
