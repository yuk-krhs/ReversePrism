...
namespace ReversePrism.DataModels
{
    ...
    // 020 ChildType                                ModelPrimitiveType string string string String
    public partial class ResourceReference : DataModel
    {
        ...
        public static ResourceReference? FromPointer(IntPtr p0)
        {
            ...
            value.ChildType                                 = GetString(new IntPtr(p + 0x020)); // 0x20 ChildType                   ( ModelPrimitiveType string string string String )
