...
namespace ReversePrism.DataModels
{
    ...
    // 020 Type                                     ModelEnumType PropertyType PropertyType PropertyType Int32
    ...
    public partial class Property : DataModel
    {
        ...
        public static Property? FromPointer(IntPtr p0)
        {
            ...
            value.Type                                      = (PropertyType)GetInt32(new IntPtr(p + 0x020)); // 0x20 Type                        ( ModelEnumType PropertyType PropertyType PropertyType Int32 )
