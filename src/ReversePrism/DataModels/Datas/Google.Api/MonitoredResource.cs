...
namespace ReversePrism.DataModels
{
    ...
    public partial class MonitoredResource
    {
        ...
        public static MonitoredResource? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new MonitoredResource();

            value.Type                                      = GetString(new IntPtr(p + 0x018)); // 0270DA801580 0x18 Type                        ( 000186671910 ModelPrimitiveType string string string String )
