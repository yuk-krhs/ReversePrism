...
namespace ReversePrism.DataModels
{
    ...
    public partial class double3x2
    {
        ...
        public static double3x2? FromPointer(IntPtr p0)
        {
            ...
            value.C0                                        = (double3)GetInt32(new IntPtr(p + 0x010)); // 0270D7E61930 0x10 C0                          ( 0001866C40F0 ModelEnumType double3 double3 double3 Int32 )
            value.C1                                        = (double3)GetInt32(new IntPtr(p + 0x028)); // 0270D7E61950 0x28 C1                          ( 0001866C40F0 ModelEnumType double3 double3 double3 Int32 )
