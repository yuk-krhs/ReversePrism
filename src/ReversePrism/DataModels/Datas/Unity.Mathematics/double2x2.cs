...
namespace ReversePrism.DataModels
{
    ...
    // 020 Zero                                     ModelEnumType double2x2 double2x2 double2x2 Int32
    public partial class double2x2 : DataModel
    {
        ...
        public static double2x2? FromPointer(IntPtr p0)
        {
            ...
            value.Zero                                      = (double2x2)GetInt32(new IntPtr(p + 0x020)); // 0x20 Zero                        ( ModelEnumType double2x2 double2x2 double2x2 Int32 )
