...
namespace ReversePrism.DataModels
{
    ...
    public partial class double4x2
    {
        ...
        public static double4x2? FromPointer(IntPtr p0)
        {
            ...
            value.C0                                        = (double4)GetInt32(new IntPtr(p + 0x010)); // 0270D7E6AE60 0x10 C0                          ( 0001866C4F90 ModelEnumType double4 double4 double4 Int32 )
            value.C1                                        = (double4)GetInt32(new IntPtr(p + 0x030)); // 0270D7E6AE80 0x30 C1                          ( 0001866C4F90 ModelEnumType double4 double4 double4 Int32 )
