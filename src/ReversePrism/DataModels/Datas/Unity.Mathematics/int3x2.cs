...
namespace ReversePrism.DataModels
{
    ...
    public partial class int3x2
    {
        ...
        public static int3x2? FromPointer(IntPtr p0)
        {
            ...
            value.C0                                        = (int3)GetInt32(new IntPtr(p + 0x010)); // 0270D7E72890 0x10 C0                          ( 0001866C91E0 ModelEnumType int3 int3 int3 Int32 )
            value.C1                                        = (int3)GetInt32(new IntPtr(p + 0x01C)); // 0270D7E728B0 0x1C C1                          ( 0001866C91E0 ModelEnumType int3 int3 int3 Int32 )
