...
namespace ReversePrism.DataModels
{
    ...
    public partial class SystemCertificateProvider
    {
        ...
        public static SystemCertificateProvider? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SystemCertificateProvider();

            value.X509pal                                   = GetObject<X509PalImpl>(new IntPtr(p + 0x010), ReversePrism.DataModels.X509PalImpl.FromPointer); // 0270D78D7590 0x10 X509pal                     ( 00018656E230 ModelClassType X509PalImpl X509PalImpl X509PalImpl Pointer )
