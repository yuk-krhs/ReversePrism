...
namespace ReversePrism.DataModels
{
    ...
    public partial class CultureNotFoundException
    {
        ...
        public static CultureNotFoundException? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new CultureNotFoundException();

            value.InvalidCultureName                        = GetString(new IntPtr(p + 0x098)); // 0270D6D312F0 0x98 InvalidCultureName          ( 000186671910 ModelPrimitiveType string string string String )
