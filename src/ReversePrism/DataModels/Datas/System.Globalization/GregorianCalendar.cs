...
namespace ReversePrism.DataModels
{
    ...
    public partial class GregorianCalendar
    {
        ...
        public static GregorianCalendar? FromPointer(IntPtr p0)
        {
            ...
            value.M_type                                    = (GregorianCalendarTypes)GetInt32(new IntPtr(p + 0x020)); // 027003CB5648 0x20 M_type                      ( 0001866996C0 ModelEnumType GregorianCalendarTypes GregorianCalendarTypes GregorianCalendarTypes Int32 )
            value.S_defaultInstance                         = GetObject<Calendar>(new IntPtr(p + 0x010), ReversePrism.DataModels.Calendar.FromPointer); // 027003CB56A8 0x10 S_defaultInstance           ( 0001865A1400 ModelClassType Calendar Calendar Calendar Pointer )
