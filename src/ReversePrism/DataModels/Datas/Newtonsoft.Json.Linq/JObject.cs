...
namespace ReversePrism.DataModels
{
    ...
    public partial class JObject : DataModel
    {
        ...
        public static JObject? FromPointer(IntPtr p0)
        {
            ...
            value.Properties                                = GetObject<JPropertyKeyedCollection>(new IntPtr(p + 0x058), ReversePrism.DataModels.JPropertyKeyedCollection.FromPointer); // 024668811C58 0x58 Properties                  ( 0001867456C0 ModelClassType JPropertyKeyedCollection JPropertyKeyedCollection JPropertyKeyedCollection Pointer )
            value.PropertyChanged                           = GetObject<PropertyChangedEventHandler>(new IntPtr(p + 0x060), ReversePrism.DataModels.PropertyChangedEventHandler.FromPointer); // 024668811C78 0x60 PropertyChanged             ( 0001865D1C20 ModelClassType PropertyChangedEventHandler PropertyChangedEventHandler PropertyChangedEventHandler Pointer )
            value.PropertyChanging                          = GetObject<PropertyChangingEventHandler>(new IntPtr(p + 0x068), ReversePrism.DataModels.PropertyChangingEventHandler.FromPointer); // 024668811C98 0x68 PropertyChanging            ( 0001865D2580 ModelClassType PropertyChangingEventHandler PropertyChangingEventHandler PropertyChangingEventHandler Pointer )
