...
namespace ReversePrism.DataModels
{
    ...
    public partial class Diagnostics
    {
        ...
        public static Diagnostics? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new Diagnostics();

            value.Handler                                   = GetObject<DiagnosticsHandler>(new IntPtr(p + 0x010), ReversePrism.DataModels.DiagnosticsHandler.FromPointer); // 027006673D68 0x10 Handler                     ( 0001866CEA40 ModelClassType DiagnosticsHandler DiagnosticsHandler DiagnosticsHandler Pointer )
