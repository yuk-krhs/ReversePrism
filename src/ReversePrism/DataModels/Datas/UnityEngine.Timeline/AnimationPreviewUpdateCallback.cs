...
namespace ReversePrism.DataModels
{
    ...
    public partial class AnimationPreviewUpdateCallback
    {
        ...
        public static AnimationPreviewUpdateCallback? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new AnimationPreviewUpdateCallback();

            value.M_Output                                  = (AnimationPlayableOutput)GetInt32(new IntPtr(p + 0x010)); // 0270DB239140 0x10 M_Output                    ( 0001866B67B0 ModelEnumType AnimationPlayableOutput AnimationPlayableOutput AnimationPlayableOutput Int32 )
            value.M_Graph                                   = (PlayableGraph)GetInt32(new IntPtr(p + 0x020)); // 0270DB239160 0x20 M_Graph                     ( 00018663F7C0 ModelEnumType PlayableGraph PlayableGraph PlayableGraph Int32 )
            value.M_PreviewComponents                       = GetObjectList<IAnimationWindowPreview>(new IntPtr(p + 0x030), ReversePrism.DataModels.IAnimationWindowPreview.FromPointer); // 0270DB239180 0x30 M_PreviewComponents         ( 000185CE0A78 ModelClassListType List`1<IAnimationWindowPreview> List`1<IAnimationWindowPreview> List<IAnimationWindowPreview> Pointer )
