...
namespace ReversePrism.DataModels
{
    ...
    // 010 M_DiscreteTime                           ModelPrimitiveType long long long Int64
    public partial class DiscreteTime : DataModel
    {
        ...
        public static DiscreteTime? FromPointer(IntPtr p0)
        {
            ...
            value.M_DiscreteTime                            = GetInt64(new IntPtr(p + 0x010)); // 0x10 M_DiscreteTime              ( ModelPrimitiveType long long long Int64 )
