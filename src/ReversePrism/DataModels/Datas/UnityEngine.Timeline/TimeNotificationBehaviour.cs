...
namespace ReversePrism.DataModels
{
    ...
    public partial class TimeNotificationBehaviour : DataModel
    {
        ...
        public static TimeNotificationBehaviour? FromPointer(IntPtr p0)
        {
            ...
            value.M_Notifications                           = GetEnumList<NotificationEntry>(new IntPtr(p + 0x010)); // 02466B30B990 0x10 M_Notifications             ( 000185D2E808 ModelEnumListType List`1<NotificationEntry> List`1<NotificationEntry> List<NotificationEntry> Pointer )
            value.M_PreviousTime                            = GetDouble(new IntPtr(p + 0x018)); // 02466B30B9B0 0x18 M_PreviousTime              ( 0001865C2950 ModelPrimitiveType double double double Double )
            value.M_NeedSortNotifications                   = GetBool(new IntPtr(p + 0x020)); // 02466B30B9D0 0x20 M_NeedSortNotifications     ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.M_TimeSource                              = (Playable)GetInt32(new IntPtr(p + 0x028)); // 02466B30B9F0 0x28 M_TimeSource                ( 00018674C270 ModelEnumType Playable Playable Playable Int32 )
