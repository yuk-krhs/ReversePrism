...
namespace ReversePrism.DataModels
{
    ...
    public partial class OpacityIdAccelerator : DataModel
    {
        ...
        public static OpacityIdAccelerator? FromPointer(IntPtr p0)
        {
            ...
            value.M_NextJobIndex                            = GetInt32(new IntPtr(p + 0x020)); // 0245A682A378 0x20 M_NextJobIndex              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Disposed                                  = GetBool(new IntPtr(p + 0x024)); // 0245A682A398 0x24 Disposed                    ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
