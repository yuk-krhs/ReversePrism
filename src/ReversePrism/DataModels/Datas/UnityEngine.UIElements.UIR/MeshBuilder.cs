...
namespace ReversePrism.DataModels
{
    ...
    public partial class MeshBuilder : DataModel
    {
        ...
        public static MeshBuilder? FromPointer(IntPtr p0)
        {
            ...
            value.S_VectorGraphicsScaleTriangle             = (ProfilerMarker)GetInt32(new IntPtr(p + 0x010)); // 0245A6829D08 0x10 S_VectorGraphicsScaleTriangle ( 0001865C9730 ModelEnumType ProfilerMarker ProfilerMarker ProfilerMarker Int32 )
            value.S_VectorGraphicsStretch                   = (ProfilerMarker)GetInt32(new IntPtr(p + 0x018)); // 0245A6829D28 0x18 S_VectorGraphicsStretch     ( 0001865C9730 ModelEnumType ProfilerMarker ProfilerMarker ProfilerMarker Int32 )
            value.S_MaxTextMeshVertices                     = GetInt32(new IntPtr(p + 0x020)); // 0245A6829D48 0x20 S_MaxTextMeshVertices       ( 0001865F4E00 ModelPrimitiveType int int int Int32 )
