...
namespace ReversePrism.DataModels
{
    ...
    // 018 M_Allocator                              ModelEnumType AllocatorHandle AllocatorHandle AllocatorHandle Int32
    public partial class NativeHashMapDispose : DataModel
    {
        ...
        public static NativeHashMapDispose? FromPointer(IntPtr p0)
        {
            ...
            value.M_Allocator                               = (AllocatorHandle)GetInt32(new IntPtr(p + 0x018)); // 0x18 M_Allocator                 ( ModelEnumType AllocatorHandle AllocatorHandle AllocatorHandle Int32 )
