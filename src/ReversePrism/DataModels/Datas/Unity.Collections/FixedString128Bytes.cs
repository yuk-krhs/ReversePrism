...
namespace ReversePrism.DataModels
{
    ...
    // 012 Bytes                                    ModelEnumType FixedBytes126 FixedBytes126 FixedBytes126 Int32
    public partial class FixedString128Bytes : DataModel
    {
        ...
        public static FixedString128Bytes? FromPointer(IntPtr p0)
        {
            ...
            value.Bytes                                     = (FixedBytes126)GetInt32(new IntPtr(p + 0x012)); // 0x12 Bytes                       ( ModelEnumType FixedBytes126 FixedBytes126 FixedBytes126 Int32 )
