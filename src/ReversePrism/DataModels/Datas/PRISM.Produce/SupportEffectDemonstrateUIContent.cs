...
namespace ReversePrism.DataModels
{
    ...
    public partial class SupportEffectDemonstrateUIContent
    {
        ...
        public static SupportEffectDemonstrateUIContent? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SupportEffectDemonstrateUIContent();

            value.SupportEffectContentList                  = GetObjectList<SupportEffectContent>(new IntPtr(p + 0x020), ReversePrism.DataModels.SupportEffectContent.FromPointer); // 0270D4BAE160 0x20 SupportEffectContentList    ( 000185D10518 ModelClassListType List`1<SupportEffectContent> List`1<SupportEffectContent> List<SupportEffectContent> Pointer )
            value.OnDisplayTapButton                        = GetObject<UIButton>(new IntPtr(p + 0x028), ReversePrism.DataModels.UIButton.FromPointer); // 0270D4BAE180 0x28 OnDisplayTapButton          ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.AnimatorWithEvent                         = GetObject<AnimatorWithEvent>(new IntPtr(p + 0x030), ReversePrism.DataModels.AnimatorWithEvent.FromPointer); // 0270D4BAE1A0 0x30 AnimatorWithEvent           ( 0001866BBE80 ModelClassType AnimatorWithEvent AnimatorWithEvent AnimatorWithEvent Pointer )
            value.IsTapped                                  = GetBool(new IntPtr(p + 0x038)); // 0270D4BAE1C0 0x38 IsTapped                    ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
