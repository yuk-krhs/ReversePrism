...
namespace ReversePrism.DataModels
{
    ...
    public partial class LegacyProduceFriendSupportSelectParameter : DataModel
    {
        ...
        public static LegacyProduceFriendSupportSelectParameter? FromPointer(IntPtr p0)
        {
            ...
            value.UnitId                                    = GetInt32(new IntPtr(p + 0x010)); // 024665A68900 0x10 UnitId                      ( 0001865F4940 ModelPrimitiveType int int int Int32 )
            value.UnitName                                  = GetString(new IntPtr(p + 0x018)); // 024665A68920 0x18 UnitName                    ( 0001866736C0 ModelPrimitiveType string string string String )
            value.SelfSupportCharacters                     = GetObjectList<ISupportCharacterStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ISupportCharacterStatus.FromPointer); // 024665A68940 0x20 SelfSupportCharacters       ( 000185D0D958 ModelClassListType IReadOnlyList`1<ISupportCharacterStatus> IReadOnlyList`1<ISupportCharacterStatus> List<ISupportCharacterStatus> Pointer )
            value.EpisodeSelectModel                        = GetObject<ViewProducePreparationEpisodeSelectModel>(new IntPtr(p + 0x028), ReversePrism.DataModels.ViewProducePreparationEpisodeSelectModel.FromPointer); // 024665A68960 0x28 EpisodeSelectModel          ( 000186520000 ModelClassType ViewProducePreparationEpisodeSelectModel ViewProducePreparationEpisodeSelectModel ViewProducePreparationEpisodeSelectModel Pointer )
            value.TutorialFriendSupport                     = GetObject<IFriendSupportStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.IFriendSupportStatus.FromPointer); // 024665A68980 0x30 TutorialFriendSupport       ( 00018651C510 ModelClassType IFriendSupportStatus IFriendSupportStatus IFriendSupportStatus Pointer )
