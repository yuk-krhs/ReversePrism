...
namespace ReversePrism.DataModels
{
    ...
    // 028 ProducePointValue                        ModelPrimitiveType int int int Int32
    // 02C CurrentPlayerPPRecoveryTime              ModelPrimitiveType float float float Single
    ...
    // 048 ProducePointMaxBase                      ModelPrimitiveType int int int Int32
    public partial class IngameProducePointModel : DataModel
    {
        ...
        public static IngameProducePointModel? FromPointer(IntPtr p0)
        {
            ...
            value.ProducePointValue                         = GetInt32(new IntPtr(p + 0x028)); // 0x28 ProducePointValue           ( ModelPrimitiveType int int int Int32 )
            value.CurrentPlayerPPRecoveryTime               = GetSingle(new IntPtr(p + 0x02C)); // 0x2C CurrentPlayerPPRecoveryTime ( ModelPrimitiveType float float float Single )
            value.ProducePointMaxBase                       = GetInt32(new IntPtr(p + 0x048)); // 0x48 ProducePointMaxBase         ( ModelPrimitiveType int int int Int32 )
