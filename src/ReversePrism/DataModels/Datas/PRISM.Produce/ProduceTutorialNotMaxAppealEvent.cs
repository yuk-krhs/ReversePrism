...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceTutorialNotMaxAppealEvent : DataModel
    {
        ...
        public static ProduceTutorialNotMaxAppealEvent? FromPointer(IntPtr p0)
        {
            ...
            value.TutorialExternalAccess                    = GetObject<TutorialExternalAccess>(new IntPtr(p + 0x010), ReversePrism.DataModels.TutorialExternalAccess.FromPointer); // 024665DBB2A0 0x10 TutorialExternalAccess      ( 0001866B98B0 ModelClassType TutorialExternalAccess TutorialExternalAccess TutorialExternalAccess Pointer )
            value.IsNotMaxAppeal                            = GetBool(new IntPtr(p + 0x018)); // 024665DBB2C0 0x18 IsNotMaxAppeal              ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
