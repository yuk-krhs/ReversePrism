...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProducePreparationEpisodeSelectAttributeIcon : DataModel
    {
        ...
        public static ProducePreparationEpisodeSelectAttributeIcon? FromPointer(IntPtr p0)
        {
            ...
            value.VodavimeLabel                             = GetObject<VoDaViMeLabel>(new IntPtr(p + 0x020), ReversePrism.DataModels.VoDaViMeLabel.FromPointer); // 024665A3DBA0 0x20 VodavimeLabel               ( 000186530180 ModelClassType VoDaViMeLabel VoDaViMeLabel VoDaViMeLabel Pointer )
