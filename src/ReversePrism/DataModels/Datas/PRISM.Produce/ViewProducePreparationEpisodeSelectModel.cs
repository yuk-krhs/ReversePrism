...
namespace ReversePrism.DataModels
{
    ...
    public partial class ViewProducePreparationEpisodeSelectModel
    {
        ...
        public static ViewProducePreparationEpisodeSelectModel? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ViewProducePreparationEpisodeSelectModel();

            value.LocalSaveData                             = GetObject<ProducePreparationEpisodeSelectSaveData>(new IntPtr(p + 0x010), ReversePrism.DataModels.ProducePreparationEpisodeSelectSaveData.FromPointer); // 0270D4CF2E80 0x10 LocalSaveData               ( 00018656B100 ModelClassType ProducePreparationEpisodeSelectSaveData ProducePreparationEpisodeSelectSaveData ProducePreparationEpisodeSelectSaveData Pointer )
            value.UnitEpisodeModels                         = GetObjectList<ProducePreparationEpisodeSelectUnitEpisodeModel>(new IntPtr(p + 0x018), ReversePrism.DataModels.ProducePreparationEpisodeSelectUnitEpisodeModel.FromPointer); // 0270D4CF2EA0 0x18 UnitEpisodeModels           ( 000185B9D730 ModelClassListType ProducePreparationEpisodeSelectUnitEpisodeModel[] ProducePreparationEpisodeSelectUnitEpisodeModel[] List<ProducePreparationEpisodeSelectUnitEpisodeModel> Pointer )
            value.Reply                                     = GetObject<IGetEpisodeListReply>(new IntPtr(p + 0x020), ReversePrism.DataModels.IGetEpisodeListReply.FromPointer); // 0270D4CF2EC0 0x20 Reply                       ( 000186532070 ModelClassType IGetEpisodeListReply IGetEpisodeListReply IGetEpisodeListReply Pointer )
            value.TutorialEpisode                           = GetObject<IEpisodeStatus>(new IntPtr(p + 0x030), ReversePrism.DataModels.IEpisodeStatus.FromPointer); // 0270D4CF2F00 0x30 TutorialEpisode             ( 0001867618B0 ModelClassType IEpisodeStatus IEpisodeStatus IEpisodeStatus Pointer )
            value.CurrentUnitId                             = GetInt32(new IntPtr(p + 0x038)); // 0270D4CF2F20 0x38 CurrentUnitId               ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.CurrentEpisodeId                          = GetInt32(new IntPtr(p + 0x03C)); // 0270D4CF2F40 0x3C CurrentEpisodeId            ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.CurrentDifficulty                         = (ProduceDifficultyType)GetInt32(new IntPtr(p + 0x040)); // 0270D4CF2F60 0x40 CurrentDifficulty           ( 00018660BEF0 ModelEnumType ProduceDifficultyType ProduceDifficultyType ProduceDifficultyType Int32 )
            value.CurrentEpisodeIndex                       = GetInt32(new IntPtr(p + 0x044)); // 0270D4CF2F80 0x44 CurrentEpisodeIndex         ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.CurrentDifficultyIndex                    = GetInt32(new IntPtr(p + 0x048)); // 0270D4CF2FA0 0x48 CurrentDifficultyIndex      ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
