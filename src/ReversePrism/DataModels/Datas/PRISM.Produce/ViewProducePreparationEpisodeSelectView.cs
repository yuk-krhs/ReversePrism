...
namespace ReversePrism.DataModels
{
    ...
    public partial class ViewProducePreparationEpisodeSelectView : DataModel
    {
        ...
        public static ViewProducePreparationEpisodeSelectView? FromPointer(IntPtr p0)
        {
            ...
            value.UnitBackgroundView                        = GetObject<ProducePreparationEpisodeSelectUnitBackgroundView>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProducePreparationEpisodeSelectUnitBackgroundView.FromPointer); // 024665A5C018 0x20 UnitBackgroundView          ( 00018656B8E0 ModelClassType ProducePreparationEpisodeSelectUnitBackgroundView ProducePreparationEpisodeSelectUnitBackgroundView ProducePreparationEpisodeSelectUnitBackgroundView Pointer )
            value.UnitListView                              = GetObject<ProducePreparationEpisodeSelectUnitListView>(new IntPtr(p + 0x028), ReversePrism.DataModels.ProducePreparationEpisodeSelectUnitListView.FromPointer); // 024665A5C038 0x28 UnitListView                ( 00018656D090 ModelClassType ProducePreparationEpisodeSelectUnitListView ProducePreparationEpisodeSelectUnitListView ProducePreparationEpisodeSelectUnitListView Pointer )
            value.EpisodeListView                           = GetObject<ProducePreparationEpisodeSelectListView>(new IntPtr(p + 0x030), ReversePrism.DataModels.ProducePreparationEpisodeSelectListView.FromPointer); // 024665A5C058 0x30 EpisodeListView             ( 00018656AC20 ModelClassType ProducePreparationEpisodeSelectListView ProducePreparationEpisodeSelectListView ProducePreparationEpisodeSelectListView Pointer )
            value.DetailView                                = GetObject<ProducePreparationEpisodeSelectDetailView>(new IntPtr(p + 0x038), ReversePrism.DataModels.ProducePreparationEpisodeSelectDetailView.FromPointer); // 024665A5C078 0x38 DetailView                  ( 00018656A2F0 ModelClassType ProducePreparationEpisodeSelectDetailView ProducePreparationEpisodeSelectDetailView ProducePreparationEpisodeSelectDetailView Pointer )
            value.ConfirmHowToPlayButton                    = GetObject<UIButton>(new IntPtr(p + 0x048), ReversePrism.DataModels.UIButton.FromPointer); // 024665A5C0B8 0x48 ConfirmHowToPlayButton      ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.FeaturesButton                            = GetObject<UIButton>(new IntPtr(p + 0x050), ReversePrism.DataModels.UIButton.FromPointer); // 024665A5C0D8 0x50 FeaturesButton              ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.TutorialButton                            = GetObject<UIButton>(new IntPtr(p + 0x058), ReversePrism.DataModels.UIButton.FromPointer); // 024665A5C0F8 0x58 TutorialButton              ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.HowToPlayManualKey                        = GetString(new IntPtr(p + 0x060)); // 024665A5C118 0x60 HowToPlayManualKey          ( 000186671910 ModelPrimitiveType string string string String )
            value.FesDataPossessionLimitCheckerCaller       = GetObject<IFesDataPossessionLimitCheckerCaller>(new IntPtr(p + 0x068), ReversePrism.DataModels.IFesDataPossessionLimitCheckerCaller.FromPointer); // 024665A5C138 0x68 FesDataPossessionLimitCheckerCaller ( 000186777310 ModelClassType IFesDataPossessionLimitCheckerCaller IFesDataPossessionLimitCheckerCaller IFesDataPossessionLimitCheckerCaller Pointer )
            value.FesDataPossessionLimitPopupCaller         = GetObject<IFesDataPossessionLimitPopupCaller>(new IntPtr(p + 0x070), ReversePrism.DataModels.IFesDataPossessionLimitPopupCaller.FromPointer); // 024665A5C158 0x70 FesDataPossessionLimitPopupCaller ( 000186777820 ModelClassType IFesDataPossessionLimitPopupCaller IFesDataPossessionLimitPopupCaller IFesDataPossessionLimitPopupCaller Pointer )
            value.HowToPlayProduceManualData                = GetObject<HowToPlayProduceManualData>(new IntPtr(p + 0x078), ReversePrism.DataModels.HowToPlayProduceManualData.FromPointer); // 024665A5C178 0x78 HowToPlayProduceManualData  ( 0001866DA470 ModelClassType HowToPlayProduceManualData HowToPlayProduceManualData HowToPlayProduceManualData Pointer )
