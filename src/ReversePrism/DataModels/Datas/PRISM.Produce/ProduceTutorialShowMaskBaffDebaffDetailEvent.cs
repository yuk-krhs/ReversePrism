...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceTutorialShowMaskBaffDebaffDetailEvent : DataModel
    {
        ...
        public static ProduceTutorialShowMaskBaffDebaffDetailEvent? FromPointer(IntPtr p0)
        {
            ...
            value.TutorialExternalAccess                    = GetObject<TutorialExternalAccess>(new IntPtr(p + 0x010), ReversePrism.DataModels.TutorialExternalAccess.FromPointer); // 024665DB8598 0x10 TutorialExternalAccess      ( 0001866B98B0 ModelClassType TutorialExternalAccess TutorialExternalAccess TutorialExternalAccess Pointer )
            value.LocalOffset                               = (Vector2)GetInt32(new IntPtr(p + 0x028)); // 024665DB85F8 0x28 LocalOffset                 ( 0001866A7FB0 ModelEnumType Vector2 Vector2 Vector2 Int32 )
