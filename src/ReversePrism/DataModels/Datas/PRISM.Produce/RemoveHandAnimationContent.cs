...
namespace ReversePrism.DataModels
{
    ...
    // 020 CardContent                              ModelClassType InGamePCardContent InGamePCardContent InGamePCardContent Pointer
    ...
    public partial class RemoveHandAnimationContent : DataModel
    {
        ...
        public static RemoveHandAnimationContent? FromPointer(IntPtr p0)
        {
            ...
            value.CardContent                               = GetObject<InGamePCardContent>(new IntPtr(p + 0x020), ReversePrism.DataModels.InGamePCardContent.FromPointer); // 0x20 CardContent                 ( ModelClassType InGamePCardContent InGamePCardContent InGamePCardContent Pointer )
