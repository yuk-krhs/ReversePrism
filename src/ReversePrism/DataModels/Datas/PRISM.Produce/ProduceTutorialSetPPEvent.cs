...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceTutorialSetPPEvent : DataModel
    {
        ...
        public static ProduceTutorialSetPPEvent? FromPointer(IntPtr p0)
        {
            ...
            value.TutorialExternalAccess                    = GetObject<TutorialExternalAccess>(new IntPtr(p + 0x010), ReversePrism.DataModels.TutorialExternalAccess.FromPointer); // 024665DBA4D8 0x10 TutorialExternalAccess      ( 0001866B98B0 ModelClassType TutorialExternalAccess TutorialExternalAccess TutorialExternalAccess Pointer )
            value.Pp                                        = GetInt32(new IntPtr(p + 0x018)); // 024665DBA4F8 0x18 Pp                          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
