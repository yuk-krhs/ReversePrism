...
namespace ReversePrism.DataModels
{
    ...
    // 010 ResetCollectionChanged                   ModelClassType NotifyCollectionChangedEventArgs NotifyCollectionChangedEventArgs NotifyCollectionChangedEventArgs Pointer
    public partial class EventArgsCache : DataModel
    {
        ...
        public static EventArgsCache? FromPointer(IntPtr p0)
        {
            ...
            value.ResetCollectionChanged                    = GetObject<NotifyCollectionChangedEventArgs>(new IntPtr(p + 0x010), ReversePrism.DataModels.NotifyCollectionChangedEventArgs.FromPointer); // 0x10 ResetCollectionChanged      ( ModelClassType NotifyCollectionChangedEventArgs NotifyCollectionChangedEventArgs NotifyCollectionChangedEventArgs Pointer )
