...
namespace ReversePrism.DataModels
{
    ...
    public partial class ResultMultipleSupportSkillPopupView : DataModel
    {
        ...
        public static ResultMultipleSupportSkillPopupView? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new ResultMultipleSupportSkillPopupView() { Pointer= p0 };
