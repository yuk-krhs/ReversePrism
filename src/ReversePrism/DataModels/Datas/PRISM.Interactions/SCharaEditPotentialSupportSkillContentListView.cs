...
namespace ReversePrism.DataModels
{
    ...
    public partial class SCharaEditPotentialSupportSkillContentListView
    {
        ...
        public static SCharaEditPotentialSupportSkillContentListView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SCharaEditPotentialSupportSkillContentListView();

            value.CanvasGroup                               = GetObject<CanvasGroup>(new IntPtr(p + 0x020), ReversePrism.DataModels.CanvasGroup.FromPointer); // 0270DB57FCD8 0x20 CanvasGroup                 ( 000186540EE0 ModelClassType CanvasGroup CanvasGroup CanvasGroup Pointer )
            value.GoContent                                 = GetObject<SCharaEditPotentialSupportSkillContentView>(new IntPtr(p + 0x028), ReversePrism.DataModels.SCharaEditPotentialSupportSkillContentView.FromPointer); // 0270DB57FCF8 0x28 GoContent                   ( 0001866A7130 ModelClassType SCharaEditPotentialSupportSkillContentView SCharaEditPotentialSupportSkillContentView SCharaEditPotentialSupportSkillContentView Pointer )
            value.ContentParent                             = GetObject<Transform>(new IntPtr(p + 0x030), ReversePrism.DataModels.Transform.FromPointer); // 0270DB57FD18 0x30 ContentParent               ( 0001866AA150 ModelClassType Transform Transform Transform Pointer )
            value.ContentList                               = GetObjectList<SCharaEditPotentialSupportSkillContentView>(new IntPtr(p + 0x038), ReversePrism.DataModels.SCharaEditPotentialSupportSkillContentView.FromPointer); // 0270DB57FD38 0x38 ContentList                 ( 000185D04FA8 ModelClassListType List`1<SCharaEditPotentialSupportSkillContentView> List`1<SCharaEditPotentialSupportSkillContentView> List<SCharaEditPotentialSupportSkillContentView> Pointer )
