...
namespace ReversePrism.DataModels
{
    ...
    public partial class ScheduleSelectionLeftBottomAreaView
    {
        ...
        public static ScheduleSelectionLeftBottomAreaView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ScheduleSelectionLeftBottomAreaView();

            value.UnitParameterContent                      = GetObject<UnitParameterContent>(new IntPtr(p + 0x020), ReversePrism.DataModels.UnitParameterContent.FromPointer); // 0270DA17DDB8 0x20 UnitParameterContent        ( 00018670F700 ModelClassType UnitParameterContent UnitParameterContent UnitParameterContent Pointer )
            value.VitalityGaugeContent                      = GetObject<VitalityGauge>(new IntPtr(p + 0x028), ReversePrism.DataModels.VitalityGauge.FromPointer); // 0270DA17DDD8 0x28 VitalityGaugeContent        ( 00018652E260 ModelClassType VitalityGauge VitalityGauge VitalityGauge Pointer )
            value.EditInfoButton                            = GetObject<UIButton>(new IntPtr(p + 0x030), ReversePrism.DataModels.UIButton.FromPointer); // 0270DA17DDF8 0x30 EditInfoButton              ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.DeckListButton                            = GetObject<UIButton>(new IntPtr(p + 0x038), ReversePrism.DataModels.UIButton.FromPointer); // 0270DA17DE18 0x38 DeckListButton              ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.InheritanceButton                         = GetObject<UIButton>(new IntPtr(p + 0x040), ReversePrism.DataModels.UIButton.FromPointer); // 0270DA17DE38 0x40 InheritanceButton           ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.InheritanceButtonCover                    = GetObject<UIImage>(new IntPtr(p + 0x048), ReversePrism.DataModels.UIImage.FromPointer); // 0270DA17DE58 0x48 InheritanceButtonCover      ( 0001866EAE30 ModelClassType UIImage UIImage UIImage Pointer )
            value.FanCountText                              = GetObject<UITextMeshProUGUI>(new IntPtr(p + 0x050), ReversePrism.DataModels.UITextMeshProUGUI.FromPointer); // 0270DA17DE78 0x50 FanCountText                ( 0001866F90E0 ModelClassType UITextMeshProUGUI UITextMeshProUGUI UITextMeshProUGUI Pointer )
            value.ScheduleSelectionLeftBottomAreaViewModel  = GetObject<ScheduleSelectionLeftBottomAreaViewModel>(new IntPtr(p + 0x060), ReversePrism.DataModels.ScheduleSelectionLeftBottomAreaViewModel.FromPointer); // 0270DA17DEB8 0x60 ScheduleSelectionLeftBottomAreaViewModel ( 0001866DA490 ModelClassType ScheduleSelectionLeftBottomAreaViewModel ScheduleSelectionLeftBottomAreaViewModel ScheduleSelectionLeftBottomAreaViewModel Pointer )
