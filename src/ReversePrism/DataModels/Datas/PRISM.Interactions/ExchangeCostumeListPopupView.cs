...
namespace ReversePrism.DataModels
{
    ...
    // 030 ViewModel                                ModelClassType ExchangeSelectionListPopupViewModel ExchangeSelectionListPopupViewModel ExchangeSelectionListPopupViewModel Pointer
    ...
    public partial class ExchangeCostumeListPopupView : DataModel
    {
        ...
        public static ExchangeCostumeListPopupView? FromPointer(IntPtr p0)
        {
            ...
            value.ViewModel                                 = GetObject<ExchangeSelectionListPopupViewModel>(new IntPtr(p + 0x030), ReversePrism.DataModels.ExchangeSelectionListPopupViewModel.FromPointer); // 0x30 ViewModel                   ( ModelClassType ExchangeSelectionListPopupViewModel ExchangeSelectionListPopupViewModel ExchangeSelectionListPopupViewModel Pointer )
