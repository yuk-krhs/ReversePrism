...
namespace ReversePrism.DataModels
{
    ...
    public partial class FavoriteIconSelectGridView
    {
        ...
        public static FavoriteIconSelectGridView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new FavoriteIconSelectGridView();

            value.CellPrefab                                = GetObject<FavoriteIconSelectGridViewCell>(new IntPtr(p + 0x090), ReversePrism.DataModels.FavoriteIconSelectGridViewCell.FromPointer); // 0270DA338918 0x90 CellPrefab                  ( 00018655ACD0 ModelClassType FavoriteIconSelectGridViewCell FavoriteIconSelectGridViewCell FavoriteIconSelectGridViewCell Pointer )
            value.EmptyView                                 = GetObject<GameObject>(new IntPtr(p + 0x098), ReversePrism.DataModels.GameObject.FromPointer); // 0270DA338938 0x98 EmptyView                   ( 0001865D81D0 ModelClassType GameObject GameObject GameObject Pointer )
