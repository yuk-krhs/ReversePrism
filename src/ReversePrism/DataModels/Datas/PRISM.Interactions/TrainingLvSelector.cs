...
namespace ReversePrism.DataModels
{
    ...
    // 020 BeforeStars                              ModelClassType StarDisplay StarDisplay StarDisplay Pointer
    // 028 AfterStars                               ModelClassType StarDisplay StarDisplay StarDisplay Pointer
    // 030 MaxStars                                 ModelClassType StarDisplay StarDisplay StarDisplay Pointer
    ...
    public partial class TrainingLvSelector : DataModel
    {
        ...
        public static TrainingLvSelector? FromPointer(IntPtr p0)
        {
            ...
            value.BeforeStars                               = GetObject<StarDisplay>(new IntPtr(p + 0x020), ReversePrism.DataModels.StarDisplay.FromPointer); // 0x20 BeforeStars                 ( ModelClassType StarDisplay StarDisplay StarDisplay Pointer )
            value.AfterStars                                = GetObject<StarDisplay>(new IntPtr(p + 0x028), ReversePrism.DataModels.StarDisplay.FromPointer); // 0x28 AfterStars                  ( ModelClassType StarDisplay StarDisplay StarDisplay Pointer )
            value.MaxStars                                  = GetObject<StarDisplay>(new IntPtr(p + 0x030), ReversePrism.DataModels.StarDisplay.FromPointer); // 0x30 MaxStars                    ( ModelClassType StarDisplay StarDisplay StarDisplay Pointer )
