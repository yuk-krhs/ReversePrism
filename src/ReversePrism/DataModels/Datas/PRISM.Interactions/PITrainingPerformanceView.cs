...
namespace ReversePrism.DataModels
{
    ...
    // 040 BeforeStarObjs                           ModelClassListType GameObject[] GameObject[] List<GameObject> Pointer
    // 048 AfterStarObjs                            ModelClassListType GameObject[] GameObject[] List<GameObject> Pointer
    ...
    // 058 Vm                                       ModelClassType PITrainingPerformanceViewModel PITrainingPerformanceViewModel PITrainingPerformanceViewModel Pointer
    ...
    public partial class PITrainingPerformanceView : DataModel
    {
        ...
        public static PITrainingPerformanceView? FromPointer(IntPtr p0)
        {
            ...
            value.BeforeStarObjs                            = GetObjectList<GameObject>(new IntPtr(p + 0x040), ReversePrism.DataModels.GameObject.FromPointer); // 0x40 BeforeStarObjs              ( ModelClassListType GameObject[] GameObject[] List<GameObject> Pointer )
            value.AfterStarObjs                             = GetObjectList<GameObject>(new IntPtr(p + 0x048), ReversePrism.DataModels.GameObject.FromPointer); // 0x48 AfterStarObjs               ( ModelClassListType GameObject[] GameObject[] List<GameObject> Pointer )
            ...
            value.Vm                                        = GetObject<PITrainingPerformanceViewModel>(new IntPtr(p + 0x058), ReversePrism.DataModels.PITrainingPerformanceViewModel.FromPointer); // 0x58 Vm                          ( ModelClassType PITrainingPerformanceViewModel PITrainingPerformanceViewModel PITrainingPerformanceViewModel Pointer )
