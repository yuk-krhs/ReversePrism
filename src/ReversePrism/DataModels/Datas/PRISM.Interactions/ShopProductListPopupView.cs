...
namespace ReversePrism.DataModels
{
    ...
    // 030 ViewModel                                ModelClassType ShopProductListPopupViewModel ShopProductListPopupViewModel ShopProductListPopupViewModel Pointer
    ...
    public partial class ShopProductListPopupView : DataModel
    {
        ...
        public static ShopProductListPopupView? FromPointer(IntPtr p0)
        {
            ...
            value.ViewModel                                 = GetObject<ShopProductListPopupViewModel>(new IntPtr(p + 0x030), ReversePrism.DataModels.ShopProductListPopupViewModel.FromPointer); // 0x30 ViewModel                   ( ModelClassType ShopProductListPopupViewModel ShopProductListPopupViewModel ShopProductListPopupViewModel Pointer )
