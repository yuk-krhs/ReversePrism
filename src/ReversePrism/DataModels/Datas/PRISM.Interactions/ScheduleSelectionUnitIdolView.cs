...
namespace ReversePrism.DataModels
{
    ...
    public partial class ScheduleSelectionUnitIdolView
    {
        ...
        public static ScheduleSelectionUnitIdolView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ScheduleSelectionUnitIdolView();

            value.UnitIdolContentList                       = GetObjectList<UnitIdolContent>(new IntPtr(p + 0x020), ReversePrism.DataModels.UnitIdolContent.FromPointer); // 0270DA17DD10 0x20 UnitIdolContentList         ( 000185D19C88 ModelClassListType List`1<UnitIdolContent> List`1<UnitIdolContent> List<UnitIdolContent> Pointer )
            value.ScheduleSelectionUnitIdolViewModel        = GetObject<ScheduleSelectionUnitIdolViewModel>(new IntPtr(p + 0x028), ReversePrism.DataModels.ScheduleSelectionUnitIdolViewModel.FromPointer); // 0270DA17DD30 0x28 ScheduleSelectionUnitIdolViewModel ( 0001866E1B50 ModelClassType ScheduleSelectionUnitIdolViewModel ScheduleSelectionUnitIdolViewModel ScheduleSelectionUnitIdolViewModel Pointer )
            value.PIdolDetailPopupViewFactory               = GetObject<IPIdolDetailPopupViewFactory>(new IntPtr(p + 0x030), ReversePrism.DataModels.IPIdolDetailPopupViewFactory.FromPointer); // 0270DA17DD50 0x30 PIdolDetailPopupViewFactory ( 0001865CFB80 ModelClassType IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory Pointer )
