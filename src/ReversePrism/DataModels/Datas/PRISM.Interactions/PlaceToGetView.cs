...
namespace ReversePrism.DataModels
{
    ...
    // 030 TxtPlace                                 ModelClassType UITextMeshProUGUI UITextMeshProUGUI UITextMeshProUGUI Pointer
    ...
    public partial class PlaceToGetView : DataModel
    {
        ...
        public static PlaceToGetView? FromPointer(IntPtr p0)
        {
            ...
            value.TxtPlace                                  = GetObject<UITextMeshProUGUI>(new IntPtr(p + 0x030), ReversePrism.DataModels.UITextMeshProUGUI.FromPointer); // 0x30 TxtPlace                    ( ModelClassType UITextMeshProUGUI UITextMeshProUGUI UITextMeshProUGUI Pointer )
