...
namespace ReversePrism.DataModels
{
    ...
    public partial class AllSongIdolRewardListCell : DataModel
    {
        ...
        public static AllSongIdolRewardListCell? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new AllSongIdolRewardListCell() { Pointer= p0 };
