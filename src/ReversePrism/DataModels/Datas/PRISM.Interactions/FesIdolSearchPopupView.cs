...
namespace ReversePrism.DataModels
{
    ...
    // 028 SortView                                 ModelClassType FesIdolSortView FesIdolSortView FesIdolSortView Pointer
    // 030 FilterView                               ModelClassType FesIdolFilterView FesIdolFilterView FesIdolFilterView Pointer
    ...
    public partial class FesIdolSearchPopupView : DataModel
    {
        ...
        public static FesIdolSearchPopupView? FromPointer(IntPtr p0)
        {
            ...
            value.SortView                                  = GetObject<FesIdolSortView>(new IntPtr(p + 0x028), ReversePrism.DataModels.FesIdolSortView.FromPointer); // 0x28 SortView                    ( ModelClassType FesIdolSortView FesIdolSortView FesIdolSortView Pointer )
            value.FilterView                                = GetObject<FesIdolFilterView>(new IntPtr(p + 0x030), ReversePrism.DataModels.FesIdolFilterView.FromPointer); // 0x30 FilterView                  ( ModelClassType FesIdolFilterView FesIdolFilterView FesIdolFilterView Pointer )
