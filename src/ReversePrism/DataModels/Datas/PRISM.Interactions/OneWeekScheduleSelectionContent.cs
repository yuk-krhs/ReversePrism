...
namespace ReversePrism.DataModels
{
    ...
    public partial class OneWeekScheduleSelectionContent : DataModel
    {
        ...
        public static OneWeekScheduleSelectionContent? FromPointer(IntPtr p0)
        {
            ...
            value.WeekDisplayContent                        = GetObject<WeekDisplayContent>(new IntPtr(p + 0x020), ReversePrism.DataModels.WeekDisplayContent.FromPointer); // 02466A1BE1D0 0x20 WeekDisplayContent          ( 000186553C90 ModelClassType WeekDisplayContent WeekDisplayContent WeekDisplayContent Pointer )
            value.OneScheduleSelectionContentList           = GetObjectList<OneScheduleSelectionContent>(new IntPtr(p + 0x028), ReversePrism.DataModels.OneScheduleSelectionContent.FromPointer); // 02466A1BE1F0 0x28 OneScheduleSelectionContentList ( 000185CF6ED8 ModelClassListType List`1<OneScheduleSelectionContent> List`1<OneScheduleSelectionContent> List<OneScheduleSelectionContent> Pointer )
            value.Disposables                               = GetObject<CompositeDisposable>(new IntPtr(p + 0x038), ReversePrism.DataModels.CompositeDisposable.FromPointer); // 02466A1BE230 0x38 Disposables                 ( 0001865F3230 ModelClassType CompositeDisposable CompositeDisposable CompositeDisposable Pointer )
