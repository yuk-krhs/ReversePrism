...
namespace ReversePrism.DataModels
{
    ...
    public partial class HomeSettingsIdolSelectPopupView
    {
        ...
        public static HomeSettingsIdolSelectPopupView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new HomeSettingsIdolSelectPopupView();

            value.GridView                                  = GetObject<HomeSettingsIdolSelectGridView>(new IntPtr(p + 0x020), ReversePrism.DataModels.HomeSettingsIdolSelectGridView.FromPointer); // 0270DB50C000 0x20 GridView                    ( 0001866CD390 ModelClassType HomeSettingsIdolSelectGridView HomeSettingsIdolSelectGridView HomeSettingsIdolSelectGridView Pointer )
            value.PopupFrame                                = GetObject<IPopupFrameView>(new IntPtr(p + 0x028), ReversePrism.DataModels.IPopupFrameView.FromPointer); // 0270DB50C020 0x28 PopupFrame                  ( 0001865DAC10 ModelClassType IPopupFrameView IPopupFrameView IPopupFrameView Pointer )
            value.ViewModel                                 = GetObject<HomeSettingsIdolSelectViewModel>(new IntPtr(p + 0x040), ReversePrism.DataModels.HomeSettingsIdolSelectViewModel.FromPointer); // 0270DB50C080 0x40 ViewModel                   ( 0001866CED60 ModelClassType HomeSettingsIdolSelectViewModel HomeSettingsIdolSelectViewModel HomeSettingsIdolSelectViewModel Pointer )
