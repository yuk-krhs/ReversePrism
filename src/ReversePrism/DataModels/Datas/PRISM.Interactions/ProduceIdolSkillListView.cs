...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceIdolSkillListView
    {
        ...
        public static ProduceIdolSkillListView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProduceIdolSkillListView();

            value.ListParent                                = GetObject<Transform>(new IntPtr(p + 0x020), ReversePrism.DataModels.Transform.FromPointer); // 0270DA2FEFD8 0x20 ListParent                  ( 0001866AA150 ModelClassType Transform Transform Transform Pointer )
            value.GoSkillContentView                        = GetObject<IdolSkillUpgradingContentView>(new IntPtr(p + 0x028), ReversePrism.DataModels.IdolSkillUpgradingContentView.FromPointer); // 0270DA2FEFF8 0x28 GoSkillContentView          ( 0001866C3650 ModelClassType IdolSkillUpgradingContentView IdolSkillUpgradingContentView IdolSkillUpgradingContentView Pointer )
            value.SkillDetailView                           = GetObject<IdolSkillUpgradingDetailContentView>(new IntPtr(p + 0x030), ReversePrism.DataModels.IdolSkillUpgradingDetailContentView.FromPointer); // 0270DA2FF018 0x30 SkillDetailView             ( 0001866C3DD0 ModelClassType IdolSkillUpgradingDetailContentView IdolSkillUpgradingDetailContentView IdolSkillUpgradingDetailContentView Pointer )
            value.CgSkillList                               = GetObject<CanvasGroup>(new IntPtr(p + 0x038), ReversePrism.DataModels.CanvasGroup.FromPointer); // 0270DA2FF038 0x38 CgSkillList                 ( 000186540EE0 ModelClassType CanvasGroup CanvasGroup CanvasGroup Pointer )
            value.CgSkillDetail                             = GetObject<CanvasGroup>(new IntPtr(p + 0x040), ReversePrism.DataModels.CanvasGroup.FromPointer); // 0270DA2FF058 0x40 CgSkillDetail               ( 000186540EE0 ModelClassType CanvasGroup CanvasGroup CanvasGroup Pointer )
