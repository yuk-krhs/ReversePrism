...
namespace ReversePrism.DataModels
{
    ...
    public partial class PartyTabGroupView : DataModel
    {
        ...
        public static PartyTabGroupView? FromPointer(IntPtr p0)
        {
            ...
            value.UiTabGroup                                = GetObject<UITabGroup>(new IntPtr(p + 0x020), ReversePrism.DataModels.UITabGroup.FromPointer); // 02466A3C2EE0 0x20 UiTabGroup                  ( 0001866F5490 ModelClassType UITabGroup UITabGroup UITabGroup Pointer )
            value.BtnUITabs                                 = GetObjectList<UITabButton>(new IntPtr(p + 0x028), ReversePrism.DataModels.UITabButton.FromPointer); // 02466A3C2F00 0x28 BtnUITabs                   ( 000185CAE378 ModelClassListType UITabButton[] UITabButton[] List<UITabButton> Pointer )
            value.BtnInputPartyName                         = GetObject<UIButton>(new IntPtr(p + 0x030), ReversePrism.DataModels.UIButton.FromPointer); // 02466A3C2F20 0x30 BtnInputPartyName           ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
