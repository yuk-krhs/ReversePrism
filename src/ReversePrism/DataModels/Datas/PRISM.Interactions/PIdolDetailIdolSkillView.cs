...
namespace ReversePrism.DataModels
{
    ...
    // 028 GoContent                                ModelClassType IdolSkillLvContentView IdolSkillLvContentView IdolSkillLvContentView Pointer
    ...
    public partial class PIdolDetailIdolSkillView : DataModel
    {
        ...
        public static PIdolDetailIdolSkillView? FromPointer(IntPtr p0)
        {
            ...
            value.GoContent                                 = GetObject<IdolSkillLvContentView>(new IntPtr(p + 0x028), ReversePrism.DataModels.IdolSkillLvContentView.FromPointer); // 0x28 GoContent                   ( ModelClassType IdolSkillLvContentView IdolSkillLvContentView IdolSkillLvContentView Pointer )
