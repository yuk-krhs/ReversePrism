...
namespace ReversePrism.DataModels
{
    ...
    public partial class SeasonMissionRewardListView
    {
        ...
        public static SeasonMissionRewardListView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SeasonMissionRewardListView();

            value.SpecialReward                             = GetObject<SeasonMissionRewardListViewCell>(new IntPtr(p + 0x090), ReversePrism.DataModels.SeasonMissionRewardListViewCell.FromPointer); // 0270DBD22B40 0x90 SpecialReward               ( 000186706E40 ModelClassType SeasonMissionRewardListViewCell SeasonMissionRewardListViewCell SeasonMissionRewardListViewCell Pointer )
