...
namespace ReversePrism.DataModels
{
    ...
    public partial class ScheduleSelectionLeftWeekView
    {
        ...
        public static ScheduleSelectionLeftWeekView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ScheduleSelectionLeftWeekView();

            value.ScheduleSelectScheduleLabel               = GetObject<ScheduleSelectScheduleLabel>(new IntPtr(p + 0x020), ReversePrism.DataModels.ScheduleSelectScheduleLabel.FromPointer); // 0270DA17DF80 0x20 ScheduleSelectScheduleLabel ( 0001866D7DC0 ModelClassType ScheduleSelectScheduleLabel ScheduleSelectScheduleLabel ScheduleSelectScheduleLabel Pointer )
            value.LeftWeekViewModel                         = GetObject<ScheduleSelectionLeftWeekViewModel>(new IntPtr(p + 0x028), ReversePrism.DataModels.ScheduleSelectionLeftWeekViewModel.FromPointer); // 0270DA17DFA0 0x28 LeftWeekViewModel           ( 0001866DB5B0 ModelClassType ScheduleSelectionLeftWeekViewModel ScheduleSelectionLeftWeekViewModel ScheduleSelectionLeftWeekViewModel Pointer )
