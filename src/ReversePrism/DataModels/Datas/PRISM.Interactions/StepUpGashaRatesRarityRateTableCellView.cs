...
namespace ReversePrism.DataModels
{
    ...
    // 078 ActiveRowViews                           ModelClassListType List`1<RarityRateTableRowView> List`1<RarityRateTableRowView> List<RarityRateTableRowView> Pointer
    public partial class StepUpGashaRatesRarityRateTableCellView : DataModel
    {
        ...
        public static StepUpGashaRatesRarityRateTableCellView? FromPointer(IntPtr p0)
        {
            ...
            value.ActiveRowViews                            = GetObjectList<RarityRateTableRowView>(new IntPtr(p + 0x078), ReversePrism.DataModels.RarityRateTableRowView.FromPointer); // 0x78 ActiveRowViews              ( ModelClassListType List`1<RarityRateTableRowView> List`1<RarityRateTableRowView> List<RarityRateTableRowView> Pointer )
