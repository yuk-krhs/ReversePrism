...
namespace ReversePrism.DataModels
{
    ...
    // 000 BottomHeight                             float IL2CPP_TYPE_R4
    ...
    public partial class GashaRatesNotesCellView : DataModel
    {
        public RectTransform?                           Rect                                    { get; set; }
        public float                                    BaseHeight                              { get; set; }
        public UITextMeshProUGUI?                       TxtNotes                                { get; set; }

        public static GashaRatesNotesCellView? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new GashaRatesNotesCellView() { Pointer= p0 };
