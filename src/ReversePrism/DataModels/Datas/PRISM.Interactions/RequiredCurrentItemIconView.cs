...
namespace ReversePrism.DataModels
{
    ...
    public partial class RequiredCurrentItemIconView
    {
        ...
        public static RequiredCurrentItemIconView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new RequiredCurrentItemIconView();

            value.ImgItem                                   = GetObject<RawImage>(new IntPtr(p + 0x020), ReversePrism.DataModels.RawImage.FromPointer); // 0270DA269798 0x20 ImgItem                     ( 000186613190 ModelClassType RawImage RawImage RawImage Pointer )
            value.Btn                                       = GetObject<UIButton>(new IntPtr(p + 0x028), ReversePrism.DataModels.UIButton.FromPointer); // 0270DA2697B8 0x28 Btn                         ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.TxtRequiredAmount                         = GetObject<UITextMeshProUGUI>(new IntPtr(p + 0x030), ReversePrism.DataModels.UITextMeshProUGUI.FromPointer); // 0270DA2697D8 0x30 TxtRequiredAmount           ( 0001866F90E0 ModelClassType UITextMeshProUGUI UITextMeshProUGUI UITextMeshProUGUI Pointer )
            value.TxtCurrentAmount                          = GetObject<UITextMeshProUGUI>(new IntPtr(p + 0x038), ReversePrism.DataModels.UITextMeshProUGUI.FromPointer); // 0270DA2697F8 0x38 TxtCurrentAmount            ( 0001866F90E0 ModelClassType UITextMeshProUGUI UITextMeshProUGUI UITextMeshProUGUI Pointer )
            value.OutlineForTextMeshProUGUI                 = GetObject<ColorToOutlineForTextMeshProUGUI>(new IntPtr(p + 0x040), ReversePrism.DataModels.ColorToOutlineForTextMeshProUGUI.FromPointer); // 0270DA269818 0x40 OutlineForTextMeshProUGUI   ( 0001865D3210 ModelClassType ColorToOutlineForTextMeshProUGUI ColorToOutlineForTextMeshProUGUI ColorToOutlineForTextMeshProUGUI Pointer )
