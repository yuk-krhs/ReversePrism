...
namespace ReversePrism.DataModels
{
    ...
    public partial class IdolBaseDetailCasualCostumeView : DataModel
    {
        ...
        public static IdolBaseDetailCasualCostumeView? FromPointer(IntPtr p0)
        {
            ...
            value.CanvasGroup                               = GetObject<CanvasGroup>(new IntPtr(p + 0x020), ReversePrism.DataModels.CanvasGroup.FromPointer); // 02466A2B8510 0x20 CanvasGroup                 ( 000186540EE0 ModelClassType CanvasGroup CanvasGroup CanvasGroup Pointer )
            value.InStoryCostumeSettingView                 = GetObject<CostumeSettingView>(new IntPtr(p + 0x028), ReversePrism.DataModels.CostumeSettingView.FromPointer); // 02466A2B8530 0x28 InStoryCostumeSettingView   ( 000186636570 ModelClassType CostumeSettingView CostumeSettingView CostumeSettingView Pointer )
            value.InOtherCostumeSettingView                 = GetObject<CostumeSettingView>(new IntPtr(p + 0x030), ReversePrism.DataModels.CostumeSettingView.FromPointer); // 02466A2B8550 0x30 InOtherCostumeSettingView   ( 000186636570 ModelClassType CostumeSettingView CostumeSettingView CostumeSettingView Pointer )
