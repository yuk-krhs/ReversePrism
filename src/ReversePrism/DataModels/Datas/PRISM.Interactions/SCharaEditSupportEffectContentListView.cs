...
namespace ReversePrism.DataModels
{
    ...
    public partial class SCharaEditSupportEffectContentListView : DataModel
    {
        ...
        public static SCharaEditSupportEffectContentListView? FromPointer(IntPtr p0)
        {
            ...
            value.CanvasGroup                               = GetObject<CanvasGroup>(new IntPtr(p + 0x020), ReversePrism.DataModels.CanvasGroup.FromPointer); // 02466B615F08 0x20 CanvasGroup                 ( 000186540EE0 ModelClassType CanvasGroup CanvasGroup CanvasGroup Pointer )
            value.GoContent                                 = GetObject<SCharaEditSupportEffectContentView>(new IntPtr(p + 0x028), ReversePrism.DataModels.SCharaEditSupportEffectContentView.FromPointer); // 02466B615F28 0x28 GoContent                   ( 0001866A8E80 ModelClassType SCharaEditSupportEffectContentView SCharaEditSupportEffectContentView SCharaEditSupportEffectContentView Pointer )
            value.ContentParent                             = GetObject<Transform>(new IntPtr(p + 0x030), ReversePrism.DataModels.Transform.FromPointer); // 02466B615F48 0x30 ContentParent               ( 0001866AA150 ModelClassType Transform Transform Transform Pointer )
            value.ContentList                               = GetObjectList<SCharaEditSupportEffectContentView>(new IntPtr(p + 0x038), ReversePrism.DataModels.SCharaEditSupportEffectContentView.FromPointer); // 02466B615F68 0x38 ContentList                 ( 000185D05638 ModelClassListType List`1<SCharaEditSupportEffectContentView> List`1<SCharaEditSupportEffectContentView> List<SCharaEditSupportEffectContentView> Pointer )
