...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceInGamePausePopupView
    {
        ...
        public static ProduceInGamePausePopupView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProduceInGamePausePopupView();

            value.ResourceTag                               = GetObject<ResourceTag>(new IntPtr(p + 0x020), ReversePrism.DataModels.ResourceTag.FromPointer); // 0270DA0E2BC0 0x20 ResourceTag                 ( 000186672320 ModelClassType ResourceTag ResourceTag ResourceTag Pointer )
            value.EnemySkillContentListView                 = GetObject<EnemySkillContentListView>(new IntPtr(p + 0x050), ReversePrism.DataModels.EnemySkillContentListView.FromPointer); // 0270DA0E2C80 0x50 EnemySkillContentListView   ( 000186732D20 ModelClassType EnemySkillContentListView EnemySkillContentListView EnemySkillContentListView Pointer )
            value.RetryButton                               = GetObject<UIButton>(new IntPtr(p + 0x058), ReversePrism.DataModels.UIButton.FromPointer); // 0270DA0E2CA0 0x58 RetryButton                 ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.GiveUpButton                              = GetObject<UIButton>(new IntPtr(p + 0x060), ReversePrism.DataModels.UIButton.FromPointer); // 0270DA0E2CC0 0x60 GiveUpButton                ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.ChallengeMissionContent                   = GetObject<ChallengeMissionContent>(new IntPtr(p + 0x068), ReversePrism.DataModels.ChallengeMissionContent.FromPointer); // 0270DA0E2CE0 0x68 ChallengeMissionContent     ( 00018656BDA0 ModelClassType ChallengeMissionContent ChallengeMissionContent ChallengeMissionContent Pointer )
            value.NotExistChallengeMissionUI                = GetObject<GameObject>(new IntPtr(p + 0x070), ReversePrism.DataModels.GameObject.FromPointer); // 0270DA0E2D00 0x70 NotExistChallengeMissionUI  ( 0001865D7D30 ModelClassType GameObject GameObject GameObject Pointer )
            value.ProduceOptionButton                       = GetObject<UIButton>(new IntPtr(p + 0x078), ReversePrism.DataModels.UIButton.FromPointer); // 0270DA0E2D20 0x78 ProduceOptionButton         ( 0001866E0F30 ModelClassType UIButton UIButton UIButton Pointer )
            value.OptionPopupViewFactory                    = GetObject<ProduceOptionPopupViewFactory>(new IntPtr(p + 0x080), ReversePrism.DataModels.ProduceOptionPopupViewFactory.FromPointer); // 0270DA0E2D40 0x80 OptionPopupViewFactory      ( 000186560F20 ModelClassType ProduceOptionPopupViewFactory ProduceOptionPopupViewFactory ProduceOptionPopupViewFactory Pointer )
            value.EnemySkillDetailPopupViewFactory          = GetObject<ProduceEnemySkillDetailPopupViewFactory>(new IntPtr(p + 0x088), ReversePrism.DataModels.ProduceEnemySkillDetailPopupViewFactory.FromPointer); // 0270DA0E2D60 0x88 EnemySkillDetailPopupViewFactory ( 00018653D6F0 ModelClassType ProduceEnemySkillDetailPopupViewFactory ProduceEnemySkillDetailPopupViewFactory ProduceEnemySkillDetailPopupViewFactory Pointer )
            value.ViewModel                                 = GetObject<ProduceInGamePausePopupViewModel>(new IntPtr(p + 0x090), ReversePrism.DataModels.ProduceInGamePausePopupViewModel.FromPointer); // 0270DA0E2D80 0x90 ViewModel                   ( 00018655A5A0 ModelClassType ProduceInGamePausePopupViewModel ProduceInGamePausePopupViewModel ProduceInGamePausePopupViewModel Pointer )
            value.Parent                                    = GetObject<IPopupFrameView>(new IntPtr(p + 0x098), ReversePrism.DataModels.IPopupFrameView.FromPointer); // 0270DA0E2DA0 0x98 Parent                      ( 0001865DAC10 ModelClassType IPopupFrameView IPopupFrameView IPopupFrameView Pointer )
