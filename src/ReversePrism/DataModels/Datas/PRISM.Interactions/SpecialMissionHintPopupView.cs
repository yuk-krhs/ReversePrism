...
namespace ReversePrism.DataModels
{
    ...
    // 028 ViewModel                                ModelClassType SpecialMissionHintPopupViewModel SpecialMissionHintPopupViewModel SpecialMissionHintPopupViewModel Pointer
    // 030 MissionText                              ModelClassType UITextMeshProUGUI UITextMeshProUGUI UITextMeshProUGUI Pointer
    // 038 HintText                                 ModelClassType UITextMeshProUGUI UITextMeshProUGUI UITextMeshProUGUI Pointer
    ...
    public partial class SpecialMissionHintPopupView : DataModel
    {
        ...
        public static SpecialMissionHintPopupView? FromPointer(IntPtr p0)
        {
            ...
            value.ViewModel                                 = GetObject<SpecialMissionHintPopupViewModel>(new IntPtr(p + 0x028), ReversePrism.DataModels.SpecialMissionHintPopupViewModel.FromPointer); // 0x28 ViewModel                   ( ModelClassType SpecialMissionHintPopupViewModel SpecialMissionHintPopupViewModel SpecialMissionHintPopupViewModel Pointer )
            ...
            value.HintText                                  = GetObject<UITextMeshProUGUI>(new IntPtr(p + 0x038), ReversePrism.DataModels.UITextMeshProUGUI.FromPointer); // 0x38 HintText                    ( ModelClassType UITextMeshProUGUI UITextMeshProUGUI UITextMeshProUGUI Pointer )
