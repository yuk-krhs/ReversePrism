...
namespace ReversePrism.DataModels
{
    ...
    public partial class SupportCharaFilterCellListView
    {
        ...
        public static SupportCharaFilterCellListView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SupportCharaFilterCellListView();

            value.Scroller                                  = GetObject<EnhancedScroller>(new IntPtr(p + 0x020), ReversePrism.DataModels.EnhancedScroller.FromPointer); // 0270DA340DC0 0x20 Scroller                    ( 000186735270 ModelClassType EnhancedScroller EnhancedScroller EnhancedScroller Pointer )
            value.FixedFilterCellViewPrefab                 = GetObject<EnhancedScrollerCellView>(new IntPtr(p + 0x028), ReversePrism.DataModels.EnhancedScrollerCellView.FromPointer); // 0270DA340DE0 0x28 FixedFilterCellViewPrefab   ( 000186735AD0 ModelClassType EnhancedScrollerCellView EnhancedScrollerCellView EnhancedScrollerCellView Pointer )
            value.SupportEffectTitleCellViewPrefab          = GetObject<EnhancedScrollerCellView>(new IntPtr(p + 0x030), ReversePrism.DataModels.EnhancedScrollerCellView.FromPointer); // 0270DA340E00 0x30 SupportEffectTitleCellViewPrefab ( 000186735AD0 ModelClassType EnhancedScrollerCellView EnhancedScrollerCellView EnhancedScrollerCellView Pointer )
            value.SupportEffectFoldCellViewPrefab           = GetObject<EnhancedScrollerCellView>(new IntPtr(p + 0x038), ReversePrism.DataModels.EnhancedScrollerCellView.FromPointer); // 0270DA340E20 0x38 SupportEffectFoldCellViewPrefab ( 000186735AD0 ModelClassType EnhancedScrollerCellView EnhancedScrollerCellView EnhancedScrollerCellView Pointer )
            value.SupportEffectCellViewPrefab               = GetObject<EnhancedScrollerCellView>(new IntPtr(p + 0x040), ReversePrism.DataModels.EnhancedScrollerCellView.FromPointer); // 0270DA340E40 0x40 SupportEffectCellViewPrefab ( 000186735AD0 ModelClassType EnhancedScrollerCellView EnhancedScrollerCellView EnhancedScrollerCellView Pointer )
            value.Context                                   = GetObject<SupportCharaSearchPopupViewModel>(new IntPtr(p + 0x048), ReversePrism.DataModels.SupportCharaSearchPopupViewModel.FromPointer); // 0270DA340E60 0x48 Context                     ( 0001865E2150 ModelClassType SupportCharaSearchPopupViewModel SupportCharaSearchPopupViewModel SupportCharaSearchPopupViewModel Pointer )
            value.CellVMAry                                 = GetObjectList<ISupportCharaSearchPopupCellViewModel>(new IntPtr(p + 0x050), ReversePrism.DataModels.ISupportCharaSearchPopupCellViewModel.FromPointer); // 0270DA340E80 0x50 CellVMAry                   ( 000185B89AD0 ModelClassListType ISupportCharaSearchPopupCellViewModel[] ISupportCharaSearchPopupCellViewModel[] List<ISupportCharaSearchPopupCellViewModel> Pointer )
