...
namespace ReversePrism.DataModels
{
    ...
    // 048 EventButton                              ModelClassType CommonFooterButton CommonFooterButton CommonFooterButton Pointer
    ...
    public partial class HomeFooterPanelView : DataModel
    {
        ...
        public static HomeFooterPanelView? FromPointer(IntPtr p0)
        {
            ...
            value.EventButton                               = GetObject<CommonFooterButton>(new IntPtr(p + 0x048), ReversePrism.DataModels.CommonFooterButton.FromPointer); // 0x48 EventButton                 ( ModelClassType CommonFooterButton CommonFooterButton CommonFooterButton Pointer )
