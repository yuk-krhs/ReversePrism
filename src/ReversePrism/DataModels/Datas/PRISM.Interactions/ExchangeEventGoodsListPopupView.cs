...
namespace ReversePrism.DataModels
{
    ...
    public partial class ExchangeEventGoodsListPopupView
    {
        ...
        public static ExchangeEventGoodsListPopupView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ExchangeEventGoodsListPopupView();

            value.ViewModel                                 = GetObject<ExchangeEventGoodsListPopupViewModel>(new IntPtr(p + 0x020), ReversePrism.DataModels.ExchangeEventGoodsListPopupViewModel.FromPointer); // 0270DB8DD338 0x20 ViewModel                   ( 000186777CF0 ModelClassType ExchangeEventGoodsListPopupViewModel ExchangeEventGoodsListPopupViewModel ExchangeEventGoodsListPopupViewModel Pointer )
            value.ExchangeProductObj                        = GetObject<GameObject>(new IntPtr(p + 0x030), ReversePrism.DataModels.GameObject.FromPointer); // 0270DB8DD378 0x30 ExchangeProductObj          ( 0001865D7D30 ModelClassType GameObject GameObject GameObject Pointer )
            value.ExchangeProductIcon                       = GetObject<RewardItem>(new IntPtr(p + 0x038), ReversePrism.DataModels.RewardItem.FromPointer); // 0270DB8DD398 0x38 ExchangeProductIcon         ( 00018667EAE0 ModelClassType RewardItem RewardItem RewardItem Pointer )
            value.ExchangeProductAmountText                 = GetObject<UITextMeshProUGUI>(new IntPtr(p + 0x040), ReversePrism.DataModels.UITextMeshProUGUI.FromPointer); // 0270DB8DD3B8 0x40 ExchangeProductAmountText   ( 0001866F90E0 ModelClassType UITextMeshProUGUI UITextMeshProUGUI UITextMeshProUGUI Pointer )
            value.ListView                                  = GetObject<ExchangeEventGoodsListView>(new IntPtr(p + 0x048), ReversePrism.DataModels.ExchangeEventGoodsListView.FromPointer); // 0270DB8DD3D8 0x48 ListView                    ( 000186778490 ModelClassType ExchangeEventGoodsListView ExchangeEventGoodsListView ExchangeEventGoodsListView Pointer )
            value.Parent                                    = GetObject<IPopupFrameView>(new IntPtr(p + 0x060), ReversePrism.DataModels.IPopupFrameView.FromPointer); // 0270DB8DD438 0x60 Parent                      ( 0001865DAC10 ModelClassType IPopupFrameView IPopupFrameView IPopupFrameView Pointer )
