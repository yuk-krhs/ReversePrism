...
namespace ReversePrism.DataModels
{
    ...
    // 018 Expression                               ModelPrimitiveType string string string String
    ...
    // 030 Location                                 ModelPrimitiveType string string string String
    public partial class Expr : DataModel
    {
        ...
        public static Expr? FromPointer(IntPtr p0)
        {
            ...
            value.Expression                                = GetString(new IntPtr(p + 0x018)); // 0x18 Expression                  ( ModelPrimitiveType string string string String )
            ...
            value.Location                                  = GetString(new IntPtr(p + 0x030)); // 0x30 Location                    ( ModelPrimitiveType string string string String )
