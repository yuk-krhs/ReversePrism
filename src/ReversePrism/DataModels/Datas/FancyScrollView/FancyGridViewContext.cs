...
namespace ReversePrism.DataModels
{
    ...
    public partial class FancyGridViewContext
    {
        ...
        public static FancyGridViewContext? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new FancyGridViewContext();

            value.FancyScrollView.IFancyScrollRectContext.ScrollDirection = (ScrollDirection)GetInt32(new IntPtr(p + 0x010)); // 0270D4C6A078 0x10 FancyScrollView.IFancyScrollRectContext.ScrollDirection ( 0001866F7950 ModelEnumType ScrollDirection ScrollDirection ScrollDirection Int32 )
            value.FancyScrollView.IFancyCellGroupContext.CellTemplate = GetObject<GameObject>(new IntPtr(p + 0x020), ReversePrism.DataModels.GameObject.FromPointer); // 0270D4C6A0B8 0x20 FancyScrollView.IFancyCellGroupContext.CellTemplate ( 0001865D7D30 ModelClassType GameObject GameObject GameObject Pointer )
