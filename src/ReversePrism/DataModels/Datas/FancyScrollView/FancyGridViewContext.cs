...
namespace ReversePrism.DataModels
{
    ...
    // 020 FancyScrollView.IFancyCellGroupContext.CellTemplate ModelClassType GameObject GameObject GameObject Pointer
    ...
    public partial class FancyGridViewContext : DataModel
    {
        ...
        public static FancyGridViewContext? FromPointer(IntPtr p0)
        {
            ...
            value.FancyScrollView.IFancyCellGroupContext.CellTemplate = GetObject<GameObject>(new IntPtr(p + 0x020), ReversePrism.DataModels.GameObject.FromPointer); // 0x20 FancyScrollView.IFancyCellGroupContext.CellTemplate ( ModelClassType GameObject GameObject GameObject Pointer )
