...
namespace ReversePrism.DataModels
{
    ...
    public partial class Touch
    {
        ...
        public static Touch? FromPointer(IntPtr p0)
        {
            ...
            value.M_Finger                                  = GetObject<Finger>(new IntPtr(p + 0x010), ReversePrism.DataModels.Finger.FromPointer); // 0270D77DDE48 0x10 M_Finger                    ( 000186582560 ModelClassType Finger Finger Finger Pointer )
