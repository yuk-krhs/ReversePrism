...
namespace ReversePrism.DataModels
{
    ...
    // 010 M_Finger                                 ModelClassType Finger Finger Finger Pointer
    ...
    public partial class Touch : DataModel
    {
        ...
        public static Touch? FromPointer(IntPtr p0)
        {
            ...
            value.M_Finger                                  = GetObject<Finger>(new IntPtr(p + 0x010), ReversePrism.DataModels.Finger.FromPointer); // 0x10 M_Finger                    ( ModelClassType Finger Finger Finger Pointer )
