...
namespace ReversePrism.DataModels
{
    ...
    // 038 ButtonDisposables                        ModelClassType CompositeDisposable CompositeDisposable CompositeDisposable Pointer
    // 040 onChoiceStart                            Subject`1<Unit> IL2CPP_TYPE_GENERICINST
    // 048 onChoiceFinish                           Subject`1<Unit> IL2CPP_TYPE_GENERICINST
    ...
    // 060 IsSelected                               ModelPrimitiveType bool bool bool Bool
    public partial class AdvChoiceButtonGroup : DataModel
    {
        ...
        public static AdvChoiceButtonGroup? FromPointer(IntPtr p0)
        {
            ...
            value.ButtonDisposables                         = GetObject<CompositeDisposable>(new IntPtr(p + 0x038), ReversePrism.DataModels.CompositeDisposable.FromPointer); // 0x38 ButtonDisposables           ( ModelClassType CompositeDisposable CompositeDisposable CompositeDisposable Pointer )
            ...
            value.IsSelected                                = GetBool(new IntPtr(p + 0x060)); // 0x60 IsSelected                  ( ModelPrimitiveType bool bool bool Bool )
