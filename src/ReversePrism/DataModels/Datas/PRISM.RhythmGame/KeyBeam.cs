...
namespace ReversePrism.DataModels
{
    ...
    // 028 FadeOutSeconds                           ModelPrimitiveType float float float Single
    ...
    public partial class KeyBeam : DataModel
    {
        ...
        public static KeyBeam? FromPointer(IntPtr p0)
        {
            ...
            value.FadeOutSeconds                            = GetSingle(new IntPtr(p + 0x028)); // 0x28 FadeOutSeconds              ( ModelPrimitiveType float float float Single )
