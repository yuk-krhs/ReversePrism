...
namespace ReversePrism.DataModels
{
    ...
    // 020 State                                    ModelEnumType JudgeState JudgeState JudgeState Int32
    // 024 LagType                                  ModelEnumType JudgmentLagType JudgmentLagType JudgmentLagType Int32
    public partial class JudgmentResult : DataModel
    {
        ...
        public static JudgmentResult? FromPointer(IntPtr p0)
        {
            ...
            value.State                                     = (JudgeState)GetInt32(new IntPtr(p + 0x020)); // 0x20 State                       ( ModelEnumType JudgeState JudgeState JudgeState Int32 )
            value.LagType                                   = (JudgmentLagType)GetInt32(new IntPtr(p + 0x024)); // 0x24 LagType                     ( ModelEnumType JudgmentLagType JudgmentLagType JudgmentLagType Int32 )
