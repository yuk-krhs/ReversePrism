...
namespace ReversePrism.DataModels
{
    ...
    // 010 Results                                  ModelEnumListType List`1<JudgmentResult> List`1<JudgmentResult> List<JudgmentResult> Pointer
    ...
    public partial class AutoJudgeManager : DataModel
    {
        ...
        public static AutoJudgeManager? FromPointer(IntPtr p0)
        {
            ...
            value.Results                                   = GetEnumList<JudgmentResult>(new IntPtr(p + 0x010)); // 0x10 Results                     ( ModelEnumListType List`1<JudgmentResult> List`1<JudgmentResult> List<JudgmentResult> Pointer )
