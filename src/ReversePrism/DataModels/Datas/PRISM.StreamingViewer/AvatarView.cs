...
namespace ReversePrism.DataModels
{
    ...
    public partial class AvatarView
    {
        ...
        public static AvatarView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new AvatarView();

            value.IsSD                                      = GetBool(new IntPtr(p + 0x070)); // 0270D4F42268 0x70 IsSD                        ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.UnitIdol                                  = GetObject<UnitIdol>(new IntPtr(p + 0x078), ReversePrism.DataModels.UnitIdol.FromPointer); // 0270D4F42288 0x78 UnitIdol                    ( 00018670C980 ModelClassType UnitIdol UnitIdol UnitIdol Pointer )
            value.IsViewPaused                              = GetBool(new IntPtr(p + 0x088)); // 0270D4F422C8 0x88 IsViewPaused                ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
