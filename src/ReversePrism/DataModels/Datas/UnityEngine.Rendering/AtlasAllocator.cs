...
namespace ReversePrism.DataModels
{
    ...
    // 010 M_Root                                   ModelClassType AtlasNode AtlasNode AtlasNode Pointer
    // 018 M_Width                                  ModelPrimitiveType int int int Int32
    // 01C M_Height                                 ModelPrimitiveType int int int Int32
    // 020 PowerOfTwoPadding                        ModelPrimitiveType bool bool bool Bool
    ...
    public partial class AtlasAllocator : DataModel
    {
        ...
        public static AtlasAllocator? FromPointer(IntPtr p0)
        {
            ...
            value.M_Root                                    = GetObject<AtlasNode>(new IntPtr(p + 0x010), ReversePrism.DataModels.AtlasNode.FromPointer); // 0x10 M_Root                      ( ModelClassType AtlasNode AtlasNode AtlasNode Pointer )
            ...
            value.PowerOfTwoPadding                         = GetBool(new IntPtr(p + 0x020)); // 0x20 PowerOfTwoPadding           ( ModelPrimitiveType bool bool bool Bool )
