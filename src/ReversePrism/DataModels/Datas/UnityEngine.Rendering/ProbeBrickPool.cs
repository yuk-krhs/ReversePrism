...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProbeBrickPool
    {
        ...
        public static ProbeBrickPool? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProbeBrickPool();

            value.EstimatedVMemCost                         = GetInt32(new IntPtr(p + 0x010)); // 0270D91E2C80 0x10 EstimatedVMemCost           ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.M_Pool                                    = (DataLocation)GetInt32(new IntPtr(p + 0x018)); // 0270D91E2CC0 0x18 M_Pool                      ( 0001865B49A0 ModelEnumType DataLocation DataLocation DataLocation Int32 )
            value.M_NextFreeChunk                           = (BrickChunkAlloc)GetInt32(new IntPtr(p + 0x068)); // 0270D91E2CE0 0x68 M_NextFreeChunk             ( 0001865B4220 ModelEnumType BrickChunkAlloc BrickChunkAlloc BrickChunkAlloc Int32 )
            value.M_AvailableChunkCount                     = GetInt32(new IntPtr(p + 0x080)); // 0270D91E2D20 0x80 M_AvailableChunkCount       ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.M_SHBands                                 = (ProbeVolumeSHBands)GetInt32(new IntPtr(p + 0x084)); // 0270D91E2D40 0x84 M_SHBands                   ( 000186521B60 ModelEnumType ProbeVolumeSHBands ProbeVolumeSHBands ProbeVolumeSHBands Int32 )
            value.M_ContainsValidity                        = GetBool(new IntPtr(p + 0x088)); // 0270D91E2D60 0x88 M_ContainsValidity          ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
