...
namespace ReversePrism.DataModels
{
    ...
    // 010 Argument                                 ModelClassType SpecialLessonResultArgument SpecialLessonResultArgument SpecialLessonResultArgument Pointer
    // 018 View                                     ModelClassType ISpecialLessonResultView ISpecialLessonResultView ISpecialLessonResultView Pointer
    ...
    public partial class SpecialLessonResultPresenter : DataModel
    {
        ...
        public static SpecialLessonResultPresenter? FromPointer(IntPtr p0)
        {
            ...
            value.Argument                                  = GetObject<SpecialLessonResultArgument>(new IntPtr(p + 0x010), ReversePrism.DataModels.SpecialLessonResultArgument.FromPointer); // 0x10 Argument                    ( ModelClassType SpecialLessonResultArgument SpecialLessonResultArgument SpecialLessonResultArgument Pointer )
            value.View                                      = GetObject<ISpecialLessonResultView>(new IntPtr(p + 0x018), ReversePrism.DataModels.ISpecialLessonResultView.FromPointer); // 0x18 View                        ( ModelClassType ISpecialLessonResultView ISpecialLessonResultView ISpecialLessonResultView Pointer )
