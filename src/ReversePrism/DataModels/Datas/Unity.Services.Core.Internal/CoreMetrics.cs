...
namespace ReversePrism.DataModels
{
    ...
    public partial class CoreMetrics
    {
        ...
        public static CoreMetrics? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new CoreMetrics();

            value.Metrics                                   = GetObject<IMetrics>(new IntPtr(p + 0x010), ReversePrism.DataModels.IMetrics.FromPointer); // 0270D0875F50 0x10 Metrics                     ( 0001865B2F70 ModelClassType IMetrics IMetrics IMetrics Pointer )
