...
namespace ReversePrism.DataModels
{
    ...
    public partial class AsyncOperation : DataModel
    {
        ...
        public static AsyncOperation? FromPointer(IntPtr p0)
        {
            ...
            value.IsDone                                    = GetBool(new IntPtr(p + 0x010)); // 02466BAE5550 0x10 IsDone                      ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.Status                                    = (AsyncOperationStatus)GetInt32(new IntPtr(p + 0x014)); // 02466BAE5570 0x14 Status                      ( 0001866FCA20 ModelEnumType AsyncOperationStatus AsyncOperationStatus AsyncOperationStatus Int32 )
            value.Exception                                 = GetObject<Exception>(new IntPtr(p + 0x018), ReversePrism.DataModels.Exception.FromPointer); // 02466BAE5590 0x18 Exception                   ( 0001865CA820 ModelClassType Exception Exception Exception Pointer )
