...
namespace ReversePrism.DataModels
{
    ...
    public partial class DependencyTreeInitializeOrderSorter
    {
        ...
        public static DependencyTreeInitializeOrderSorter? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new DependencyTreeInitializeOrderSorter();

            value.Tree                                      = GetObject<DependencyTree>(new IntPtr(p + 0x010), ReversePrism.DataModels.DependencyTree.FromPointer); // 0270DBA733B0 0x10 Tree                        ( 0001866C0090 ModelClassType DependencyTree DependencyTree DependencyTree Pointer )
