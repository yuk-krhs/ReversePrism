...
namespace ReversePrism.DataModels
{
    ...
    public partial class UDPReflectionUtils
    {
        ...
        public static UDPReflectionUtils? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new UDPReflectionUtils();

            value.K_whiteListedAssemblies                   = GetStringList(new IntPtr(p + 0x010)); // 0270066CDF80 0x10 K_whiteListedAssemblies     ( 000185B820A0 ModelPrimitiveListType string[] string[] List<string> Pointer )
