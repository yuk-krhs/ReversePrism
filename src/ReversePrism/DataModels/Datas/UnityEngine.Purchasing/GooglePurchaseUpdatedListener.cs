...
namespace ReversePrism.DataModels
{
    ...
    public partial class GooglePurchaseUpdatedListener
    {
        ...
        public static GooglePurchaseUpdatedListener? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GooglePurchaseUpdatedListener();

            value.M_LastKnownProductService                 = GetObject<IGoogleLastKnownProductService>(new IntPtr(p + 0x020), ReversePrism.DataModels.IGoogleLastKnownProductService.FromPointer); // 0270069063B0 0x20 M_LastKnownProductService   ( 00018655C890 ModelClassType IGoogleLastKnownProductService IGoogleLastKnownProductService IGoogleLastKnownProductService Pointer )
            value.M_GooglePurchaseCallback                  = GetObject<IGooglePurchaseCallback>(new IntPtr(p + 0x028), ReversePrism.DataModels.IGooglePurchaseCallback.FromPointer); // 0270069063D0 0x28 M_GooglePurchaseCallback    ( 000186560F00 ModelClassType IGooglePurchaseCallback IGooglePurchaseCallback IGooglePurchaseCallback Pointer )
            value.M_PurchaseBuilder                         = GetObject<IGooglePurchaseBuilder>(new IntPtr(p + 0x030), ReversePrism.DataModels.IGooglePurchaseBuilder.FromPointer); // 0270069063F0 0x30 M_PurchaseBuilder           ( 0001865609D0 ModelClassType IGooglePurchaseBuilder IGooglePurchaseBuilder IGooglePurchaseBuilder Pointer )
            value.M_GoogleCachedQuerySkuDetailsService      = GetObject<IGoogleCachedQuerySkuDetailsService>(new IntPtr(p + 0x038), ReversePrism.DataModels.IGoogleCachedQuerySkuDetailsService.FromPointer); // 027006906410 0x38 M_GoogleCachedQuerySkuDetailsService ( 00018655B990 ModelClassType IGoogleCachedQuerySkuDetailsService IGoogleCachedQuerySkuDetailsService IGoogleCachedQuerySkuDetailsService Pointer )
            value.M_GooglePurchaseStateEnumProvider         = GetObject<IGooglePurchaseStateEnumProvider>(new IntPtr(p + 0x040), ReversePrism.DataModels.IGooglePurchaseStateEnumProvider.FromPointer); // 027006906430 0x40 M_GooglePurchaseStateEnumProvider ( 0001865618B0 ModelClassType IGooglePurchaseStateEnumProvider IGooglePurchaseStateEnumProvider IGooglePurchaseStateEnumProvider Pointer )
            value.M_GoogleQueryPurchasesService             = GetObject<IGoogleQueryPurchasesService>(new IntPtr(p + 0x048), ReversePrism.DataModels.IGoogleQueryPurchasesService.FromPointer); // 027006906450 0x48 M_GoogleQueryPurchasesService ( 000186562050 ModelClassType IGoogleQueryPurchasesService IGoogleQueryPurchasesService IGoogleQueryPurchasesService Pointer )
