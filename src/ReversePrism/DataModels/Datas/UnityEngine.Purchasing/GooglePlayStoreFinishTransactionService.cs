...
namespace ReversePrism.DataModels
{
    ...
    public partial class GooglePlayStoreFinishTransactionService : DataModel
    {
        ...
        public static GooglePlayStoreFinishTransactionService? FromPointer(IntPtr p0)
        {
            ...
            value.M_GooglePlayStoreService                  = GetObject<IGooglePlayStoreService>(new IntPtr(p + 0x018), ReversePrism.DataModels.IGooglePlayStoreService.FromPointer); // 0245A68D0E80 0x18 M_GooglePlayStoreService    ( 00018655F5C0 ModelClassType IGooglePlayStoreService IGooglePlayStoreService IGooglePlayStoreService Pointer )
            value.M_StoreCallback                           = GetObject<IStoreCallback>(new IntPtr(p + 0x020), ReversePrism.DataModels.IStoreCallback.FromPointer); // 0245A68D0EA0 0x20 M_StoreCallback             ( 000186658CA0 ModelClassType IStoreCallback IStoreCallback IStoreCallback Pointer )
            value.M_RetryCount                              = GetInt32(new IntPtr(p + 0x028)); // 0245A68D0EC0 0x28 M_RetryCount                ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
