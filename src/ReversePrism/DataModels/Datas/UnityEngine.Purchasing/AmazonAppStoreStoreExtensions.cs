...
namespace ReversePrism.DataModels
{
    ...
    public partial class AmazonAppStoreStoreExtensions : DataModel
    {
        ...
        public static AmazonAppStoreStoreExtensions? FromPointer(IntPtr p0)
        {
            ...
            value.Android                                   = GetObject<AndroidJavaObject>(new IntPtr(p + 0x010), ReversePrism.DataModels.AndroidJavaObject.FromPointer); // 0245A68C0700 0x10 Android                     ( 0001866AD7E0 ModelClassType AndroidJavaObject AndroidJavaObject AndroidJavaObject Pointer )
