...
namespace ReversePrism.DataModels
{
    ...
    public partial class GooglePlayStoreService
    {
        ...
        public static GooglePlayStoreService? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new GooglePlayStoreService();

            value.M_CurrentConnectionAttempts               = GetInt32(new IntPtr(p + 0x010)); // 027006902340 0x10 M_CurrentConnectionAttempts ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.M_BillingClient                           = GetObject<IGoogleBillingClient>(new IntPtr(p + 0x018), ReversePrism.DataModels.IGoogleBillingClient.FromPointer); // 027006902360 0x18 M_BillingClient             ( 00018655AFC0 ModelClassType IGoogleBillingClient IGoogleBillingClient IGoogleBillingClient Pointer )
            value.M_BillingClientStateListener              = GetObject<IBillingClientStateListener>(new IntPtr(p + 0x020), ReversePrism.DataModels.IBillingClientStateListener.FromPointer); // 027006902380 0x20 M_BillingClientStateListener ( 00018670F8E0 ModelClassType IBillingClientStateListener IBillingClientStateListener IBillingClientStateListener Pointer )
            value.M_QuerySkuDetailsService                  = GetObject<IQuerySkuDetailsService>(new IntPtr(p + 0x028), ReversePrism.DataModels.IQuerySkuDetailsService.FromPointer); // 0270069023A0 0x28 M_QuerySkuDetailsService    ( 00018660C000 ModelClassType IQuerySkuDetailsService IQuerySkuDetailsService IQuerySkuDetailsService Pointer )
            value.M_GooglePurchaseService                   = GetObject<IGooglePurchaseService>(new IntPtr(p + 0x040), ReversePrism.DataModels.IGooglePurchaseService.FromPointer); // 027006902400 0x40 M_GooglePurchaseService     ( 000186561400 ModelClassType IGooglePurchaseService IGooglePurchaseService IGooglePurchaseService Pointer )
            value.M_GoogleFinishTransactionService          = GetObject<IGoogleFinishTransactionService>(new IntPtr(p + 0x048), ReversePrism.DataModels.IGoogleFinishTransactionService.FromPointer); // 027006902420 0x48 M_GoogleFinishTransactionService ( 00018655C370 ModelClassType IGoogleFinishTransactionService IGoogleFinishTransactionService IGoogleFinishTransactionService Pointer )
            value.M_GoogleQueryPurchasesService             = GetObject<IGoogleQueryPurchasesService>(new IntPtr(p + 0x050), ReversePrism.DataModels.IGoogleQueryPurchasesService.FromPointer); // 027006902440 0x50 M_GoogleQueryPurchasesService ( 0001865622D0 ModelClassType IGoogleQueryPurchasesService IGoogleQueryPurchasesService IGoogleQueryPurchasesService Pointer )
            value.M_GooglePriceChangeService                = GetObject<IGooglePriceChangeService>(new IntPtr(p + 0x058), ReversePrism.DataModels.IGooglePriceChangeService.FromPointer); // 027006902460 0x58 M_GooglePriceChangeService  ( 00018655FAB0 ModelClassType IGooglePriceChangeService IGooglePriceChangeService IGooglePriceChangeService Pointer )
            value.M_GoogleLastKnownProductService           = GetObject<IGoogleLastKnownProductService>(new IntPtr(p + 0x060), ReversePrism.DataModels.IGoogleLastKnownProductService.FromPointer); // 027006902480 0x60 M_GoogleLastKnownProductService ( 00018655C890 ModelClassType IGoogleLastKnownProductService IGoogleLastKnownProductService IGoogleLastKnownProductService Pointer )
            value.M_TelemetryDiagnostics                    = GetObject<ITelemetryDiagnostics>(new IntPtr(p + 0x068), ReversePrism.DataModels.ITelemetryDiagnostics.FromPointer); // 0270069024A0 0x68 M_TelemetryDiagnostics      ( 00018666E030 ModelClassType ITelemetryDiagnostics ITelemetryDiagnostics ITelemetryDiagnostics Pointer )
            value.M_Logger                                  = GetObject<ILogger>(new IntPtr(p + 0x070), ReversePrism.DataModels.ILogger.FromPointer); // 0270069024C0 0x70 M_Logger                    ( 0001865A19E0 ModelClassType ILogger ILogger ILogger Pointer )
