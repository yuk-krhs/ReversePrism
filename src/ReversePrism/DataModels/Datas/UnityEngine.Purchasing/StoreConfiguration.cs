...
namespace ReversePrism.DataModels
{
    ...
    public partial class StoreConfiguration
    {
        ...
        public static StoreConfiguration? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new StoreConfiguration();

            value.AndroidStore                              = (AppStore)GetInt32(new IntPtr(p + 0x010)); // 02700691C598 0x10 AndroidStore                ( 0001866CB330 ModelEnumType AppStore AppStore AppStore Int32 )
