...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProductCatalogPayout : DataModel
    {
        ...
        public static ProductCatalogPayout? FromPointer(IntPtr p0)
        {
            ...
            value.T                                         = GetString(new IntPtr(p + 0x010)); // 0245A68DD798 0x10 T                           ( 000186671910 ModelPrimitiveType string string string String )
            value.St                                        = GetString(new IntPtr(p + 0x018)); // 0245A68DD7D8 0x18 St                          ( 000186671910 ModelPrimitiveType string string string String )
            value.Q                                         = GetDouble(new IntPtr(p + 0x020)); // 0245A68DD7F8 0x20 Q                           ( 0001865C2950 ModelPrimitiveType double double double Double )
            value.D                                         = GetString(new IntPtr(p + 0x028)); // 0245A68DD838 0x28 D                           ( 000186671910 ModelPrimitiveType string string string String )
