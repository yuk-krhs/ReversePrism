...
namespace ReversePrism.DataModels
{
    ...
    // 010 M_NumberReceivedCallbacks                ModelPrimitiveType int int int Int32
    // 018 m_OnSkuDetailsResponseConsolidated       Action`1<ISkuDetailsQueryResponse> IL2CPP_TYPE_GENERICINST
    // 020 M_Responses                              ModelClassType ISkuDetailsQueryResponse ISkuDetailsQueryResponse ISkuDetailsQueryResponse Pointer
    ...
    public partial class SkuDetailsResponseConsolidator : DataModel
    {
        ...
        public static SkuDetailsResponseConsolidator? FromPointer(IntPtr p0)
        {
            ...
            value.M_NumberReceivedCallbacks                 = GetInt32(new IntPtr(p + 0x010)); // 0x10 M_NumberReceivedCallbacks   ( ModelPrimitiveType int int int Int32 )
            value.M_Responses                               = GetObject<ISkuDetailsQueryResponse>(new IntPtr(p + 0x020), ReversePrism.DataModels.ISkuDetailsQueryResponse.FromPointer); // 0x20 M_Responses                 ( ModelClassType ISkuDetailsQueryResponse ISkuDetailsQueryResponse ISkuDetailsQueryResponse Pointer )
