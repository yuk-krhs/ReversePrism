...
namespace ReversePrism.DataModels
{
    ...
    public partial class MetricizedGooglePlayStoreService
    {
        ...
        public static MetricizedGooglePlayStoreService? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new MetricizedGooglePlayStoreService();

            value.M_TelemetryMetricsService                 = GetObject<ITelemetryMetricsService>(new IntPtr(p + 0x078), ReversePrism.DataModels.ITelemetryMetricsService.FromPointer); // 027006906CC0 0x78 M_TelemetryMetricsService   ( 00018666FD70 ModelClassType ITelemetryMetricsService ITelemetryMetricsService ITelemetryMetricsService Pointer )
            value.M_TelemetryDiagnostics                    = GetObject<ITelemetryDiagnostics>(new IntPtr(p + 0x080), ReversePrism.DataModels.ITelemetryDiagnostics.FromPointer); // 027006906CE0 0x80 M_TelemetryDiagnostics      ( 00018666E030 ModelClassType ITelemetryDiagnostics ITelemetryDiagnostics ITelemetryDiagnostics Pointer )
