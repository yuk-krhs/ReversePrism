...
namespace ReversePrism.DataModels
{
    ...
    public partial class GoogleFinishTransactionService : DataModel
    {
        ...
        public static GoogleFinishTransactionService? FromPointer(IntPtr p0)
        {
            ...
            value.M_BillingClient                           = GetObject<IGoogleBillingClient>(new IntPtr(p + 0x010), ReversePrism.DataModels.IGoogleBillingClient.FromPointer); // 0245A68C17E0 0x10 M_BillingClient             ( 00018655AFC0 ModelClassType IGoogleBillingClient IGoogleBillingClient IGoogleBillingClient Pointer )
            value.M_GoogleQueryPurchasesService             = GetObject<IGoogleQueryPurchasesService>(new IntPtr(p + 0x018), ReversePrism.DataModels.IGoogleQueryPurchasesService.FromPointer); // 0245A68C1800 0x18 M_GoogleQueryPurchasesService ( 0001865622D0 ModelClassType IGoogleQueryPurchasesService IGoogleQueryPurchasesService IGoogleQueryPurchasesService Pointer )
