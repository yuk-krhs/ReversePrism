...
namespace ReversePrism.DataModels
{
    ...
    // 010 M_Logger                                 ModelClassType ILogger ILogger ILogger Pointer
    public partial class UnityServicesInitializationChecker : DataModel
    {
        ...
        public static UnityServicesInitializationChecker? FromPointer(IntPtr p0)
        {
            ...
            value.M_Logger                                  = GetObject<ILogger>(new IntPtr(p + 0x010), ReversePrism.DataModels.ILogger.FromPointer); // 0x10 M_Logger                    ( ModelClassType ILogger ILogger ILogger Pointer )
