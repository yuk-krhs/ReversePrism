...
namespace ReversePrism.DataModels
{
    ...
    // 050 Scheduler                                ModelClassType IScheduler IScheduler IScheduler Pointer
    public partial class TimerObservable : DataModel
    {
        ...
        public static TimerObservable? FromPointer(IntPtr p0)
        {
            ...
            value.Scheduler                                 = GetObject<IScheduler>(new IntPtr(p + 0x050), ReversePrism.DataModels.IScheduler.FromPointer); // 0x50 Scheduler                   ( ModelClassType IScheduler IScheduler IScheduler Pointer )
