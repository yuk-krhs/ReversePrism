...
namespace ReversePrism.DataModels
{
    ...
    public partial class SerStack : DataModel
    {
        ...
        public static SerStack? FromPointer(IntPtr p0)
        {
            ...
            value.StackId                                   = GetString(new IntPtr(p + 0x018)); // 024666CC4840 0x18 StackId                     ( 000186671BA0 ModelPrimitiveType string string string String )
            value.Top                                       = GetInt32(new IntPtr(p + 0x020)); // 024666CC4860 0x20 Top                         ( 0001865F2F90 ModelPrimitiveType int int int Int32 )
