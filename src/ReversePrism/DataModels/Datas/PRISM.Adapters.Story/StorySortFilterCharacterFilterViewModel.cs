...
namespace ReversePrism.DataModels
{
    ...
    // 010 CellDataArray                            ModelClassListType StorySortFilterCharacterFilterCellData[] StorySortFilterCharacterFilterCellData[] List<StorySortFilterCharacterFilterCellData> Pointer
