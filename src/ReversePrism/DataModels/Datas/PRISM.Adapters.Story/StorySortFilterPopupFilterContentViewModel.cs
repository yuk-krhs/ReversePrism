...
namespace ReversePrism.DataModels
{
    ...
    public partial class StorySortFilterPopupFilterContentViewModel
    {
        ...
        public static StorySortFilterPopupFilterContentViewModel? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new StorySortFilterPopupFilterContentViewModel();

            value.ReadToggleFilterViewModel                 = GetObject<StorySortFilterToggleFilterViewModel>(new IntPtr(p + 0x010), ReversePrism.DataModels.StorySortFilterToggleFilterViewModel.FromPointer); // 0270D67C0D70 0x10 ReadToggleFilterViewModel   ( 0001865A4110 ModelClassType StorySortFilterToggleFilterViewModel StorySortFilterToggleFilterViewModel StorySortFilterToggleFilterViewModel Pointer )
            value.StoryTypeToggleFilterViewModel            = GetObject<StorySortFilterToggleFilterViewModel>(new IntPtr(p + 0x018), ReversePrism.DataModels.StorySortFilterToggleFilterViewModel.FromPointer); // 0270D67C0D90 0x18 StoryTypeToggleFilterViewModel ( 0001865A4110 ModelClassType StorySortFilterToggleFilterViewModel StorySortFilterToggleFilterViewModel StorySortFilterToggleFilterViewModel Pointer )
            value.CharacterFilterViewModel                  = GetObject<StorySortFilterCharacterFilterViewModel>(new IntPtr(p + 0x020), ReversePrism.DataModels.StorySortFilterCharacterFilterViewModel.FromPointer); // 0270D67C0DB0 0x20 CharacterFilterViewModel    ( 00018659F2D0 ModelClassType StorySortFilterCharacterFilterViewModel StorySortFilterCharacterFilterViewModel StorySortFilterCharacterFilterViewModel Pointer )
