...
namespace ReversePrism.DataModels
{
    ...
    public partial class StorySortFilterCharacterFilterCellContainerData
    {
        ...
        public static StorySortFilterCharacterFilterCellContainerData? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new StorySortFilterCharacterFilterCellContainerData();

            value.UnitId                                    = GetInt32(new IntPtr(p + 0x010)); // 0270D67BE768 0x10 UnitId                      ( 0001865F4260 ModelPrimitiveType int int int Int32 )
            value.CellDataList                              = GetObjectList<StorySortFilterCharacterFilterCellData>(new IntPtr(p + 0x018), ReversePrism.DataModels.StorySortFilterCharacterFilterCellData.FromPointer); // 0270D67BE788 0x18 CellDataList                ( 000185D16918 ModelClassListType IReadOnlyList`1<StorySortFilterCharacterFilterCellData> IReadOnlyList`1<StorySortFilterCharacterFilterCellData> List<StorySortFilterCharacterFilterCellData> Pointer )
