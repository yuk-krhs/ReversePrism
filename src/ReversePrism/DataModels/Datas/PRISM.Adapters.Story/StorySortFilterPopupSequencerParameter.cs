...
namespace ReversePrism.DataModels
{
    ...
    public partial class StorySortFilterPopupSequencerParameter
    {
        ...
        public static StorySortFilterPopupSequencerParameter? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new StorySortFilterPopupSequencerParameter();

            value.SortTargetIndex                           = GetInt32(new IntPtr(p + 0x010)); // 0270D67C3148 0x10 SortTargetIndex             ( 0001865F4260 ModelPrimitiveType int int int Int32 )
            value.UseFavoriteSortToggle                     = GetBool(new IntPtr(p + 0x014)); // 0270D67C3168 0x14 UseFavoriteSortToggle       ( 0001865965D0 ModelPrimitiveType bool bool bool Bool )
