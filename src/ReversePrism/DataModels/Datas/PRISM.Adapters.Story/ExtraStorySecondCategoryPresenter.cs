...
namespace ReversePrism.DataModels
{
    ...
    public partial class ExtraStorySecondCategoryPresenter : DataModel
    {
        ...
        public static ExtraStorySecondCategoryPresenter? FromPointer(IntPtr p0)
        {
            ...
            value.View                                      = GetObject<IExtraStorySecondCategoryView>(new IntPtr(p + 0x010), ReversePrism.DataModels.IExtraStorySecondCategoryView.FromPointer); // 0246667FDEA0 0x10 View                        ( 000186773510 ModelClassType IExtraStorySecondCategoryView IExtraStorySecondCategoryView IExtraStorySecondCategoryView Pointer )
            value.Argument                                  = GetObject<ExtraStorySecondCategoryArgument>(new IntPtr(p + 0x018), ReversePrism.DataModels.ExtraStorySecondCategoryArgument.FromPointer); // 0246667FDEC0 0x18 Argument                    ( 00018653BF40 ModelClassType ExtraStorySecondCategoryArgument ExtraStorySecondCategoryArgument ExtraStorySecondCategoryArgument Pointer )
            value.Cts                                       = GetObject<CancellationTokenSource>(new IntPtr(p + 0x020), ReversePrism.DataModels.CancellationTokenSource.FromPointer); // 0246667FDEE0 0x20 Cts                         ( 0001865A4380 ModelClassType CancellationTokenSource CancellationTokenSource CancellationTokenSource Pointer )
            value.Disposables                               = GetObject<CompositeDisposable>(new IntPtr(p + 0x028), ReversePrism.DataModels.CompositeDisposable.FromPointer); // 0246667FDF00 0x28 Disposables                 ( 0001865F38F0 ModelClassType CompositeDisposable CompositeDisposable CompositeDisposable Pointer )
            value.Model                                     = GetObject<ExtraStorySecondCategoryModel>(new IntPtr(p + 0x030), ReversePrism.DataModels.ExtraStorySecondCategoryModel.FromPointer); // 0246667FDF20 0x30 Model                       ( 00018653E140 ModelClassType ExtraStorySecondCategoryModel ExtraStorySecondCategoryModel ExtraStorySecondCategoryModel Pointer )
