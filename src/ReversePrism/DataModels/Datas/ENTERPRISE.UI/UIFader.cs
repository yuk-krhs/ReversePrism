...
namespace ReversePrism.DataModels
{
    ...
    // 040 IsDark                                   ModelPrimitiveType bool bool bool Bool
    // 048 FadeImage                                ModelClassType Image Image Image Pointer
    ...
    public partial class UIFader : DataModel
    {
        ...
        public static UIFader? FromPointer(IntPtr p0)
        {
            ...
            value.IsDark                                    = GetBool(new IntPtr(p + 0x040)); // 0x40 IsDark                      ( ModelPrimitiveType bool bool bool Bool )
            value.FadeImage                                 = GetObject<Image>(new IntPtr(p + 0x048), ReversePrism.DataModels.Image.FromPointer); // 0x48 FadeImage                   ( ModelClassType Image Image Image Pointer )
