...
namespace ReversePrism.DataModels
{
    ...
    public partial class UnicodeLineBreakingRules : DataModel
    {
        ...
        public static UnicodeLineBreakingRules? FromPointer(IntPtr p0)
        {
            ...
            value.M_UnicodeLineBreakingRules                = GetObject<TextAsset>(new IntPtr(p + 0x010), ReversePrism.DataModels.TextAsset.FromPointer); // 0245A68BFD48 0x10 M_UnicodeLineBreakingRules  ( 000186634CA0 ModelClassType TextAsset TextAsset TextAsset Pointer )
            value.M_LeadingCharacters                       = GetObject<TextAsset>(new IntPtr(p + 0x018), ReversePrism.DataModels.TextAsset.FromPointer); // 0245A68BFD68 0x18 M_LeadingCharacters         ( 000186634CA0 ModelClassType TextAsset TextAsset TextAsset Pointer )
            value.M_FollowingCharacters                     = GetObject<TextAsset>(new IntPtr(p + 0x020), ReversePrism.DataModels.TextAsset.FromPointer); // 0245A68BFD88 0x20 M_FollowingCharacters       ( 000186634CA0 ModelClassType TextAsset TextAsset TextAsset Pointer )
            value.M_UseModernHangulLineBreakingRules        = GetBool(new IntPtr(p + 0x028)); // 0245A68BFDA8 0x28 M_UseModernHangulLineBreakingRules ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
