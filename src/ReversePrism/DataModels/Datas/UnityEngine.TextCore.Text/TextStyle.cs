...
namespace ReversePrism.DataModels
{
    ...
    // 030 M_OpeningTagArray                        ModelPrimitiveListType uint[] uint[] List<uint> Pointer
    // 038 M_ClosingTagArray                        ModelPrimitiveListType uint[] uint[] List<uint> Pointer
    ...
    public partial class TextStyle : DataModel
    {
        ...
        public static TextStyle? FromPointer(IntPtr p0)
        {
            ...
            value.M_OpeningTagArray                         = GetUInt32List(new IntPtr(p + 0x030)); // 0x30 M_OpeningTagArray           ( ModelPrimitiveListType uint[] uint[] List<uint> Pointer )
            value.M_ClosingTagArray                         = GetUInt32List(new IntPtr(p + 0x038)); // 0x38 M_ClosingTagArray           ( ModelPrimitiveListType uint[] uint[] List<uint> Pointer )
