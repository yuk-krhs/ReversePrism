...
namespace ReversePrism.DataModels
{
    ...
    public partial class CharacterSubstitution : DataModel
    {
        ...
        public static CharacterSubstitution? FromPointer(IntPtr p0)
        {
            ...
            value.Index                                     = GetInt32(new IntPtr(p + 0x010)); // 0245A68BC3C8 0x10 Index                       ( 0001865F36C0 ModelPrimitiveType int int int Int32 )
            value.Unicode                                   = GetUInt32(new IntPtr(p + 0x014)); // 0245A68BC3E8 0x14 Unicode                     ( 0001866992B0 ModelPrimitiveType uint uint uint UInt32 )
