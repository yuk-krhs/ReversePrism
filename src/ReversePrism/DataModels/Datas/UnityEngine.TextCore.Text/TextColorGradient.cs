...
namespace ReversePrism.DataModels
{
    ...
    public partial class TextColorGradient : DataModel
    {
        ...
        public static TextColorGradient? FromPointer(IntPtr p0)
        {
            ...
            value.ColorMode                                 = (ColorGradientMode)GetInt32(new IntPtr(p + 0x018)); // 0245A68AD800 0x18 ColorMode                   ( 0001865CD450 ModelEnumType ColorGradientMode ColorGradientMode ColorGradientMode Int32 )
            value.TopLeft                                   = (Color)GetInt32(new IntPtr(p + 0x01C)); // 0245A68AD820 0x1C TopLeft                     ( 0001865AB0A0 ModelEnumType Color Color Color Int32 )
            value.TopRight                                  = (Color)GetInt32(new IntPtr(p + 0x02C)); // 0245A68AD840 0x2C TopRight                    ( 0001865AB0A0 ModelEnumType Color Color Color Int32 )
            value.BottomLeft                                = (Color)GetInt32(new IntPtr(p + 0x03C)); // 0245A68AD860 0x3C BottomLeft                  ( 0001865AB0A0 ModelEnumType Color Color Color Int32 )
            value.BottomRight                               = (Color)GetInt32(new IntPtr(p + 0x04C)); // 0245A68AD880 0x4C BottomRight                 ( 0001865AB0A0 ModelEnumType Color Color Color Int32 )
