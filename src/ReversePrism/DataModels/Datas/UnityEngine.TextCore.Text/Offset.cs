...
namespace ReversePrism.DataModels
{
    ...
    public partial class Offset
    {
        ...
        public static Offset? FromPointer(IntPtr p0)
        {
            ...
            value.M_Left                                    = GetSingle(new IntPtr(p + 0x010)); // 0270068EB328 0x10 M_Left                      ( 0001866656B0 ModelPrimitiveType float float float Single )
            value.M_Right                                   = GetSingle(new IntPtr(p + 0x014)); // 0270068EB348 0x14 M_Right                     ( 0001866656B0 ModelPrimitiveType float float float Single )
            value.M_Top                                     = GetSingle(new IntPtr(p + 0x018)); // 0270068EB368 0x18 M_Top                       ( 0001866656B0 ModelPrimitiveType float float float Single )
            value.M_Bottom                                  = GetSingle(new IntPtr(p + 0x01C)); // 0270068EB388 0x1C M_Bottom                    ( 0001866656B0 ModelPrimitiveType float float float Single )
