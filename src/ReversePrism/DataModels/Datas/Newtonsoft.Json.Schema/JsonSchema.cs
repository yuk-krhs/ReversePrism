...
namespace ReversePrism.DataModels
{
    ...
    // 0A8 AdditionalItems                          ModelClassType JsonSchema JsonSchema JsonSchema Pointer
    // 0B0 AllowAdditionalItems                     ModelPrimitiveType bool bool bool Bool
    // 0B1 UniqueItems                              ModelPrimitiveType bool bool bool Bool
    // 0B8 <Properties>k__BackingField              IDictionary`2<string, JsonSchema> IL2CPP_TYPE_GENERICINST
    // 0C0 AdditionalProperties                     ModelClassType JsonSchema JsonSchema JsonSchema Pointer
    // 0C8 <PatternProperties>k__BackingField       IDictionary`2<string, JsonSchema> IL2CPP_TYPE_GENERICINST
    // 0D0 AllowAdditionalProperties                ModelPrimitiveType bool bool bool Bool
    // 0D8 Requires                                 ModelPrimitiveType string string string String
    ...
    // 0F0 Default                                  ModelClassType JToken JToken JToken Pointer
    // 0F8 <Extends>k__BackingField                 IList`1<JsonSchema> IL2CPP_TYPE_GENERICINST
    // 100 Format                                   ModelPrimitiveType string string string String
    // 108 Location                                 ModelPrimitiveType string string string String
    // 110 InternalId                               ModelPrimitiveType string string string String
    // 118 DeferredReference                        ModelPrimitiveType string string string String
    // 120 ReferencesResolved                       ModelPrimitiveType bool bool bool Bool
    public partial class JsonSchema : DataModel
    {
        ...
        public static JsonSchema? FromPointer(IntPtr p0)
        {
            ...
            value.AdditionalItems                           = GetObject<JsonSchema>(new IntPtr(p + 0x0A8), ReversePrism.DataModels.JsonSchema.FromPointer); // 0xA8 AdditionalItems             ( ModelClassType JsonSchema JsonSchema JsonSchema Pointer )
            value.AllowAdditionalItems                      = GetBool(new IntPtr(p + 0x0B0)); // 0xB0 AllowAdditionalItems        ( ModelPrimitiveType bool bool bool Bool )
            value.UniqueItems                               = GetBool(new IntPtr(p + 0x0B1)); // 0xB1 UniqueItems                 ( ModelPrimitiveType bool bool bool Bool )
            value.AdditionalProperties                      = GetObject<JsonSchema>(new IntPtr(p + 0x0C0), ReversePrism.DataModels.JsonSchema.FromPointer); // 0xC0 AdditionalProperties        ( ModelClassType JsonSchema JsonSchema JsonSchema Pointer )
            value.AllowAdditionalProperties                 = GetBool(new IntPtr(p + 0x0D0)); // 0xD0 AllowAdditionalProperties   ( ModelPrimitiveType bool bool bool Bool )
            value.Requires                                  = GetString(new IntPtr(p + 0x0D8)); // 0xD8 Requires                    ( ModelPrimitiveType string string string String )
            value.Default                                   = GetObject<JToken>(new IntPtr(p + 0x0F0), ReversePrism.DataModels.JToken.FromPointer); // 0xF0 Default                     ( ModelClassType JToken JToken JToken Pointer )
            value.Format                                    = GetString(new IntPtr(p + 0x100)); // 0x100 Format                      ( ModelPrimitiveType string string string String )
            value.Location                                  = GetString(new IntPtr(p + 0x108)); // 0x108 Location                    ( ModelPrimitiveType string string string String )
            value.InternalId                                = GetString(new IntPtr(p + 0x110)); // 0x110 InternalId                  ( ModelPrimitiveType string string string String )
            value.DeferredReference                         = GetString(new IntPtr(p + 0x118)); // 0x118 DeferredReference           ( ModelPrimitiveType string string string String )
            value.ReferencesResolved                        = GetBool(new IntPtr(p + 0x120)); // 0x120 ReferencesResolved          ( ModelPrimitiveType bool bool bool Bool )
