...
namespace ReversePrism.DataModels
{
    ...
    public partial class JsonSchemaBuilder : DataModel
    {
        ...
        public static JsonSchemaBuilder? FromPointer(IntPtr p0)
        {
            ...
            value.Resolver                                  = GetObject<JsonSchemaResolver>(new IntPtr(p + 0x018), ReversePrism.DataModels.JsonSchemaResolver.FromPointer); // 0246687EEC90 0x18 Resolver                    ( 00018675D250 ModelClassType JsonSchemaResolver JsonSchemaResolver JsonSchemaResolver Pointer )
            value.CurrentSchema                             = GetObject<JsonSchema>(new IntPtr(p + 0x028), ReversePrism.DataModels.JsonSchema.FromPointer); // 0246687EECD0 0x28 CurrentSchema               ( 00018675AD30 ModelClassType JsonSchema JsonSchema JsonSchema Pointer )
            value.RootSchema                                = GetObject<JObject>(new IntPtr(p + 0x030), ReversePrism.DataModels.JObject.FromPointer); // 0246687EECF0 0x30 RootSchema                  ( 000186744370 ModelClassType JObject JObject JObject Pointer )
