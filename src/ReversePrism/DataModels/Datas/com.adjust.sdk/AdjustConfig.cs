...
namespace ReversePrism.DataModels
{
    ...
    // 010 AppToken                                 ModelPrimitiveType string string string String
    // 018 SceneName                                ModelPrimitiveType string string string String
    // 020 UserAgent                                ModelPrimitiveType string string string String
    // 028 DefaultTracker                           ModelPrimitiveType string string string String
    // 030 ExternalDeviceId                         ModelPrimitiveType string string string String
    // 038 UrlStrategy                              ModelPrimitiveType string string string String
    ...
    // 0AE LaunchDeferredDeeplink                   ModelPrimitiveType bool bool bool Bool
    // 0B0 logLevel                                 Nullable`1<AdjustLogLevel> IL2CPP_TYPE_GENERICINST
    // 0B8 Environment                              ModelEnumType AdjustEnvironment AdjustEnvironment AdjustEnvironment Int32
    ...
    // 100 ProcessName                              ModelPrimitiveType string string string String
    ...
    // 110 PreinstallFilePath                       ModelPrimitiveType string string string String
    ...
    public partial class AdjustConfig : DataModel
    {
        ...
        public static AdjustConfig? FromPointer(IntPtr p0)
        {
            ...
            value.AppToken                                  = GetString(new IntPtr(p + 0x010)); // 0x10 AppToken                    ( ModelPrimitiveType string string string String )
            value.SceneName                                 = GetString(new IntPtr(p + 0x018)); // 0x18 SceneName                   ( ModelPrimitiveType string string string String )
            value.UserAgent                                 = GetString(new IntPtr(p + 0x020)); // 0x20 UserAgent                   ( ModelPrimitiveType string string string String )
            value.DefaultTracker                            = GetString(new IntPtr(p + 0x028)); // 0x28 DefaultTracker              ( ModelPrimitiveType string string string String )
            value.ExternalDeviceId                          = GetString(new IntPtr(p + 0x030)); // 0x30 ExternalDeviceId            ( ModelPrimitiveType string string string String )
            value.UrlStrategy                               = GetString(new IntPtr(p + 0x038)); // 0x38 UrlStrategy                 ( ModelPrimitiveType string string string String )
            value.LaunchDeferredDeeplink                    = GetBool(new IntPtr(p + 0x0AE)); // 0xAE LaunchDeferredDeeplink      ( ModelPrimitiveType bool bool bool Bool )
            value.Environment                               = (AdjustEnvironment)GetInt32(new IntPtr(p + 0x0B8)); // 0xB8 Environment                 ( ModelEnumType AdjustEnvironment AdjustEnvironment AdjustEnvironment Int32 )
            value.ProcessName                               = GetString(new IntPtr(p + 0x100)); // 0x100 ProcessName                 ( ModelPrimitiveType string string string String )
            value.PreinstallFilePath                        = GetString(new IntPtr(p + 0x110)); // 0x110 PreinstallFilePath          ( ModelPrimitiveType string string string String )
