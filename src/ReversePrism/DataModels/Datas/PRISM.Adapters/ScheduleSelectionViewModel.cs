...
namespace ReversePrism.DataModels
{
    ...
    public partial class ScheduleSelectionViewModel
    {
        ...
        public static ScheduleSelectionViewModel? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ScheduleSelectionViewModel();

            value.Display3DColor                            = (Color)GetInt32(new IntPtr(p + 0x010)); // 0270D6627190 0x10 Display3DColor              ( 0001865AA8E0 ModelEnumType Color Color Color Int32 )
            value.NotDisplay3DColor                         = (Color)GetInt32(new IntPtr(p + 0x020)); // 0270D66271B0 0x20 NotDisplay3DColor           ( 0001865AA8E0 ModelEnumType Color Color Color Int32 )
            value.ProduceBaseInfoViewModel                  = GetObject<ProduceBaseInfoViewModel>(new IntPtr(p + 0x030), ReversePrism.DataModels.ProduceBaseInfoViewModel.FromPointer); // 0270D66271D0 0x30 ProduceBaseInfoViewModel    ( 000186533A20 ModelClassType ProduceBaseInfoViewModel ProduceBaseInfoViewModel ProduceBaseInfoViewModel Pointer )
            value.WeekScheduleListViewModel                 = GetObject<WeekScheduleListViewModel>(new IntPtr(p + 0x038), ReversePrism.DataModels.WeekScheduleListViewModel.FromPointer); // 0270D66271F0 0x38 WeekScheduleListViewModel   ( 000186554400 ModelClassType WeekScheduleListViewModel WeekScheduleListViewModel WeekScheduleListViewModel Pointer )
            value.ScheduleSelectionUnitIdolViewModel        = GetObject<ScheduleSelectionUnitIdolViewModel>(new IntPtr(p + 0x040), ReversePrism.DataModels.ScheduleSelectionUnitIdolViewModel.FromPointer); // 0270D6627210 0x40 ScheduleSelectionUnitIdolViewModel ( 0001866E1B50 ModelClassType ScheduleSelectionUnitIdolViewModel ScheduleSelectionUnitIdolViewModel ScheduleSelectionUnitIdolViewModel Pointer )
            value.ScheduleSelectionUnitParameterViewModel   = GetObject<ScheduleSelectionLeftBottomAreaViewModel>(new IntPtr(p + 0x048), ReversePrism.DataModels.ScheduleSelectionLeftBottomAreaViewModel.FromPointer); // 0270D6627230 0x48 ScheduleSelectionUnitParameterViewModel ( 0001866DA490 ModelClassType ScheduleSelectionLeftBottomAreaViewModel ScheduleSelectionLeftBottomAreaViewModel ScheduleSelectionLeftBottomAreaViewModel Pointer )
            value.ScheduleSelectionLeftWeekViewModel        = GetObject<ScheduleSelectionLeftWeekViewModel>(new IntPtr(p + 0x050), ReversePrism.DataModels.ScheduleSelectionLeftWeekViewModel.FromPointer); // 0270D6627250 0x50 ScheduleSelectionLeftWeekViewModel ( 0001866DB5B0 ModelClassType ScheduleSelectionLeftWeekViewModel ScheduleSelectionLeftWeekViewModel ScheduleSelectionLeftWeekViewModel Pointer )
            value.ScheduleSelectionScheduleDisplayViewModel = GetObject<ScheduleSelectionScheduleDisplayViewModel>(new IntPtr(p + 0x058), ReversePrism.DataModels.ScheduleSelectionScheduleDisplayViewModel.FromPointer); // 0270D6627270 0x58 ScheduleSelectionScheduleDisplayViewModel ( 0001866E00E0 ModelClassType ScheduleSelectionScheduleDisplayViewModel ScheduleSelectionScheduleDisplayViewModel ScheduleSelectionScheduleDisplayViewModel Pointer )
            value.ScheduleSelectionScheduleDetailViewModel  = GetObject<ScheduleSelectionScheduleDetailViewModel>(new IntPtr(p + 0x060), ReversePrism.DataModels.ScheduleSelectionScheduleDetailViewModel.FromPointer); // 0270D6627290 0x60 ScheduleSelectionScheduleDetailViewModel ( 0001866DF950 ModelClassType ScheduleSelectionScheduleDetailViewModel ScheduleSelectionScheduleDetailViewModel ScheduleSelectionScheduleDetailViewModel Pointer )
