...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProducePolicyViewModel
    {
        ...
        public static ProducePolicyViewModel? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProducePolicyViewModel();

            value.CacheProduceStrategyListViewModel         = GetObject<ProduceStrategyListViewModel>(new IntPtr(p + 0x010), ReversePrism.DataModels.ProduceStrategyListViewModel.FromPointer); // 0270D65A9E28 0x10 CacheProduceStrategyListViewModel ( 000186583C40 ModelClassType ProduceStrategyListViewModel ProduceStrategyListViewModel ProduceStrategyListViewModel Pointer )
            value.CacheProduceBaseInfoViewModel             = GetObject<ProduceBaseInfoViewModel>(new IntPtr(p + 0x018), ReversePrism.DataModels.ProduceBaseInfoViewModel.FromPointer); // 0270D65A9E48 0x18 CacheProduceBaseInfoViewModel ( 000186533A20 ModelClassType ProduceBaseInfoViewModel ProduceBaseInfoViewModel ProduceBaseInfoViewModel Pointer )
