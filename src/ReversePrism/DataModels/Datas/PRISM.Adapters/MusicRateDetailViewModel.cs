...
namespace ReversePrism.DataModels
{
    ...
    public partial class MusicRateDetailViewModel
    {
        ...
        public static MusicRateDetailViewModel? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new MusicRateDetailViewModel();

            value.UserInfoData                              = GetObject<MusicRateOverlayUserInfoViewModel>(new IntPtr(p + 0x010), ReversePrism.DataModels.MusicRateOverlayUserInfoViewModel.FromPointer); // 0270D63F4E50 0x10 UserInfoData                ( 00018666E7A0 ModelClassType MusicRateOverlayUserInfoViewModel MusicRateOverlayUserInfoViewModel MusicRateOverlayUserInfoViewModel Pointer )
            value.RewardDataList                            = GetObjectList<MusicRateRewardListCellData>(new IntPtr(p + 0x018), ReversePrism.DataModels.MusicRateRewardListCellData.FromPointer); // 0270D63F4E70 0x18 RewardDataList              ( 000185D13648 ModelClassListType IReadOnlyList`1<MusicRateRewardListCellData> IReadOnlyList`1<MusicRateRewardListCellData> List<MusicRateRewardListCellData> Pointer )
            value.TargetMusicDataList                       = GetObjectList<MusicRateTargetMusicListCellData>(new IntPtr(p + 0x020), ReversePrism.DataModels.MusicRateTargetMusicListCellData.FromPointer); // 0270D63F4E90 0x20 TargetMusicDataList         ( 000185D13898 ModelClassListType IReadOnlyList`1<MusicRateTargetMusicListCellData> IReadOnlyList`1<MusicRateTargetMusicListCellData> List<MusicRateTargetMusicListCellData> Pointer )
