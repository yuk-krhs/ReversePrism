...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProfileEditPlayerNamePopupSequencer
    {
        ...
        public static ProfileEditPlayerNamePopupSequencer? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProfileEditPlayerNamePopupSequencer();

            value.ViewModel                                 = GetObject<ProfileUserSalfViewModel>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProfileUserSalfViewModel.FromPointer); // 0270D668B608 0x20 ViewModel                   ( 0001865C6380 ModelClassType ProfileUserSalfViewModel ProfileUserSalfViewModel ProfileUserSalfViewModel Pointer )
            value.Canceller                                 = (AutoCancellationTokenSource)GetInt32(new IntPtr(p + 0x028)); // 0270D668B628 0x28 Canceller                   ( 000186724470 ModelEnumType AutoCancellationTokenSource AutoCancellationTokenSource AutoCancellationTokenSource Int32 )
