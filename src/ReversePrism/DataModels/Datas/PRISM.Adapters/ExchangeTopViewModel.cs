...
namespace ReversePrism.DataModels
{
    ...
    public partial class ExchangeTopViewModel
    {
        ...
        public static ExchangeTopViewModel? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ExchangeTopViewModel();

            value.SaveData                                  = GetObject<ExchangeSaveData>(new IntPtr(p + 0x010), ReversePrism.DataModels.ExchangeSaveData.FromPointer); // 0270D61DE490 0x10 SaveData                    ( 000186516CF0 ModelClassType ExchangeSaveData ExchangeSaveData ExchangeSaveData Pointer )
            value.TabDatas                                  = GetObjectList<TabData>(new IntPtr(p + 0x018), ReversePrism.DataModels.TabData.FromPointer); // 0270D61DE4B0 0x18 TabDatas                    ( 000185D235F8 ModelClassListType List`1<TabData> List`1<TabData> List<TabData> Pointer )
            value.CurSelectTabData                          = GetObject<TabData>(new IntPtr(p + 0x020), ReversePrism.DataModels.TabData.FromPointer); // 0270D61DE4D0 0x20 CurSelectTabData            ( 00018665D310 ModelClassType TabData TabData TabData Pointer )
            value.SelectionTicketViewModels                 = GetObjectList<ExchangeLargeSpaceGoodsGridViewModel>(new IntPtr(p + 0x028), ReversePrism.DataModels.ExchangeLargeSpaceGoodsGridViewModel.FromPointer); // 0270D61DE4F0 0x28 SelectionTicketViewModels   ( 000185CDA9E8 ModelClassListType List`1<ExchangeLargeSpaceGoodsGridViewModel> List`1<ExchangeLargeSpaceGoodsGridViewModel> List<ExchangeLargeSpaceGoodsGridViewModel> Pointer )
            value.EventGridViewModels                       = GetObjectList<ExchangeEventGridViewModel>(new IntPtr(p + 0x030), ReversePrism.DataModels.ExchangeEventGridViewModel.FromPointer); // 0270D61DE510 0x30 EventGridViewModels         ( 000185CDA308 ModelClassListType List`1<ExchangeEventGridViewModel> List`1<ExchangeEventGridViewModel> List<ExchangeEventGridViewModel> Pointer )
            value.ExchangeSelectionListPopupViewModel       = GetObject<ExchangeSelectionListPopupViewModel>(new IntPtr(p + 0x038), ReversePrism.DataModels.ExchangeSelectionListPopupViewModel.FromPointer); // 0270D61DE530 0x38 ExchangeSelectionListPopupViewModel ( 00018651A2F0 ModelClassType ExchangeSelectionListPopupViewModel ExchangeSelectionListPopupViewModel ExchangeSelectionListPopupViewModel Pointer )
            value.CharacterEffectViewModel                  = GetObject<ExchangeCharacterEffectViewModel>(new IntPtr(p + 0x040), ReversePrism.DataModels.ExchangeCharacterEffectViewModel.FromPointer); // 0270D61DE550 0x40 CharacterEffectViewModel    ( 000186774140 ModelClassType ExchangeCharacterEffectViewModel ExchangeCharacterEffectViewModel ExchangeCharacterEffectViewModel Pointer )
            value.HorizontalTabIndex                        = GetInt32(new IntPtr(p + 0x048)); // 0270D61DE570 0x48 HorizontalTabIndex          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.IsGoToOtherView                           = GetBool(new IntPtr(p + 0x04C)); // 0270D61DE590 0x4C IsGoToOtherView             ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.CurrentTab                                = (ExchangeTabType)GetInt32(new IntPtr(p + 0x050)); // 0270D61DE5B0 0x50 CurrentTab                  ( 000186640E10 ModelEnumType ExchangeTabType ExchangeTabType ExchangeTabType Int32 )
