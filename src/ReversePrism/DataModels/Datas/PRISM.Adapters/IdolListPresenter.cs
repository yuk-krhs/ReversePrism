...
namespace ReversePrism.DataModels
{
    ...
    public partial class IdolListPresenter : DataModel
    {
        ...
        public static IdolListPresenter? FromPointer(IntPtr p0)
        {
            ...
            value.View                                      = GetObject<IIdolListView>(new IntPtr(p + 0x010), ReversePrism.DataModels.IIdolListView.FromPointer); // 024665F36C70 0x10 View                        ( 000186574B90 ModelClassType IIdolListView IIdolListView IIdolListView Pointer )
            value.TitleView                                 = GetObject<CommonTitleView>(new IntPtr(p + 0x018), ReversePrism.DataModels.CommonTitleView.FromPointer); // 024665F36C90 0x18 TitleView                   ( 0001865EA1D0 ModelClassType CommonTitleView CommonTitleView CommonTitleView Pointer )
            value.PiView                                    = GetObject<IIdolListProduceIdolListView>(new IntPtr(p + 0x020), ReversePrism.DataModels.IIdolListProduceIdolListView.FromPointer); // 024665F36CB0 0x20 PiView                      ( 000186574110 ModelClassType IIdolListProduceIdolListView IIdolListProduceIdolListView IIdolListProduceIdolListView Pointer )
            value.ScView                                    = GetObject<IIdolListSupportCharaListView>(new IntPtr(p + 0x028), ReversePrism.DataModels.IIdolListSupportCharaListView.FromPointer); // 024665F36CD0 0x28 ScView                      ( 000186574650 ModelClassType IIdolListSupportCharaListView IIdolListSupportCharaListView IIdolListSupportCharaListView Pointer )
            value.FuView                                    = GetObject<IIdolListFesUnitListView>(new IntPtr(p + 0x030), ReversePrism.DataModels.IIdolListFesUnitListView.FromPointer); // 024665F36CF0 0x30 FuView                      ( 000186573C30 ModelClassType IIdolListFesUnitListView IIdolListFesUnitListView IIdolListFesUnitListView Pointer )
            value.FiView                                    = GetObject<IIdolListFesIdolListView>(new IntPtr(p + 0x038), ReversePrism.DataModels.IIdolListFesIdolListView.FromPointer); // 024665F36D10 0x38 FiView                      ( 000186573710 ModelClassType IIdolListFesIdolListView IIdolListFesIdolListView IIdolListFesIdolListView Pointer )
            value.Argument                                  = GetObject<IdolListArgument>(new IntPtr(p + 0x040), ReversePrism.DataModels.IdolListArgument.FromPointer); // 024665F36D30 0x40 Argument                    ( 0001866B1540 ModelClassType IdolListArgument IdolListArgument IdolListArgument Pointer )
            value.PIdolDetailPopupViewFactory               = GetObject<IPIdolDetailPopupViewFactory>(new IntPtr(p + 0x070), ReversePrism.DataModels.IPIdolDetailPopupViewFactory.FromPointer); // 024665F36DF0 0x70 PIdolDetailPopupViewFactory ( 0001865D0010 ModelClassType IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory Pointer )
            value.SCharaDetailPopupViewFactory              = GetObject<ISCharaDetailPopupViewFactory>(new IntPtr(p + 0x080), ReversePrism.DataModels.ISCharaDetailPopupViewFactory.FromPointer); // 024665F36E30 0x80 SCharaDetailPopupViewFactory ( 000186622C10 ModelClassType ISCharaDetailPopupViewFactory ISCharaDetailPopupViewFactory ISCharaDetailPopupViewFactory Pointer )
            value.FUnitDetailPopupViewFactory               = GetObject<IFUnitDetailPopupViewFactory>(new IntPtr(p + 0x090), ReversePrism.DataModels.IFUnitDetailPopupViewFactory.FromPointer); // 024665F36E70 0x90 FUnitDetailPopupViewFactory ( 000186774B10 ModelClassType IFUnitDetailPopupViewFactory IFUnitDetailPopupViewFactory IFUnitDetailPopupViewFactory Pointer )
            value.FIdolDetailPopupViewFactory               = GetObject<IFIdolDetailPopupViewFactory>(new IntPtr(p + 0x0B0), ReversePrism.DataModels.IFIdolDetailPopupViewFactory.FromPointer); // 024665F36EF0 0xB0 FIdolDetailPopupViewFactory ( 000186774150 ModelClassType IFIdolDetailPopupViewFactory IFIdolDetailPopupViewFactory IFIdolDetailPopupViewFactory Pointer )
            value.MasterData                                = GetObject<MasterData>(new IntPtr(p + 0x0D0), ReversePrism.DataModels.MasterData.FromPointer); // 024665F36F70 0xD0 MasterData                  ( 00018660B7A0 ModelClassType MasterData MasterData MasterData Pointer )
            value.FuModel                                   = GetObject<FesUnitSelectModel>(new IntPtr(p + 0x0E8), ReversePrism.DataModels.FesUnitSelectModel.FromPointer); // 024665F36FD0 0xE8 FuModel                     ( 00018656BAF0 ModelClassType FesUnitSelectModel FesUnitSelectModel FesUnitSelectModel Pointer )
            value.FiModel                                   = GetObject<FesIdolSelectModel>(new IntPtr(p + 0x0F0), ReversePrism.DataModels.FesIdolSelectModel.FromPointer); // 024665F36FF0 0xF0 FiModel                     ( 0001865640D0 ModelClassType FesIdolSelectModel FesIdolSelectModel FesIdolSelectModel Pointer )
            value.Cts                                       = GetObject<CancellationTokenSource>(new IntPtr(p + 0x0F8), ReversePrism.DataModels.CancellationTokenSource.FromPointer); // 024665F37010 0xF8 Cts                         ( 0001865A4380 ModelClassType CancellationTokenSource CancellationTokenSource CancellationTokenSource Pointer )
            value.Disposables                               = GetObject<CompositeDisposable>(new IntPtr(p + 0x100), ReversePrism.DataModels.CompositeDisposable.FromPointer); // 024665F37030 0x100 Disposables                 ( 0001865F38F0 ModelClassType CompositeDisposable CompositeDisposable CompositeDisposable Pointer )
            value.ProduceAdvStatusList                      = GetObjectList<IProduceAdvStatus>(new IntPtr(p + 0x108), ReversePrism.DataModels.IProduceAdvStatus.FromPointer); // 024665F37050 0x108 ProduceAdvStatusList        ( 000185D05518 ModelClassListType IReadOnlyList`1<IProduceAdvStatus> IReadOnlyList`1<IProduceAdvStatus> List<IProduceAdvStatus> Pointer )
