...
namespace ReversePrism.DataModels
{
    ...
    public partial class SpecialMissionPopupViewModel : DataModel
    {
        ...
        public static SpecialMissionPopupViewModel? FromPointer(IntPtr p0)
        {
            ...
            value.MissionModelLists                         = GetObjectList<SpecialMissionListViewModel>(new IntPtr(p + 0x010), ReversePrism.DataModels.SpecialMissionListViewModel.FromPointer); // 0246663E77D0 0x10 MissionModelLists           ( 000185D0B008 ModelClassListType List`1<SpecialMissionListViewModel> List`1<SpecialMissionListViewModel> List<SpecialMissionListViewModel> Pointer )
            value.CurrentSpecialMission                     = GetObject<SpecialMission>(new IntPtr(p + 0x018), ReversePrism.DataModels.SpecialMission.FromPointer); // 0246663E77F0 0x18 CurrentSpecialMission       ( 000186541670 ModelClassType SpecialMission SpecialMission SpecialMission Pointer )
            value.CurrentStepMission                        = GetObject<SpecialMissionStep>(new IntPtr(p + 0x020), ReversePrism.DataModels.SpecialMissionStep.FromPointer); // 0246663E7810 0x20 CurrentStepMission          ( 000186549510 ModelClassType SpecialMissionStep SpecialMissionStep SpecialMissionStep Pointer )
            value.NextStepMission                           = GetObject<SpecialMissionStep>(new IntPtr(p + 0x028), ReversePrism.DataModels.SpecialMissionStep.FromPointer); // 0246663E7830 0x28 NextStepMission             ( 000186549510 ModelClassType SpecialMissionStep SpecialMissionStep SpecialMissionStep Pointer )
            value.SpecialMissionList                        = GetObjectList<SpecialMission>(new IntPtr(p + 0x030), ReversePrism.DataModels.SpecialMission.FromPointer); // 0246663E7850 0x30 SpecialMissionList          ( 000185D0ADD8 ModelClassListType List`1<SpecialMission> List`1<SpecialMission> List<SpecialMission> Pointer )
            value.SelectSpecialMissionId                    = GetInt32(new IntPtr(p + 0x038)); // 0246663E7870 0x38 SelectSpecialMissionId      ( 0001865F4260 ModelPrimitiveType int int int Int32 )
            value.SelectTabIndex                            = GetInt32(new IntPtr(p + 0x03C)); // 0246663E7890 0x3C SelectTabIndex              ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
