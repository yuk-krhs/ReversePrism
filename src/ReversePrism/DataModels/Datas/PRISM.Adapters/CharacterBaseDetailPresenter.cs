...
namespace ReversePrism.DataModels
{
    ...
    public partial class CharacterBaseDetailPresenter : DataModel
    {
        ...
        public static CharacterBaseDetailPresenter? FromPointer(IntPtr p0)
        {
            ...
            value.Cts                                       = GetObject<CancellationTokenSource>(new IntPtr(p + 0x010), ReversePrism.DataModels.CancellationTokenSource.FromPointer); // 024665EDC2F0 0x10 Cts                         ( 0001865A4380 ModelClassType CancellationTokenSource CancellationTokenSource CancellationTokenSource Pointer )
            value.Disposables                               = GetObject<CompositeDisposable>(new IntPtr(p + 0x018), ReversePrism.DataModels.CompositeDisposable.FromPointer); // 024665EDC310 0x18 Disposables                 ( 0001865F38F0 ModelClassType CompositeDisposable CompositeDisposable CompositeDisposable Pointer )
            value.Argument                                  = GetObject<CharacterBaseDetailArgument>(new IntPtr(p + 0x020), ReversePrism.DataModels.CharacterBaseDetailArgument.FromPointer); // 024665EDC330 0x20 Argument                    ( 000186598110 ModelClassType CharacterBaseDetailArgument CharacterBaseDetailArgument CharacterBaseDetailArgument Pointer )
            value.TitleView                                 = GetObject<CommonTitleView>(new IntPtr(p + 0x028), ReversePrism.DataModels.CommonTitleView.FromPointer); // 024665EDC350 0x28 TitleView                   ( 0001865EA1D0 ModelClassType CommonTitleView CommonTitleView CommonTitleView Pointer )
            value.UiCharacterView                           = GetObject<IIdolBaseDetailUICharacterView>(new IntPtr(p + 0x030), ReversePrism.DataModels.IIdolBaseDetailUICharacterView.FromPointer); // 024665EDC370 0x30 UiCharacterView             ( 000186570A90 ModelClassType IIdolBaseDetailUICharacterView IIdolBaseDetailUICharacterView IIdolBaseDetailUICharacterView Pointer )
            value.View                                      = GetObject<IIdolBaseDetailView>(new IntPtr(p + 0x038), ReversePrism.DataModels.IIdolBaseDetailView.FromPointer); // 024665EDC390 0x38 View                        ( 000186570FA0 ModelClassType IIdolBaseDetailView IIdolBaseDetailView IIdolBaseDetailView Pointer )
            value.ProfileView                               = GetObject<IIdolBaseDetailProfileView>(new IntPtr(p + 0x040), ReversePrism.DataModels.IIdolBaseDetailProfileView.FromPointer); // 024665EDC3B0 0x40 ProfileView                 ( 00018656FDF0 ModelClassType IIdolBaseDetailProfileView IIdolBaseDetailProfileView IIdolBaseDetailProfileView Pointer )
            value.GalleryView                               = GetObject<IIdolBaseDetailGalleryView>(new IntPtr(p + 0x048), ReversePrism.DataModels.IIdolBaseDetailGalleryView.FromPointer); // 024665EDC3D0 0x48 GalleryView                 ( 00018656F8D0 ModelClassType IIdolBaseDetailGalleryView IIdolBaseDetailGalleryView IIdolBaseDetailGalleryView Pointer )
            value.SCharaDetailPopupViewFactory              = GetObject<ISCharaDetailPopupViewFactory>(new IntPtr(p + 0x098), ReversePrism.DataModels.ISCharaDetailPopupViewFactory.FromPointer); // 024665EDC510 0x98 SCharaDetailPopupViewFactory ( 000186622C10 ModelClassType ISCharaDetailPopupViewFactory ISCharaDetailPopupViewFactory ISCharaDetailPopupViewFactory Pointer )
            value.ViewModel                                 = GetObject<IdolBaseDetailViewModel>(new IntPtr(p + 0x0A0), ReversePrism.DataModels.IdolBaseDetailViewModel.FromPointer); // 024665EDC530 0xA0 ViewModel                   ( 0001866AB5A0 ModelClassType IdolBaseDetailViewModel IdolBaseDetailViewModel IdolBaseDetailViewModel Pointer )
            value.ProfileViewModel                          = GetObject<IdolBaseDetailProfileViewModel>(new IntPtr(p + 0x0A8), ReversePrism.DataModels.IdolBaseDetailProfileViewModel.FromPointer); // 024665EDC550 0xA8 ProfileViewModel            ( 0001866A8760 ModelClassType IdolBaseDetailProfileViewModel IdolBaseDetailProfileViewModel IdolBaseDetailProfileViewModel Pointer )
            value.GalleryViewModel                          = GetObject<IdolBaseDetailGalleryViewModel>(new IntPtr(p + 0x0B0), ReversePrism.DataModels.IdolBaseDetailGalleryViewModel.FromPointer); // 024665EDC570 0xB0 GalleryViewModel            ( 0001866A73D0 ModelClassType IdolBaseDetailGalleryViewModel IdolBaseDetailGalleryViewModel IdolBaseDetailGalleryViewModel Pointer )
            value.AlbumPopupViewModel                       = GetObject<AlbumViewModel>(new IntPtr(p + 0x0B8), ReversePrism.DataModels.AlbumViewModel.FromPointer); // 024665EDC590 0xB8 AlbumPopupViewModel         ( 0001866A02C0 ModelClassType AlbumViewModel AlbumViewModel AlbumViewModel Pointer )
            value.CostumePopupViewModel                     = GetObject<CostumePopupViewModel>(new IntPtr(p + 0x0C0), ReversePrism.DataModels.CostumePopupViewModel.FromPointer); // 024665EDC5B0 0xC0 CostumePopupViewModel       ( 00018662F240 ModelClassType CostumePopupViewModel CostumePopupViewModel CostumePopupViewModel Pointer )
            value.VoicePopupViewModel                       = GetObject<VoicePopupViewModel>(new IntPtr(p + 0x0C8), ReversePrism.DataModels.VoicePopupViewModel.FromPointer); // 024665EDC5D0 0xC8 VoicePopupViewModel         ( 000186539100 ModelClassType VoicePopupViewModel VoicePopupViewModel VoicePopupViewModel Pointer )
            value.VoicePlayTabListPopupViewModel            = GetObject<VoicePlayTabListPopupViewModel>(new IntPtr(p + 0x0D0), ReversePrism.DataModels.VoicePlayTabListPopupViewModel.FromPointer); // 024665EDC5F0 0xD0 VoicePlayTabListPopupViewModel ( 000186537C90 ModelClassType VoicePlayTabListPopupViewModel VoicePlayTabListPopupViewModel VoicePlayTabListPopupViewModel Pointer )
            value.CasualCostumeVoicePlayListViewModel       = GetObjectList<ICategoryElementGridCellViewModel>(new IntPtr(p + 0x0D8), ReversePrism.DataModels.ICategoryElementGridCellViewModel.FromPointer); // 024665EDC610 0xD8 CasualCostumeVoicePlayListViewModel ( 000185CE17D8 ModelClassListType List`1<ICategoryElementGridCellViewModel> List`1<ICategoryElementGridCellViewModel> List<ICategoryElementGridCellViewModel> Pointer )
            value.MoviePopupViewModel                       = GetObject<MoviePopupViewModel>(new IntPtr(p + 0x0E0), ReversePrism.DataModels.MoviePopupViewModel.FromPointer); // 024665EDC630 0xE0 MoviePopupViewModel         ( 00018665B410 ModelClassType MoviePopupViewModel MoviePopupViewModel MoviePopupViewModel Pointer )
            value.EtceteraPopupViewModel                    = GetObject<EtceteraPopupViewModel>(new IntPtr(p + 0x0E8), ReversePrism.DataModels.EtceteraPopupViewModel.FromPointer); // 024665EDC650 0xE8 EtceteraPopupViewModel      ( 00018674A520 ModelClassType EtceteraPopupViewModel EtceteraPopupViewModel EtceteraPopupViewModel Pointer )
            value.MstCharacterInfoId                        = GetInt32(new IntPtr(p + 0x0F8)); // 024665EDC690 0xF8 MstCharacterInfoId          ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.InitializeCts                             = GetObject<CancellationTokenSource>(new IntPtr(p + 0x100), ReversePrism.DataModels.CancellationTokenSource.FromPointer); // 024665EDC6B0 0x100 InitializeCts               ( 0001865A39A0 ModelClassType CancellationTokenSource CancellationTokenSource CancellationTokenSource Pointer )
            value.AdditionalLoadedCueSheets                 = GetStringList(new IntPtr(p + 0x108)); // 024665EDC6D0 0x108 AdditionalLoadedCueSheets   ( 000185B815B0 ModelPrimitiveListType string[] string[] List<string> Pointer )
