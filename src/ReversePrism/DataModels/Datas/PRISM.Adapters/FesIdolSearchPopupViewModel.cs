...
namespace ReversePrism.DataModels
{
    ...
    public partial class FesIdolSearchPopupViewModel : DataModel
    {
        ...
        public static FesIdolSearchPopupViewModel? FromPointer(IntPtr p0)
        {
            ...
            value.IsSortView                                = GetBool(new IntPtr(p + 0x010)); // 024665F8E808 0x10 IsSortView                  ( 0001865965D0 ModelPrimitiveType bool bool bool Bool )
            value.InitialSelectedDisplayOrderIndex          = GetInt32(new IntPtr(p + 0x014)); // 024665F8E828 0x14 InitialSelectedDisplayOrderIndex ( 0001865F4260 ModelPrimitiveType int int int Int32 )
            value.SortDirection                             = (SortDirection)GetInt32(new IntPtr(p + 0x018)); // 024665F8E848 0x18 SortDirection               ( 00018652E880 ModelEnumType SortDirection SortDirection SortDirection Int32 )
