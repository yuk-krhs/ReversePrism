...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceIdolUpgradingPresenter : DataModel
    {
        ...
        public static ProduceIdolUpgradingPresenter? FromPointer(IntPtr p0)
        {
            ...
            value.Cts                                       = GetObject<CancellationTokenSource>(new IntPtr(p + 0x010), ReversePrism.DataModels.CancellationTokenSource.FromPointer); // 024666042F20 0x10 Cts                         ( 0001865A4380 ModelClassType CancellationTokenSource CancellationTokenSource CancellationTokenSource Pointer )
            value.Disposables                               = GetObject<CompositeDisposable>(new IntPtr(p + 0x018), ReversePrism.DataModels.CompositeDisposable.FromPointer); // 024666042F40 0x18 Disposables                 ( 0001865F38F0 ModelClassType CompositeDisposable CompositeDisposable CompositeDisposable Pointer )
            value.Argument                                  = GetObject<ProduceIdolUpgradingArgument>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProduceIdolUpgradingArgument.FromPointer); // 024666042F60 0x20 Argument                    ( 000186553C70 ModelClassType ProduceIdolUpgradingArgument ProduceIdolUpgradingArgument ProduceIdolUpgradingArgument Pointer )
            value.MasterData                                = GetObject<MasterData>(new IntPtr(p + 0x028), ReversePrism.DataModels.MasterData.FromPointer); // 024666042F80 0x28 MasterData                  ( 00018660B7A0 ModelClassType MasterData MasterData MasterData Pointer )
            value.TitleView                                 = GetObject<CommonTitleView>(new IntPtr(p + 0x030), ReversePrism.DataModels.CommonTitleView.FromPointer); // 024666042FA0 0x30 TitleView                   ( 0001865EA1D0 ModelClassType CommonTitleView CommonTitleView CommonTitleView Pointer )
            value.UiCharacterView                           = GetObject<IProduceIdolUpgradingUICharacterView>(new IntPtr(p + 0x038), ReversePrism.DataModels.IProduceIdolUpgradingUICharacterView.FromPointer); // 024666042FC0 0x38 UiCharacterView             ( 0001865ECA50 ModelClassType IProduceIdolUpgradingUICharacterView IProduceIdolUpgradingUICharacterView IProduceIdolUpgradingUICharacterView Pointer )
            value.View                                      = GetObject<IProduceIdolUpgradingView>(new IntPtr(p + 0x040), ReversePrism.DataModels.IProduceIdolUpgradingView.FromPointer); // 024666042FE0 0x40 View                        ( 0001865ECF00 ModelClassType IProduceIdolUpgradingView IProduceIdolUpgradingView IProduceIdolUpgradingView Pointer )
            value.StatusView                                = GetObject<IProduceIdolStatusView>(new IntPtr(p + 0x048), ReversePrism.DataModels.IProduceIdolStatusView.FromPointer); // 024666043000 0x48 StatusView                  ( 0001865EBA60 ModelClassType IProduceIdolStatusView IProduceIdolStatusView IProduceIdolStatusView Pointer )
            value.AwakeningView                             = GetObject<IProduceIdolAwakeningView>(new IntPtr(p + 0x050), ReversePrism.DataModels.IProduceIdolAwakeningView.FromPointer); // 024666043020 0x50 AwakeningView               ( 0001865E8F20 ModelClassType IProduceIdolAwakeningView IProduceIdolAwakeningView IProduceIdolAwakeningView Pointer )
            value.TrainingView                              = GetObject<IProduceIdolTrainingView>(new IntPtr(p + 0x058), ReversePrism.DataModels.IProduceIdolTrainingView.FromPointer); // 024666043040 0x58 TrainingView                ( 0001865EBF10 ModelClassType IProduceIdolTrainingView IProduceIdolTrainingView IProduceIdolTrainingView Pointer )
            value.SkillView                                 = GetObject<IProduceIdolSkillView>(new IntPtr(p + 0x060), ReversePrism.DataModels.IProduceIdolSkillView.FromPointer); // 024666043060 0x60 SkillView                   ( 0001865EAD10 ModelClassType IProduceIdolSkillView IProduceIdolSkillView IProduceIdolSkillView Pointer )
            value.PIdolDetailPopupViewFactory               = GetObject<IPIdolDetailPopupViewFactory>(new IntPtr(p + 0x070), ReversePrism.DataModels.IPIdolDetailPopupViewFactory.FromPointer); // 0246660430A0 0x70 PIdolDetailPopupViewFactory ( 0001865D0010 ModelClassType IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory Pointer )
            value.ProductService                            = GetObject<ProductService>(new IntPtr(p + 0x0B8), ReversePrism.DataModels.ProductService.FromPointer); // 0246660431C0 0xB8 ProductService              ( 0001865A4890 ModelClassType ProductService ProductService ProductService Pointer )
            value.TargetPI                                  = GetObject<IProduceIdolStatus>(new IntPtr(p + 0x0C0), ReversePrism.DataModels.IProduceIdolStatus.FromPointer); // 0246660431E0 0xC0 TargetPI                    ( 0001865EB0E0 ModelClassType IProduceIdolStatus IProduceIdolStatus IProduceIdolStatus Pointer )
            value.DefaultTab                                = (ProduceIdolUpgradeTab)GetInt32(new IntPtr(p + 0x0C8)); // 024666043200 0xC8 DefaultTab                  ( 000186552FD0 ModelEnumType ProduceIdolUpgradeTab ProduceIdolUpgradeTab ProduceIdolUpgradeTab Int32 )
            value.ProduceIdolStatusModel                    = GetObject<ProduceIdolStatusViewModel>(new IntPtr(p + 0x0D0), ReversePrism.DataModels.ProduceIdolStatusViewModel.FromPointer); // 024666043220 0xD0 ProduceIdolStatusModel      ( 000186550CE0 ModelClassType ProduceIdolStatusViewModel ProduceIdolStatusViewModel ProduceIdolStatusViewModel Pointer )
            value.ProduceIdolAwakeningModel                 = GetObject<ProduceIdolAwakeningViewModel>(new IntPtr(p + 0x0D8), ReversePrism.DataModels.ProduceIdolAwakeningViewModel.FromPointer); // 024666043240 0xD8 ProduceIdolAwakeningModel   ( 000186547710 ModelClassType ProduceIdolAwakeningViewModel ProduceIdolAwakeningViewModel ProduceIdolAwakeningViewModel Pointer )
            value.ProduceIdolTrainingModel                  = GetObject<ProduceIdolTrainingViewModel>(new IntPtr(p + 0x0E0), ReversePrism.DataModels.ProduceIdolTrainingViewModel.FromPointer); // 024666043260 0xE0 ProduceIdolTrainingModel    ( 000186551E60 ModelClassType ProduceIdolTrainingViewModel ProduceIdolTrainingViewModel ProduceIdolTrainingViewModel Pointer )
            value.IdolSkillLvUpModel                        = GetObject<IdolSkillLvUpModel>(new IntPtr(p + 0x0E8), ReversePrism.DataModels.IdolSkillLvUpModel.FromPointer); // 024666043280 0xE8 IdolSkillLvUpModel          ( 0001866C1440 ModelClassType IdolSkillLvUpModel IdolSkillLvUpModel IdolSkillLvUpModel Pointer )
            value.SkillLvUpVoiceMotion                      = GetObject<MstOutgameVoiceMotion>(new IntPtr(p + 0x0F0), ReversePrism.DataModels.MstOutgameVoiceMotion.FromPointer); // 0246660432A0 0xF0 SkillLvUpVoiceMotion        ( 0001866264F0 ModelClassType MstOutgameVoiceMotion MstOutgameVoiceMotion MstOutgameVoiceMotion Pointer )
            value.UnitIdol                                  = GetObject<UnitIdol>(new IntPtr(p + 0x0F8), ReversePrism.DataModels.UnitIdol.FromPointer); // 0246660432C0 0xF8 UnitIdol                    ( 00018670C980 ModelClassType UnitIdol UnitIdol UnitIdol Pointer )
            value.Display3DSceneLoader                      = GetObject<SceneLoaderAddressable>(new IntPtr(p + 0x100), ReversePrism.DataModels.SceneLoaderAddressable.FromPointer); // 0246660432E0 0x100 Display3DSceneLoader        ( 0001866CC6B0 ModelClassType SceneLoaderAddressable SceneLoaderAddressable SceneLoaderAddressable Pointer )
            value.ProduceAdvStatusList                      = GetObjectList<IProduceAdvStatus>(new IntPtr(p + 0x108), ReversePrism.DataModels.IProduceAdvStatus.FromPointer); // 024666043300 0x108 ProduceAdvStatusList        ( 000185D05518 ModelClassListType IReadOnlyList`1<IProduceAdvStatus> IReadOnlyList`1<IProduceAdvStatus> List<IProduceAdvStatus> Pointer )
