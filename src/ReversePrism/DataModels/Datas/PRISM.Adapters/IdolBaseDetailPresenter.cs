...
namespace ReversePrism.DataModels
{
    ...
    public partial class IdolBaseDetailPresenter
    {
        ...
        public static IdolBaseDetailPresenter? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new IdolBaseDetailPresenter();

            value.Cts                                       = GetObject<CancellationTokenSource>(new IntPtr(p + 0x010), ReversePrism.DataModels.CancellationTokenSource.FromPointer); // 0270D5E9F998 0x10 Cts                         ( 0001865A4380 ModelClassType CancellationTokenSource CancellationTokenSource CancellationTokenSource Pointer )
            value.Disposables                               = GetObject<CompositeDisposable>(new IntPtr(p + 0x018), ReversePrism.DataModels.CompositeDisposable.FromPointer); // 0270D5E9F9B8 0x18 Disposables                 ( 0001865F38F0 ModelClassType CompositeDisposable CompositeDisposable CompositeDisposable Pointer )
            value.Argument                                  = GetObject<IdolBaseDetailArgument>(new IntPtr(p + 0x020), ReversePrism.DataModels.IdolBaseDetailArgument.FromPointer); // 0270D5E9F9D8 0x20 Argument                    ( 0001866A5B30 ModelClassType IdolBaseDetailArgument IdolBaseDetailArgument IdolBaseDetailArgument Pointer )
            value.TitleView                                 = GetObject<CommonTitleView>(new IntPtr(p + 0x028), ReversePrism.DataModels.CommonTitleView.FromPointer); // 0270D5E9F9F8 0x28 TitleView                   ( 0001865EA1D0 ModelClassType CommonTitleView CommonTitleView CommonTitleView Pointer )
            value.UiCharacterView                           = GetObject<IIdolBaseDetailUICharacterView>(new IntPtr(p + 0x030), ReversePrism.DataModels.IIdolBaseDetailUICharacterView.FromPointer); // 0270D5E9FA18 0x30 UiCharacterView             ( 000186570A90 ModelClassType IIdolBaseDetailUICharacterView IIdolBaseDetailUICharacterView IIdolBaseDetailUICharacterView Pointer )
            value.View                                      = GetObject<IIdolBaseDetailView>(new IntPtr(p + 0x038), ReversePrism.DataModels.IIdolBaseDetailView.FromPointer); // 0270D5E9FA38 0x38 View                        ( 000186570FA0 ModelClassType IIdolBaseDetailView IIdolBaseDetailView IIdolBaseDetailView Pointer )
            value.ProfileView                               = GetObject<IIdolBaseDetailProfileView>(new IntPtr(p + 0x040), ReversePrism.DataModels.IIdolBaseDetailProfileView.FromPointer); // 0270D5E9FA58 0x40 ProfileView                 ( 00018656FDF0 ModelClassType IIdolBaseDetailProfileView IIdolBaseDetailProfileView IIdolBaseDetailProfileView Pointer )
            value.StatusView                                = GetObject<IIdolBaseDetailStatusView>(new IntPtr(p + 0x048), ReversePrism.DataModels.IIdolBaseDetailStatusView.FromPointer); // 0270D5E9FA78 0x48 StatusView                  ( 000186570590 ModelClassType IIdolBaseDetailStatusView IIdolBaseDetailStatusView IIdolBaseDetailStatusView Pointer )
            value.GalleryView                               = GetObject<IIdolBaseDetailGalleryView>(new IntPtr(p + 0x050), ReversePrism.DataModels.IIdolBaseDetailGalleryView.FromPointer); // 0270D5E9FA98 0x50 GalleryView                 ( 00018656F8D0 ModelClassType IIdolBaseDetailGalleryView IIdolBaseDetailGalleryView IIdolBaseDetailGalleryView Pointer )
            value.CasualCostumeView                         = GetObject<IIdolBaseDetailCasualCostumeView>(new IntPtr(p + 0x058), ReversePrism.DataModels.IIdolBaseDetailCasualCostumeView.FromPointer); // 0270D5E9FAB8 0x58 CasualCostumeView           ( 00018656F140 ModelClassType IIdolBaseDetailCasualCostumeView IIdolBaseDetailCasualCostumeView IIdolBaseDetailCasualCostumeView Pointer )
            value.PIdolDetailPopupViewFactory               = GetObject<IPIdolDetailPopupViewFactory>(new IntPtr(p + 0x0A8), ReversePrism.DataModels.IPIdolDetailPopupViewFactory.FromPointer); // 0270D5E9FBF8 0xA8 PIdolDetailPopupViewFactory ( 0001865D0010 ModelClassType IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory Pointer )
            value.SCharaDetailPopupViewFactory              = GetObject<ISCharaDetailPopupViewFactory>(new IntPtr(p + 0x0B8), ReversePrism.DataModels.ISCharaDetailPopupViewFactory.FromPointer); // 0270D5E9FC38 0xB8 SCharaDetailPopupViewFactory ( 000186622C10 ModelClassType ISCharaDetailPopupViewFactory ISCharaDetailPopupViewFactory ISCharaDetailPopupViewFactory Pointer )
            value.ViewModel                                 = GetObject<IdolBaseDetailViewModel>(new IntPtr(p + 0x0C0), ReversePrism.DataModels.IdolBaseDetailViewModel.FromPointer); // 0270D5E9FC58 0xC0 ViewModel                   ( 0001866AB5A0 ModelClassType IdolBaseDetailViewModel IdolBaseDetailViewModel IdolBaseDetailViewModel Pointer )
            value.ProfileViewModel                          = GetObject<IdolBaseDetailProfileViewModel>(new IntPtr(p + 0x0C8), ReversePrism.DataModels.IdolBaseDetailProfileViewModel.FromPointer); // 0270D5E9FC78 0xC8 ProfileViewModel            ( 0001866A8760 ModelClassType IdolBaseDetailProfileViewModel IdolBaseDetailProfileViewModel IdolBaseDetailProfileViewModel Pointer )
            value.StatusViewModel                           = GetObject<IdolBaseDetailStatusViewModel>(new IntPtr(p + 0x0D0), ReversePrism.DataModels.IdolBaseDetailStatusViewModel.FromPointer); // 0270D5E9FC98 0xD0 StatusViewModel             ( 0001866AA4C0 ModelClassType IdolBaseDetailStatusViewModel IdolBaseDetailStatusViewModel IdolBaseDetailStatusViewModel Pointer )
            value.GalleryViewModel                          = GetObject<IdolBaseDetailGalleryViewModel>(new IntPtr(p + 0x0D8), ReversePrism.DataModels.IdolBaseDetailGalleryViewModel.FromPointer); // 0270D5E9FCB8 0xD8 GalleryViewModel            ( 0001866A73D0 ModelClassType IdolBaseDetailGalleryViewModel IdolBaseDetailGalleryViewModel IdolBaseDetailGalleryViewModel Pointer )
            value.CasualCostumeViewModel                    = GetObject<IdolBaseDetailCasualCostumeViewModel>(new IntPtr(p + 0x0E0), ReversePrism.DataModels.IdolBaseDetailCasualCostumeViewModel.FromPointer); // 0270D5E9FCD8 0xE0 CasualCostumeViewModel      ( 0001866A6740 ModelClassType IdolBaseDetailCasualCostumeViewModel IdolBaseDetailCasualCostumeViewModel IdolBaseDetailCasualCostumeViewModel Pointer )
            value.AlbumPopupViewModel                       = GetObject<AlbumViewModel>(new IntPtr(p + 0x0F0), ReversePrism.DataModels.AlbumViewModel.FromPointer); // 0270D5E9FD18 0xF0 AlbumPopupViewModel         ( 0001866A02C0 ModelClassType AlbumViewModel AlbumViewModel AlbumViewModel Pointer )
            value.CostumePopupViewModel                     = GetObject<CostumePopupViewModel>(new IntPtr(p + 0x0F8), ReversePrism.DataModels.CostumePopupViewModel.FromPointer); // 0270D5E9FD38 0xF8 CostumePopupViewModel       ( 00018662F240 ModelClassType CostumePopupViewModel CostumePopupViewModel CostumePopupViewModel Pointer )
            value.VoicePopupViewModel                       = GetObject<VoicePopupViewModel>(new IntPtr(p + 0x100), ReversePrism.DataModels.VoicePopupViewModel.FromPointer); // 0270D5E9FD58 0x100 VoicePopupViewModel         ( 000186539100 ModelClassType VoicePopupViewModel VoicePopupViewModel VoicePopupViewModel Pointer )
            value.VoicePlayTabListPopupViewModel            = GetObject<VoicePlayTabListPopupViewModel>(new IntPtr(p + 0x108), ReversePrism.DataModels.VoicePlayTabListPopupViewModel.FromPointer); // 0270D5E9FD78 0x108 VoicePlayTabListPopupViewModel ( 000186537C90 ModelClassType VoicePlayTabListPopupViewModel VoicePlayTabListPopupViewModel VoicePlayTabListPopupViewModel Pointer )
            value.CasualCostumeVoicePlayListViewModel       = GetObjectList<ICategoryElementGridCellViewModel>(new IntPtr(p + 0x110), ReversePrism.DataModels.ICategoryElementGridCellViewModel.FromPointer); // 0270D5E9FD98 0x110 CasualCostumeVoicePlayListViewModel ( 000185CE17D8 ModelClassListType List`1<ICategoryElementGridCellViewModel> List`1<ICategoryElementGridCellViewModel> List<ICategoryElementGridCellViewModel> Pointer )
            value.MoviePopupViewModel                       = GetObject<MoviePopupViewModel>(new IntPtr(p + 0x128), ReversePrism.DataModels.MoviePopupViewModel.FromPointer); // 0270D5E9FDF8 0x128 MoviePopupViewModel         ( 00018665B410 ModelClassType MoviePopupViewModel MoviePopupViewModel MoviePopupViewModel Pointer )
            value.EtceteraPopupViewModel                    = GetObject<EtceteraPopupViewModel>(new IntPtr(p + 0x130), ReversePrism.DataModels.EtceteraPopupViewModel.FromPointer); // 0270D5E9FE18 0x130 EtceteraPopupViewModel      ( 00018674A520 ModelClassType EtceteraPopupViewModel EtceteraPopupViewModel EtceteraPopupViewModel Pointer )
            value.IdolBase                                  = GetObject<IIdolBaseStatus>(new IntPtr(p + 0x138), ReversePrism.DataModels.IIdolBaseStatus.FromPointer); // 0270D5E9FE38 0x138 IdolBase                    ( 000186572300 ModelClassType IIdolBaseStatus IIdolBaseStatus IIdolBaseStatus Pointer )
            value.InitializeCts                             = GetObject<CancellationTokenSource>(new IntPtr(p + 0x140), ReversePrism.DataModels.CancellationTokenSource.FromPointer); // 0270D5E9FE58 0x140 InitializeCts               ( 0001865A39A0 ModelClassType CancellationTokenSource CancellationTokenSource CancellationTokenSource Pointer )
            value.AdditionalLoadedCueSheets                 = GetStringList(new IntPtr(p + 0x148)); // 0270D5E9FE78 0x148 AdditionalLoadedCueSheets   ( 000185B815B0 ModelPrimitiveListType string[] string[] List<string> Pointer )
