...
namespace ReversePrism.DataModels
{
    ...
    public partial class SupportCharaLvUpCompletedPopupPresenter : DataModel
    {
        ...
        public static SupportCharaLvUpCompletedPopupPresenter? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new SupportCharaLvUpCompletedPopupPresenter() { Pointer= p0 };

            value.View                                      = GetObject<ISupportCharaLvUpCompletedPopupView>(new IntPtr(p + 0x010), ReversePrism.DataModels.ISupportCharaLvUpCompletedPopupView.FromPointer); // 02466600E350 0x10 View                        ( 000186666B00 ModelClassType ISupportCharaLvUpCompletedPopupView ISupportCharaLvUpCompletedPopupView ISupportCharaLvUpCompletedPopupView Pointer )
            value.Vm                                        = GetObject<SupportCharaLvUpCompletedPopupViewModel>(new IntPtr(p + 0x018), ReversePrism.DataModels.SupportCharaLvUpCompletedPopupViewModel.FromPointer); // 02466600E370 0x18 Vm                          ( 0001865E07C0 ModelClassType SupportCharaLvUpCompletedPopupViewModel SupportCharaLvUpCompletedPopupViewModel SupportCharaLvUpCompletedPopupViewModel Pointer )
