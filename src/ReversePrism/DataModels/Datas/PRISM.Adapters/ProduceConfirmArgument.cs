...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceConfirmArgument : DataModel
    {
        ...
        public static ProduceConfirmArgument? FromPointer(IntPtr p0)
        {
            ...
            value.EpisodeSelectModel                        = GetObject<ViewProducePreparationEpisodeSelectModel>(new IntPtr(p + 0x010), ReversePrism.DataModels.ViewProducePreparationEpisodeSelectModel.FromPointer); // 0246665C9270 0x10 EpisodeSelectModel          ( 000186520560 ModelClassType ViewProducePreparationEpisodeSelectModel ViewProducePreparationEpisodeSelectModel ViewProducePreparationEpisodeSelectModel Pointer )
            value.SelectedFriendSCharaStatus                = GetObject<ISupportCharacterStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ISupportCharacterStatus.FromPointer); // 0246665C9290 0x18 SelectedFriendSCharaStatus  ( 00018666A290 ModelClassType ISupportCharacterStatus ISupportCharacterStatus ISupportCharacterStatus Pointer )
            value.SelectedFriendSupportId                   = GetString(new IntPtr(p + 0x020)); // 0246665C92B0 0x20 SelectedFriendSupportId     ( 0001866736C0 ModelPrimitiveType string string string String )
