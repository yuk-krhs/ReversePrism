...
namespace ReversePrism.DataModels
{
    ...
    public partial class OtherBonusModel : DataModel
    {
        ...
        public static OtherBonusModel? FromPointer(IntPtr p0)
        {
            ...
            value.DressUnlockPremiseStarList                = GetInt32List(new IntPtr(p + 0x018)); // 024666040E80 0x18 DressUnlockPremiseStarList  ( 000185CED1B8 ModelPrimitiveListType List`1<int> List`1<int> List<int> Pointer )
            value.ViewModel                                 = GetObject<OtherBonusViewModel>(new IntPtr(p + 0x020), ReversePrism.DataModels.OtherBonusViewModel.FromPointer); // 024666040EA0 0x20 ViewModel                   ( 0001866EED30 ModelClassType OtherBonusViewModel OtherBonusViewModel OtherBonusViewModel Pointer )
