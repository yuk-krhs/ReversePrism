...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProfileProgressPanelViewModel
    {
        ...
        public static ProfileProgressPanelViewModel? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProfileProgressPanelViewModel();

            value.HasReplyData                              = GetBool(new IntPtr(p + 0x010)); // 0270D66888E0 0x10 HasReplyData                ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.TotalHighScoreRateViewModel               = GetObject<MusicRateViewModel>(new IntPtr(p + 0x018), ReversePrism.DataModels.MusicRateViewModel.FromPointer); // 0270D6688900 0x18 TotalHighScoreRateViewModel ( 000186671BD0 ModelClassType MusicRateViewModel MusicRateViewModel MusicRateViewModel Pointer )
            value.TotalTechnicalRateViewModel               = GetObject<MusicRateViewModel>(new IntPtr(p + 0x020), ReversePrism.DataModels.MusicRateViewModel.FromPointer); // 0270D6688920 0x20 TotalTechnicalRateViewModel ( 000186671BD0 ModelClassType MusicRateViewModel MusicRateViewModel MusicRateViewModel Pointer )
            value.LiveClearCountViewModels                  = GetObjectList<ProfileProgressCountViewModel>(new IntPtr(p + 0x028), ReversePrism.DataModels.ProfileProgressCountViewModel.FromPointer); // 0270D6688940 0x28 LiveClearCountViewModels    ( 000185B9EBA0 ModelClassListType ProfileProgressCountViewModel[] ProfileProgressCountViewModel[] List<ProfileProgressCountViewModel> Pointer )
            value.FullComboCountViewModels                  = GetObjectList<ProfileProgressCountViewModel>(new IntPtr(p + 0x030), ReversePrism.DataModels.ProfileProgressCountViewModel.FromPointer); // 0270D6688960 0x30 FullComboCountViewModels    ( 000185B9EBA0 ModelClassListType ProfileProgressCountViewModel[] ProfileProgressCountViewModel[] List<ProfileProgressCountViewModel> Pointer )
            value.AllGrateCountViewModels                   = GetObjectList<ProfileProgressCountViewModel>(new IntPtr(p + 0x038), ReversePrism.DataModels.ProfileProgressCountViewModel.FromPointer); // 0270D6688980 0x38 AllGrateCountViewModels     ( 000185B9EBA0 ModelClassListType ProfileProgressCountViewModel[] ProfileProgressCountViewModel[] List<ProfileProgressCountViewModel> Pointer )
            value.AllPerfectCountViewModels                 = GetObjectList<ProfileProgressCountViewModel>(new IntPtr(p + 0x040), ReversePrism.DataModels.ProfileProgressCountViewModel.FromPointer); // 0270D66889A0 0x40 AllPerfectCountViewModels   ( 000185B9EBA0 ModelClassListType ProfileProgressCountViewModel[] ProfileProgressCountViewModel[] List<ProfileProgressCountViewModel> Pointer )
            value.Rank                                      = (ProduceParameterRank)GetInt32(new IntPtr(p + 0x048)); // 0270D66889C0 0x48 Rank                        ( 00018660D900 ModelEnumType ProduceParameterRank ProduceParameterRank ProduceParameterRank Int32 )
            value.RankScore                                 = GetInt32(new IntPtr(p + 0x04C)); // 0270D66889E0 0x4C RankScore                   ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.EpisordClearCount                         = GetInt32List(new IntPtr(p + 0x050)); // 0270D6688A00 0x50 EpisordClearCount           ( 000185B7D2C0 ModelPrimitiveListType int[] int[] List<int> Pointer )
            value.FesUnitDetailViewModels                   = GetObjectList<ProfileProgressFesUnitRankDetailViewModel>(new IntPtr(p + 0x058), ReversePrism.DataModels.ProfileProgressFesUnitRankDetailViewModel.FromPointer); // 0270D6688A20 0x58 FesUnitDetailViewModels     ( 000185B9ED80 ModelClassListType ProfileProgressFesUnitRankDetailViewModel[] ProfileProgressFesUnitRankDetailViewModel[] List<ProfileProgressFesUnitRankDetailViewModel> Pointer )
