...
namespace ReversePrism.DataModels
{
    ...
    // 010 View                                     ModelClassType IIntroductionRewardView IIntroductionRewardView IIntroductionRewardView Pointer
    // 018 ViewModel                                ModelClassType IntroductionViewModel IntroductionViewModel IntroductionViewModel Pointer
    ...
    public partial class IntroductionRewardPresenter : DataModel
    {
        ...
        public static IntroductionRewardPresenter? FromPointer(IntPtr p0)
        {
            ...
            value.View                                      = GetObject<IIntroductionRewardView>(new IntPtr(p + 0x010), ReversePrism.DataModels.IIntroductionRewardView.FromPointer); // 0x10 View                        ( ModelClassType IIntroductionRewardView IIntroductionRewardView IIntroductionRewardView Pointer )
            value.ViewModel                                 = GetObject<IntroductionViewModel>(new IntPtr(p + 0x018), ReversePrism.DataModels.IntroductionViewModel.FromPointer); // 0x18 ViewModel                   ( ModelClassType IntroductionViewModel IntroductionViewModel IntroductionViewModel Pointer )
