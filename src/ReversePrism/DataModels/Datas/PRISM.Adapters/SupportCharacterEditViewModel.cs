...
namespace ReversePrism.DataModels
{
    ...
    public partial class SupportCharacterEditViewModel : DataModel
    {
        ...
        public static SupportCharacterEditViewModel? FromPointer(IntPtr p0)
        {
            ...
            value.UnitId                                    = GetInt32(new IntPtr(p + 0x010)); // 024666287160 0x10 UnitId                      ( 0001865F4940 ModelPrimitiveType int int int Int32 )
            value.SelfSupportCharacters                     = GetObjectList<ISupportCharacterStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ISupportCharacterStatus.FromPointer); // 024666287180 0x18 SelfSupportCharacters       ( 000185D0D958 ModelClassListType IReadOnlyList`1<ISupportCharacterStatus> IReadOnlyList`1<ISupportCharacterStatus> List<ISupportCharacterStatus> Pointer )
            value.FriendSupportCharacter                    = GetObject<ISupportCharacterStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ISupportCharacterStatus.FromPointer); // 0246662871A0 0x20 FriendSupportCharacter      ( 00018666A290 ModelClassType ISupportCharacterStatus ISupportCharacterStatus ISupportCharacterStatus Pointer )
            value.SupportEffectViewModels                   = GetObjectList<SCharaEditSupportEffectContentViewModel>(new IntPtr(p + 0x028), ReversePrism.DataModels.SCharaEditSupportEffectContentViewModel.FromPointer); // 0246662871C0 0x28 SupportEffectViewModels     ( 000185D15B08 ModelClassListType IReadOnlyList`1<SCharaEditSupportEffectContentViewModel> IReadOnlyList`1<SCharaEditSupportEffectContentViewModel> List<SCharaEditSupportEffectContentViewModel> Pointer )
            value.PotentialSupportSkillViewModels           = GetObjectList<SCharaEditPotentialSupportSkillContentViewModel>(new IntPtr(p + 0x030), ReversePrism.DataModels.SCharaEditPotentialSupportSkillContentViewModel.FromPointer); // 0246662871E0 0x30 PotentialSupportSkillViewModels ( 000185D15698 ModelClassListType IReadOnlyList`1<SCharaEditPotentialSupportSkillContentViewModel> IReadOnlyList`1<SCharaEditPotentialSupportSkillContentViewModel> List<SCharaEditPotentialSupportSkillContentViewModel> Pointer )
            value.UnitName                                  = GetString(new IntPtr(p + 0x038)); // 024666287200 0x38 UnitName                    ( 0001866736C0 ModelPrimitiveType string string string String )
