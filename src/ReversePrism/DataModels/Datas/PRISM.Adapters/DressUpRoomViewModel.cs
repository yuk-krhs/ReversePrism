...
namespace ReversePrism.DataModels
{
    ...
    public partial class DressUpRoomViewModel
    {
        ...
        public static DressUpRoomViewModel? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new DressUpRoomViewModel();

            value.Rand                                      = GetObject<Random>(new IntPtr(p + 0x010), ReversePrism.DataModels.Random.FromPointer); // 0270D622A5C0 0x10 Rand                        ( 000186609880 ModelClassType Random Random Random Pointer )
            value.Idol                                      = GetObject<DressUpRoomIdol>(new IntPtr(p + 0x020), ReversePrism.DataModels.DressUpRoomIdol.FromPointer); // 0270D622A600 0x20 Idol                        ( 000186700EF0 ModelClassType DressUpRoomIdol DressUpRoomIdol DressUpRoomIdol Pointer )
            value.CostumeChangeViewIdol                     = GetObject<DressUpRoomIdol>(new IntPtr(p + 0x028), ReversePrism.DataModels.DressUpRoomIdol.FromPointer); // 0270D622A620 0x28 CostumeChangeViewIdol       ( 000186700EF0 ModelClassType DressUpRoomIdol DressUpRoomIdol DressUpRoomIdol Pointer )
            value.DressCostume                              = GetObject<CharacterCostume>(new IntPtr(p + 0x030), ReversePrism.DataModels.CharacterCostume.FromPointer); // 0270D622A640 0x30 DressCostume                ( 00018659D660 ModelClassType CharacterCostume CharacterCostume CharacterCostume Pointer )
            value.DefaultDressCostumeId                     = (IdolCostumeId)GetInt32(new IntPtr(p + 0x038)); // 0270D622A660 0x38 DefaultDressCostumeId       ( 0001866ADC00 ModelEnumType IdolCostumeId IdolCostumeId IdolCostumeId Int32 )
            value.CasualCostume                             = GetObject<CharacterCostume>(new IntPtr(p + 0x050), ReversePrism.DataModels.CharacterCostume.FromPointer); // 0270D622A680 0x50 CasualCostume               ( 00018659D660 ModelClassType CharacterCostume CharacterCostume CharacterCostume Pointer )
            value.DefaultCasualCostumeId                    = (IdolCostumeId)GetInt32(new IntPtr(p + 0x058)); // 0270D622A6A0 0x58 DefaultCasualCostumeId      ( 0001866ADC00 ModelEnumType IdolCostumeId IdolCostumeId IdolCostumeId Int32 )
            value.SrcCostumeList                            = GetObjectList<ICostumeStatus>(new IntPtr(p + 0x078), ReversePrism.DataModels.ICostumeStatus.FromPointer); // 0270D622A6E0 0x78 SrcCostumeList              ( 000185CF4218 ModelClassListType IReadOnlyList`1<ICostumeStatus> IReadOnlyList`1<ICostumeStatus> List<ICostumeStatus> Pointer )
            value.SrcHairstyleList                          = GetObjectList<IHairstyleStatus>(new IntPtr(p + 0x080), ReversePrism.DataModels.IHairstyleStatus.FromPointer); // 0270D622A700 0x80 SrcHairstyleList            ( 000185CFBF78 ModelClassListType IReadOnlyList`1<IHairstyleStatus> IReadOnlyList`1<IHairstyleStatus> List<IHairstyleStatus> Pointer )
            value.SrcAccessoryList                          = GetObjectList<IAccessoryStatus>(new IntPtr(p + 0x088), ReversePrism.DataModels.IAccessoryStatus.FromPointer); // 0270D622A720 0x88 SrcAccessoryList            ( 000185CF0F88 ModelClassListType IReadOnlyList`1<IAccessoryStatus> IReadOnlyList`1<IAccessoryStatus> List<IAccessoryStatus> Pointer )
            value.ArcCostumeSetList                         = GetObjectList<ICostumeSetStatus>(new IntPtr(p + 0x090), ReversePrism.DataModels.ICostumeSetStatus.FromPointer); // 0270D622A740 0x90 ArcCostumeSetList           ( 000185CF3D68 ModelClassListType IReadOnlyList`1<ICostumeSetStatus> IReadOnlyList`1<ICostumeSetStatus> List<ICostumeSetStatus> Pointer )
            value.DressCostumeSetDataList                   = GetObjectList<CostumeSetListViewCellData>(new IntPtr(p + 0x0E0), ReversePrism.DataModels.CostumeSetListViewCellData.FromPointer); // 0270D622A880 0xE0 DressCostumeSetDataList     ( 000185CD48E8 ModelClassListType List`1<CostumeSetListViewCellData> List`1<CostumeSetListViewCellData> List<CostumeSetListViewCellData> Pointer )
            value.CasualCostumeSetDataList                  = GetObjectList<CostumeSetListViewCellData>(new IntPtr(p + 0x0F0), ReversePrism.DataModels.CostumeSetListViewCellData.FromPointer); // 0270D622A8C0 0xF0 CasualCostumeSetDataList    ( 000185CD48E8 ModelClassListType List`1<CostumeSetListViewCellData> List`1<CostumeSetListViewCellData> List<CostumeSetListViewCellData> Pointer )
            value.UseOtherCharacterCostume                  = GetBool(new IntPtr(p + 0x108)); // 0270D622A920 0x108 UseOtherCharacterCostume    ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.CostumeType                               = (CostumeType)GetInt32(new IntPtr(p + 0x10C)); // 0270D622A940 0x10C CostumeType                 ( 0001865EEA20 ModelEnumType CostumeType CostumeType CostumeType Int32 )
            value.CostumeTypeInCostumeChangeView            = (CostumeType)GetInt32(new IntPtr(p + 0x110)); // 0270D622A960 0x110 CostumeTypeInCostumeChangeView ( 0001865EEA20 ModelEnumType CostumeType CostumeType CostumeType Int32 )
            value.IsTryOnMode                               = GetBool(new IntPtr(p + 0x114)); // 0270D622A980 0x114 IsTryOnMode                 ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.CurrentSelectedTab                        = (CostumeCategory)GetInt32(new IntPtr(p + 0x118)); // 0270D622A9A0 0x118 CurrentSelectedTab          ( 0001866293F0 ModelEnumType CostumeCategory CostumeCategory CostumeCategory Int32 )
