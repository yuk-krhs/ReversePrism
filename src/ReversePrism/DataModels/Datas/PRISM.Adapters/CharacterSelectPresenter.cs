...
namespace ReversePrism.DataModels
{
    ...
    public partial class CharacterSelectPresenter : DataModel
    {
        ...
        public static CharacterSelectPresenter? FromPointer(IntPtr p0)
        {
            ...
            value.View                                      = GetObject<ICharacterSelectView>(new IntPtr(p + 0x010), ReversePrism.DataModels.ICharacterSelectView.FromPointer); // 024665F03E90 0x10 View                        ( 00018672C500 ModelClassType ICharacterSelectView ICharacterSelectView ICharacterSelectView Pointer )
            value.TitleView                                 = GetObject<CommonTitleView>(new IntPtr(p + 0x018), ReversePrism.DataModels.CommonTitleView.FromPointer); // 024665F03EB0 0x18 TitleView                   ( 0001865EA1D0 ModelClassType CommonTitleView CommonTitleView CommonTitleView Pointer )
            value.PiView                                    = GetObject<IProduceIdolListView>(new IntPtr(p + 0x020), ReversePrism.DataModels.IProduceIdolListView.FromPointer); // 024665F03ED0 0x20 PiView                      ( 0001865E9A80 ModelClassType IProduceIdolListView IProduceIdolListView IProduceIdolListView Pointer )
            value.ScView                                    = GetObject<ISupportCharaListView>(new IntPtr(p + 0x028), ReversePrism.DataModels.ISupportCharaListView.FromPointer); // 024665F03EF0 0x28 ScView                      ( 000186666630 ModelClassType ISupportCharaListView ISupportCharaListView ISupportCharaListView Pointer )
            value.PiUpgradingView                           = GetObject<IPIdolUpgradingButtonView>(new IntPtr(p + 0x030), ReversePrism.DataModels.IPIdolUpgradingButtonView.FromPointer); // 024665F03F10 0x30 PiUpgradingView             ( 0001865D04C0 ModelClassType IPIdolUpgradingButtonView IPIdolUpgradingButtonView IPIdolUpgradingButtonView Pointer )
            value.ScUpgradingView                           = GetObject<ISCharaUpgradingButtonView>(new IntPtr(p + 0x038), ReversePrism.DataModels.ISCharaUpgradingButtonView.FromPointer); // 024665F03F30 0x38 ScUpgradingView             ( 000186623350 ModelClassType ISCharaUpgradingButtonView ISCharaUpgradingButtonView ISCharaUpgradingButtonView Pointer )
            value.PIdolDetailPopupViewFactory               = GetObject<IPIdolDetailPopupViewFactory>(new IntPtr(p + 0x060), ReversePrism.DataModels.IPIdolDetailPopupViewFactory.FromPointer); // 024665F03FD0 0x60 PIdolDetailPopupViewFactory ( 0001865D0010 ModelClassType IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory Pointer )
            value.SCharaDetailPopupViewFactory              = GetObject<ISCharaDetailPopupViewFactory>(new IntPtr(p + 0x070), ReversePrism.DataModels.ISCharaDetailPopupViewFactory.FromPointer); // 024665F04010 0x70 SCharaDetailPopupViewFactory ( 000186622C10 ModelClassType ISCharaDetailPopupViewFactory ISCharaDetailPopupViewFactory ISCharaDetailPopupViewFactory Pointer )
            value.Cts                                       = GetObject<CancellationTokenSource>(new IntPtr(p + 0x080), ReversePrism.DataModels.CancellationTokenSource.FromPointer); // 024665F04050 0x80 Cts                         ( 0001865A4380 ModelClassType CancellationTokenSource CancellationTokenSource CancellationTokenSource Pointer )
            value.Disposables                               = GetObject<CompositeDisposable>(new IntPtr(p + 0x088), ReversePrism.DataModels.CompositeDisposable.FromPointer); // 024665F04070 0x88 Disposables                 ( 0001865F38F0 ModelClassType CompositeDisposable CompositeDisposable CompositeDisposable Pointer )
            value.CharacterType                             = (CharacterType)GetInt32(new IntPtr(p + 0x090)); // 024665F04090 0x90 CharacterType               ( 0001865A75C0 ModelEnumType CharacterType CharacterType CharacterType Int32 )
            value.ProduceAdvStatusList                      = GetObjectList<IProduceAdvStatus>(new IntPtr(p + 0x0A8), ReversePrism.DataModels.IProduceAdvStatus.FromPointer); // 024665F040F0 0xA8 ProduceAdvStatusList        ( 000185D05518 ModelClassListType IReadOnlyList`1<IProduceAdvStatus> IReadOnlyList`1<IProduceAdvStatus> List<IProduceAdvStatus> Pointer )
