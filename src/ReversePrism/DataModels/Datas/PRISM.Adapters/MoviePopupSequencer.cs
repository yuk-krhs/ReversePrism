...
namespace ReversePrism.DataModels
{
    ...
    public partial class MoviePopupSequencer
    {
        ...
        public static MoviePopupSequencer? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new MoviePopupSequencer();

            value.Vm                                        = GetObject<MoviePopupViewModel>(new IntPtr(p + 0x018), ReversePrism.DataModels.MoviePopupViewModel.FromPointer); // 0270D5E83BD0 0x18 Vm                          ( 00018665B8E0 ModelClassType MoviePopupViewModel MoviePopupViewModel MoviePopupViewModel Pointer )
            value.PIdolDetailPopupViewFactory               = GetObject<IPIdolDetailPopupViewFactory>(new IntPtr(p + 0x020), ReversePrism.DataModels.IPIdolDetailPopupViewFactory.FromPointer); // 0270D5E83BF0 0x20 PIdolDetailPopupViewFactory ( 0001865D0010 ModelClassType IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory Pointer )
            value.SCharaDetailPopupViewFactory              = GetObject<ISCharaDetailPopupViewFactory>(new IntPtr(p + 0x028), ReversePrism.DataModels.ISCharaDetailPopupViewFactory.FromPointer); // 0270D5E83C10 0x28 SCharaDetailPopupViewFactory ( 000186622C10 ModelClassType ISCharaDetailPopupViewFactory ISCharaDetailPopupViewFactory ISCharaDetailPopupViewFactory Pointer )
            value.ProduceAdvStatusList                      = GetObjectList<IProduceAdvStatus>(new IntPtr(p + 0x038), ReversePrism.DataModels.IProduceAdvStatus.FromPointer); // 0270D5E83C50 0x38 ProduceAdvStatusList        ( 000185D05518 ModelClassListType IReadOnlyList`1<IProduceAdvStatus> IReadOnlyList`1<IProduceAdvStatus> List<IProduceAdvStatus> Pointer )
