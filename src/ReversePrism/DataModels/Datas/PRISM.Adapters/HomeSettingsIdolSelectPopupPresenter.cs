...
namespace ReversePrism.DataModels
{
    ...
    public partial class HomeSettingsIdolSelectPopupPresenter : DataModel
    {
        ...
        public static HomeSettingsIdolSelectPopupPresenter? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new HomeSettingsIdolSelectPopupPresenter() { Pointer= p0 };

            value.View                                      = GetObject<IHomeSettingsIdolSelectPopupView>(new IntPtr(p + 0x010), ReversePrism.DataModels.IHomeSettingsIdolSelectPopupView.FromPointer); // 02466628BC58 0x10 View                        ( 00018656B710 ModelClassType IHomeSettingsIdolSelectPopupView IHomeSettingsIdolSelectPopupView IHomeSettingsIdolSelectPopupView Pointer )
            value.IdolSelectViewModel                       = GetObject<HomeSettingsIdolSelectViewModel>(new IntPtr(p + 0x018), ReversePrism.DataModels.HomeSettingsIdolSelectViewModel.FromPointer); // 02466628BC78 0x18 IdolSelectViewModel         ( 0001866CED60 ModelClassType HomeSettingsIdolSelectViewModel HomeSettingsIdolSelectViewModel HomeSettingsIdolSelectViewModel Pointer )
