...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceSupportCharaSelectPopupViewModel
    {
        ...
        public static ProduceSupportCharaSelectPopupViewModel? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProduceSupportCharaSelectPopupViewModel();

            value.Disposables                               = GetObject<CompositeDisposable>(new IntPtr(p + 0x010), ReversePrism.DataModels.CompositeDisposable.FromPointer); // 0270D651C178 0x10 Disposables                 ( 0001865F3230 ModelClassType CompositeDisposable CompositeDisposable CompositeDisposable Pointer )
            value.ChangeTargetStatus                        = GetObject<ISupportCharacterStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.ISupportCharacterStatus.FromPointer); // 0270D651C198 0x18 ChangeTargetStatus          ( 00018666A290 ModelClassType ISupportCharacterStatus ISupportCharacterStatus ISupportCharacterStatus Pointer )
            value.SettingSCharaStatus                       = GetObjectList<ISupportCharacterStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.ISupportCharacterStatus.FromPointer); // 0270D651C1B8 0x20 SettingSCharaStatus         ( 000185D0D8A8 ModelClassListType IReadOnlyList`1<ISupportCharacterStatus> IReadOnlyList`1<ISupportCharacterStatus> List<ISupportCharacterStatus> Pointer )
            value.SCharaIcons                               = GetObjectList<SCharaIcon>(new IntPtr(p + 0x030), ReversePrism.DataModels.SCharaIcon.FromPointer); // 0270D651C1F8 0x30 SCharaIcons                 ( 000185CA2588 ModelClassListType SCharaIcon[] SCharaIcon[] List<SCharaIcon> Pointer )
            value.SortedSCharaIcons                         = GetObjectList<SCharaIcon>(new IntPtr(p + 0x038), ReversePrism.DataModels.SCharaIcon.FromPointer); // 0270D651C218 0x38 SortedSCharaIcons           ( 000185CA2588 ModelClassListType SCharaIcon[] SCharaIcon[] List<SCharaIcon> Pointer )
            value.CellViewModelList                         = GetObjectList<ProduceSupportCharaSelectGridViewCellViewModel>(new IntPtr(p + 0x050), ReversePrism.DataModels.ProduceSupportCharaSelectGridViewCellViewModel.FromPointer); // 0270D651C278 0x50 CellViewModelList           ( 000185CFCEB8 ModelClassListType List`1<ProduceSupportCharaSelectGridViewCellViewModel> List`1<ProduceSupportCharaSelectGridViewCellViewModel> List<ProduceSupportCharaSelectGridViewCellViewModel> Pointer )
