...
namespace ReversePrism.DataModels
{
    ...
    public partial class FavoriteIconViewModel : DataModel
    {
        ...
        public static FavoriteIconViewModel? FromPointer(IntPtr p0)
        {
            ...
            value.OnSelected                                = GetObject<BoolReactiveProperty>(new IntPtr(p + 0x010), ReversePrism.DataModels.BoolReactiveProperty.FromPointer); // 024666117E00 0x10 OnSelected                  ( 0001867695E0 ModelClassType BoolReactiveProperty BoolReactiveProperty BoolReactiveProperty Pointer )
            value.FavoriteId                                = GetInt32(new IntPtr(p + 0x018)); // 024666117E20 0x18 FavoriteId                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
