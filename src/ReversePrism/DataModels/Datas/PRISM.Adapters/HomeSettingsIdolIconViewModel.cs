...
namespace ReversePrism.DataModels
{
    ...
    // 018 IconViewModel                            ModelClassType CharacterBaseIconViewModel CharacterBaseIconViewModel CharacterBaseIconViewModel Pointer
    // 020 IsSetting                                ModelPrimitiveType bool bool bool Bool
    ...
    public partial class HomeSettingsIdolIconViewModel : DataModel
    {
        ...
        public static HomeSettingsIdolIconViewModel? FromPointer(IntPtr p0)
        {
            ...
            value.IconViewModel                             = GetObject<CharacterBaseIconViewModel>(new IntPtr(p + 0x018), ReversePrism.DataModels.CharacterBaseIconViewModel.FromPointer); // 0x18 IconViewModel               ( ModelClassType CharacterBaseIconViewModel CharacterBaseIconViewModel CharacterBaseIconViewModel Pointer )
            value.IsSetting                                 = GetBool(new IntPtr(p + 0x020)); // 0x20 IsSetting                   ( ModelPrimitiveType bool bool bool Bool )
