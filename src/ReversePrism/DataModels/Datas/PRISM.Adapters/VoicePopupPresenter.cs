...
namespace ReversePrism.DataModels
{
    ...
    public partial class VoicePopupPresenter
    {
        ...
        public static VoicePopupPresenter? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new VoicePopupPresenter();

            value.View                                      = GetObject<IVoicePopupView>(new IntPtr(p + 0x010), ReversePrism.DataModels.IVoicePopupView.FromPointer); // 0270D5FB11B8 0x10 View                        ( 0001866997F0 ModelClassType IVoicePopupView IVoicePopupView IVoicePopupView Pointer )
            value.ResourceLoader                            = GetObject<IResourceLoader>(new IntPtr(p + 0x018), ReversePrism.DataModels.IResourceLoader.FromPointer); // 0270D5FB11D8 0x18 ResourceLoader              ( 00018661AD70 ModelClassType IResourceLoader IResourceLoader IResourceLoader Pointer )
            value.Vm                                        = GetObject<VoicePopupViewModel>(new IntPtr(p + 0x020), ReversePrism.DataModels.VoicePopupViewModel.FromPointer); // 0270D5FB11F8 0x20 Vm                          ( 0001865395F0 ModelClassType VoicePopupViewModel VoicePopupViewModel VoicePopupViewModel Pointer )
            value.PIdolDetailPopupViewFactory               = GetObject<IPIdolDetailPopupViewFactory>(new IntPtr(p + 0x028), ReversePrism.DataModels.IPIdolDetailPopupViewFactory.FromPointer); // 0270D5FB1218 0x28 PIdolDetailPopupViewFactory ( 0001865D0010 ModelClassType IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory IPIdolDetailPopupViewFactory Pointer )
            value.SCharaDetailPopupViewFactory              = GetObject<ISCharaDetailPopupViewFactory>(new IntPtr(p + 0x030), ReversePrism.DataModels.ISCharaDetailPopupViewFactory.FromPointer); // 0270D5FB1238 0x30 SCharaDetailPopupViewFactory ( 000186622C10 ModelClassType ISCharaDetailPopupViewFactory ISCharaDetailPopupViewFactory ISCharaDetailPopupViewFactory Pointer )
            value.ProduceAdvStatusList                      = GetObjectList<IProduceAdvStatus>(new IntPtr(p + 0x040), ReversePrism.DataModels.IProduceAdvStatus.FromPointer); // 0270D5FB1278 0x40 ProduceAdvStatusList        ( 000185D05518 ModelClassListType IReadOnlyList`1<IProduceAdvStatus> IReadOnlyList`1<IProduceAdvStatus> List<IProduceAdvStatus> Pointer )
