...
namespace ReversePrism.DataModels
{
    ...
    // 010 View                                     ModelClassType IExchangeTopOverlayView IExchangeTopOverlayView IExchangeTopOverlayView Pointer
    // 018 ViewModel                                ModelClassType ExchangeTopViewModel ExchangeTopViewModel ExchangeTopViewModel Pointer
    ...
    public partial class ExchangeTopOverlayPresenter : DataModel
    {
        ...
        public static ExchangeTopOverlayPresenter? FromPointer(IntPtr p0)
        {
            ...
            value.View                                      = GetObject<IExchangeTopOverlayView>(new IntPtr(p + 0x010), ReversePrism.DataModels.IExchangeTopOverlayView.FromPointer); // 0x10 View                        ( ModelClassType IExchangeTopOverlayView IExchangeTopOverlayView IExchangeTopOverlayView Pointer )
            value.ViewModel                                 = GetObject<ExchangeTopViewModel>(new IntPtr(p + 0x018), ReversePrism.DataModels.ExchangeTopViewModel.FromPointer); // 0x18 ViewModel                   ( ModelClassType ExchangeTopViewModel ExchangeTopViewModel ExchangeTopViewModel Pointer )
