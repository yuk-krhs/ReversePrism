...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProduceEditInformationPopupViewModel
    {
        ...
        public static ProduceEditInformationPopupViewModel? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ProduceEditInformationPopupViewModel();

            value.SupportSkillSlotViewModels                = GetObjectList<SupportSkillSlotViewModel>(new IntPtr(p + 0x010), ReversePrism.DataModels.SupportSkillSlotViewModel.FromPointer); // 0270D64DB1D8 0x10 SupportSkillSlotViewModels  ( 000185D111B8 ModelClassListType List`1<SupportSkillSlotViewModel> List`1<SupportSkillSlotViewModel> List<SupportSkillSlotViewModel> Pointer )
            value.ProduceBaseInfo                           = GetObject<IProduceBaseInfoStatus>(new IntPtr(p + 0x018), ReversePrism.DataModels.IProduceBaseInfoStatus.FromPointer); // 0270D64DB1F8 0x18 ProduceBaseInfo             ( 0001865E3840 ModelClassType IProduceBaseInfoStatus IProduceBaseInfoStatus IProduceBaseInfoStatus Pointer )
            value.SelfSupportCharacters                     = GetObjectList<IInProduceSupportCharacterStatus>(new IntPtr(p + 0x020), ReversePrism.DataModels.IInProduceSupportCharacterStatus.FromPointer); // 0270D64DB218 0x20 SelfSupportCharacters       ( 000185CFF058 ModelClassListType IReadOnlyList`1<IInProduceSupportCharacterStatus> IReadOnlyList`1<IInProduceSupportCharacterStatus> List<IInProduceSupportCharacterStatus> Pointer )
            value.FriendSupportCharacter                    = GetObject<IInProduceSupportCharacterStatus>(new IntPtr(p + 0x028), ReversePrism.DataModels.IInProduceSupportCharacterStatus.FromPointer); // 0270D64DB238 0x28 FriendSupportCharacter      ( 00018657E840 ModelClassType IInProduceSupportCharacterStatus IInProduceSupportCharacterStatus IInProduceSupportCharacterStatus Pointer )
            value.SupportEffectViewModels                   = GetObjectList<IInProduceSupportEffectContentViewModel>(new IntPtr(p + 0x030), ReversePrism.DataModels.IInProduceSupportEffectContentViewModel.FromPointer); // 0270D64DB258 0x30 SupportEffectViewModels     ( 000185CFF2A8 ModelClassListType IReadOnlyList`1<IInProduceSupportEffectContentViewModel> IReadOnlyList`1<IInProduceSupportEffectContentViewModel> List<IInProduceSupportEffectContentViewModel> Pointer )
