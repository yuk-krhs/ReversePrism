...
namespace ReversePrism.DataModels
{
    ...
    public partial class ProfileSupportCharaSelectViewModel : DataModel
    {
        ...
        public static ProfileSupportCharaSelectViewModel? FromPointer(IntPtr p0)
        {
            ...
            value.DecideReactiveProperty                    = GetObject<BoolReactiveProperty>(new IntPtr(p + 0x010), ReversePrism.DataModels.BoolReactiveProperty.FromPointer); // 0246666F92A8 0x10 DecideReactiveProperty      ( 0001867695E0 ModelClassType BoolReactiveProperty BoolReactiveProperty BoolReactiveProperty Pointer )
            value.SCharaIcons                               = GetObjectList<SCharaIcon>(new IntPtr(p + 0x018), ReversePrism.DataModels.SCharaIcon.FromPointer); // 0246666F92C8 0x18 SCharaIcons                 ( 000185CA2588 ModelClassListType SCharaIcon[] SCharaIcon[] List<SCharaIcon> Pointer )
            value.SCharaIconViewModels                      = GetObjectList<ProfileSupportCharaIconViewModel>(new IntPtr(p + 0x020), ReversePrism.DataModels.ProfileSupportCharaIconViewModel.FromPointer); // 0246666F92E8 0x20 SCharaIconViewModels        ( 000185B9F140 ModelClassListType ProfileSupportCharaIconViewModel[] ProfileSupportCharaIconViewModel[] List<ProfileSupportCharaIconViewModel> Pointer )
            value.Disposables                               = GetObject<CompositeDisposable>(new IntPtr(p + 0x038), ReversePrism.DataModels.CompositeDisposable.FromPointer); // 0246666F9348 0x38 Disposables                 ( 0001865F3230 ModelClassType CompositeDisposable CompositeDisposable CompositeDisposable Pointer )
            value.CursorSelectedSChara                      = GetObject<SCharaIcon>(new IntPtr(p + 0x040), ReversePrism.DataModels.SCharaIcon.FromPointer); // 0246666F9368 0x40 CursorSelectedSChara        ( 0001866A9C80 ModelClassType SCharaIcon SCharaIcon SCharaIcon Pointer )
            value.SettingsCharaId                           = GetInt32(new IntPtr(p + 0x048)); // 0246666F9388 0x48 SettingsCharaId             ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
