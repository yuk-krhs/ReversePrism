...
namespace ReversePrism.DataModels
{
    ...
    // 020 CellList                                 ModelClassType EventStoryFirstCategoryCellList EventStoryFirstCategoryCellList EventStoryFirstCategoryCellList Pointer
    ...
    public partial class StoryTopEventContentView : DataModel
    {
        ...
        public static StoryTopEventContentView? FromPointer(IntPtr p0)
        {
            ...
            value.CellList                                  = GetObject<EventStoryFirstCategoryCellList>(new IntPtr(p + 0x020), ReversePrism.DataModels.EventStoryFirstCategoryCellList.FromPointer); // 0x20 CellList                    ( ModelClassType EventStoryFirstCategoryCellList EventStoryFirstCategoryCellList EventStoryFirstCategoryCellList Pointer )
