...
namespace ReversePrism.DataModels
{
    ...
    public partial class ExtraStorySecondCategoryView
    {
        ...
        public static ExtraStorySecondCategoryView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ExtraStorySecondCategoryView();

            value.UiCharacterViewer                         = GetObject<UICharacterViewer>(new IntPtr(p + 0x020), ReversePrism.DataModels.UICharacterViewer.FromPointer); // 0270DB61FBF0 0x20 UiCharacterViewer           ( 0001866E2C70 ModelClassType UICharacterViewer UICharacterViewer UICharacterViewer Pointer )
            value.CharacterPositionAdjuster                 = GetObject<CenteringObjectsOutsideSafeArea>(new IntPtr(p + 0x028), ReversePrism.DataModels.CenteringObjectsOutsideSafeArea.FromPointer); // 0270DB61FC10 0x28 CharacterPositionAdjuster   ( 000186553690 ModelClassType CenteringObjectsOutsideSafeArea CenteringObjectsOutsideSafeArea CenteringObjectsOutsideSafeArea Pointer )
            value.TitleView                                 = GetObject<CommonTitleView>(new IntPtr(p + 0x030), ReversePrism.DataModels.CommonTitleView.FromPointer); // 0270DB61FC30 0x30 TitleView                   ( 0001865E9D00 ModelClassType CommonTitleView CommonTitleView CommonTitleView Pointer )
            value.SecondCategoryCellList                    = GetObject<ExtraStorySecondCategoryCellList>(new IntPtr(p + 0x038), ReversePrism.DataModels.ExtraStorySecondCategoryCellList.FromPointer); // 0270DB61FC50 0x38 SecondCategoryCellList      ( 00018653D6C0 ModelClassType ExtraStorySecondCategoryCellList ExtraStorySecondCategoryCellList ExtraStorySecondCategoryCellList Pointer )
