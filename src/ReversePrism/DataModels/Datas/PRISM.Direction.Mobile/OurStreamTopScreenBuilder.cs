...
namespace ReversePrism.DataModels
{
    ...
    public partial class OurStreamTopScreenBuilder : DataModel
    {
        ...
        public static OurStreamTopScreenBuilder? FromPointer(IntPtr p0)
        {
            ...
            value.ViewPrefab                                = GetObject<OurStreamTopScreenView>(new IntPtr(p + 0x020), ReversePrism.DataModels.OurStreamTopScreenView.FromPointer); // 02466B6D5800 0x20 ViewPrefab                  ( 0001866FA0B0 ModelClassType OurStreamTopScreenView OurStreamTopScreenView OurStreamTopScreenView Pointer )
            value.DetailPopupViewFactory                    = GetObject<OurStreamLiveContentDetailPopupViewFactory>(new IntPtr(p + 0x028), ReversePrism.DataModels.OurStreamLiveContentDetailPopupViewFactory.FromPointer); // 02466B6D5820 0x28 DetailPopupViewFactory      ( 0001866F42C0 ModelClassType OurStreamLiveContentDetailPopupViewFactory OurStreamLiveContentDetailPopupViewFactory OurStreamLiveContentDetailPopupViewFactory Pointer )
            value.ViewParent                                = GetObject<Transform>(new IntPtr(p + 0x030), ReversePrism.DataModels.Transform.FromPointer); // 02466B6D5840 0x30 ViewParent                  ( 0001866AA150 ModelClassType Transform Transform Transform Pointer )
