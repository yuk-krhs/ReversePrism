...
namespace ReversePrism.DataModels
{
    ...
    public partial class MicroCoroutine
    {
        ...
        public static MicroCoroutine? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new MicroCoroutine();

            value.Tail                                      = GetInt32(new IntPtr(p + 0x028)); // 027003C25E90 0x28 Tail                        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Running                                   = GetBool(new IntPtr(p + 0x02C)); // 027003C25EB0 0x2C Running                     ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
            value.Coroutines                                = GetObjectList<IEnumerator>(new IntPtr(p + 0x030), ReversePrism.DataModels.IEnumerator.FromPointer); // 027003C25ED0 0x30 Coroutines                  ( 000185B86390 ModelClassListType IEnumerator[] IEnumerator[] List<IEnumerator> Pointer )
