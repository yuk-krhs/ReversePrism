...
namespace ReversePrism.DataModels
{
    ...
    // 030 WaitingListCount                         ModelPrimitiveType int int int Int32
    ...
    public partial class ThreadSafeQueueWorker : DataModel
    {
        ...
        public static ThreadSafeQueueWorker? FromPointer(IntPtr p0)
        {
            ...
            value.WaitingListCount                          = GetInt32(new IntPtr(p + 0x030)); // 0x30 WaitingListCount            ( ModelPrimitiveType int int int Int32 )
