...
namespace ReversePrism.DataModels
{
    ...
    public partial class LoggedException
    {
        ...
        public static LoggedException? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new LoggedException();

            value.Name                                      = GetString(new IntPtr(p + 0x090)); // 0270DBC61220 0x90 Name                        ( 000186671910 ModelPrimitiveType string string string String )
            value.CustomStackTrace                          = GetString(new IntPtr(p + 0x098)); // 0270DBC61240 0x98 CustomStackTrace            ( 000186671910 ModelPrimitiveType string string string String )
