...
namespace ReversePrism.DataModels
{
    ...
    // 010 ItemCellDataList                         ModelClassListType IReadOnlyList`1<StoryUnlockPopupItemCellData> IReadOnlyList`1<StoryUnlockPopupItemCellData> List<StoryUnlockPopupItemCellData> Pointer
    public partial class StoryUnlockPopupViewModel : DataModel
    {
        ...
        public static StoryUnlockPopupViewModel? FromPointer(IntPtr p0)
        {
            ...
            value.ItemCellDataList                          = GetObjectList<StoryUnlockPopupItemCellData>(new IntPtr(p + 0x010), ReversePrism.DataModels.StoryUnlockPopupItemCellData.FromPointer); // 0x10 ItemCellDataList            ( ModelClassListType IReadOnlyList`1<StoryUnlockPopupItemCellData> IReadOnlyList`1<StoryUnlockPopupItemCellData> List<StoryUnlockPopupItemCellData> Pointer )
