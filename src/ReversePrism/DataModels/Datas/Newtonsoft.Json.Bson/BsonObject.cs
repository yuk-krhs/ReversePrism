...
namespace ReversePrism.DataModels
{
    ...
    public partial class BsonObject : DataModel
    {
        ...
        public static BsonObject? FromPointer(IntPtr p0)
        {
            ...
            value.Children                                  = GetObjectList<BsonProperty>(new IntPtr(p + 0x020), ReversePrism.DataModels.BsonProperty.FromPointer); // 0246688CCA70 0x20 Children                    ( 000185CCF9A8 ModelClassListType List`1<BsonProperty> List`1<BsonProperty> List<BsonProperty> Pointer )
