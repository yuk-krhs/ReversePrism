...
namespace ReversePrism.DataModels
{
    ...
    public partial class Model3dLoaderForProduceInGameResult : DataModel
    {
        public Model3dLoaderCore?                       Core                                    { get; set; }

        public static Model3dLoaderForProduceInGameResult? FromPointer(IntPtr p0)
        {
            if(p0 == IntPtr.Zero)
                return null;

            var p       = p0.ToInt64();
            var value   = new Model3dLoaderForProduceInGameResult() { Pointer= p0 };
