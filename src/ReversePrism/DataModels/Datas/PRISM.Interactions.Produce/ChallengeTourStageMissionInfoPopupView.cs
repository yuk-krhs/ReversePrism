...
namespace ReversePrism.DataModels
{
    ...
    public partial class ChallengeTourStageMissionInfoPopupView
    {
        ...
        public static ChallengeTourStageMissionInfoPopupView? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new ChallengeTourStageMissionInfoPopupView();

            value.LsitView                                  = GetObject<ChallengeTourStageMissionListView>(new IntPtr(p + 0x020), ReversePrism.DataModels.ChallengeTourStageMissionListView.FromPointer); // 0270DA1C9FF0 0x20 LsitView                    ( 000186583450 ModelClassType ChallengeTourStageMissionListView ChallengeTourStageMissionListView ChallengeTourStageMissionListView Pointer )
            value.ViewModels                                = GetObjectList<ChallengeTourRewardViewModel>(new IntPtr(p + 0x030), ReversePrism.DataModels.ChallengeTourRewardViewModel.FromPointer); // 0270DA1CA030 0x30 ViewModels                  ( 000185B74740 ModelClassListType ChallengeTourRewardViewModel[] ChallengeTourRewardViewModel[] List<ChallengeTourRewardViewModel> Pointer )
            value.Parent                                    = GetObject<IPopupFrameView>(new IntPtr(p + 0x038), ReversePrism.DataModels.IPopupFrameView.FromPointer); // 0270DA1CA050 0x38 Parent                      ( 0001865DAC10 ModelClassType IPopupFrameView IPopupFrameView IPopupFrameView Pointer )
