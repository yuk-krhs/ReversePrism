...
namespace ReversePrism.DataModels
{
    ...
    // 010 Normal                                   ModelEnumType Vector3 Vector3 Vector3 Int32
    ...
    public partial class Plane : DataModel
    {
        ...
        public static Plane? FromPointer(IntPtr p0)
        {
            ...
            value.Normal                                    = (Vector3)GetInt32(new IntPtr(p + 0x010)); // 0x10 Normal                      ( ModelEnumType Vector3 Vector3 Vector3 Int32 )
