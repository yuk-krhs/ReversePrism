...
namespace ReversePrism.DataModels
{
    ...
    public partial class RequestSyncCommand : DataModel
    {
        ...
        public static RequestSyncCommand? FromPointer(IntPtr p0)
        {
            ...
            value.BaseCommand                               = (InputDeviceCommand)GetInt32(new IntPtr(p + 0x010)); // 024667854960 0x10 BaseCommand                 ( 0001865ECDD0 ModelEnumType InputDeviceCommand InputDeviceCommand InputDeviceCommand Int32 )
