...
namespace ReversePrism.DataModels
{
    ...
    // 018 OutDimensions                            ModelEnumType Vector2 Vector2 Vector2 Int32
    public partial class QueryDimensionsCommand : DataModel
    {
        ...
        public static QueryDimensionsCommand? FromPointer(IntPtr p0)
        {
            ...
            value.OutDimensions                             = (Vector2)GetInt32(new IntPtr(p + 0x018)); // 0x18 OutDimensions               ( ModelEnumType Vector2 Vector2 Vector2 Int32 )
