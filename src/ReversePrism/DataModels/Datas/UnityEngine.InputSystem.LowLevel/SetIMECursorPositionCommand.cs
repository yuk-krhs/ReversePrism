...
namespace ReversePrism.DataModels
{
    ...
    // 018 M_Position                               ModelEnumType Vector2 Vector2 Vector2 Int32
    public partial class SetIMECursorPositionCommand : DataModel
    {
        ...
        public static SetIMECursorPositionCommand? FromPointer(IntPtr p0)
        {
            ...
            value.M_Position                                = (Vector2)GetInt32(new IntPtr(p + 0x018)); // 0x18 M_Position                  ( ModelEnumType Vector2 Vector2 Vector2 Int32 )
