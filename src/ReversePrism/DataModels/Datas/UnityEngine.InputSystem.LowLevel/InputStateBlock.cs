...
namespace ReversePrism.DataModels
{
    ...
    public partial class InputStateBlock
    {
        ...
        public static InputStateBlock? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new InputStateBlock();

            value.FormatUInt                                = (FourCC)GetInt32(new IntPtr(p + 0x010)); // 027002E35AF8 0x10 FormatUInt                  ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatShort                               = (FourCC)GetInt32(new IntPtr(p + 0x014)); // 027002E35B38 0x14 FormatShort                 ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatUShort                              = (FourCC)GetInt32(new IntPtr(p + 0x018)); // 027002E35B78 0x18 FormatUShort                ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatByte                                = (FourCC)GetInt32(new IntPtr(p + 0x01C)); // 027002E35BB8 0x1C FormatByte                  ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatSByte                               = (FourCC)GetInt32(new IntPtr(p + 0x020)); // 027002E35BF8 0x20 FormatSByte                 ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatLong                                = (FourCC)GetInt32(new IntPtr(p + 0x024)); // 027002E35C38 0x24 FormatLong                  ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatULong                               = (FourCC)GetInt32(new IntPtr(p + 0x028)); // 027002E35C78 0x28 FormatULong                 ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatFloat                               = (FourCC)GetInt32(new IntPtr(p + 0x02C)); // 027002E35CB8 0x2C FormatFloat                 ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatDouble                              = (FourCC)GetInt32(new IntPtr(p + 0x030)); // 027002E35CF8 0x30 FormatDouble                ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatVector2                             = (FourCC)GetInt32(new IntPtr(p + 0x034)); // 027002E35D38 0x34 FormatVector2               ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatVector3                             = (FourCC)GetInt32(new IntPtr(p + 0x038)); // 027002E35D78 0x38 FormatVector3               ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatQuaternion                          = (FourCC)GetInt32(new IntPtr(p + 0x03C)); // 027002E35DB8 0x3C FormatQuaternion            ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatVector2Short                        = (FourCC)GetInt32(new IntPtr(p + 0x040)); // 027002E35DF8 0x40 FormatVector2Short          ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatVector3Short                        = (FourCC)GetInt32(new IntPtr(p + 0x044)); // 027002E35E18 0x44 FormatVector3Short          ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatVector2Byte                         = (FourCC)GetInt32(new IntPtr(p + 0x048)); // 027002E35E38 0x48 FormatVector2Byte           ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatVector3Byte                         = (FourCC)GetInt32(new IntPtr(p + 0x04C)); // 027002E35E58 0x4C FormatVector3Byte           ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.FormatPose                                = (FourCC)GetInt32(new IntPtr(p + 0x050)); // 027002E35E78 0x50 FormatPose                  ( 0001865BBBA0 ModelEnumType FourCC FourCC FourCC Int32 )
            value.Format                                    = (FourCC)GetInt32(new IntPtr(p + 0x010)); // 027002E35EB8 0x10 Format                      ( 0001865BB210 ModelEnumType FourCC FourCC FourCC Int32 )
            value.M_ByteOffset                              = GetUInt32(new IntPtr(p + 0x014)); // 027002E35ED8 0x14 M_ByteOffset                ( 000186698DF0 ModelPrimitiveType uint uint uint UInt32 )
            value.BitOffset                                 = GetUInt32(new IntPtr(p + 0x018)); // 027002E35EF8 0x18 BitOffset                   ( 000186698B70 ModelPrimitiveType uint uint uint UInt32 )
            value.SizeInBits                                = GetUInt32(new IntPtr(p + 0x01C)); // 027002E35F18 0x1C SizeInBits                  ( 000186698B70 ModelPrimitiveType uint uint uint UInt32 )
