...
namespace ReversePrism.DataModels
{
    ...
    public partial class WarpMousePositionCommand : DataModel
    {
        ...
        public static WarpMousePositionCommand? FromPointer(IntPtr p0)
        {
            ...
            value.BaseCommand                               = (InputDeviceCommand)GetInt32(new IntPtr(p + 0x010)); // 0246678552C8 0x10 BaseCommand                 ( 0001865ECDD0 ModelEnumType InputDeviceCommand InputDeviceCommand InputDeviceCommand Int32 )
            value.WarpPositionInPlayerDisplaySpace          = (Vector2)GetInt32(new IntPtr(p + 0x018)); // 0246678552E8 0x18 WarpPositionInPlayerDisplaySpace ( 0001866A8740 ModelEnumType Vector2 Vector2 Vector2 Int32 )
