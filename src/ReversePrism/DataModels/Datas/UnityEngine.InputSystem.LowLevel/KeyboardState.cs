...
namespace ReversePrism.DataModels
{
    ...
    public partial class KeyboardState
    {
        ...
        public static KeyboardState? FromPointer(IntPtr p0)
        {
            ...
            value.Keys                                      = (<keys>e__FixedBuffer)GetInt32(new IntPtr(p + 0x010)); // 0270D77FDD60 0x10 Keys                        ( 0001866788C0 ModelEnumType <keys>e__FixedBuffer <keys>e__FixedBuffer <keys>e__FixedBuffer Int32 )
