...
namespace ReversePrism.DataModels
{
    ...
    public partial class PrivacyOptionPopupParameter
    {
        ...
        public static PrivacyOptionPopupParameter? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new PrivacyOptionPopupParameter();

            value.IsOnTitleSequence                         = GetBool(new IntPtr(p + 0x010)); // 0270D68F6880 0x10 IsOnTitleSequence           ( 0001865965D0 ModelPrimitiveType bool bool bool Bool )
