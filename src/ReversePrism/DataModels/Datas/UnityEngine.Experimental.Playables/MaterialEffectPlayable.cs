...
namespace ReversePrism.DataModels
{
    ...
    public partial class MaterialEffectPlayable : DataModel
    {
        ...
        public static MaterialEffectPlayable? FromPointer(IntPtr p0)
        {
            ...
            value.M_Handle                                  = (PlayableHandle)GetInt32(new IntPtr(p + 0x010)); // 0245A2396EC8 0x10 M_Handle                    ( 000186640190 ModelEnumType PlayableHandle PlayableHandle PlayableHandle Int32 )
