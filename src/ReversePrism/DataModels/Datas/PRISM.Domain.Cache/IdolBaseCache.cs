...
namespace ReversePrism.DataModels
{
    ...
    public partial class IdolBaseCache
    {
        ...
        public static IdolBaseCache? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new IdolBaseCache();

            value.IsReady                                   = GetBool(new IntPtr(p + 0x018)); // 027004A887C8 0x18 IsReady                     ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
