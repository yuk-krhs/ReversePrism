...
namespace ReversePrism.DataModels
{
    ...
    public partial class CostumeSetCache
    {
        ...
        public static CostumeSetCache? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new CostumeSetCache();

            value.IsReady                                   = GetBool(new IntPtr(p + 0x018)); // 027004A86740 0x18 IsReady                     ( 000186594D10 ModelPrimitiveType bool bool bool Bool )
