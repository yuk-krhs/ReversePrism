...
namespace ReversePrism.DataModels
{
    ...
    // 010 ConverterTypeName                        ModelPrimitiveType string string string String
    public partial class TypeConverterAttribute : DataModel
    {
        ...
        public static TypeConverterAttribute? FromPointer(IntPtr p0)
        {
            ...
            value.ConverterTypeName                         = GetString(new IntPtr(p + 0x010)); // 0x10 ConverterTypeName           ( ModelPrimitiveType string string string String )
