...
namespace ReversePrism.DataModels
{
    ...
    public partial class MessageBase
    {
        ...
        public static MessageBase? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new MessageBase();

            value.Type                                      = GetInt32(new IntPtr(p + 0x010)); // 0270D793BD88 0x10 Type                        ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.Flags                                     = (NtlmFlags)GetInt32(new IntPtr(p + 0x014)); // 0270D793BDA8 0x14 Flags                       ( 0001866B9CA0 ModelEnumType NtlmFlags NtlmFlags NtlmFlags Int32 )
