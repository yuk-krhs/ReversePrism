...
namespace ReversePrism.DataModels
{
    ...
    public partial class XPathParser : DataModel
    {
        ...
        public static XPathParser? FromPointer(IntPtr p0)
        {
            ...
            value.Scanner                                   = GetObject<XPathScanner>(new IntPtr(p + 0x010), ReversePrism.DataModels.XPathScanner.FromPointer); // 024667693710 0x10 Scanner                     ( 000186580D50 ModelClassType XPathScanner XPathScanner XPathScanner Pointer )
            value.ParseDepth                                = GetInt32(new IntPtr(p + 0x018)); // 024667693730 0x18 ParseDepth                  ( 0001865F2AF0 ModelPrimitiveType int int int Int32 )
            value.S_temparray3                              = GetEnumList<XPathResultType>(new IntPtr(p + 0x010)); // 024667693790 0x10 S_temparray3                ( 000185CB3408 ModelEnumListType XPathResultType[] XPathResultType[] List<XPathResultType> Pointer )
            value.S_temparray4                              = GetEnumList<XPathResultType>(new IntPtr(p + 0x018)); // 0246676937B0 0x18 S_temparray4                ( 000185CB3408 ModelEnumListType XPathResultType[] XPathResultType[] List<XPathResultType> Pointer )
            value.S_temparray5                              = GetEnumList<XPathResultType>(new IntPtr(p + 0x020)); // 0246676937D0 0x20 S_temparray5                ( 000185CB3408 ModelEnumListType XPathResultType[] XPathResultType[] List<XPathResultType> Pointer )
            value.S_temparray6                              = GetEnumList<XPathResultType>(new IntPtr(p + 0x028)); // 0246676937F0 0x28 S_temparray6                ( 000185CB3408 ModelEnumListType XPathResultType[] XPathResultType[] List<XPathResultType> Pointer )
            value.S_temparray7                              = GetEnumList<XPathResultType>(new IntPtr(p + 0x030)); // 024667693810 0x30 S_temparray7                ( 000185CB3408 ModelEnumListType XPathResultType[] XPathResultType[] List<XPathResultType> Pointer )
            value.S_temparray8                              = GetEnumList<XPathResultType>(new IntPtr(p + 0x038)); // 024667693830 0x38 S_temparray8                ( 000185CB3408 ModelEnumListType XPathResultType[] XPathResultType[] List<XPathResultType> Pointer )
            value.S_temparray9                              = GetEnumList<XPathResultType>(new IntPtr(p + 0x040)); // 024667693850 0x40 S_temparray9                ( 000185CB3408 ModelEnumListType XPathResultType[] XPathResultType[] List<XPathResultType> Pointer )
