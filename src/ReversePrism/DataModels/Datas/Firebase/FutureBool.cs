...
namespace ReversePrism.DataModels
{
    ...
    public partial class FutureBool
    {
        ...
        public static FutureBool? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new FutureBool();

            value.SwigCPtr                                  = (HandleRef)GetInt32(new IntPtr(p + 0x028)); // 0270DB768598 0x28 SwigCPtr                    ( 0001866A7EC0 ModelEnumType HandleRef HandleRef HandleRef Int32 )
            value.SWIG_CompletionCB                         = GetObject<SWIG_CompletionDelegate>(new IntPtr(p + 0x040), ReversePrism.DataModels.SWIG_CompletionDelegate.FromPointer); // 0270DB768638 0x40 SWIG_CompletionCB           ( 0001866DD580 ModelClassType SWIG_CompletionDelegate SWIG_CompletionDelegate SWIG_CompletionDelegate Pointer )
