...
namespace ReversePrism.DataModels
{
    ...
    public partial class FutureBase : DataModel
    {
        ...
        public static FutureBase? FromPointer(IntPtr p0)
        {
            ...
            value.SwigCPtr                                  = (HandleRef)GetInt32(new IntPtr(p + 0x010)); // 02466B7DBB28 0x10 SwigCPtr                    ( 0001866A7EC0 ModelEnumType HandleRef HandleRef HandleRef Int32 )
            value.SwigCMemOwn                               = GetBool(new IntPtr(p + 0x020)); // 02466B7DBB48 0x20 SwigCMemOwn                 ( 000186595480 ModelPrimitiveType bool bool bool Bool )
