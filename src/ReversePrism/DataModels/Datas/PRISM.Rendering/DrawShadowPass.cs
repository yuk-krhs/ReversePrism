...
namespace ReversePrism.DataModels
{
    ...
    public partial class DrawShadowPass
    {
        ...
        public static DrawShadowPass? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new DrawShadowPass();

            value.ShaderTagIdList                           = GetEnumList<ShaderTagId>(new IntPtr(p + 0x010)); // 0270D0AC1860 0x10 ShaderTagIdList             ( 000185D08628 ModelEnumListType List`1<ShaderTagId> List`1<ShaderTagId> List<ShaderTagId> Pointer )
            value.RenderTargetIdentifiers                   = GetEnumList<RenderTargetIdentifier>(new IntPtr(p + 0x018)); // 0270D0AC1880 0x18 RenderTargetIdentifiers     ( 000185CA0AC8 ModelEnumListType RenderTargetIdentifier[] RenderTargetIdentifier[] List<RenderTargetIdentifier> Pointer )
