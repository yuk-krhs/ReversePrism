...
namespace ReversePrism.DataModels
{
    ...
    // 018 DrawPassNames                            ModelEnumListType List`1<ShaderTagId> List`1<ShaderTagId> List<ShaderTagId> Pointer
    // 020 FilteringSettings                        ModelEnumType FilteringSettings FilteringSettings FilteringSettings Int32
    public partial class DrawTransparentPass : DataModel
    {
        ...
        public static DrawTransparentPass? FromPointer(IntPtr p0)
        {
            ...
            value.DrawPassNames                             = GetEnumList<ShaderTagId>(new IntPtr(p + 0x018)); // 0x18 DrawPassNames               ( ModelEnumListType List`1<ShaderTagId> List`1<ShaderTagId> List<ShaderTagId> Pointer )
            value.FilteringSettings                         = (FilteringSettings)GetInt32(new IntPtr(p + 0x020)); // 0x20 FilteringSettings           ( ModelEnumType FilteringSettings FilteringSettings FilteringSettings Int32 )
