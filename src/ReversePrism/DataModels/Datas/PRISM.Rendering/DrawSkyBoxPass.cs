...
namespace ReversePrism.DataModels
{
    ...
    public partial class DrawSkyBoxPass
    {
        ...
        public static DrawSkyBoxPass? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new DrawSkyBoxPass();

            value.RenderTargetIdentifiers                   = GetEnumList<RenderTargetIdentifier>(new IntPtr(p + 0x010)); // 0270D0AC1A80 0x10 RenderTargetIdentifiers     ( 000185CA0AC8 ModelEnumListType RenderTargetIdentifier[] RenderTargetIdentifier[] List<RenderTargetIdentifier> Pointer )
