...
namespace ReversePrism.DataModels
{
    ...
    public partial class HttpEncoder
    {
        ...
        public static HttpEncoder? FromPointer(IntPtr p0)
        {
            ...
            var p       = p0.ToInt64();
            var value   = new HttpEncoder();

            value.CurrentEncoder                            = GetObject<HttpEncoder>(new IntPtr(p + 0x028), ReversePrism.DataModels.HttpEncoder.FromPointer); // 0270D79999E0 0x28 CurrentEncoder              ( 0001866DE820 ModelClassType HttpEncoder HttpEncoder HttpEncoder Pointer )
